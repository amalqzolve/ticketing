...
var payment_list_table = $('#payment_list').DataTable({
	...
	buttons: [{
		...
		},
		{
            ...
            doc.content[1].table.widths = [ '50%',  '50%', '30%'];
                       }
		},
		{
			extend: 'print',
			...
			if (result.value) {
				...
				$.ajax({
					...
					success: function(data) {
						...
						window.location.href = "settingspaymentTerms";
