      ...
      columns: [
          ...
          { data: 'tax_percentage', name: 'tax_percentage' },
          {
            ...
            <div class="dropdown"><a data-toggle="dropdown" class="btn btn-sm btn-clean btn-icon btn-icon-md">\
                        ...
                        <ul class="kt-nav">\
                        <a href="settingsedit_tax?id=' + row.id + '" data-type="edit" data-target="#product_category"><li class="kt-nav__item">\
                        <span class="kt-nav__link">\
                        <i class="kt-nav__link-icon flaticon2-edit"></i>\
                        <span class="kt-nav__link-text" data-id="' + row.id + '" >Edit</span>\
                        </span></li></a>\
                        <a href="settingsTaxView?id=' + row.id + '" data-type="edit" data-target="#kt_form"><li class="kt-nav__item">\
                        <span class="kt-nav__link">\
                        ...
                        <span class="kt-nav__link-text taxdelete" id=' + row.id + ' data-id=' + row.id + '>Delete</span></span></li>\
                       </ul></div></div></span>';
              }
          },
...
$(document).on('click', '#tax_submit', function(e) {
    e.preventDefault();
        ...
        if (tax_name == ""){
            ...
            $('#tax_name').removeClass('is-invalid');
        }

        if (tax_percentage == "") {
            $('#tax_percentage').addClass('is-invalid');
            return false;
        } else {
             $('#tax_percentage').removeClass('is-invalid');
         }
        ...
        success: function(data) {
          if(data == false)
          {
           ...
           else
           {
             ...
             $('#tax_submit').prop("disabled", false);
              window.location.href = "settingstax";
             toastr.success('Tax '+sucess_msg+' successfuly');
             closeModel();
           }
