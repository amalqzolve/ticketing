...
$(document).ready(function () {
      ...
      var maindetails_list_table = $('#maindetails_list').DataTable({
            ...
            columns: [
                  {
                        data: 'id', name: 'id', render: function (data, type, row) {
                              if ((row.status != null))
                                    ...
                                    if (row.is_parent != 1)
                                          return '<input type="checkbox" class="vcheck" id="' + row.id + '" value="' + row.id + '" />';
                                    else
                                          return '<input type="checkbox" class="" id="" value="" disabled="disabled" />';
                              }
                        }
                  },
            ...
            columnDefs: [
                  { width: '50px', "orderable": false, "searchable": false, targets: [0] },
                  { width: '70px', targets: [1, 2, 5] },
                  { width: '120px', targets: [4, 3] }
            ],
            fixedColumns: true,
      });
      // 
