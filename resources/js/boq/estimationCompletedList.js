...
$('.list-boq-estimation-completed').addClass('kt-menu__item--active');
...
var maindetails_list_table = $('#maindetails_list').DataTable({
    ...
    ajax: {
        "url": 'list-boq-estimation-completed',
        "type": "POST",
        "data": function (data) {
            ...
            render: function (data, type, row) {
                ...
                if (row.status == null) {
                    ...
                    j = '<li class="kt-nav__item callBack" data-id="' + row.id + '">\
                            ...
                            <li class="kt-nav__item sendToTender" data-id="' + row.id + '">\
                                <span class="kt-nav__link">\
                                <i class="kt-nav__link-icon flaticon2-paper-plane"></i>\
                                 <span class="kt-nav__link-text " data-id="' + row.id + '">Send To Tender</span>\
                             </span>\
                          </li>';
...
$('#maindetails_list').on('click', 'tbody td', function () {
    ...
    if ((index) && (index != 9)) {
        ...
        window.location.href = 'view-childen-estimation-completed?id=' + data.id;
    }
});
