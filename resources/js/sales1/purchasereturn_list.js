var purchasereturndetails_list_table = $('#purchasereturndetails_list').DataTable({
      processing: true,
      serverSide: true,
      scrollX: true,
      ...
      columns: [
          ...
          
          {
            ...
            <div class="dropdown"><a data-toggle="dropdown" class="btn btn-sm btn-clean btn-icon btn-icon-md">\
                        ...
                        <ul class="kt-nav">\
                        <a href="edit_purchasereturn?id=' + row.id + '" data-type="edit" data-target="#kt_form"><li class="kt-nav__item">\
                        ...
                        <span class="kt-nav__link-text kt_purchasereturn_delete" id=' + row.id + ' data-id=' + row.id + '>Delete</span></span></li>\
                       </ul></div></div></span>';
              }
          },
      ]
...
$(document).on('click', '#purchasereturn_submit', function(e) {
    e.preventDefault();
    ...
    $.ajax({
        ...
        data: {
            ...
            purchasereturnno : $('#purchasereturnno').val(),
        ...
        success: function(data) {
            ...
            if(data == false)
          {
            $('#purchasereturn_submit').removeClass('kt-spinner');
            $('#purchasereturn_submit').prop("disabled", false);
             toastr.warning('The Purchase Return Number Already Exists');
          ...
          else
          {
            $('#purchasereturn_submit').removeClass('kt-spinner');
            $('#purchasereturn_submit').prop("disabled", false);
            toastr.success('Purchase Return Details Added Successfuly');

            // swal.fire("Done", "Submission Sucessfully", "success");
            location.reload();
            window.location.href = "purchasesreturn";
            }
        },
 ...
 $(document).on('click', '.kt_purchasereturn_delete', function() {
    var id = $(this).attr('id');
    swal.fire({
        title: "Are you sure?",
        ...
        if (result.value) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    purchasereturndetails_list_table.ajax.reload();
                }
            });
        } else {
