...
var creditnotedetails_list_table = $('#creditnotedetails_list').DataTable({
      ...
      columns: [
          ...
          
          {
              ...
              render: function(data, type, row) {
                var j='';
                     j='<a href="creditnotepdf?id=' + row.id +'" target="_blank" data-type="edit" data-target="#kt_form" ><li class="kt-nav__item">\
                        <span class="kt-nav__link">\
                        <i class="kt-nav__link-icon flaticon2-file-1"></i>\
                        <span class="kt-nav__link-text" data-id="' + row.id + '" >PDF</span>\
                        </span></li></a><a href="creditnotepdfletter?id=' + row.id +'" target="_blank" data-type="edit" data-target="#kt_form" ><li class="kt-nav__item">\
                        <span class="kt-nav__link">\
                        <i class="kt-nav__link-icon flaticon2-file-1"></i>\
...
$(document).on('click', '#creditnote_customer_submit', function(e) {
    e.preventDefault();
   ...
   var vat_percentage = [];
    ...
    $.ajax({
        ...
        success: function(data) {
             ...
             $('#creditnote_customer_submit').removeClass('kt-spinner');
             $('#creditnote_customer_submit').prop("disabled", false);
             location.reload();
              window.location.href = "creditnote";
             toastr.success('Credit Note - Customer'+sucess_msg+' successfuly');
...
$(document).on('click', '#creditnote_supplier_submit', function(e) {
    e.preventDefault();
   ...
   var vat_percentage = [];
    ...
    $.ajax({
        ...
        success: function(data) {
             ...
             $('#creditnote_supplier_submit').removeClass('kt-spinner');
             $('#creditnote_supplier_submit').prop("disabled", false);
             location.reload();
              window.location.href = "creditnote";
             toastr.success('Credit Note - Customer'+sucess_msg+' successfuly');
