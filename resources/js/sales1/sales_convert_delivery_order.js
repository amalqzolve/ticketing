...
final_calculate1();
    ...
    $(document).on('click', '#sales_convert_deliveryorder_update', function(e) {
    e.preventDefault();
  ...
  var dquantity = [];
   ...
   var vat_percentage = [];
    ...
    $.ajax({
        type: "POST",
        url: "sales_convert_deliveryorder_update",
        dataType: "text",
        data: {
            _token: $('#token').val(),
        id            : $('#id').val(),
        ...
        success: function(data) {
             ...
             $('#sales_convert_deliveryorder_update').removeClass('kt-spinner');
             $('#sales_convert_deliveryorder_update').prop("disabled", false);
             location.reload();
