      ...
      columns: [
...

          {
              ...
              render: function(data, type, row) {
                 if (row.invoice == 0) 
                {
                     return '<span style="color: red">Invoice Not Generated</span>';
                }
                if (row.invoice == 1) 
                {
...

          {
              ...
              render: function(data, type, row) {
                var j='';
                     j='<a href="pinvoice_pdf?id=' + row.id + '" target="_blank" data-type="edit" data-target="#kt_form" ><li class="kt-nav__item">\
                        <span class="kt-nav__link">\
                        <i class="kt-nav__link-icon flaticon2-file-1"></i>\
                        <span class="kt-nav__link-text" data-id="' + row.id + '" >PDF Letterhead</span>\
                        </span></li></a> <a href="pinvoice_pdf_print?id=' + row.id +'" target="_blank" data-type="edit" data-target="#kt_form"><li class="kt-nav__item">\
                        <span class="kt-nav__link">\
                        <i class="kt-nav__link-icon flaticon2-reload-1"></i>\
                        <span class="kt-nav__link-text" data-id="' + row.id + '" >PDF</span>\
                        </span></li></a>\
                        <a href="pinvoice_edit?id=' + row.id + '&&cid='+row.customer+'" data-type="edit" data-target="#kt_form"><li class="kt-nav__item">\
                        <span class="kt-nav__link">\
                        <i class="kt-nav__link-icon flaticon2-reload-1"></i>\
                    ...
                    if (row.invoice == 0) 
                {
                       j+='<a href="performa_convert?id=' + row.id + '" data-type="edit" data-target="#kt_form"><li class="kt-nav__item">\
                        <span class="kt-nav__link">\
   ...
   var vat_percentage = [];
    ...
    $.ajax({
        ...
        success: function(data) {
             ...
             toastr.success('Perfoma Invoice'+sucess_msg+' successfuly');
