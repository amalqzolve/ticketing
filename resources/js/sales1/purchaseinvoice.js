...
var newpurchaseinvoicedetails_list_table = $('#newpurchaseinvoicedetails_list').DataTable({
      processing: true,
      serverSide: true,
...

          {
              ...
              render: function(data, type, row) {
                var j='';
                 ...
                 j='<a href="purchaseinvoice_pdf?id=' + row.pi_id + '" data-type="edit" target="_blank"><li class="kt-nav__item">\
                        <span class="kt-nav__link">\
                        <i class="kt-nav__link-icon flaticon2-reload-1"></i>\
                        <span class="kt-nav__link-text" data-id="' + row.pi_id + '" >PDF</span>\
                        </span></li></a>';
...
var purchaseinvoicedetails_list_table = $('#purchaseinvoicedetails_list').DataTable({
      processing: true,
      serverSide: true,
      pagingType: "full_numbers",
      dom: 'Blfrtip',
...

          {
              ...
              render: function(data, type, row) {
                var j='';
                 ...
                 j='<a href="purchaseinvoice_pdf?id=' + row.id + '" data-type="edit" target="_blank"><li class="kt-nav__item">\
                        <span class="kt-nav__link">\
                        <i class="kt-nav__link-icon flaticon2-reload-1"></i>\
                        <span class="kt-nav__link-text" data-id="' + row.id + '" >Technical PO PDF</span>\
                        </span></li></a><a href="purchaseinvoice_pdf1?id=' + row.id + '" data-type="edit" target="_blank"><li class="kt-nav__item">\
                        <span class="kt-nav__link">\
                        <i class="kt-nav__link-icon flaticon2-reload-1"></i>\
