var quotationdetails_list_table = $('#quotationdetails_list').DataTable({
      ...
      columns: [
          ...
          { data: 'purchaseno', name: 'purchaseno' },
          ...
          
          {
            ...
            <div class="dropdown"><a data-toggle="dropdown" class="btn btn-sm btn-clean btn-icon btn-icon-md">\
                        ...
                        <ul class="kt-nav">\
                        <a href="edit_quotation?id=' + row.id + '" data-type="edit" data-target="#kt_form"><li class="kt-nav__item">\
                        <span class="kt-nav__link">\
                        <i class="kt-nav__link-icon flaticon2-contract"></i>\
                        <span class="kt-nav__link-text" data-id="' + row.id + '" >Edit</span>\
                        </span></li></a>\
                        <a href="view_quotation?id=' + row.id + '" data-type="edit" data-target="#kt_form"><li class="kt-nav__item">\
                        <span class="kt-nav__link">\
                        <i class="kt-nav__link-icon flaticon2-contract"></i>\
                        <span class="kt-nav__link-text" data-id="' + row.id + '" >View</span>\
                        </span></li></a>\
                        <a href="pdf_quotation?id=' + row.id + '" target="_blank" data-type="edit" data-target="#kt_form"><li class="kt-nav__item">\
                        <span class="kt-nav__link">\
                        <i class="kt-nav__link-icon flaticon2-contract"></i>\
                        ...
                        <span class="kt-nav__link-text delete_quotation" id=' + row.id + ' data-id=' + row.id + '>Delete</span></span></li>\
                       </ul></div></div></span>';
              }
          },
      ]
...
$(document).on('click', '#quotation_submit', function(e) {
    e.preventDefault();
    var checkedValue  = $('.ven_sup:checked').val();
    var product_code  = $('#supplier_vendor_names').val();
    var purchase_date = $('#purchase_order_date').val();
    var deliverto     = $('.deliver:checked').val();
 ...
 var newbatchname = [];
    ...
    $("select[name^='extbatchname[]']")
        ...
        if (product_code == "") {
            ...
            toastr.warning("Please Add Product Code!");
                      return false;
        } else {
        ...
        if (deliver_name == "") {
            ...
            toastr.warning("Please Add Deliver Name!");
                      return false;
        } else {
        ...
        if (recievedto == "") {
            ...
            toastr.warning("Please Add Reciever!");
                      return false;
        } else {
        ...
        if (purchaseno == "") {
            ...
            toastr.warning("Please Add Purchase Number!");
                      return false;
        } else {
        ...
        success: function(data) {
          ...
          if(data == false)
          {
            ...
            $('#quotation_submit').prop("disabled", false);
             toastr.warning('The Quotation Number Already Exists');
           ...
           else
           {
            ...
            toastr.success('Quotation Details Added Successfuly');
            ...
            if (result.value) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        quotationdetails_list_table.ajax.reload();
                    }
                });
            } else {
