...
var mrWorkflow = $('#mrWorkflow').DataTable({
    ...
    columns: [
        ...
        {
            data: 'voucher_name', name: 'voucher_name', render: function (data, type, row) {
                return row.prefix + '~' + row.voucher_name;
            }
        },
        { data: 'decription', name: 'decription', "sType": "html" },
        {
            data: 'action',
            name: 'action',
          ...
          <div class="dropdown"><a data-toggle="dropdown" class="btn btn-sm btn-clean btn-icon btn-icon-md">\
                      ...
                      <ul class="kt-nav">\
                      <a href="synthesis-edit-view?id=' + row.id + '" data-type="edit" data-target="#product_category"><li class="kt-nav__item">\
                      <span class="kt-nav__link">\
                      <i class="kt-nav__link-icon flaticon2-edit"></i>\
                      <span class="kt-nav__link-text" data-id="' + row.id + '" >Edit</span>\
                      </span></li></a>\
                      <a href="synthesis-view?id=' + row.id + '" data-type="edit" data-target="#kt_form"><li class="kt-nav__item">\
                      <span class="kt-nav__link">\
