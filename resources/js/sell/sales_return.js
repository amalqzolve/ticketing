$(document).on('click', '#sell_return_update', function(e) {
    e.preventDefault();
   ...
   var vat_percentage = [];
    ...
    $.ajax({
        ...
        success: function(data) {
         ...
         //    $('#sell_return_update').removeClass('kt-spinner');
              window.location.href = "sales_return_list_sell";
             toastr.success('Sales Return'+sucess_msg+' successfuly');
             $('#sell_return_update').prop("disabled", false);
