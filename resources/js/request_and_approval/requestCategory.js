...
$('.request-category').addClass('kt-menu__item--active');
    ...
    columns: [
        ...
        },
        {
          ...
          <div class="dropdown"><a data-toggle="dropdown" class="btn btn-sm btn-clean btn-icon btn-icon-md">\
                      ...
                      <ul class="kt-nav">\
                      <a href="request-category-edit?id=' + row.id + '" data-type="edit" data-target="#product_category"><li class="kt-nav__item">\
                      <span class="kt-nav__link">\
                      <i class="kt-nav__link-icon flaticon2-edit"></i>\
                      <span class="kt-nav__link-text" data-id="' + row.id + '" >Edit</span>\
                      </span></li></a>\
                      <a href="request-category-view?id=' + row.id + '" data-type="edit" data-target="#kt_form"><li class="kt-nav__item">\
                      <span class="kt-nav__link">\
...
function back() {
    window.location.href = "request-category";
}
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data == false) {
                ...
                toastr.error('Request category already exist');
                ...
                $('#tax_submit').prop("disabled", false);
                window.location.href = "request-category";
                toastr.success('Request category ' + sucess_msg + ' successfuly');
                closeModel();
            }
