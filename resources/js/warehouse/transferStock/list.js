            ...
            render: function (data, type, row) {
                ...
                if (row.status == 1) {
                    j = '<a href="transfer-stock-pdf?id=' + row.id + '" target="_blank" data-type="edit" data-target="#kt_form" ><li class="kt-nav__item">\
                        ...
                        <a href="transfer-stock-edit-view?id=' + row.id + '" data-type="edit" data-target="#kt_form"><li class="kt-nav__item">\
                        <span class="kt-nav__link">\
                        ...
                        <span class="kt-nav__link-text" data-id="' + row.id + '" id=' + row.id + '>Transfer Stock</span>\
                        </span></li></a>';
                }
                if (row.status == 2) {
                    j = '<a href="transfer-stock-pdf?id=' + row.id + '" target="_blank" data-type="edit" data-target="#kt_form" ><li class="kt-nav__item">\
...
$(document).on('click', '.send_req', function () {
    ...
    swal.fire({
        title: "Are you sure?",
        text: "Do you want Send this Transfer Stock To next level",
        type: "warning",
        ...
        if (result.value) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.status == 1) {
                        toastr.success('Transfer Stock Send successfuly');
