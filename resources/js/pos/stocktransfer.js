	var stocktransferdetails_list_table = $('#stocktransferdetails_list').DataTable({
			processing: true,
			serverSide: true,
			...
			columns: [
					...
					
					{
						...
						<div class="dropdown"><a data-toggle="dropdown" class="btn btn-sm btn-clean btn-icon btn-icon-md">\
												...
												<ul class="kt-nav">\
												<a href="stocktransfer_pdf?id=' + row.id + '" data-type="edit" target="_blank"><li class="kt-nav__item">\
    ...
    $(document).on('click', '#stocktransfersubmit', function(e) {
				e.preventDefault();
				van = $('#van').val();
				date = $('#date').val();
				notes = $('#notes').val();
				...
				$.ajax({
						...
						success: function(data) {
							console.log(data);
								$('#stocktransfersubmit').removeClass('kt-spinner');
								$('#stocktransfersubmit').prop("disabled", false);
								// location.reload();
								toastr.success('Stock Transfer '+sucess_msg+' Successfuly');
