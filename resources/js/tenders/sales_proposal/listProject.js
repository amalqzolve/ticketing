...
var boqListTbl = $('#draftTbl').DataTable({
    ...
    ajax: {
        "url": 'sales-proposal-list-project',
        "type": "POST",
        "data": function (data) {
...
var boqListTbl = $('#sendTbl').DataTable({
    ...
    ajax: {
        "url": 'sales-proposal-list-project-send',
        "type": "POST",
        "data": function (data) {
            data._token = $('#token').val()
        }
...
var boqListTbl = $('#approvedTbl').DataTable({
    ...
    ajax: {
        "url": 'sales-proposal-list-project-approved',
        "type": "POST",
        "data": function (data) {
            data._token = $('#token').val()
        }
...
var boqListTbl = $('#rejectedTbl').DataTable({
    ...
    ajax: {
        "url": 'sales-proposal-list-project-rejected',
        "type": "POST",
        "data": function (data) {
            data._token = $('#token').val()
        }
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.status == 1) {
                        ...
                        window.location.href = "sales-proposal-list-project";
                    } else {
