...
$('.sales-proposal-synthesis').addClass('kt-menu__item--active');
var mrWorkflow = $('#mrWorkflow').DataTable({
    processing: true,
    serverSide: true,
    ...
    columns: [
        ...
        },
        {
          ...
          <div class="dropdown"><a data-toggle="dropdown" class="btn btn-sm btn-clean btn-icon btn-icon-md">\
                      ...
                      <ul class="kt-nav">\
                      <a href="sales-proposal-synthesis-edit-view?id=' + row.id + '" data-type="edit" data-target="#product_category"><li class="kt-nav__item">\
                      <span class="kt-nav__link">\
                      <i class="kt-nav__link-icon flaticon2-edit"></i>\
                      <span class="kt-nav__link-text" data-id="' + row.id + '" >Edit</span>\
                      </span></li></a>\
                      <a href="sales-proposal-synthesis-clone?id=' + row.id + '" data-type="edit" data-target="#kt_form"><li class="kt-nav__item">\
                      <span class="kt-nav__link">\
...
var tax_trash_list_table = $('#tax_trash_list').DataTable({
   ...
   lengthMenu: [
    ...
    ajax: {
        "url": 'sales-proposal-synthesis-delete',
        "type": "POST",
        "data": function (data) {
            data._token = $('#token').val()
        }
...
$("#export-button-print").on("click", function () {
    mrWorkflow.button('.buttons-print').trigger();
});
$("#export-button-copy").on("click", function () {
    mrWorkflow.button('.buttons-copy').trigger();
});

$("#export-button-csv").on("click", function () {
    mrWorkflow.button('.buttons-csv').trigger();
});

$("#export-button-pdf").on("click", function () {
    mrWorkflow.button('.buttons-pdf').trigger();
});
