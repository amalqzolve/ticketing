...
var costmatrixdetails_list_table = $('#costmatrixdetails_list').DataTable({
      processing: true,
      serverSide: true,
      ...
      columns: [
            ...
            { data: 'costmatrixname', name: 'costmatrixname' },
            { data: 'description', name: 'description' },
            {
                  ...
                  <div class="dropdown"><a data-toggle="dropdown" class="btn btn-sm btn-clean btn-icon btn-icon-md">\
                                    ...
                                    <ul class="kt-nav">\
                                    <a href="costmatrixedit?id='+ row.id + '" data-type="edit" data-target="#kt_form"><li class="kt-nav__item">\
...
$("#export-button-print").on("click", function () {
      costmatrixdetails_list_table.button('.buttons-print').trigger();
});
$("#export-button-copy").on("click", function () {
      costmatrixdetails_list_table.button('.buttons-copy').trigger();
});
$("#export-button-csv").on("click", function () {
      costmatrixdetails_list_table.button('.buttons-csv').trigger();
});
$("#export-button-pdf").on("click", function () {
      costmatrixdetails_list_table.button('.buttons-pdf').trigger();
});
