            ...
            columns: [
                  ...
                  { data: 'estimation_amount', name: 'estimation_amount' },
                  {
                        ...
                        render: function (data, type, row) {
                              var j = '';
                              if ((row.is_parent != 1) && (row.estimation_status != 1)) {
                                    j = '<a href="cost-describe?id=' + row.id + '" data-type="edit" data-target="#kt_form" ><li class="kt-nav__item">\
                            <span class="kt-nav__link">\
                            <i class="kt-nav__link-icon flaticon2-graph-1"></i>\
                            <span class="kt-nav__link-text" data-id="' + row.id + '" >Prepare Estimation</span>\
                            </span></li></a>\
