...
$(document).on('click', '.delete', function () {
    ...
    swal.fire({
        title: "Are you sure?",
        text: "Do you want trash this Agreement",
        type: "warning",
        ...
        if (result.value) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.status == 1) {
                        closeModel()
                        toastr.warning('Agreements Trashed successfuly');
                    } else
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.status == 1) {
                    ...
                    toastr.success('Note Saved ' + sucess_msg + ' successfuly');
                    closeModel();
                }
                else {
                    $('#btnSave').removeClass('kt-spinner');
