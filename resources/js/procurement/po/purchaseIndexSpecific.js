...
var closedTbl = $('#closedTbl').DataTable({
    ...
    ajax: {
        "url": 'purchase-index-list-specific',
        "type": "POST",
        "data": function (data) {
    ...
    columns: [
        ...
        },
        {
            ...
            render: function (data, type, row) {
                var j = '<a href="epr-po-pdf?id=' + row.id + '" target="_blank" data-type="edit" data-target="#kt_form" ><li class="kt-nav__item">\
                        ...
                        <a href="purchase-index-pdf?id=' + row.id + '" target="_blank" data-type="edit" data-target="#kt_form" ><li class="kt-nav__item">\
                        <span class="kt-nav__link">\
                        <i class="kt-nav__link-icon flaticon-background"></i>\
                        <span class="kt-nav__link-text" data-id="' + row.id + '" >Purchase Index</span>\
                        </span></li></a>\
