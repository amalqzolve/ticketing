        ...
        },
        {
            ...
            render: function (data, type, row) {
                ...
                if (row.status == 1) {//approval pending
                    j = '<a href="epr-po-pdf?id=' + row.po_id + '" target="_blank" data-type="edit" data-target="#kt_form" ><li class="kt-nav__item">\
                    <span class="kt-nav__link">\
                    <i class="kt-nav__link-icon flaticon-background"></i>\
                    <span class="kt-nav__link-text" data-id="' + row.id + '" >Internal PO</span>\
                    </span></li></a>\
                    <a href="epr-po-pdf-no-sign?id=' + row.po_id + '" target="_blank" data-type="edit" data-target="#kt_form" ><li class="kt-nav__item">\
                    <span class="kt-nav__link">\
                    <i class="kt-nav__link-icon flaticon2-file-1"></i>\
                    <span class="kt-nav__link-text" data-id="' + row.id + '" >Commercial PO</span>\
                    </span></li></a>\
                    <a href="epr-po-pdf-technical?id=' + row.po_id + '" target="_blank" data-type="edit" data-target="#kt_form" ><li class="kt-nav__item">\
                        <span class="kt-nav__link">\
                        <i class="kt-nav__link-icon flaticon2-file-1"></i>\
                        <span class="kt-nav__link-text" data-id="' + row.id + '" >Technical PO</span>\
                        </span></li></a>\
                    <a href="suggestion-send?id=' + row.po_id + '&type=PO" target="_blank" data-type="edit" data-target="#kt_form" ><li class="kt-nav__item">\
                    <span class="kt-nav__link">\
                    <i class="kt-nav__link-icon flaticon2-file-1"></i>\
                    <span class="kt-nav__link-text">Suggestion</span>\
                    </span></li></a>\
                    <a data-type="approved" data-target="#kt_form"><li class="kt-nav__item viewSynHistory" id=' + row.po_id + '>\
                        <span class="kt-nav__link">\
                        <i class="kt-nav__link-icon flaticon2-check-mark"></i>\
                        <span class="kt-nav__link-text" data-id="' + row.po_id + '" id=' + row.po_id + '>Synthesis Milestone </span>\
                        </span></li></a>\
                    <a data-type="approved" data-target="#kt_form"><li class="kt-nav__item po_approve" id=' + row.id + '>\
                        ...
                        <a data-type="edit" data-target="#kt_form"><li class="kt-nav__item po_return" id=' + row.id + '>\
                        <span class="kt-nav__link">\
...
var approvedTbl = $('#approvedTbl').DataTable({
    ...
    ajax: {
        "url": 'epr-po-approve-list-approved',
        "type": "POST",
        "data": function (data) {
            data._token = $('#token').val()
        }
...
$(document).on('click', '.po_approve', function () {
    ...
    swal.fire({
        title: "Are you sure?",
        text: "Do you want Approve this PO",
        type: "warning",
        ...
        if (result.value) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.status == 1) {
                        loaderClose();
                        toastr.success('EPR Send for Approved successfuly');
                        window.location.href = "epr-po-approve-list";
                    } else
...
$(document).on('click', '.po_return', function () {
    var id = $(this).attr('id');
    swal.fire({
        title: "Are you sure?",
        text: "Do you want return this PO",
        type: "warning",
        showCancelButton: true,
        confirmButtonClass: "btn-danger",
