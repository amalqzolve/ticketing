        ...
        },
        {
            ...
            render: function (data, type, row) {
                ...
                if (row.status == 1) {//approval pending
                    j = '<a href="epr-po-grn-pdf?id=' + row.grn_id + '" target="_blank" data-type="edit" data-target="#kt_form" ><li class="kt-nav__item">\
                    <span class="kt-nav__link">\
                    <i class="kt-nav__link-icon flaticon-background"></i>\
                    <span class="kt-nav__link-text" data-id="' + row.grn_id + '" >PDF</span>\
                    </span></li></a>\
                    <a href="suggestion-send?id=' + row.grn_id + '&type=GRN" target="_blank" data-type="edit" data-target="#kt_form" ><li class="kt-nav__item">\
                    <span class="kt-nav__link">\
                    <i class="kt-nav__link-icon flaticon2-file-1"></i>\
                    <span class="kt-nav__link-text">Suggestion</span>\
                    </span></li></a>\
                    <a data-type="approved" data-target="#kt_form"><li class="kt-nav__item viewSynHistory" id=' + row.grn_id + '>\
                    <span class="kt-nav__link">\
                    <i class="kt-nav__link-icon flaticon2-check-mark"></i>\
                    <span class="kt-nav__link-text" data-id="' + row.grn_id + '" id=' + row.grn_id + '>Synthesis Milestone </span>\
                    </span></li></a>\
...
$(document).on('click', '.approve_btn', function () {
    ...
    swal.fire({
        title: "Are you sure?",
        text: "Do you want Approve this GRN",
        type: "warning",
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.status == 1) {
                        ...
                        window.location.href = "epr-po-grn-approve-list";
                    } else
...
$(document).on('click', '.return_btn', function () {
    ...
    swal.fire({
        title: "Are you sure?",
        text: "Do you want return this GRN for Revice",
        type: "warning",
        showCancelButton: true,
        confirmButtonClass: "btn-danger",
        ...
        if (result.value) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    loaderClose();
                    if (data.status == 1) {
                        toastr.success('GRN Returned for reviceing successfuly');
                        window.location.href = "epr-po-grn-approve-list";
                    } else
                        toastr.error(data.msg);
                },
...
$(document).on('click', '.reject_btn', function () {
    ...
    swal.fire({
        title: "Are you sure?",
        text: "Do you want Reject this GRN",
        type: "warning",
        showCancelButton: true,
        confirmButtonClass: "btn-danger",
        ...
        if (result.value) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    loaderClose();
                    if (data.status == 1) {
                        toastr.success('GRN Rejected successfuly');
                        window.location.href = "epr-po-grn-approve-list";
                    } else
                        toastr.error(data.msg);
