...
var workFlowTbl = $('#mrWorkflow').DataTable({
    processing: true,
    serverSide: true,
    ...
    columns: [
        ...
        },
        {
          ...
          <div class="dropdown"><a data-toggle="dropdown" class="btn btn-sm btn-clean btn-icon btn-icon-md">\
                      ...
                      <ul class="kt-nav">\
                      <a href="stock-in-workflow-edit-view?id=' + row.id + '" data-type="edit" data-target="#product_category"><li class="kt-nav__item">\
                      <span class="kt-nav__link">\
                      <i class="kt-nav__link-icon flaticon2-edit"></i>\
                      <span class="kt-nav__link-text" data-id="' + row.id + '" >Edit</span>\
                      </span></li></a>\
                      <a href="stock-in-workflow-clone?id=' + row.id + '" data-type="edit" data-target="#kt_form"><li class="kt-nav__item">\
                      <span class="kt-nav__link">\
                      ...
                      <span class="kt-nav__link-text delete" id=' + row.id + ' data-id=' + row.id + '>Delete</span></span></li>\
                     </ul></div></div></span>';
            }
        },
...
$("#export-button-print").on("click", function () {
    workFlowTbl.button('.buttons-print').trigger();
});
$("#export-button-copy").on("click", function () {
    workFlowTbl.button('.buttons-copy').trigger();
});

$("#export-button-csv").on("click", function () {
    workFlowTbl.button('.buttons-csv').trigger();
});

$("#export-button-pdf").on("click", function () {
    workFlowTbl.button('.buttons-pdf').trigger();
});
