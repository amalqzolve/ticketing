...
var boqListTable = $('#list').DataTable({
    ...
    columns: [
        ...
        { data: 'rfq_valid_till', name: 'rfq_valid_till' },
        {
        ...
        },
        {
            ...
            render: function (data, type, row) {
                ...
                if (row.status == 1) {//Draft
                    j = '<a href="epr-rfq-view-pdf?id=' + row.id + '"  target="_blank"  data-type="edit" data-target="#kt_form" ><li class="kt-nav__item">\
                    <span class="kt-nav__link">\
                    <i class="kt-nav__link-icon flaticon-background"></i>\
                    <span class="kt-nav__link-text" data-id="' + row.id + '" >RFQ Details</span>\
                    </span></li></a>\
                ...
                if (row.status == 2) {//Submited
                    j = '<a href="epr-rfq-view-pdf?id=' + row.id + '"  target="_blank"  data-type="edit" data-target="#kt_form" ><li class="kt-nav__item">\
                    <span class="kt-nav__link">\
                    <i class="kt-nav__link-icon flaticon-background"></i>\
                    <span class="kt-nav__link-text" data-id="' + row.id + '" >RFQ Details</span>\
                    </span></li></a>\
                    <a href="epr-rfq-view-pdf-quote?id=' + row.id + '" target="_blank" data-type="edit" data-target="#kt_form" ><li class="kt-nav__item">\
                    <span class="kt-nav__link">\
                    <i class="kt-nav__link-icon flaticon2-file-1"></i>\
                    <span class="kt-nav__link-text" data-id="' + row.id + '" >Supplier Quote</span>\
                    </span></li></a>\
                    ...
                    <span class="kt-nav__link">\
                    <i class="kt-nav__link-icon flaticon2-telegram-logo"></i>\
                    <span class="kt-nav__link-text" data-id="' + row.id + '" >Submit Supplier Quotation</span>\
                    </span></li></a>';
                }
