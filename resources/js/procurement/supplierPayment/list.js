$('.supplierPayment').addClass('kt-menu__item--active');
            ...
            render: function (data, type, row) {
                ...
                if (row.status == 1) {
                    j = '<a href="supplier-payment-pdf?id=' + row.id + '" target="_blank" data-type="edit" data-target="#kt_form" ><li class="kt-nav__item">\
                        ...
                        <a href="generate-supplier-payment-view?id=' + row.id + '" data-type="edit" data-target="#kt_form" ><li class="kt-nav__item">\
                        <span class="kt-nav__link">\
                ...
                if (row.status == 3) {
                    ...
                    <a href="generate-supplier-payment-view-revice?id=' + row.id + '" data-type="edit" data-target="#kt_form"><li class="kt-nav__item">\
                    <span class="kt-nav__link">\
                    <i class="kt-nav__link-icon flaticon2-reload-1"></i>\
...
var sendTbl = $('#sendTbl').DataTable({
    ...
    ajax: {
        "url": 'supplier-payment-send-list',
        "type": "POST",
        "data": function (data) {
            data._token = $('#token').val()
        }
...
var sendTbl = $('#approvedTbl').DataTable({
    processing: true,
    serverSide: true,
    pagingType: "full_numbers",
    dom: 'Blfrtip',
    ...
    ajax: {
        "url": 'supplier-payment-approved-list',
        "type": "POST",
        "data": function (data) {
            data._token = $('#token').val()
        }
...
var rejectedTbl = $('#rejectedTbl').DataTable({
    ...
    ajax: {
        "url": 'supplier-payment-rejected-list',
        "type": "POST",
        "data": function (data) {
            data._token = $('#token').val()
        }
