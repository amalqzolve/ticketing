...
$('.stockTransferWorkflow').addClass('kt-menu__item--active')
var tax_list_table = $('#workflowTbl').DataTable({
    processing: true,
    serverSide: true,
    ...
    columns: [
        ...
        },
        {
          ...
          <div class="dropdown"><a data-toggle="dropdown" class="btn btn-sm btn-clean btn-icon btn-icon-md">\
                      ...
                      <ul class="kt-nav">\
                      <a href="stock-transfer-workflow-edit-view?id=' + row.id + '" data-type="edit" data-target="#product_category"><li class="kt-nav__item">\
                      <span class="kt-nav__link">\
                      <i class="kt-nav__link-icon flaticon2-edit"></i>\
                      <span class="kt-nav__link-text" data-id="' + row.id + '" >Edit</span>\
                      </span></li></a>\
                      <a href="stock-transfer-workflow-clone?id=' + row.id + '" data-type="edit" data-target="#kt_form"><li class="kt-nav__item">\
                      <span class="kt-nav__link">\
...
$(document).on('click', '.mrWorkFlowdelete', function () {
    ...
    swal.fire({
        ...
        if (result.value) {
            ...
            $.ajax({
                type: "POST",
                url: 'stock-transfer-workflow-delete',
                dataType: "json",
                data: {
                    _token: $('#token').val(),
                    id: id
