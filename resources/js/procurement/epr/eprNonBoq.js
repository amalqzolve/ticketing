...
$('.eprList3').addClass('kt-menu__item--active');
    ...
    columns: [
        ...
        },
        {
            ...
            render: function (data, type, row) {
                var j = '';
                if (row.status == 1) {
                    j = '<a href="epr_view?id=' + row.id + '" target="_blank" data-type="edit" data-target="#kt_form" ><li class="kt-nav__item">\
                        ...
                        <a href="material-request-edit-view?id=' + row.id + '" data-type="edit" data-target="#kt_form"><li class="kt-nav__item">\
                        <span class="kt-nav__link">\
                        <i class="kt-nav__link-icon flaticon2-reload-1"></i>\
                        <span class="kt-nav__link-text" data-id="' + row.id + '" >Edit</span>\
                        </span></li></a>\
                        <a data-type="approved" data-target="#kt_form"><li class="kt-nav__item epr_send" id=' + row.id + '>\
                        <span class="kt-nav__link">\
                        <i class="kt-nav__link-icon flaticon2-check-mark"></i>\
                ...
                if (row.status == 0) {
                    j = '<a href="epr_view?id=' + row.id + '" data-type="edit" data-target="#kt_form"><li class="kt-nav__item">\
                        <span class="kt-nav__link">\
                        <i class="kt-nav__link-icon flaticon2-telegram-logo"></i>\
                ...
                j = j + '<a data-type="approved" data-target="#kt_form"><li class="kt-nav__item commentspoup" data-id="EPR" id=' + row.id + '>\
                <span class="kt-nav__link">\
...
var nonboqListTable = $('#send').DataTable({
    processing: true,
    serverSide: true,
    pagingType: "full_numbers",
    dom: 'Blfrtip',
...
var stockRequestTable = $('#approved').DataTable({
    processing: true,
    serverSide: true,
    pagingType: "full_numbers",
    dom: 'Blfrtip',
...
$(document).on('click', '.epr_send', function () {
    var id = $(this).attr('id');
    swal.fire({
        title: "Are you sure?",
        text: "Do you want Send this EPR",
        type: "warning",
        ...
        if (result.value) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    loaderClose();
                    if (data.status == 1) {
                        toastr.success('EPR Send for Approval successfuly');
...
$(document).on('click', '.epr_trash', function () {
    var id = $(this).attr('id');
    swal.fire({
        title: "Are you sure?",
        ...
        if (result.value) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    loaderClose();
                    if (data.status == 1) {
                        toastr.warning('EPR Send for Approval successfuly');
                        window.location.href = "list-non-boq";
                    } else
