            ...
            render: function (data, type, row) {
                ...
                if (row.status == 1) {
                    j = '<a href="stock-transfer-pdf?id=' + row.id + '" target="_blank" data-type="edit" data-target="#kt_form" ><li class="kt-nav__item">\
                        ...
                        <a href="stock-transfer-edit-view?id=' + row.id + '" data-type="edit" data-target="#kt_form"><li class="kt-nav__item">\
                        <span class="kt-nav__link">\
                ...
                if (row.status == 3) {
                    ...
                    <a href="stock-transfer-resubmit?id=' + row.id + '" data-type="edit" data-target="#kt_form"><li class="kt-nav__item">\
                    <span class="kt-nav__link">\
                    <i class="kt-nav__link-icon flaticon2-reload-1"></i>\
...
var approvedTbl = $('#approvedTbl').DataTable({
    ...
    ajax: {
        "url": 'stock-transfer-approvedlist',
        "type": "POST",
        "data": function (data) {
            data._token = $('#token').val()
        }
...
var rejectedTbl = $('#rejectedTbl').DataTable({
    ...
    ajax: {
        "url": 'stock-transfer-list-rejected',
        "type": "POST",
        "data": function (data) {
            data._token = $('#token').val()
        }
