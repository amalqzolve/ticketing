...
$('.project-category').addClass('kt-menu__item--active');
...
$(document).on('click', '.taxrestore', function () {
    ...
    swal.fire({
        ...
        if (result.value) {
            ...
            $.ajax({
                type: "POST",
                url: 'project-settingsrestore-tax',
                data: {
                    _token: $('#token').val(),
                    id: id
                },
...
$(document).on('click', '.taxtrashdelete', function () {
    ...
    swal.fire({
        ...
        if (result.value) {
            ...
            $.ajax({
                type: "POST",
                url: 'project-settingstrashdelete-tax',
                data: {
                    _token: $('#token').val(),
                    id: id
                },
