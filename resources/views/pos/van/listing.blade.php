...
<br/>
                       ...
                       <a href="{{url('/')}}/Add-van" class="btn btn-brand btn-elevate btn-icon-sm">
...
<table class="table table-striped table-hover table-checkable dataTable no-footer" id="vandetails_list">
    <thead>
        <tr>
