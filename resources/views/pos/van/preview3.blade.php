...
foreach ($vandetails as $key => $value)
{
        $van_id = $value->id;
...
{
  if($salesmens->id == $salesman)
  {
    $salemanname = $salesmens->name;
  } 
}
...
foreach($drivers as $driverss)
{
  if($driverss->id == $driver)
  {
    $drivername = $driverss->name;
  } 
}
?>
...
<div class="row" style="margin-top:0px;">
    ...
    <table style="width:100%;" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <table style=" width: 100%; ">
                  ...
                  <tr>
                    <td style="border-color: white; padding: 0; font-weight: bold;  font-size:11px;">License No</td>
                    <td style="border-color: white; padding: 0;text-align:  center;  font-size:11px;">{{$licenseno}}</td>
                    ...
                    <tr>
                    <td style="border-color: white; padding: 0; font-weight: bold;  font-size:11px;"> Driver</td>
                    <td style="border-color: white; padding: 0;text-align:  center;  font-size:11px;">{{$drivername}}</td>
                    <td style="border-color: white; padding: 0;text-align:  right;  font-size:11px;">
 ...
 <tr>
                  ...
                  <tr>
                    <td style="border-color: white; padding: 0; font-weight: bold;  font-size:11px;">Route</td>
                    <td style="border-color: white; padding: 0;text-align:  center;  font-size:11px;">{{$route_name}}</td>
                    <td style="border-color: white; padding: 0;text-align:  right;  font-size:11px;">
  ...
  ?>
                  ...
                  <tr>    
                    ...
                    <td style="height:60px; border-color: white; padding:0; font-size: 32px; text-align:right;">
                      ...
                      <strong> Van Details</strong><br>     </td>
   ...
   <table style="table-layout: auto; " cellspacing="0" cellpadding="0" >
    ...
    <tr>
      ...
      <td  style="border-color: white;   padding: 1px; text-align: center;">
        ...
        <h3 style="letter-spacing: 0px; margin: 0;">Customer Details</h3>
   ...
   <table>
      <tr>
       <td   style="border-color: white;  width: 8%;text-align:left; white-space: nowrap;">#</td>
       
       <td  style="border-color: white; text-align: left; width: 24%;">Customer Name<br> </td>
       <td  style="border-color: white;  padding: 0;  width: 24%;text-align: left;">Code  <br></td>
      
       <td  style="border-color: white;  padding: 0;  width: 24%;text-align: left;">Category  <br></td>
       
       <td  style="border-color: white;  padding: 0; width: 24%;text-align: center;">Phone Number  <br> </td>
     ...
     <tr class="str">
      ...
      <td style="border-color: white;   padding: 2px; text-align: center;">{{$customers->cust_name}}</td>
               
       <td  style="border-color: white;   padding: 2px; text-align: left;">{{$customers->code}}</td>

      <td  style="border-color: white;   padding: 2px; text-align: justify;"> {{$customers->category}} </td>
            
       <td  style="border-color: white;   padding: 2px; text-align: left;">{{$customers->phone}}
          </td>
     </tr>
