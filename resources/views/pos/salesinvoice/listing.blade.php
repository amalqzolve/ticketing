...
<br/>
                       ...
                       <a href="{{url('/')}}/possalesinvoice" class="btn btn-brand btn-elevate btn-icon-sm">
...
<table class="table table-striped table-hover table-checkable dataTable no-footer" id="invoicedetails_list">
    <thead>
        <tr>
