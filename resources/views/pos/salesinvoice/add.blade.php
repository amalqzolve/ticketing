	...
	<div class="col-lg-6">
								...
								<input type="text" class="form-control kt_datetimepickerr" name="dateofsupply" id="dateofsupply" value="{{date('d-m-Y')}}">               
										...
										<div class="col-md-8 input-group-sm">
											...
											<select class="form-control kt-selectpicker method" id="method">
...
if($user_id == 'Qzolve')
{
 ...
 <div class="col-lg-6">
										...
										<div class="col-md-8  input-group-sm">
											<select class="form-control single-select kt-selectpicker vanid" id="vanid" name="vanid">
												<option value="">select</option>
			@foreach($van as $data)
            <option value="{{$data->id}}">{{$data->vanname}}</option>
            @endforeach
											</select>                
										</div>
										</div>
 ...
 <?php
	...
	{?>
<input type="hidden" name="vanid" id="vanid" value="{{$van_id}}">
<div class="col-lg-6">
										<div class="form-group row pr-md-3">
										<div class="col-md-4">
										<label>@lang('app.Customer') </label>
...
function createproduct(product_name){
  ...
  // alert(product_name);
      ...
      $.ajax({
      url: "getproduct_name_details_pos",
      method: "POST",
      data: {
         _token: $('#token').val(),
         id:product_name,
      ...
      success: function(data) { 
         ...
         $.each(data, function(key, value) {
			...
			var selling_price = (value.rate !=null) ? value.rate : 0;
          var product = '';
         product += '<tr>\
                 <td>'+rowcount+'</td><td>\
                 <div class="input-group input-group-sm">\
                 ...
                 <div>\
                 <input type="hidden" class="form-control single-select item_details_id" name="item_details_id[]" id="item_details_id" data-id="'+rowcount+'" value="'+value.productid+'">\
                 </td>\
                 <td>\
                 <div class="input-group input-group-sm">\
...
<script src="{{url('/')}}/resources/js/pos/invoice.js" type="text/javascript"></script>
<script src="{{ URL::asset('assets') }}/datatables/jquery.dataTables.min.js"></script>
<script src="{{url('/')}}/resources/js/pos/purchaseproduct.js" type="text/javascript"></script>
<!-- <script src="{{url('/')}}/resources/js/pos/vanproduct.js" type="text/javascript"></script> -->
