...
<tr>
                    <td style="border-color: white; padding: 0; font-weight: bold;  font-size:11px;">Van Name</td>
                    <td style="border-color: white; padding: 0;text-align:  center;  font-size:11px;">{{$vanname}}</td>
                    <td style="border-color: white; padding: 0;text-align:  right;  font-size:11px;">
                      المرجع الاقتباس
...
<td  style="border-color: white; border-color: white;  padding: 0px; font-size: 12px;"> </td>
   ...
   <table>
      <tr>
       ...
       <td  style="border-color: white; text-align: left; width: 40%;">Nature of goods or Services<br> تفاصيل الخدمات         </td>
      ...
      <tr class="str">
        <td style="background-color: white !important;border-color: white; border: 0px;  padding: 0;"  colspan="9"><hr style="height: 2px; color:black; font-size: 5px; background-color: black; margin: 0;"></td>
