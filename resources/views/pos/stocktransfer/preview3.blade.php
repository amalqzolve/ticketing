    ...
    <table style="width:100%;" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <table style=" width: 100%; ">
                   ...
                   <tr>
                    <td style="border-color: white; padding: 0; font-weight: bold;  font-size:11px;">Transfer ID</td>
                    <td style="border-color: white; padding: 0;text-align:  center;  font-size:11px;">{{$transferid}}</td>
  ...
  ?>
                  ...
                  <tr>    
                    ...
                    <td style="height:60px; border-color: white; padding:0; font-size: 32px; text-align:right;">
                      ...
                      <strong>Stock Transfer</strong><br>     </td>
   ...
   <table>
      <tr>
       <td   style="border-color: white;  width: 10%;text-align:left; white-space: nowrap;">#</td>
       
       <td  style="border-color: white; text-align: left; width: 30%;">Product Name<br> </td>
       <td  style="border-color: white;  padding: 0;  width: 20%;text-align: left;">Transfer Quantity  <br></td>
      
       <td  style="border-color: white;  padding: 0;  width: 20%;text-align: left;">Rate  <br></td>
       <td  style="border-color: white;  padding: 0;  width: 20%;text-align: left;">Amount  <br></td>
      ...
      <tr class="str">
       ...
       @foreach($stocktransfer_products as $key=>$stocktransfer_products)
     <tr class="str">
       <td  style="border-color: white;   padding: 2px; text-align: left;">{{$key+1}}</td>
      
      <td style="border-color: white;   padding: 2px; text-align: center;">{{$stocktransfer_products->product_name}}</td>
               
       <td  style="border-color: white;   padding: 2px; text-align: left;">{{$stocktransfer_products->quantity}}</td>

      <td  style="border-color: white;   padding: 2px; text-align: justify;"> {{$stocktransfer_products->rate}} </td>
      <td  style="border-color: white;   padding: 2px; text-align: justify;"> {{$stocktransfer_products->amount}} </td>
            ...
            <tr style="background-color: white !important;">
              ...
              <td style="border-color: white;background-color: white !important; width: 100%; padding: 0; ">
                <table style="width:100%; background-color: white !important;">
                  <tr style="background-color: white !important;">
                    <td style="border-color: white; padding: 0;background-color: white !important;">Total Items</td>
                    <td style="border-color: white; padding: 0;background-color: white !important;text-align:right;">{{$totalitems}}</td>
                  </tr>

                   <tr style="background-color: white !important;">
                    <td style="border-color: white; padding: 0;background-color: white !important;">Total Quantity</td>
                    <td style="border-color: white; padding: 0;background-color: white !important;text-align:right;">{{$totalquantity}} </td>
                  </tr>
