...
<br/>
                       ...
                       <a href="{{url('/')}}/Add-stocktransfer" class="btn btn-brand btn-elevate btn-icon-sm">
...
<table class="table table-striped table-hover table-checkable dataTable no-footer" id="stocktransferdetails_list">
    <thead>
        <tr>
