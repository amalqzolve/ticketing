...
<br/>
                       ...
                       <a href="{{url('/')}}/Add-driver" class="btn btn-brand btn-elevate btn-icon-sm">
...
<table class="table table-striped table-hover table-checkable dataTable no-footer" id="driverdetails_list">
    <thead>
        <tr>
