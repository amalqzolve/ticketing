...
-->
   ...
   <!---Warehouse--->
 <?php 
                if(can('warehouse_details_add') || can('warehouse_details_edit') || can('warehouse_details_delete') || can('warehouse_details_restore') || can('warehouse_manager_add') || can('warehouse_manager_edit') || can('warehouse_manager_delete')|| can('warehouse_manager_restore') || can('warehouse_incharge_add') || can('warehouse_incharge_edit')|| can('warehouse_incharge_delete') || can('warehouse_incharge_restore')) { ?>
    <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon">
                               <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <rect x="0" y="0" width="24" height="24"/>
...
</svg>              </span><span class="kt-menu__link-text">Warehouse</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
        <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
            <ul class="kt-menu__subnav">
                <?php 
                if(can('warehouse_details_add') || can('warehouse_details_edit') || can('warehouse_details_delete') || can('warehouse_details_restore'))
                {
                    ?>
                <li class="kt-menu__item " aria-haspopup="true"><a href="{{url('/')}}/WarehouseList" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Warehouse Details</span></a></li>
                <?php
            }
            ?>
            <?php 
                if(can('warehouse_manager_add') || can('warehouse_manager_edit') || can('warehouse_manager_delete') || can('warehouse_manager_restore'))
                {
                    ?>
                <li class="kt-menu__item " aria-haspopup="true"><a href="{{url('/')}}/WarehouseManagerList" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Warehouse Managers</span></a></li>
                <?php
            }
            ?>
            <?php 
                if(can('warehouse_incharge_add') || can('warehouse_incharge_edit') || can('warehouse_incharge_delete') || can('warehouse_incharge_restore'))
                {
                    ?>
                <li class="kt-menu__item " aria-haspopup="true"><a href="{{url('/')}}/WarehouseInchargeList" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Warehouse Inchargers</span></a></li>
                <?php
            }
        }
            ?>
