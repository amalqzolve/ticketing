...
<br/>
					  ...
					  <!--  <a href="{{url('/')}}/Add-newenquiry" class="btn btn-brand btn-elevate btn-icon-sm">
					   <i class="kt-nav__link-icon la la-file-pdf-o"></i>
                            ...
                            <input type="text" class="form-control kt_datetimepickerr" name="from" id="from" value="{{date('d-m-Y')}}">
                            ...
                            <div class="col-md-8">
                            <div class="input-group input-group-sm">
                            <input type="text" class="form-control kt_datetimepickerr" name="to" id="to" value="{{date('d-m-Y')}}">
                            ...
                            <button id="salesmensubmitenquiry" class="btn btn-primary">{{ __('product.Save') }}</button>
...
<script src="{{url('/')}}/resources/js/report/enquiry.js" type="text/javascript"></script>
