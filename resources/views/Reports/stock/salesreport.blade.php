...
<br/>
						...
						<a href="{{url('/')}}/salesreportpdf?fromdate={{$fromdate}}&&todate={{$todate}}" class="btn btn-brand btn-elevate btn-icon-sm" target="_blank">
													PDF
												</a>
...
<tr  data-href='viewsalesreport?id={{$value->item_id}}'>
	<td>{{$key+1}}</td>
