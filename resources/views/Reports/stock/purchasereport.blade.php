...
<br/>
						...
						<a href="{{url('/')}}/purchasereportpdf?fromdate={{$fromdate}}&&todate={{$todate}}" class="btn btn-brand btn-elevate btn-icon-sm" target="_blank">
													PDF
												</a>
...
<tr  data-href='viewpurchasereport?id={{$value->itemname}}'>
	<td>{{$key+1}}</td>
