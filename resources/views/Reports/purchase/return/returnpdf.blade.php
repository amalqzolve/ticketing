    ...
    <div class="row" style="margin-top:10px;">
      ...
      <div class="str" style="width: 100%;padding-bottom: 0px;">
        ...
        foreach ($details as $key => $details1) {
          ...
          $exvat += $details1->amountafterdiscount;
        ...
        <table class="table table-striped table-hover table-checkable dataTable no-footer" id="salesvatdetails_list">
          <thead>
            ...
            <tr>
              ...
              <td style="border-color: white;   white-space: nowrap;">Return Date</tf>
              <td style="border-color: white;  white-space: nowrap;">Invoice No</td>
              <td style="border-color: white;  white-space: nowrap;width: 155">Supplier</td>
              <td style="border-color: white;   white-space: nowrap; text-align:right;">Excluding Vat</td>
              <td style="border-color: white;   white-space: nowrap; text-align:right;">@lang('app.Vat Amount')</td>
              <td style="border-color: white;   white-space: nowrap; text-align:right;">Total Amount</td>
