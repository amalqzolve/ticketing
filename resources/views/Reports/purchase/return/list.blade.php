			...
			<div class="kt-portlet__head-toolbar">
				<div class="kt-portlet__head-wrapper">
					<div class="kt-portlet__head-actions">
						<a href="{{url('purchase-return-report-pdf')}}?fromdate={{$fromdate}}&&todate={{$todate}}" target="_blank" class="btn btn-brand btn-elevate btn-icon-sm">
							PDF
						</a>&nbsp;
					</div>
				</div>
				...
				<table class="table table-striped table-hover table-checkable dataTable no-footer" id="salesvatdetails_list">
					...
					<tbody>
						...
						<tr>
							...
							<td>{{number_format($details->amountafterdiscount,2,'.',',')}}</td>
							<td>{{number_format($details->totalvatamount,2,'.',',')}}</td>
...
<script>
	...
	$('.purchase-return-report-index').addClass('kt-menu__item--active');
</script>
@endsection