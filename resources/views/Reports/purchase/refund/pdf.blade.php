      ...
      <div class="str" style="width: 100%;padding-bottom: 0px;">
        ...
        <table class="table table-striped table-hover table-checkable dataTable no-footer" id="salesvatdetails_list">
          <thead>
            ...
            <tr>
              <th style="border-color: white; background-color: white;  padding: 1px;  white-space: nowrap;">@lang('app.Sl.No')</th>
              <th style="border-color: white; background-color: white;  padding: 1px;  white-space: nowrap;">Refund Date</th>
              <th style="border-color: white; background-color: white;  padding: 1px;  white-space: nowrap;">Supplier Name</th>
              <th style="border-color: white; background-color: white;  padding: 1px;  white-space: nowrap;">Return ID</th>
              <th style="border-color: white; background-color: white;  padding: 1px;  white-space: nowrap;">Return Date</th>
              <th style="border-color: white; background-color: white;  padding: 1px;  white-space: nowrap;">Invoice ID</th>
              <th style="border-color: white; background-color: white;  padding: 1px; text-align:right; white-space: nowrap;">Amount</th>
            </tr>
            <tr>
              <td colspan="7">
