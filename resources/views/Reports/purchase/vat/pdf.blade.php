        ...
        <table class="table table-striped table-hover table-checkable dataTable no-footer" id="salesvatdetails_list">
          <thead>
            ...
            <tr>
              ...
              <td style="border-color: white;   white-space: nowrap;">Bill Date</tf>
              <td style="border-color: white;  white-space: nowrap;">Invoice ID</td>
              ...
              <td style="border-color: white;   white-space: nowrap; text-align:right;">Amount</td>
          ...
          <tbody>
            ...
            $exvat += $details->amountafterdiscount;
