                  ...
                  <td style="border-color: white; padding:0; ">
                    <table>
                      <tr>
                        ...
                        <td style="border-color: white; padding:0;">
                          <h2 style="font-size: 25px; text-align: right; margin: 0;"> Payable Report </h2>
                        </td>
                      </tr>
                    </table>
                  </td>
        ...
        <table style="table-layout: auto; border-collapse: collapse; " cellspacing="0" cellpadding="0" id="soadetails_list">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td style="text-align:  right;">{{$details->grandtotalamount-$details->balance_amount}}</td>
              <td style="text-align:  right;">{{$details->balance_amount}}</td>
            </tr>
            <?php
