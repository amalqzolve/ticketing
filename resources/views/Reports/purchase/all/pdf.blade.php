        ...
        <table class="table table-striped table-hover table-checkable dataTable no-footer" id="salesvatdetails_list">
          <thead>
            ...
            <tr>
              ...
              <th style="border-color: white; background-color: white;  padding: 1px; text-align:left; white-space: nowrap;">Invoice No</th>
              <th style="border-color: white; background-color: white;  padding: 1px; text-align:left; white-space: nowrap;">Supplier</th>
              <th style="border-color: white; background-color: white;  padding: 1px; text-align:right; white-space: nowrap;">Total Amount Excluding Vat</th>
              <th style="border-color: white; background-color: white;  padding: 1px; text-align:right; white-space: nowrap;">Vat Amount</th>
              <th style="border-color: white; background-color: white;  padding: 1px; text-align:right; white-space: nowrap;">Total Amount Including Vat</th>
            </tr>
            <tr>
              <td colspan="7">
          ...
          <tbody>
            ...
            <tr style="text-align: center;color: red">
              ...
              <td style="text-align: right;"><b>{{number_format(($totalvat),2,'.',',')}}</b></td>
