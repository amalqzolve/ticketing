...
<form method="POST" action="{{ route('salesmanreportsubmit') }}">
	@csrf
<div class="row">
								...
								<select class="form-control kt-selectpicker" name="salesman" id="salesman">
...
<div class="col-lg-2">
	  <button type="submit" id="salesmanreportsubmit" class="btn btn-primary" style="float:right;">Submit</button>
</div>
</div>
</form>
