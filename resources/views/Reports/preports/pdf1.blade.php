...
<table class="table table-striped table-hover table-checkable dataTable no-footer" id="purchasedetails_list">
	<thead>
		...
		<tr>
			<td style="border-color: white;  width: 5%; text-align:center; white-space: nowrap;">@lang('app.Sl.No')</td>
			<td style="border-color: white;   white-space: nowrap;">@lang('app.Purchase Date')</td>
			<td style="border-color: white;   white-space: nowrap;">@lang('app.Purchase ID')</td>
			<td style="border-color: white;   white-space: nowrap;">@lang('app.Supplier/Vendor Name')</td>
			<td style="border-color: white;   white-space: nowrap;">@lang('app.Vat No')</td>
			<td style="border-color: white;   white-space: nowrap;">@lang('app.Cr No')</td>
			<td style="border-color: white;   white-space: nowrap; text-align:right;">@lang('app.Purchase Amount')</td>
			<td style="border-color: white;   white-space: nowrap; text-align:right;">@lang('app.Excluding Vat Amount')</td>
			<td style="border-color: white;   white-space: nowrap; text-align:right;">@lang('app.Vat Amount')</td>
...
<td style="text-align:right;">{{number_format($details->totalvatamount),2,'.',','}}</td>
