    ...
    <div class="row" style="margin-top:10px;">
      ...
      <div style="width: 100%;padding-bottom: 0px;">
        ...
        <table style="width:100%;" cellspacing="0" cellpadding="0">
          ...
          <?php $address = $detailsd->cust_add1 . ' ' . $detailsd->cust_add2 . ' ' . $detailsd->cust_region . ' ' . $detailsd->cust_city . ' ' . $detailsd->cntry_name;
      ...
      <div class="str">
        <table style="table-layout: auto; border-collapse: collapse; " cellspacing="0" cellpadding="0" id="soadetails_list">
          ...
          <tbody>
            ...
            //   $row_balance += $details->paid_amount;
            // } elseif ($details->transaction_type == 'credit') {
            //   $total_cr_amount += 0;
            //   $total_dr_amount += $details->cr_amount;
            //   //$row_balance-=$details->paid_amount;
            //   $row_balance += $details->totalamount - $details->paid_amount;
            // } elseif ($details->transaction_type == 'Debit') {
            //   $total_cr_amount += 0;
            //   $total_dr_amount += $details->dr_amount;

            //   //echo $row_balance; echo "-";
            //   $row_balance -= $details->dr_amount;
            //   //echo $details->dr_amount; echo "-"; echo $row_balance;exit();
            // } else {
            // }
            ...
            <tr class="str" style="border-collapse: collapse;">
              ...
              <td style="border-collapse: collapse; border:0;"><?php if ($details->transaction_type == 'credit') {
                                                                  echo "Debit";
                                                                } else {
                                                                  echo "Credit";
                                                                } ?></td>
              <td style="border-collapse: collapse; border:0;">dd</td>
              <td style="border-collapse: collapse; border:0;">{{$details->doc_transaction}}</td>


              <?php
              $total_credit += $details->cr_amount;
              $total_debt += $details->dr_amount;
              $row_balance = ($details->cr_amount - $details->dr_amount) + $row_balance;
              ?>
            ...
            <tr>
              <td style="background-color: white !important;border-color: white; border: 0px;  padding: 0;text-align: right;" colspan="6">Total Debit</td>
              <td style="text-align: right; border-collapse: collapse; border:0;">{{$total_credit}}</td>
              <td style="text-align: right; border-collapse: collapse; border:0;"></td>
              <td style="text-align: right; border-collapse: collapse; border:0;"></td>
            </tr>

            <tr>
              <td style="background-color: white !important;border-color: white; border: 0px;  padding: 0;text-align: right;" colspan="6">Total Credit</td>
              <td style="text-align: right; border-collapse: collapse; border:0;">{{$total_debt}}</td>
              <td style="text-align: right; border-collapse: collapse; border:0;"></td>
              <td style="text-align: right; border-collapse: collapse; border:0;"></td>
            </tr>
            ...
            <tr>
              <td style="background-color: white !important;border-color: white; border: 0px;  padding: 0;text-align: right;" colspan="6" ;>Balance Amount</td>
              <td style="text-align: right; border-collapse: collapse; border:0;">{{$total_credit-$total_debt}}</td>
              <td style="text-align: right; border-collapse: collapse; border:0;"></td>
              <td style="text-align: right; border-collapse: collapse; border:0;"></td>
            </tr>
            <tr>
              <td style="background-color: white !important;border-color: white; border: 0px;  padding: 0;text-align: right;" colspan="6">&nbsp;</td>
              <td style="text-align: right; border-collapse: collapse; border:0;">&nbsp;</td>
              <td style="text-align: right; border-collapse: collapse; border:0;">&nbsp;</td>
              <td style="text-align: right; border-collapse: collapse; border:0;">&nbsp;</td>
            </tr>
            ...
            <tr>
              <td style="background-color: white !important;border-color: white; border: 0px;  padding: 0;text-align: right;" colspan="6" ;>Opening Balance </td>
              <td style="text-align: right; border-collapse: collapse; border:0;">{{$openBALh}}</td>
              <td style="text-align: right; border-collapse: collapse; border:0;"></td>
              <td style="text-align: right; border-collapse: collapse; border:0;"></td>
            </tr>
            ...
            <tr>
              <td style="background-color: white !important;border-color: white; border: 0px;  padding: 0;text-align: right;" colspan="6">Total Due Amount</td>
              <td style="text-align: right; border-collapse: collapse; border:0;">{{($total_credit-$total_debt)+$openBALh}}</td>
              <td style="text-align: right; border-collapse: collapse; border:0;"></td>
              <td style="text-align: right; border-collapse: collapse; border:0;"></td>
            </tr>
