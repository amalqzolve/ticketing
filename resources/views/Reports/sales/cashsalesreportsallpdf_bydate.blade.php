...
<table class="table table-striped table-hover table-checkable dataTable no-footer" id="salesvatdetails_list">
	<thead>
      ...
      <th style="border-color: white; background-color: white;  padding: 1px; text-align:left; white-space: nowrap;">Total Amount Excluding Vat</th>
      <th style="border-color: white; background-color: white;  padding: 1px; text-align:left; white-space: nowrap;">Vat Amount</th>
      <th style="border-color: white; background-color: white;  padding: 1px; text-align:left; white-space: nowrap;">Total Amount Including Vat</th>
...
<?php
$total+= $value->totalamounts;
$totalvat+= $value->vatamounts;
$grandtotal+= $value->grandtotalamounts;
?>
</tr>
@endforeach
...
<tr><td colspan="5"></td></tr>
<tr><td colspan="5"></td></tr>
<tr style="text-align: center;color: red"><td colspan="2">Total</td><td>{{number_format(($total),2,'.',',')}}</td><td>{{number_format(($totalvat),2,'.',',')}}</td><td>{{number_format(($grandtotal),2,'.',',')}}</td></tr>
</tbody>
