...
<table class="table table-striped table-hover table-checkable dataTable no-footer" id="salesvatdetails_list">
	<thead>
		...
		<tr>
			...
			<td   style="border-color: white;   white-space: nowrap;">@lang('app.Sales Date')</tf>
			<td   style="border-color: white;  white-space: nowrap;">@lang('app.Sales ID')</td>
			<td   style="border-color: white;  white-space: nowrap;width: 155">Customer</td>
			<td   style="border-color: white;   white-space: nowrap;">@lang('app.Vat No')</td>
		
			<td   style="border-color: white;   white-space: nowrap; text-align:right;">Sales Amount</td>
