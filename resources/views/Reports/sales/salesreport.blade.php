...
<br/>
					   ...
					   <a href="{{url('/')}}/cashsell_report" class="btn btn-brand btn-elevate btn-icon-sm">
													Cash Sales
													
												</a>
						 <a href="{{url('/')}}/creditsell_report" class="btn btn-brand btn-elevate btn-icon-sm">
													Credit Sales
												</a>
						<a href="{{url('/')}}/sell_report_pdf" class="btn btn-brand btn-elevate btn-icon-sm" target="_blank">
													PDF
												</a>
