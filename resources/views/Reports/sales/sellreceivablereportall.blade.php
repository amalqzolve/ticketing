									...
									<div class="kt-portlet__head-toolbar">
										<div class="kt-portlet__head-wrapper">
											<div class="kt-portlet__head-actions">
												...
												<a href="{{url('/')}}/sell_receivable_reportpdf?fromdate={{$fromdate}}&&todate={{$todate}}"  target="_blank" class="btn btn-brand btn-elevate btn-icon-sm">
													PDF
												</a>&nbsp;
...
<tr><td colspan="9"></td></tr>
<tr><td colspan="9"></td></tr>
<tr style="text-align: center;color: red"><td colspan="6">Total</td><td>{{$total}}</td><td>{{$totalpaid}}</td><td>{{$totaldue}}</td></tr>
...
<div class="row mt-5">
										...
										<input type="text" class="form-control" name="totalamount" id="totalamount" readonly style=" text-align: right; font-size: 1.25rem; background-color: #f2f3f8;" value="{{$totalinvoice}}">
										...
										<input type="text" class="form-control discount" name="discount" id="discount" readonly style=" text-align: right; font-size: 1.25rem; background-color: #f2f3f8;" value="{{number_format(($totalpaid),2,'.',',')}}">
										...
										<input type="text" class="form-control discount" name="discount" id="discount" readonly style=" text-align: right; font-size: 1.25rem; background-color: #f2f3f8;" value="{{number_format(($totaldue),2,'.',',')}}">
