...
<table class="table table-striped table-hover table-checkable dataTable no-footer" id="salesvatdetails_list">
	<thead>
      ...
      <th style="text-align: right;border-color: white; background-color: white;  padding: 1px;  white-space: nowrap;">Invoice Number</th>
      <th style="text-align: right;border-color: white; background-color: white;  padding: 1px;  white-space: nowrap;">Date</th>
      <th style="text-align: right;border-color: white; background-color: white;  padding: 1px;  white-space: nowrap;">Sale Type</th>
      <th style="text-align: right;border-color: white; background-color: white;  padding: 1px;  white-space: nowrap;">Customer</th>
      <th style="text-align: right;border-color: white; background-color: white;  padding: 1px;  white-space: nowrap;">Salesman</th>
      <th style="text-align: right;border-color: white; background-color: white;  padding: 1px;  white-space: nowrap;">Invoice Amount</th>
      <th style="text-align: right;border-color: white; background-color: white;  padding: 1px;  white-space: nowrap;">Paid Amount</th>
      <th style="text-align: right;border-color: white; background-color: white;  padding: 1px;  white-space: nowrap;">Due Amount</th>
...
<td style="text-align:right;">{{number_format($details->paid_amount,2,'.',',')}}</td>
<td style="text-align:right;">{{number_format(($details->grandtotalamount - $details->paid_amount),2,'.',',')}}</td>
<?php 
$total+= $details->grandtotalamount;
$totalpaid+= $details->paid_amount;
$totaldue+= ($details->grandtotalamount - $details->paid_amount);
 ?>
...
<tr><td colspan="9"></td></tr>
<tr><td colspan="9"></td></tr>
<tr style="text-align: center;color: red"><td colspan="6">Total Amount</td><td>{{$total}}</td><td>{{$totalpaid}}</td><td>{{$totaldue}}</td></tr>
