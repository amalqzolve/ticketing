...
<!--begin: Datatable -->
<table class="table table-striped table-hover table-checkable dataTable no-footer" id="cashsalesreport_lists">
	<thead>
		<tr>
...
<tr  data-href='viewcashsellreport?id={{$value->quotedate}}'>
	<td>{{$key+1}}</td>
...
$('#cashsalesreport_lists').on('click', 'tbody tr', function() {
