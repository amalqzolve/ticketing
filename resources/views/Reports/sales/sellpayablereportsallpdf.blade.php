...
<table class="table table-striped table-hover table-checkable dataTable no-footer" id="salesvatdetails_list">
  <thead>
    ...
    <tr>
      ...
      <th style="text-align: right;border-color: white; background-color: white;  padding: 1px;  white-space: nowrap;">Purchase Number</th>
      <th style="text-align: right;border-color: white; background-color: white;  padding: 1px;  white-space: nowrap;">Date</th>
      
      <th style="text-align: right;border-color: white; background-color: white;  padding: 1px;  white-space: nowrap;">Supplier</th>
      <th style="text-align: right;border-color: white; background-color: white;  padding: 1px;  white-space: nowrap;">Purchaser</th>
      <th style="text-align: right;border-color: white; background-color: white;  padding: 1px;  white-space: nowrap;">Purchase Amount</th>
...
<td style="text-align:right;">{{number_format($details->paidamount,2,'.',',')}}</td>
<td style="text-align:right;">{{number_format($details->balanceamount,2,'.',',')}}</td>
<?php 
$total+= $details->grandtotalamount;
$totalpaid+= $details->paidamount;
$totaldue+= $details->balanceamount;
 ?>

</tr>
@endforeach
<tr style="text-align: center;color: red"><td colspan="5">Total</td><td>{{$total}}</td><td>{{$totalpaid}}</td><td>{{$totaldue}}</td></tr>
</tbody>
