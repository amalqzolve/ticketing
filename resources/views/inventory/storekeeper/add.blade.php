							...
							<div class="kt-portlet kt-portlet--mobile">
								...
								<form class="kt-form" id="kt_form">
								 <div class="row" style="padding-bottom: 6px;">
									...
									<input type="text" class="form-control" name="storekeepername" placeholder="{{ __('storerack.Store Keeper Name') }}" id="storekeepername">
									</div>
									</div>
									</div>
									<!--  <div class="col-lg-6">
									...
									<div class="col-md-8 input-group input-group-sm">
									<input type="text" class="form-control" name="code" id="code" placeholder="{{ __('storerack.Store Keeper Code') }}">
									</div>
									</div>
									</div>
