								...
								<div class="kt-portlet__head kt-portlet__head--lg">
									<div class="kt-portlet__head-label">
										...
										<h3 class="kt-portlet__head-title">
											{{ __('storerack.Store Keepers Trash List') }}
										</h3>
									</div>
                                    ...
                                    <li class="kt-nav__item" id="storekeepers_trash_list_print"> <span href="#" class="kt-nav__link">
                                            <i class="kt-nav__link-icon la la-print"></i>
                                            <span class="kt-nav__link-text">{{ __('storerack.Print') }}</span>
                                        </span>
                                    </li>
                                    <li class="kt-nav__item" id="storekeepers_trash_list_copy"> <span class="kt-nav__link">
                                            <i class="kt-nav__link-icon la la-copy"></i>
                                            <span class="kt-nav__link-text">{{ __('storerack.Copy') }}</span>
                                        </span>
                                    </li>
                                    <li class="kt-nav__item" id="storekeepers_trash_list_csv">
                                    ...
                                    <li class="kt-nav__item" id="storekeepers_trash_list_pdf"> <span class="kt-nav__link">
...
<!--begin: Datatable -->
<table class="table table-striped table-hover table-checkable dataTable no-footer" id="storekeepers_trash_list">
    <thead>
        <tr>
