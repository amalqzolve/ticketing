...
<br/>
								...
								<div class="kt-portlet__head kt-portlet__head--lg">
									<div class="kt-portlet__head-label">
										...
										<h3 class="kt-portlet__head-title">
											{{ __('storerack.Store Keepers List') }}
										</h3>
									</div>
                       ...
                       <a href="{{url('/')}}/Add-storekeeper" class="btn btn-brand btn-elevate btn-icon-sm">
                                    ...
                                    <li class="kt-nav__item" id="storekeepers_list_print"> <span href="#" class="kt-nav__link">
                                            <i class="kt-nav__link-icon la la-print"></i>
                                            <span class="kt-nav__link-text">{{ __('storerack.Print') }}</span>
                                        </span>
                                    </li>
                                    <li class="kt-nav__item" id="storekeepers_list_copy"> <span class="kt-nav__link">
                                            <i class="kt-nav__link-icon la la-copy"></i>
                                            <span class="kt-nav__link-text">{{ __('storerack.Copy') }}</span>
                                        </span>
                                    </li>
                                    <li class="kt-nav__item" id="storekeepers_list_csv">
                                    ...
                                    <li class="kt-nav__item" id="storekeepers_list_pdf"> <span class="kt-nav__link">
                                            ...
                                            <span class="kt-nav__link-text">{{ __('storerack.PDF') }}</span>
												...
												<a href="{{url('/')}}/Trash-storekeeper" class="btn btn-secondary btn-hover-warning">
                                    {{ __('storerack.Trash') }} 
...
<!--begin: Datatable -->
<table class="table table-striped table-hover table-checkable dataTable no-footer" id="storekeepers_list">
    <thead>
        <tr>
            <th>{{ __('storerack.S.No') }}</th>
            <th>{{ __('storerack.Store Keeper Name') }}</th>
