...
<br/>
                       ...
                       <a href="{{url('/')}}/Add-barcode" class="btn btn-brand btn-elevate btn-icon-sm">
...
<table class="table table-striped table-hover table-checkable dataTable no-footer" id="barcodeformats">
    <thead>
        <tr>
