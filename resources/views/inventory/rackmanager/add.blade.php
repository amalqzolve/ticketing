							...
							<div class="kt-portlet kt-portlet--mobile">
								...
								<form class="kt-form" id="kt_form">
								 <div class="row" style="padding-bottom: 6px;">
									...
									<input type="text" class="form-control" name="managername" placeholder="{{ __('storerack.Manager Name') }}" id="managername">
									</div>
									</div>
									</div>
									<!--  <div class="col-lg-6">
									...
									<div class="col-md-8 input-group input-group-sm">
									<input type="text" class="form-control" name="manager_code" id="manager_code" placeholder="{{ __('warehouse.Manager Code') }}">
									</div>
									</div>
									</div>
