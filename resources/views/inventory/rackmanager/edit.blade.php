							...
							<div class="kt-portlet kt-portlet--mobile">
								<div class="kt-portlet__head kt-portlet__head--lg">
									<div class="kt-portlet__head-label">
										...
										<h3 class="kt-portlet__head-title">
											{{ __('rackmanagement.New Rack Manager') }}
										</h3>
									</div>
								</div>
								...
								<form class="kt-form" id="kt_form">
								 ...
								 <div class="row" style="padding-bottom: 6px;">
									...
									<div class="col-md-4">
									<label>{{ __('storerack.Manager Name') }}<span style="color: red">*</span></label>
									</div>  
									<div class="col-md-8 input-group input-group-sm">
									<input type="text" class="form-control" name="managername" placeholder="{{ __('storerack.Manager Name') }}" id="managername" value="{{$data->name}}">
									</div>
									</div>
									</div>
									<!--  <div class="col-lg-6">
									...
									<div class="col-md-8 input-group input-group-sm">
									<input type="text" class="form-control" name="manager_code" id="manager_code" placeholder="{{ __('warehouse.Manager Code') }}" value="{{$data->manager_code}}">
									</div>
									</div>
									</div>
