								...
								<div class="kt-portlet__head kt-portlet__head--lg">
									<div class="kt-portlet__head-label">
										...
										<h3 class="kt-portlet__head-title">
											{{ __('rackmanagement.Rack Management Trash Lists') }}
										</h3>
									</div>
									...
									class="la la-undo"></i>Back</button>
													...
													<div class="dropdown-menu dropdown-menu-right">
														<ul class="kt-nav">
															...
															<li class="kt-nav__item" id="rackmanagement_trash_list_print">
																<span href="#" class="kt-nav__link">
																	<i class="kt-nav__link-icon la la-print"></i>
																	<span class="kt-nav__link-text">{{ __('rackmanagement.Print') }}</span>
																</span>
															</li>
															<li class="kt-nav__item" id="rackmanagement_trash_list_copy">
																<span class="kt-nav__link">
																	<i class="kt-nav__link-icon la la-copy"></i>
																	<span class="kt-nav__link-text">{{ __('rackmanagement.Copy') }}</span>
																</span>
															</li>
															<li class="kt-nav__item" id="rackmanagement_trash_list_csv">
																<a href="#" class="kt-nav__link">
																	<i class="kt-nav__link-icon la la-file-text-o"></i>
																	<span class="kt-nav__link-text">{{ __('rackmanagement.CSV') }}</span>
																</a>
															</li>
															<li class="kt-nav__item" id="rackmanagement_trash_list_pdf">
																<span class="kt-nav__link">
...
<table class="table table-striped table-hover table-checkable dataTable no-footer" id="rackmanagement_trash_list">
    <thead>
        <tr>
