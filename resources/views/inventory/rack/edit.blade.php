...
<input type="hidden" name="id" id="id" value="<?php echo $data->id;?>">
									...
									{
										?>
											<option value="{{$item->id}}" selected>{{$item->store_name}}</option>
										<?php
									...
									<div class="col-md-8 input-group input-group-sm">
									<input type="text" class="form-control" name="rackname" placeholder="{{ __('rackmanagement.Rack Name') }}" id="rackname" value="<?php echo $data->rack_name;?>">
									</div>
									</div>
									</div>
												...
												<div class="kt-form__actions">
													<div class="row">
														...
														<div class="col-lg-6 kt-align-right">
															...
															<button type="reset" class="btn btn-secondary" onclick="RackManagement()"><svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x icon-16"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg> {{ __('rackmanagement.Cancel') }}</button>
														</div>
													</div>
												</div>
											</div>
