								...
								<div class="kt-portlet__head kt-portlet__head--lg">
									<div class="kt-portlet__head-label">
										...
										<h3 class="kt-portlet__head-title">
											{{ __('accounts.Accounts Trash List') }}
										</h3>
									</div>
                      			...
                      			<div class="dropdown dropdown-inline">
													...
													<div class="dropdown-menu dropdown-menu-right">
														<ul class="kt-nav">
															...
															<li class="kt-nav__item" id="accounts_list_trash_print">
																<span href="#" class="kt-nav__link">
																	<i class="kt-nav__link-icon la la-print"></i>
																	<span class="kt-nav__link-text">{{ __('accounts.Print') }}</span>
																</span>
															</li>
															<li class="kt-nav__item" id="accounts_list_trash_copy">
																<span class="kt-nav__link">
																	<i class="kt-nav__link-icon la la-copy"></i>
																	<span class="kt-nav__link-text">{{ __('accounts.Copy') }}</span>
																</span>
															</li>
															<li class="kt-nav__item" id="accounts_list_trash_csv">
																<a href="#" class="kt-nav__link">
																	<i class="kt-nav__link-icon la la-file-text-o"></i>
																	<span class="kt-nav__link-text">{{ __('accounts.CSV') }}</span>
																</a>
															</li>
															<li class="kt-nav__item" id="accounts_list_trash_pdf">
																<span class="kt-nav__link">
...
<!--begin: Datatable -->
<table class="table table-striped table-hover table-checkable dataTable no-footer" id="accounts_list_trash">
    <thead>
        <tr>
