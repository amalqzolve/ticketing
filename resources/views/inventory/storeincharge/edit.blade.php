							...
							<div class="kt-portlet kt-portlet--mobile">
								<div class="kt-portlet__head kt-portlet__head--lg">
									<div class="kt-portlet__head-label">
										...
										<h3 class="kt-portlet__head-title">
											{{ __('storerack.New Store in Charge') }}
										</h3>
									</div>
								</div>
								...
								<form class="kt-form" id="kt_form">
								 ...
								 <div class="row" style="padding-bottom: 6px;">
									...
									<div class="col-md-4">
									<label>{{ __('storerack.Store in Charge Name') }}<span style="color: red">*</span></label>
									</div>  
									<div class="col-md-8 input-group input-group-sm">
								   <input type="text" class="form-control" name="storeinchargename" placeholder="{{ __('storerack.Store in Charge Name') }}" id="storeinchargename" value="{{$data->name}}">
									</div>
									</div>
									</div>
									 <!-- <div class="col-lg-6">
									...
									<div class="form-group row pl-md-3">
									<div class="col-md-4">
									<label>{{ __('warehouse.Incharge Code') }} </label>
									</div>  
									<div class="col-md-8 input-group input-group-sm">
									<input type="text" class="form-control" name="code" id="code" placeholder="{{ __('warehouse.Incharge Code') }}" value="{{$data->code}}">
									</div>
									</div>
									</div>
