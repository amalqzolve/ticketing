							...
							<div class="kt-portlet kt-portlet--mobile">
								...
								<form class="kt-form" id="kt_form">
								 <div class="row" style="padding-bottom: 6px;">
									...
									<input type="text" class="form-control" name="storeinchargename" placeholder="{{ __('storerack.Store in Charge Name') }}" id="storeinchargename">
									</div>
									</div>
									</div>
									<!--  <div class="col-lg-6">
									...
									<div class="col-md-8 input-group input-group-sm">
									<input type="text" class="form-control" name="code" id="code" placeholder="{{ __('warehouse.Incharge Code') }}">
									</div>
									</div>
									</div>
