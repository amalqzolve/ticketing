							...
							<div class="kt-portlet kt-portlet--mobile">
								...
								<form class="kt-form" id="product_category">
								 <div class="row" style="padding-bottom: 6px;">
									...
									<input type="text" class="form-control" name="categoryname" id="categoryname" placeholder="{{ __('product.Category Name') }}" autocomplete="off">
									</div>
									</div>
									</div>
									</div>
									...
									<div class="col-md-8">
									<div class="input-group input-group-sm">
									<input type="text" class="form-control" name="categorycode" id="categorycode" placeholder="{{__('product.Category Code') }}" autocomplete="off">
									</div>
									</div>
									</div>
									</div>
									...
									<input type="number" min="0" class="form-control" name="startingnumber" placeholder="{{ __('product.Starting Number') }}" id="startingnumber" autocomplete="off">
									</div>
									</div>
									</div> -->
									<div class="col-lg-12">
									...
									<div class="col-md-10 input-group input-group-sm">
									 <textarea class="form-control" name="description" id="description" autocomplete="off" placeholder="{{ __('app.Note') }}"></textarea>
									</div>
									</div>
									</div>
								 </div>
