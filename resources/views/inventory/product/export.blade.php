								 ...
								 <div class="row" style="padding-bottom: 6px;">
								  ...
								  <!--  <div class="form-group">
								   ...
								   <input type="file" id="files" name="files[]" accept="image/*"/>
									  ...
									  <form action="{{ route('file-import-product') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
            	<div class="col-lg-4">
            		<a href="{{url('/')}}/product_download" class="btn btn-brand btn-elevate btn-icon-sm" style=" width: 100%;  height: 39px;  padding-top: 9px;">
												  <i class="la la-download"></i>
													{{ __('product.Template Download')
												}}
												  </a>
            	</div>
            	<div class="col-lg-6">
                ...
                <div class="custom-file text-left">
                   ...
                   <!--  <input type="file" name="file" class="custom-file-input" id="customFile" accept=".csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel" required > -->
                    ...
                    <label class="custom-file-label" for="customFile">{{ __('product.Choose file')}}</label>
                </div>
            </div>
            	</div>
            	<div class="col-lg-2">
            		 <button class="btn btn-primary float-right" style=" width: 100%;  height: 39px;  padding-top: 9px;">{{ __('product.Upload Data')}}</button>
            	</div>
