														...
														<div class="kt-portlet kt-portlet--mobile">
																<div class="kt-portlet__head kt-portlet__head--lg">
																		<div class="kt-portlet__head-label">
																				...
																				<h3 class="kt-portlet__head-title">
																					 {{ __('product.Edit Manufacturer') }} 
																				</h3>
																		</div>
																</div>
																<div class="kt-portlet__body">
															 
																<form class="kt-form" id="manufacture_form">
																<input type="hidden" name="id" id="id" value="<?php echo $data->id;?>">
																 <div class="row" style="padding-bottom: 6px;">
																		...
																		<input type="text" class="form-control" name="manufacture_name" id="manufacture_name" placeholder="{{ __('product.Manufacturer Name') }}" autocomplete="off" value="<?php echo $data->manufacture_name;?>">
																		</div>
																		</div>
																		</div>
																		</div>
																		...
																		<input type="text" class="form-control" name="manufacture_code" id="manufacture_code" placeholder="{{ __('product.Manufacturer Code') }}" autocomplete="off" value="<?php echo $data->manufacture_code;?>">
																		</div>
																		</div>
																		</div>
																		...
																		<div class="col-md-10">
																		<div class="input-group input-group-sm">
																		<textarea class="form-control" name="description" id="description" autocomplete="off" placeholder="{{ __('app.Note') }}"> {{$data->description}}
																		</textarea>
																		</div>
																		</div>
																		</div>
																	...
																	<div class="form-group">
																 	...
																 	<input type="hidden" class="form-control" name="branch" id="branch" value="{{$data->branch}}">
