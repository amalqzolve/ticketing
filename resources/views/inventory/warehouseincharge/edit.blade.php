							...
							<div class="kt-portlet kt-portlet--mobile">
								<div class="kt-portlet__head kt-portlet__head--lg">
									<div class="kt-portlet__head-label">
										...
										<h3 class="kt-portlet__head-title">
											{{ __('warehouse.New Warehouse Incharge') }} 
										</h3>
									</div>
								...
								<form class="kt-form">
								 ...
								 <div class="row" style="padding-bottom: 6px;">
										  <input type="hidden" class="form-control" name="id" id="id" placeholder="Warehouse Name" value="<?php echo $data->id;?>">                       

									<div class="col-lg-6">
									<div class="form-group row pr-md-3">
									<div class="col-md-4">
									<label>{{ __('warehouse.Incharge Name') }}<span style="color: red">*</span></label>
									</div>
									<div class="col-md-8">
									<div class="input-group input-group-sm">
									<input type="text" class="form-control" name="inchargename" id="inchargename" placeholder="{{ __('warehouse.Incharge Name') }}" value="<?php echo $data->incharge_name;?>">
									</div>
									</div>
									</div>
									</div>
									...
									<div class="col-md-4">
									<label>{{ __('warehouse.Incharge Code') }}<span style="color: red">*</span></label>
									</div>  
									<div class="col-md-8 input-group input-group-sm">
									<input type="text" class="form-control" name="inchargecode" id="inchargecode" placeholder="{{ __('warehouse.Incharge Code') }}" value="<?php echo $data->incharge_code;?>">
									</div>
									</div>
									</div>
