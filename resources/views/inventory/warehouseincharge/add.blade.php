							...
							<div class="kt-portlet kt-portlet--mobile">
								...
								<form class="kt-form" id="kt_form">
								 ...
								 <div class="row" style="padding-bottom: 6px;">
										  <input type="hidden" class="form-control" name="id" id="id" placeholder="Warehouse Name">                       
									...
									<input type="text" class="form-control" name="inchargename" id="inchargename" placeholder="{{ __('warehouse.Incharge Name') }}">
									</div>
									</div>
									</div>
									</div>
									...
									<input type="text" class="form-control" name="inchargecode" id="inchargecode" placeholder="{{ __('warehouse.Incharge Code') }}">
									</div>
									</div>
									</div>
