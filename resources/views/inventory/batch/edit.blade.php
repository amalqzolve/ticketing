							...
							<div class="kt-portlet kt-portlet--mobile">
								...
								<form class="kt-form" id="product_category">
								 <div class="row" style="padding-bottom: 6px;">
									...
									<div class="col-md-4">
									<label>{{ __('product.Batch Name') }}<span style="color: red">*</span></label>
									</div>
									<div class="col-md-8">
									<div class="input-group input-group-sm">
									<input type="text" class="form-control" name="batchname" id="batchname" placeholder="{{ __('product.Batch Name') }}" autocomplete="off" value="{{$batch->batchname}}">
									</div>
									</div>
									</div>
									</div>
									...
									<div class="col-md-8 input-group input-group-sm">
									 <textarea class="form-control" name="description" id="description" autocomplete="off" placeholder="{{ __('app.Note') }}">{{$batch->description}}</textarea>
									</div>
									</div>
									</div>
								 </div>
