									...
									<div class="kt-portlet__head-toolbar">
										<div class="kt-portlet__head-wrapper">
											<div class="kt-portlet__head-actions">
												@can('Batch Add')
                       <a href="{{url('/')}}/Add-batch" class="btn btn-brand btn-elevate btn-icon-sm">
						...
						<span class="kt-nav__link">
							...
							<span class="kt-nav__link-text"> {{ __('product.PDF') }}</span>
												...
												<a href="batchTrash" class="btn btn-secondary btn-hover-warning">
                                                {{ __('product.Trash') }} 
                                            </a>
...
<table class="table table-striped table-hover table-checkable dataTable no-footer" id="batch_list">
    <thead>
        <tr>
