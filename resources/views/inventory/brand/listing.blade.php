...
<br/>
							<div class="kt-portlet kt-portlet--mobile">
								...
								@can('Brand Add')				
                       <a href="{{url('/')}}/Add-Brand" class="btn btn-brand btn-elevate btn-icon-sm">
                                            ...
                                            <a href="brandtrashlist" class="btn btn-secondary btn-hover-warning">
                                                {{ __('product.Trash') }} 
...
<table class="table table-striped table-hover table-checkable dataTable no-footer" id="branddetails_list">
    <thead>
        <tr>
