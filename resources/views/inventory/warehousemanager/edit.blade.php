								...
								<div class="kt-portlet__head kt-portlet__head--lg">
									<div class="kt-portlet__head-label">
										...
										<h3 class="kt-portlet__head-title">
											{{ __('warehouse.New Warehouse Manager') }}
										</h3>
									</div>
...
<input type="hidden" class="form-control" name="id" id="id" placeholder="Manager Name" value="<?php echo $data->id;?>">
									...
									<div class="col-md-4">
									<label>{{ __('warehouse.Manager Name') }}<span style="color: red">*</span></label>
									</div>
									<div class="col-md-8">
									<div class="input-group input-group-sm">
									<input type="text" class="form-control" name="manager_name" id="manager_name" placeholder="{{ __('warehouse.Manager Name') }}" value="<?php echo $data->manager_name;?>">
									</div>
									</div>
									</div>
									</div>
									...
									<div class="col-md-4">
									<label>{{ __('warehouse.Manager Code') }}<span style="color: red">*</span></label>
									</div>  
									<div class="col-md-8 input-group input-group-sm">
									<input type="text" class="form-control" name="manager_code" id="manager_code" placeholder="{{ __('warehouse.Manager Code') }}" value="<?php echo $data->manager_code;?>">
									</div>
									</div>
									</div>
