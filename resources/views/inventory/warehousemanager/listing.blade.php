...
<br/>
                       ...
                       <a href="{{url('/')}}/Add-WarehouseManager" class="btn btn-brand btn-elevate btn-icon-sm">
                                    ...
                                    <li class="kt-nav__item" id="warehousemanagers_list_print"> <span href="#" class="kt-nav__link">
                                            <i class="kt-nav__link-icon la la-print"></i>
                                            <span class="kt-nav__link-text">{{ __('warehouse.Print') }}</span>
                                        </span>
                                    </li>
                                    <li class="kt-nav__item" id="warehousemanagers_list_copy"> <span class="kt-nav__link">
                                            <i class="kt-nav__link-icon la la-copy"></i>
                                            <span class="kt-nav__link-text">{{ __('warehouse.Copy') }}</span>
                                        </span>
                                    </li>
                                    <li class="kt-nav__item" id="warehousemanagers_list_csv">
                                    ...
                                    <li class="kt-nav__item" id="warehousemanagers_list_pdf"> <span class="kt-nav__link">
                                            ...
                                            <span class="kt-nav__link-text">{{ __('warehouse.PDF') }}</span>
												...
												<a href="{{url('/')}}/Trash-WarehouseManager" class="btn btn-secondary btn-hover-warning">
                                     {{ __('warehouse.Trash') }}
...
<!--begin: Datatable -->
<table class="table table-striped table-hover table-checkable dataTable no-footer" id="warehousemanagers_list">
    <thead>
        <tr>
