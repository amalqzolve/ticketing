...
<br/>
                       ...
                       <a href="{{url('/')}}/Add-Attribute" class="btn btn-brand btn-elevate btn-icon-sm">
												...
												<div class="dropdown dropdown-inline">
													...
													<div class="dropdown-menu dropdown-menu-right">
														<ul class="kt-nav">
															...
															<li class="kt-nav__item" id="attributedetails_list_print">
																<span href="#" class="kt-nav__link">
																	<i class="kt-nav__link-icon la la-print"></i>
																	<span class="kt-nav__link-text">{{ __('product.Print') }}</span>
																</span>
															</li>
															<li class="kt-nav__item" id="attributedetails_list_copy">
																<span class="kt-nav__link">
																	<i class="kt-nav__link-icon la la-copy"></i>
																	<span class="kt-nav__link-text">{{ __('product.Copy') }}</span>
																</span>
															</li>
															<li class="kt-nav__item" id="attributedetails_list_csv">
																<a href="#" class="kt-nav__link">
																	<i class="kt-nav__link-icon la la-file-text-o"></i>
																	<span class="kt-nav__link-text">{{ __('product.CSV') }}</span>
																</a>
															</li>
															<li class="kt-nav__item" id="attributedetails_list_pdf">
																<span class="kt-nav__link">
                                            ...
                                            <a href="trashlist" class="btn btn-secondary btn-hover-warning">
                                               {{ __('product.Trash') }} 
...
<!--begin: Datatable -->
<table class="table table-striped table-hover table-checkable dataTable no-footer" id="attributedetails_list">
    <thead>
        <tr>
            <th>{{ __('product.S.No') }}</th>
            <th>{{ __('product.Attribute Name') }}</th>
            <th>{{ __('product.Attribute Code') }}</th>
            <th>{{ __('product.Options') }}</th>
