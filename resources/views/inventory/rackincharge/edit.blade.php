								...
								<form class="kt-form" id="kt_form">
								 <div class="row" style="padding-bottom: 6px;">
								   ...
								   <input type="hidden" name="id" id="id" value="{{$data->id}}">
									...
									<input type="text" class="form-control" name="name" placeholder="{{ __('rackmanagement.Incharge Name') }}" id="name" value="{{$data->name}}">
									</div>
									</div>
									</div>
									<!--  <div class="col-lg-6">
									...
									<div class="col-md-8 input-group input-group-sm">
									<input type="text" class="form-control" name="code" id="code" placeholder="{{ __('warehouse.Code') }}" value="{{$data->code}}">
									</div>
									</div>
									</div>
