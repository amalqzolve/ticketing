                    ...
                    <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
                        <ul class="kt-menu__nav ">
                            ...
                            <li class="kt-menu__item home" aria-haspopup="true">
                                <a href="{{url('/vouchers/home')}}" class="kt-menu__link ">
                            ...
                            <li class="kt-menu__item voucherEntry" aria-haspopup="true">
                                <a href="{{url('/vouchers/vouchers')}}" class="kt-menu__link ">
                                    <span class="kt-menu__link-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                <polygon points="0 0 24 0 24 24 0 24" />
                                    ...
                                    <span class="kt-menu__link-text">Voucher Entry</span>
                                </a>
                            </li>

                            <li class="kt-menu__item voucherApproval" aria-haspopup="true">
                                <a href="{{url('/vouchers/voucher-approval')}}" class="kt-menu__link ">
                                    <span class="kt-menu__link-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                <polygon points="0 0 24 0 24 24 0 24" />
                                    ...
                                    <span class="kt-menu__link-text">Voucher Approval</span>
                                </a>
                            </li>

                            <li class="kt-menu__item synthesis" aria-haspopup="true">
                                <a href="{{url('/vouchers/synthesis')}}" class="kt-menu__link ">
                                    <span class="kt-menu__link-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                <polygon points="0 0 24 0 24 24 0 24" />
                                    ...
                                    <span class="kt-menu__link-text">Approval Synthesis</span>
                                </a>
                            </li>
