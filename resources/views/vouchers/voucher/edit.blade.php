                  ...
                  <div class="row">
                        ...
                        <div class="form-group  row pr-md-3">
                           ...
                           <div class="col-md-8 input-group-sm">
                              <select class="form-control single-select kt-selectpicker" id="voucher_type">
                                 ...
                                 <option value="{{$data->id}}" {{($voucher->voucher_type==$data->id)?'selected':''}}>{{$data->voucher_name}}</option>
                                 @endforeach
                              </select>
                           </div>
                        </div>
                        ...
                        <div class="form-group  row pr-md-3">
                           ...
                           <div class="col-md-8 input-group-sm">
                              <select class="form-control single-select kt-selectpicker method" id="purchase_type">
                                 <option value="1" {{($voucher->purchase_type==1)?'selected':''}}>Cash</option>
                                 <option value="2" {{($voucher->purchase_type==2)?'selected':''}}>Credit</option>
                              </select>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="col-lg-6">
                        <div class="form-group  row pr-md-3">
                           ...
                           <div class="col-md-8 input-group-sm">
                              <input type="text" class="form-control" name="bill_id" id="bill_id" value="{{$voucher->bill_id}}">
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="col-lg-6">
                        <div class="form-group  row pr-md-3">
                           ...
                           <div class="col-md-8 input-group-sm">
                              <input type="text" class="form-control kt_datetimepickerr" name="quotedate" id="quotedate" value="{{($voucher->quotedate!=null)?date('d-m-Y',strtotime($voucher->quotedate)):date('d-m-Y')}}">
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="col-lg-6">
                        <div class="form-group  row pr-md-3">
                           ...
                           <div class="col-md-8 input-group-sm">
                              <input type="text" class="form-control kt_datetimepickerr" name="entrydate" id="entrydate" value="{{($voucher->entrydate!=null)?date('d-m-Y',strtotime($voucher->entrydate)):date('d-m-Y')}}">
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="col-lg-6">
                        <div class="form-group  row pr-md-3">
                           ...
                           <div class="col-md-8 input-group-sm">
                              <input type="text" class="form-control kt_datetimepickerr" name="dateofsupply" id="dateofsupply" value="{{($voucher->dateofsupply!=null)?date('d-m-Y',strtotime($voucher->dateofsupply)):date('d-m-Y')}}">
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="col-lg-6">
                        <div class="form-group  row pr-md-3">
                           ...
                           <div class="col-md-8 input-group-sm">
                              <input type="text" class="form-control" name="po_wo_ref" id="po_wo_ref" value="{{$voucher->po_wo_ref}}">
                           </div>
                        </div>
                     </div>
                     <div class="col-lg-6">
                        <div class="form-group  row pr-md-3">
                           ...
                           <div class="col-md-8 input-group-sm">
                              <select class="form-control single-select kt-selectpicker" id="salesman">
                                 ...
                                 <option value="{{$data->id}}" {{($voucher->salesman==$data->id)?'selected':''}}>{{$data->name}}</option>
                                 @endforeach
                              </select>
                           </div>
                        </div>
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                        <div class="form-group  row pr-md-3">
                           ...
                           <div class="col-md-8 input-group-sm">
                              <textarea class="form-control" name="internalreference" id="internalreference">{{$voucher->internalreference}}</textarea>
                           </div>
                        </div>
                     </div>
                     <div class="col-lg-12">
                        <div class="form-group  row pr-md-3">
                           ...
                           <div class="col-md-8 input-group-sm">
                              <textarea class="form-control" name="notes" id="notes">{{$voucher->notes}}</textarea>
                           </div>
                        </div>
                     </div>
                  </div>
                     ...
                     <div class="form-group  row pr-md-3">
                        ...
                        <div class="col-md-9 input-group-sm">
                           ...
                           <select class="form-control single-select kt-selectpicker" id="terms" name="terms">
                              ...
                              <option value="{{$data->id}}" {{($voucher->terms==$data->id)?'selected':''}}>{{$data->term}}</option>
                              @endforeach
                           </select>
                        </div>
                     </div>
                     ...
                     <div class="form-group  row pr-md-3">
                        <div class="col-md-12 input-group-sm">
                           <div class="kt-tinymce">
                              <textarea id="kt-tinymce-4" name="kt-tinymce-4" class="tox-target">{{$voucher->description}}</textarea>
                           </div>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="row">
                        ...
                        <div class="form-group row pr-md-3">
                           ...
                           <div class="col-md-8  input-group input-group-sm">
                              <select class="form-control single-select kt-selectpicker customer" id="customer1" name="customer">
                                 ...
                                 <option value="{{$data->id}}" {{($voucher->cust_id==$data->id)?'selected':''}}>{{$data->sup_name}}</option>
                                 @endforeach
                              </select>
                           </div>
                        </div>
                        ...
                        <div class="form-group row pr-md-3">
                           ...
                           <div class="col-md-8  input-group input-group-sm">
                              <select class="form-control single-select Cust_category" id="cust_category" name="cust_category">
                                 ...
                                 <option value="{{$item->id}}" {{($voucher->cust_category==$item->id)?'selected':''}}>{{$item->customer_category}}</option>
                                 @endforeach
                              </select>
                           </div>
                        </div>
                        ...
                        <div class="form-group row pr-md-3">
                           ...
                           <div class="col-md-8">
                              <div class="input-group input-group-sm">
                                 <input type="text" class="form-control branch" name="cust_code" id="cust_code" value="{{$voucher->cust_code}}" placeholder="{{ __('customer.Customer Code') }}" autocomplete="off" readonly="">
                              </div>
                           </div>
                        </div>
                     </div>
                        ...
                        <div class="form-group row  pr-md-3">
                           ...
                           <div class="col-md-8 input-group input-group-sm">
                              <select class="form-control single-select" id="cust_type" name="cust_type">
                                 ...
                                 <option value="{{$key->id}}" {{($voucher->cust_type==$key->id)?'selected':''}}>{{$key->title}}</option>
                                 @endforeach
                              </select>
                           </div>
                        </div>
                     ...
                     <div class="col-lg-6">
                        <div class="form-group row pr-md-3">
                           ...
                           <div class="col-md-8 ">
                              <div class="input-group input-group-sm">
                                 <input type="text" class="form-control" id="cust_name" name="cust_name" value="{{$voucher->cust_name}}" autocomplete="off" placeholder="{{ __('customer.Customer Name/Company name') }}">
                              </div>
                           </div>
                        </div>
                     </div>
                     <div class="col-lg-6">
                        <div class="form-group row pl-md-3">
                           ...
                           <div class="col-md-8 ">
                              <div class="input-group input-group-sm">
                                 <input type="text" class="form-control" id="building_no" name="building_no" autocomplete="off" value="{{$voucher->building_no}}" placeholder="{{ __('customer.Building No') }}">
                              </div>
                           </div>
                        </div>
                     </div>
                     <div class="col-lg-6">
                        <div class="form-group row pr-md-3">
                           ...
                           <div class="col-md-8">
                              <div class="input-group  input-group-sm">
                                 <input type="text" class="form-control" id="cust_region" name="cust_region" autocomplete="off" value="{{$voucher->cust_region}}" placeholder="{{ __('customer.Street Name') }}">
                              </div>
                           </div>
                        </div>
                     </div>
                     <div class="col-lg-6">
                        <div class="form-group row pl-md-3">
                           ...
                           <div class="col-md-8">
                              <div class="input-group  input-group-sm">
                                 <input type="text" class="form-control" id="cust_district" name="cust_district" value="{{$voucher->cust_district}}" autocomplete="off" placeholder="{{ __('customer.District') }}">
                              </div>
                           </div>
                        </div>
                     </div>
                     <div class="col-lg-6">
                        <div class="form-group row pr-md-3">
                           ...
                           <div class="col-md-8">
                              <div class="input-group  input-group-sm">
                                 <input type="text" class="form-control" id="cust_city" name="cust_city" autocomplete="off" value="{{$voucher->cust_city}}" placeholder="{{ __('customer.City') }}">
                              </div>
                           </div>
                        </div>
                     </div>
                           ...
                           <div class="col-md-8">
                              <div class="input-group  input-group-sm">
                                 <select name="cust_country" id="cust_country" class="form-control single-select">
                                    ...
                                    <option value="{{$coun->id}}" {{($voucher->cust_country==$coun->id)?'selected':''}}>{{$coun->cntry_name}}</option>
                                    @endforeach
                                 </select>
                              </div>
                           </div>
                     ...
                     <div class="col-lg-6">
                        <div class="form-group row pr-md-3">
                           ...
                           <div class="col-md-8">
                              <div class="input-group  input-group-sm">
                                 <input type="text" class="form-control" id="cust_zip" name="cust_zip" autocomplete="off" value="{{$voucher->cust_zip}}" placeholder="{{ __('customer.Postal Code') }}">
                              </div>
                           </div>
                        </div>
                     </div>
                     <div class="col-md-6">
                        <div class="form-group row pl-md-3">
                           ...
                           <div class="col-md-8">
                              <div class="input-group  input-group-sm">
                                 <input type="text" class="form-control" placeholder="{{ __('customer.Mobile') }}" id="mobile" name="mobile" value="{{$voucher->mobile}}" autocomplete="off">
                              </div>
                           </div>
                        </div>
                     </div>
                     <div class="col-md-6">
                        <div class="form-group row pr-md-3">
                           ...
                           <div class="col-md-8">
                              <div class="input-group  input-group-sm">
                                 <input type="text" class="form-control" placeholder="{{ __('customer.Vat No') }}" id="vatno" name="vatno" autocomplete="off" value="{{$voucher->vatno}}">
                              </div>
                           </div>
                        </div>
                     </div>
                     <div class="col-md-6">
                        <div class="form-group row pl-md-3">
                           ...
                           <div class="col-md-8">
                              <div class="input-group  input-group-sm">
                                 <input type="text" class="form-control" placeholder="" id="buyerid_crno" name="buyerid_crno" autocomplete="off" value="{{$voucher->buyerid_crno}}">
                              </div>
                           </div>
                        </div>
                     </div>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="product_table" style="width:100%">
                           <thead class="thead-light">
                              <tr>
                                 ...
                                 <th style="background-color:  #3f4aa0; color: white; white-space: nowrap;     padding: 2px 7px !important;" width="150px">Account Name</th>
                                 <th style="background-color:  #3f4aa0; color: white; white-space: nowrap;     padding: 2px 7px !important;">Ledger</th>
                                 ...
                                 <th style="background-color:  #3f4aa0; color: white; white-space: nowrap;     padding: 2px 7px !important; width: ;" width="75px;">@lang('app.VAT Amount')</th>
                                 <th style="background-color:  #3f4aa0; color: white; white-space: nowrap;     padding: 2px 7px !important;" width="75px;">@lang('app.Total Amount')</th>
                           ...
                           <tbody>
                              ...
                              <tr>
                                 ...
                                 <td>
                                    <input type="text" class="form-control head_name" name="head_name[]" id="head_name{{$key+1}}" value="{{$product->hed}}">
                                 </td>
                                 <td>
                                    <select class="form-control form-control-sm single-select ledger kt-selectpicker" data-id="{{$key+1}}" name="ledger[]" id="ledger{{$key+1}}">
                                       <option value="">select</option>
                                       @foreach($account_heads as $data)
                                       <option value="{{$data->lid}}" {{($product->ledger==$data->lid)?'selected':''}}>{{$data->lname}}</option>
                                       @endforeach
                                    </select>
                                 </td>
                                 <td>
                                    <textarea class="form-control" id="product_description{{$key+1}}" name="product_description[]" rows="1" data-id="{{$key+1}}" style=" height: 30px !important;">{{$product->product_description}}</textarea>
                                 </td>
                                 <td>
                                    <div>
                                       <select class="form-control form-control-sm single-select unit kt-selectpicker" data-id="{{$key+1}}" name="unit[]" id="unit{{$key+1}}">
                                          <option value="">select</option>
                                          @foreach($unitlist as $data)
                                          <option value="{{$data->id}}" {{($product->unit==$data->id)?'selected':''}}>{{$data->unit_name}}</option>
                                          @endforeach
                                       </select>
                                    </div>
                                 </td>
                                 <td>
                                    <div class="input-group input-group-sm"> <input type="text" class="form-control quantity" data-id="{{$key+1}}" name="quantity[]" id="quantity{{$key+1}}" value="{{$product->quantity}}"> </div>
                                 </td>
                                 <td>
                                    <div class="input-group input-group-sm"> <input type="text" class="form-control rate" name="rate[]" id="rate{{$key+1}}" data-id="{{$key+1}}" value="{{$product->rate}}"> </div>
                                 </td>
                                 <td>
                                    <div class="input-group input-group-sm"> <input type="text" class="form-control amount" name="amount[]" data-id="{{$key+1}}" id="amount{{$key+1}}" readonly="" value="{{$product->amount}}"> </div>
                                 </td>
                                 <td>
                                    <div class="input-group input-group-sm"> <input type="text" class="form-control discountamount" data-id="{{$key+1}}" name="discountamount[]" id="discountamount{{$key+1}}" value="{{$product->rdiscount}}"> </div>
                                 </td>
                                 <td>
                                 ...
                                 <td>
                                    <input type="text" class="form-control vatamount form-control-sm" name="vatamount[]" id="vatamount{{$key+1}}" data-id="{{$key+1}}" value="{{$product->vatamount}}" readonly="">
                                 </td>
                                 <td>
                                    <div class="input-group input-group-sm"> <input type="text" class="form-control row_total" data-id="{{$key+1}}" name="row_total[]" id="row_total{{$key+1}}" value="{{$product->row_total}}" readonly=""> </div>
                                 </td>
            ...
            <div class="row mt-5">
               ...
               <div class="col-lg-6">
                  <div class="form-group  row pr-md-3">
                     ...
                     <div class="col-md-8 input-group-sm">
                        <input type="text" class="form-control" name="totalamount" id="totalamount" value="{{$voucher->totalamount}}" readonly style=" text-align: right; font-size: 1.25rem; background-color: #f2f3f8;  height: calc(1.25em + 1rem + 2px);">
                     </div>
                  </div>
               </div>
               <div class="col-lg-6">
               ...
               <div class="col-lg-6">
                  <div class="form-group  row pr-md-3">
                     ...
                     <div class="col-md-8 input-group-sm">
                        <input type="text" class="form-control discount" name="discount" id="discount" value="{{$voucher->discount}}" readonly style=" text-align: right; font-size: 1.25rem; background-color: #f2f3f8;  height: calc(1.25em + 1rem + 2px);">
                     </div>
                  </div>
               </div>
               <div class="col-lg-6">
               ...
               <div class="col-lg-6">
                  <div class="form-group  row pr-md-3">
                     ...
                     <div class="col-md-8 input-group-sm">
                        <input type="text" class="form-control" name="amountafterdiscount" id="amountafterdiscount" value="{{$voucher->amountafterdiscount}}" readonly style=" text-align: right; font-size: 1.25rem; background-color: #f2f3f8;  height: calc(1.25em + 1rem + 2px);">
                     </div>
                  </div>
               </div>
               <div class="col-lg-6">
               ...
               <div class="col-lg-6">
                  <div class="form-group  row pr-md-3">
                     ...
                     <div class="col-md-8 input-group-sm">
                        <input type="text" class="form-control" name="totalvatamount" id="totalvatamount" value="{{$voucher->totalvatamount}}" readonly style=" text-align: right; font-size: 1.25rem; background-color: #f2f3f8;  height: calc(1.25em + 1rem + 2px);">
                     </div>
                  </div>
               </div>
               <div class="col-lg-6">
                  <div class="form-group  row pr-md-3">
                     ...
                     <div class="col-md-8 input-group-sm">
                        <input type="text" class="form-control paidamount" name="paidamount" id="paidamount" value="{{$voucher->paidamount}}" style=" text-align: right; font-size: 1.25rem; background-color: #f2f3f8;  height: calc(1.25em + 1rem + 2px);">
                     </div>
                  </div>
               </div>
               <div class="col-lg-6">
                  <div class="form-group  row pr-md-3">
                     ...
                     <div class="col-md-8 input-group-sm">
                        <input type="text" class="form-control" name="grandtotalamount" id="grandtotalamount" value="{{$voucher->grandtotalamount}}" readonly style="background-color: #ffffff00;  border: none;  text-align: right;  font-size: 1.75rem; font-weight: bold; color: #646c9a; padding-top: 0px;">
                     </div>
                  </div>
               </div>
               ...
               <div class="col-lg-6">
                  <div class="form-group  row pr-md-3">
                     ...
                     <div class="col-md-8 input-group-sm">
                        <input type="text" class="form-control" name="balanceamount" id="balanceamount" value="{{$voucher->balanceamount}}" readonly style=" text-align: right; font-size: 1.25rem; background-color: #f2f3f8;  height: calc(1.25em + 1rem + 2px);">
                     </div>
                  </div>
               </div>
            </div>
               ...
               <div class="kt-form__actions">
                  <div class="row">
                     ...
                     <div class="col-lg-12 kt-align-right">
                        ...
                        <button type="button" class="btn btn-primary" id="voucher_submit">
