         ...
         <div class="kt-portlet__head-toolbar">
            <div class="kt-portlet__head-wrapper">
               <div class="kt-portlet__head-actions">
                  ...
                  <a type="button" class="btn btn-brand btn-elevate btn-icon-sm" href="{{url('/vouchers/voucher-add')}}"><i class="la la-plus"></i>{{ __('customer.New Record') }}</a>
...
<script src="{{url('/')}}/resources/js/vouchers/voucher/list.js" type="text/javascript"></script>
<!-- end::Global Config -->
