						...
						<div class="form-group row pr-md-3">
							...
							<div class="col-md-8 input-group input-group-sm">
								<select class="form-control single-select kt-selectpicker" id="mrCat">
									...
									<option value="{{$value->id}}">{{$value->prefix}}-{{$value->voucher_name}}</option>
									@endforeach
								</select>
							</div>
						</div>
					...
					<div class="kt-form__actions">
						<div class="row">
							...
							<div class="col-lg-6 kt-align-right">
								<button type="submit" name="tax_submit" id="saveMrWorkFlow" class="btn btn-primary">@lang('app.Save')</button>
...
<script src="{{url('/')}}/resources/js/vouchers/synthesis/add.js" type="text/javascript"></script>
<script>
