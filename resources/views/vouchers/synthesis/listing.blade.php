			...
			<div class="kt-portlet__head-toolbar">
				<div class="kt-portlet__head-wrapper">
					<div class="kt-portlet__head-actions">
						<a href="{{url('/vouchers/synthesis-add')}}" class="btn btn-brand btn-elevate btn-icon-sm">
			...
			<table class="table table-striped table-hover table-checkable dataTable no-footer" id="mrWorkflow">
				<thead>
					<tr>
						...
						<th><strong>Voucher Details</strong></th>
...
<script src="{{url('/')}}/resources/js/vouchers/synthesis/listing.js" type="text/javascript"></script>
@endsection