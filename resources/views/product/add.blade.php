     	...
     	<div class="kt-subheader  kt-grid__item" id="kt_subheader">
						...
						<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
							...
							<div class="alert alert-light alert-elevate" role="alert">
								...
								<div class="alert-text"><span class="kt-font-success kt-font-boldest">User's Guide:</span>
							...
							<!--begin::Portlet-->
									<div class="kt-portlet">
										...
										<span class="kt-subheader__desc" id="kt_subheader_total">
											<h4 class="kt-font-boldest kt-font-transform-u">Payroll Group Setting entry form </h4></span>
								 	     </div>
								 	   </div>
                                      </div>

										<!--begin::Form-->
										<form class="kt-form kt-form--label-right" id="form_salarygroup_save">
												...
												<div class="form-group row">
													...
													<div class="col-lg-6 ">
														...
														<div class="kt-input-icon">
															<input type="text" name="cust_type" id="cust_type" class="form-control">
														</div>
													</div>
											...
											<div class="kt-portlet__foot">
												<div class="kt-form__actions">
													<div class="row">
														...
														<div class="col-lg-8">
															<!-- <input type="hidden" name="What" value="salarygroup_save"> -->
													    <button id="productaddsubmit" class="btn btn-brand kt-spinner--right kt-spinner--sm kt-spinner--light">Submit</button>
...
@section('script')
    ...
    <script src="{{ URL::asset('assets') }}/js/prodcutdetails.js" type="text/javascript"></script>
