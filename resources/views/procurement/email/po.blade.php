...
<head>
  ...
  <page size="A4">
    <form action="{{ route('mark.dec.po') }}" id="frmAction" method="POST" style="padding-block: 73px;  padding-left: 20px;  padding-right: 20px;">
      @csrf
      <input type="hidden" name="token" value="{{$token}}">
      <input type="hidden" name="epr_id" value="{{$mainData->id}}">
              ...
              <tr>
                <td style="border-color: white;   padding-top: 0; padding-right: 0; padding-bottom: 0;  ">
                  <table style=" width: 100%; ">
                    ...
                    <tr>
                      <td style="border-color: white; padding: 0; font-weight: bold;  font-size:11px; width: 30%;">Delivery terms</td>
                      <td style="border-color: white; padding: 0;text-align: left;  font-size:11px; "> {{$mainData->delivery_terms}}</td>
                      <td style="border-color: white; padding: 0;text-align: right;  font-size:11px; width: 30%;"></td>
                    </tr>
                      ...
                      <td colspan="2" style="border-color: white; ">
                        <table style=" padding:0">
                          ...
                          <tr>
                            ...
                            <td style="border-color: white; padding:0;">&nbsp;</td>
                            <td style="border-color: white; padding:0; text-align:right;"> <span style="font-weight: bold;">Generated by </span>:{{$mainData->created_name}} <br>Date: {{isset($mainData->po_date)?date('d-m-Y',strtotime($mainData->po_date)):''}}</td>
                          </tr>
                    </tr>
                  </table>
                </td>
          ...
          <table style="table-layout: auto; " cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td style="border-color: white;   padding: 1px; text-align: center;">
                <h3 style="letter-spacing: 0px; margin: 0;">Purchase Order </h3>
              </td>
            </tr>
            <tr>
              <td style="border-color: white;   padding: 1px">
