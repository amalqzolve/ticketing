...
<head>
  ...
  <page size="A4">
    <form action="{{ route('mark.dec.stockin') }}" id="frmAction" method="POST" style="padding-block: 73px;  padding-left: 20px;  padding-right: 20px;">
      @csrf
              ...
              <tr>
                <td style="border-color: white;   padding-top: 0; padding-right: 0; padding-bottom: 0;  ">
                  <table style=" width: 100%; ">
                    <tr>
                      <td style="border-color: white; padding: 0; font-weight: bold;  font-size:11px; width: 30%;">Stock In ID.</td>
                    ...
                    <tr>
                      <td style="border-color: white; padding: 0; font-weight: bold;  font-size:11px; width: 30%;">Warehouse Name</td>
                      <td style="border-color: white; padding: 0;text-align: left;  font-size:11px; "> {{$mainData->warehouse_name}} </td>
                      <td style="border-color: white; padding: 0;text-align: right;  font-size:11px; width: 30%;"></td>
                    </tr>
                    <tr>
                      <td style="border-color: white; padding: 0; font-weight: bold;  font-size:11px; width: 30%;">Warehouse Transfer Date</td>
                      <td style="border-color: white; padding: 0;text-align: left;  font-size:11px; "> {{date('d-m-Y',strtotime($mainData->warehouse_transfer_date))}}</td>
                      <td style="border-color: white; padding: 0;text-align: right;  font-size:11px; width: 30%;"></td>
                    </tr>
                      ...
                      <td colspan="2" style="border-color: white; ">
                        <table style=" padding:0">
                          ...
                          <tr>
                            ...
                            <td style="border-color: white; padding:0;">&nbsp;</td>
                            <td style="border-color: white; padding:0; text-align:right;"> <span style="font-weight: bold;">Generated by </span>:{{$mainData->created_name}} <br>Date: {{isset($mainData->warehouse_transfer_date)?date('d-m-Y',strtotime($mainData->warehouse_transfer_date)):''}}</td>
                          </tr>
                    </tr>
                  </table>
                </td>
          ...
          <table style="table-layout: auto; " cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td style="border-color: white;   padding: 1px; text-align: center;">
                <h3 style="letter-spacing: 0px; margin: 0;">GRN to Warehouse </h3>
              </td>
            </tr>
            <tr>
              <td style="border-color: white;   padding: 1px">
