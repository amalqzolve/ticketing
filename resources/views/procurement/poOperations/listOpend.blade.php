                                        ...
                                        <table class="table table-striped table-hover table-checkable dataTable no-footer" id="internal_use_list">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <td>Supplier</td>
                                                    <td>Request Type</td>
                                                    <td>Request Against</td>
                                                    <td>MR Category</td>
                                                    <td>Client</td>
                                                    <td>Project</td>
                                                    <td>GRN Status</td>
                                                    <td>Invoice Booking Status</td>
                                                    <td>Action</td>
                                                </tr>
                                            </thead>
                                            <tbody>
...
<script src="{{url('/')}}/resources/js/procurement/poOperations/listOpend.js" type="text/javascript"></script>
<!-- end::Global Config -->
