        ...
        <div class="kt-portlet__head kt-portlet__head--lg">
            <div class="kt-portlet__head-label">
                ...
                <h3 class="kt-portlet__head-title">
                    Supplier Invoice Booking PO#{{$MaterialRequest->id}}
                </h3>
            </div>
        ...
        <div class="kt-portlet__body pl-2 pr-2 pb-0">
            ...
            <form class="kt-form" id="kt_form" name="kt_form">
                ...
                <ul class="nav nav-tabs nav-fill" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab" href="#kt_tabs_2_1">Supplier Details</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane p-2 active" id="kt_tabs_2_1" role="tabpanel">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    <div class="col-md-4">
                                        <label>Bill Entry Date <span style="color: red">*</span></label>
                                    </div>
                                    <div class="col-md-8 input-group-sm">
                                        <input type="text" id="bill_entry_date" name="bill_entry_date" value="{{isset($MaterialRequest->bill_entry_date)?date('d-m-Y',strtotime($MaterialRequest->bill_entry_date)):date('d-m-Y')}}" class="form-control kt_datetimepickerr">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <input type="text" id="supplier_invoice_number" name="supplier_invoice_number" value="{{$MaterialRequest->supplier_invoice_number}}" class="form-control">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    <div class="col-md-4">
                                        <label>Supplier Invoice Date <span style="color: red">*</span></label>
                                    </div>
                                    <div class="col-md-8 input-group-sm">
                                        <input type="text" id="supplier_invoice_date" name="supplier_invoice_date" value="{{isset($MaterialRequest->supplier_invoice_date)?date('d-m-Y',strtotime($MaterialRequest->supplier_invoice_date)):date('d-m-Y')}}" class="form-control kt_datetimepickerr">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <input type="text" id="supplier_invoice_over_due_date" name="supplier_invoice_over_due_date" value="{{isset($MaterialRequest->supplier_invoice_over_due_date)?date('d-m-Y',strtotime($MaterialRequest->supplier_invoice_over_due_date)):date('d-m-Y')}}" class="form-control kt_datetimepickerr">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <input type="text" id="supplier_invoice_credit_period" name="supplier_invoice_credit_period" value="{{$MaterialRequest->supplier_invoice_credit_period}}" class="form-control">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="tab-pane p-3 " id="kt_tabs_2_2" role="tabpanel">
                        <div class="row">
                            ...
                            <input type="hidden" name="poId" id="poId" value="{{$MaterialRequest->id}}">
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    <div class="col-md-4">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <input type="text" name="" id="" class="form-control" value="PO#{{$MaterialRequest->id}}" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                            ...
                            <table class="table table-striped table-bordered table-hover" id="product_table" style="table-layout:fixed; width:100%">
                                <thead class="thead-light">
                                    <tr>
                                       ...
                                       color: white; white-space: nowrap;     padding: 2px 7px !important;" width="75px">@lang('app.Quantity')</th> -->
                                        <th style="background-color:  #3f4aa0;
                                       color: white; white-space: nowrap;     padding: 2px 7px !important;">PO Amount</th>
                                        <th style="background-color:  #3f4aa0;
                                       color: white; white-space: nowrap;     padding: 2px 7px !important;">Booked Amount</th>
                                        <th style="background-color:  #3f4aa0;
                                       color: white; white-space: nowrap;     padding: 2px 7px !important;">Booking Amount</th>
                                        <th style="background-color:  #3f4aa0;
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td> <input type="hidden" class="form-control eprPoProductId" name="eprPoProductId[]" id="eprPoProductId{{$key+1}}" data-id="{{$key+1}}" value="{{$cinvoice_products->id}}">
                                        ...
                                        <!-- <td> -->
                                        <input type="hidden" class="form-control quantity qtyCheck" name="quantity[]" id="quantity{{$key+1}}" data-id="{{$key+1}}" value="{{$cinvoice_products->quantity}}" readonly>
                                        <!-- </td> -->
                                        ...
                                        <td><input type="text" class="form-control payed" name="payed[]" id="payed{{$key+1}}" data-id="{{$key+1}}" readonly="" value="{{$reqProduct[$key]['payed']}}"></td>
                                        <td><input type="text" class="form-control payment" name="payment[]" id="payment{{$key+1}}" data-id="{{$key+1}}" value="{{$reqProduct[$key]['payment']}}"></td>
                                        <td><input type="text" class="form-control balance" name="balance[]" id="balance{{$key+1}}" data-id="{{$key+1}}" readonly="" value="{{$reqProduct[$key]['balance']}}"></td>
                                        <td>
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group  row pr-md-3">
                            ...
                            <div class="col-md-8 input-group-sm">
                                <input type="text" class="form-control" name="grandtotalamount" id="grandtotalamount" readonly="" value="0.00" style="background-color: #ffffff00;  border: none;  text-align: right;  font-size: 1.75rem;  font-weight: bold; color: #646c9a; padding-top: 0px;">
                            </div>
                        </div>
                    </div>
...
<script src="{{url('/')}}/resources/js/procurement/poOperations/invoiceAdd.js" type="text/javascript"></script>
<script>
