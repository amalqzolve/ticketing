                            ...
                            <table class="table table-striped table-bordered table-hover" id="product_table" style="table-layout:fixed; width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td> <input type="hidden" class="form-control eprPoProductId" name="eprPoProductId[]" id="eprPoProductId{{$key+1}}" data-id="{{$key+1}}" value="{{$cinvoice_products->id}}" readonly>
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group  row pr-md-3">
                            ...
                            <div class="col-md-8 input-group-sm">
                                <input type="text" class="form-control" name="total_qty" id="total_qty" readonly="" style=" text-align: right; font-size: 1.25rem; background-color: #f2f3f8;  height: calc(1.25em + 1rem + 2px);" value="0">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
...
<script src="{{url('/')}}/resources/js/procurement/poOperations/grnAdd.js" type="text/javascript"></script>
<script>
