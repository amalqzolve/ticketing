		...
		<div class="kt-portlet__head kt-portlet__head--lg">
			<div class="kt-portlet__head-label">
				...
				<h3 class="kt-portlet__head-title">
					Invoice Approval synthesis
				</h3>
			</div>
			<div class="kt-portlet__head-toolbar">
				<div class="kt-portlet__head-wrapper">
					<div class="kt-portlet__head-actions">
						@can('Invoice Approval Synthesis ADD')
						<a href="{{url('/')}}/invoice-workflow-add" class="btn btn-brand btn-elevate btn-icon-sm">
...
<script src="{{url('/')}}/resources/js/procurement/invoiceWorkflow/listing.js" type="text/javascript"></script>
@endsection