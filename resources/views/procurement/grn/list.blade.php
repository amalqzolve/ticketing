    ...
    <div class="kt-portlet kt-portlet--mobile">
        ...
        <div class="kt-portlet__body">
            <div class="kt-grid kt-wizard-v3 kt-wizard-v3--white" id="kt_wizard_v3" data-ktwizard-state="first">
                ...
                <div class="kt-wizard-v3__content   fadeIn" data-ktwizard-type="step-content">
                    <div class="mt-3">
                        <table class="table table-striped table-hover table-checkable dataTable no-footer" id="apptovedTbl">
                            <thead>
                                <tr>
                                    <th>@lang('app.Sl.No')</th>
                                    <th>GRN ID</th>
...
<script src="{{url('/')}}/resources/js/procurement/grn/list.js" type="text/javascript"></script>
<!-- end::Global Config -->
