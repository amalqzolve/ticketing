        ...
        <div class="kt-portlet__body pl-2 pr-2 pb-0">
            ...
            <form class="kt-form" id="kt_form" name="kt_form">
                ...
                <ul class="nav nav-tabs nav-fill" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab" href="#kt_tabs_2_1">Stock Details</a>
                    </li>
                    <li class="nav-item">
...
<script src="{{url('/')}}/resources/js/procurement/stockTransfer/submit.js" type="text/javascript"></script>
<script>
