        ...
        <div class="kt-portlet__body pl-2 pr-2 pb-0">
            ...
            <form class="kt-form" id="kt_form" name="kt_form">
                ...
                <ul class="nav nav-tabs nav-fill" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab" href="#kt_tabs_2_1">Warehouse Details</a>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="row">
                                ...
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <select class="form-control single-select kt-selectpicker" id="transfer_type" name="transfer_type">
                                            ...
                                            <option value="Send To Warehouse" {{($MaterialRequest->transfer_type=='Send To Warehouse')?'selected':''}}>Send To Warehouse</option>
                                            @if($MaterialRequest->projectname!='')
                                            <option value="Send To Project" {{($MaterialRequest->transfer_type=='Send To Project')?'selected':''}}>Send To Project</option>
                                            <option value="Allocate To Project" {{($MaterialRequest->transfer_type=='Allocate To Project')?'selected':''}}>Allocate To Project</option>
                                            @endif
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <div id="warehouseDiv" style="display:{{($flg==0)?'block':'none'}}">
                                        ...
                                        <div id="projectDiv" style="display:{{($flg==1)?'block':'none'}}">
...
<script src="{{url('/')}}/resources/js/procurement/sendToWareHouse/edit.js" type="text/javascript"></script>
