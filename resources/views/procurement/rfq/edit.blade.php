        ...
        <div class="kt-portlet__body pl-2 pr-2 pb-0">
            ...
            <form class="kt-form" id="kt_form" name="kt_form">
                ...
                <ul class="nav nav-tabs nav-fill" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab" href="#kt_tabs_2_1">RFQ Details</a>
                    </li>
                    <li class="nav-item">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <input type="text" class="form-control kt_datetimepickerr" name="rfq_date" id="rfq_date" value="{{date('d-m-Y',strtotime($MaterialRequest->rfq_date))}}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <input type="text" class="form-control kt_datetimepickerr" name="rfq_valid_till" id="rfq_valid_till" value="{{date('d-m-Y',strtotime($MaterialRequest->rfq_valid_till))}}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-10 input-group-sm">
                                        ...
                                        <!-- <select class="form-control single-select input-group-sm kt-selectpicker supplier_vendor_names kt-select2" name="supplier_vendor_names[]" id="supplier_vendor_names">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group  row pr-md-3">
                                ...
                                <div class="col-md-9 input-group-sm">
                                    ...
                                    <input type="hidden" id="terms" name="terms" value="{{$MaterialRequest->terms}}">
                                    <!-- </div> -->
                                </div>
                            </div>
                        </div>
...
<script src="{{url('/')}}/resources/js/procurement/rfq/edit.js" type="text/javascript"></script>
