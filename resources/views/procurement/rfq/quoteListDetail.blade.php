...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid mb-3">
    ...
    <div class="kt-portlet kt-portlet--mobile">
        <div class="kt-portlet__head kt-portlet__head--lg">
            <div class="kt-portlet__head-label">
                ...
                <h3 class="kt-portlet__head-title">
                    Electronic Purchase Requisition #EPR-{{$id}}
                </h3>
            </div>
        ...
        <div class="kt-portlet__body">
            <input type="hidden" name="eprId" id="eprId" value="{{$id}}">
...
<script src="{{url('/')}}/resources/js/procurement/rfq/quoteListDetail.js" type="text/javascript"></script>
<!-- end::Global Config -->
