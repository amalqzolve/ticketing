            ...
            <form class="kt-form" id="kt_form" name="kt_form">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <input type="text" class="form-control kt_datetimepickerr" name="po_date" id="po_date" value="{{date('d-m-Y')}}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <input type="text" class="form-control kt_datetimepickerr" name="po_valid_till" id="po_valid_till" value="{{date('d-m-Y')}}">
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row p-0" style="background-color:#f2f3f8;">
                    <div class="col-12">
                        ...
                        <br>
                        <br>
                        <div class="table-responsive" style=" width: 100%;      background-color: #f2f3f8;   margin-top: -10px;">
                            ...
                            <table class="table table-striped table-bordered table-hover" id="product_table" style="table-layout:fixed; width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" class="form-control epr_quantity" name="epr_quantity[]" id="epr_quantity{{$key+1}}" data-id="{{$key+1}}" value="{{$reqProduct[$key]['epr_quantity']}}" readonly></td>
                                        <td><input type="text" class="form-control po_assigned_qty" name="po_assigned_qty[]" id="po_assigned_qty{{$key+1}}" data-id="{{$key+1}}" value="{{$reqProduct[$key]['po_assigned_qty']}}" readonly></td>
                                        <td><input type="text" class="form-control quantity qtyCheck" name="quantity[]" id="quantity{{$key+1}}" data-id="{{$key+1}}" value="{{$reqProduct[$key]['quantity']}}"></td>
                                        <td><input type="text" class="form-control balanceQty" name="balanceQty[]" id="balanceQty{{$key+1}}" data-id="{{$key+1}}" value="{{$reqProduct[$key]['balance']}}" readonly></td>
                                        ...
                                        <td>
                                            <select name="vat_percentage[]" id="vat_percentage{{$key+1}}" class="form-control kt-selectpicker vat_percentage" data-id="{{$key+1}}">
                                                ...
                                                <option value="{{$vatLi->total}}" {{($cinvoice_products->vat == $vatLi->total)?'selected':''}}>{{$vatLi->total}}</option>
                                                @endforeach
                                            </select>
                                        </td>
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group  row pr-md-3">
                            ...
                            <div class="col-md-8 input-group-sm">
                                ...
                                <input type="text" class="form-control" name="totalamount" id="totalamount" value="{{$MaterialRequest->totalamount}}" readonly="" style=" text-align: right; font-size: 1.25rem; background-color: #f2f3f8;  height: calc(1.25em + 1rem + 2px);" value="0.00">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group  row pr-md-3">
                            ...
                            <div class="col-md-8 input-group-sm">
                                ...
                                <input type="text" class="form-control discount" name="discount" id="discount" value="{{$MaterialRequest->discount}}" readonly="" style=" text-align: right; font-size: 1.25rem; background-color: #f2f3f8;  height: calc(1.25em + 1rem + 2px);">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group  row pr-md-3">
                            ...
                            <div class="col-md-8 input-group-sm">
                                <input type="text" class="form-control" name="amountafterdiscount" id="amountafterdiscount" readonly="" value="{{$MaterialRequest->amountafterdiscount}}" style=" text-align: right; font-size: 1.25rem; background-color: #f2f3f8;  height: calc(1.25em + 1rem + 2px);" value="0.00">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group  row pr-md-3">
                            ...
                            <div class="col-md-8 input-group-sm">
                                ...
                                <input type="text" class="form-control" name="totalvatamount" id="totalvatamount" value="{{$MaterialRequest->totalvatamount}}" readonly="" style=" text-align: right; font-size: 1.25rem; background-color: #f2f3f8;  height: calc(1.25em + 1rem + 2px);" value="0.00">
...
<script src="{{url('/')}}/resources/js/procurement/rfq/submitPo.js" type="text/javascript"></script>
@endsection