          ...
          <tr>
            ...
            <td style="border-color: white;   padding-top: 0; padding-right: 0; padding-bottom: 0;  ">
              ...
              <table style=" width: 100%; ">
                ...
                <tr>
                  <td style="border-color: white; padding: 0; font-weight: bold;  font-size:11px;">Supplier Quote ID</td>
                  <td style="border-color: white; padding: 0;text-align:  left;  font-size:11px;"> {{($mainData->supp_quot_id!=null)?$mainData->supp_quot_id:''}}</td>
                </tr>
                <tr>
                  <td style="border-color: white; padding: 0; font-weight: bold;  font-size:11px;">Quote Date</td>
                  <td style="border-color: white; padding: 0;text-align:  left;  font-size:11px;"> {{($mainData->quot_date!=null)?date('d-m-Y',strtotime($mainData->quot_date)):''}}</td>
                </tr>

                <tr>
                  <td style="border-color: white; padding: 0; font-weight: bold;  font-size:11px;">Quote Valid Till</td>
                  <td style="border-color: white; padding: 0;text-align:  left;  font-size:11px;"> {{($mainData->quote_valid_date!=null)?date('d-m-Y',strtotime($mainData->quote_valid_date)):''}}</td>
                </tr>
              </table>
            </td>
                    ...
                    <table style=" padding:0">
                      ...
                      <tr>
                        ...
                        <td colspan="3" style="height:60px; border-color: white; padding:0; font-size: 32px; text-align:right;">
                          <strong> Supplier&nbsp;Quote</strong><br>
                        </td>
                      </tr>
                      <tr>
      ...
      <table style="table-layout: auto; " cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td style="border-color: white;   padding: 1px; text-align: center;">
            <h3 style="letter-spacing: 0px; margin: 0;"> Supplier Quote Submission </h3>
      ...
      <div class="str">
        <table>
          <tr>
            ...
            <td style="border-color: white;   padding: 0; text-align:  right; width: 7%;">VAT </td>
          ...
          <tr class="str">
            ...
            <td style="border-color: white;   padding: 2px; text-align: right ">{{number_format($cinvoice_products->discont,2,',','.')}}</td>
            <td style="border-color: white;   padding: 2px; text-align: right">{{number_format($cinvoice_products->vat_amount,2,'.',',')}}</td>
            <td style="border-color: white;   padding: 2px; text-align: right">{{number_format($cinvoice_products->total,2,'.',',')}}</td>
          </tr>
          @endforeach
                  ...
                  <tr style="background-color: white !important; ">
                    ...
                    <td style="border-color: white;background-color: white !important; width: 100%; padding: 0; ">
                      <table style="width:100%; background-color: white !important;">
                        <tr style="background-color: white !important;">
                          <td style="border-color: white; padding: 0;background-color: white !important;"><b>Gross Amount (SAR)</b></td>
                        ...
                        <tr style="background-color: white !important;">
                          <td style="border-color: white; padding: 0;background-color: white !important;"><b>Total VAT Amount (in %) </b></td>
