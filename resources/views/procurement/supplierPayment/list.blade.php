                                        ...
                                        <table class="table table-striped table-hover table-checkable dataTable no-footer" id="draftTbl">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <td>Payment <br>Request Status</td>
                                                    <td>Action</td>
                                                </tr>
                                            </thead>
...
<script src="{{url('/')}}/resources/js/procurement/supplierPayment/list.js" type="text/javascript"></script>
<!-- end::Global Config -->
