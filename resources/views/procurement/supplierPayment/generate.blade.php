                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane p-3 " id="kt_tabs_2_2" role="tabpanel">
                        <div class="row">
                            ...
                            <input type="hidden" name="invoice_id" id="invoice_id" value="{{$MaterialRequest->id}}">
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    <div class="col-md-4">
                                ...
                                <thead class="thead-light">
                                    <tr>
                                       ...
                                       color: white; white-space: nowrap;     padding: 2px 7px !important;">@lang('app.Description')</th>
                                        <th style="background-color:  #3f4aa0;
                                       color: white; white-space: nowrap;     padding: 2px 7px !important;">Invoice Booked Amount</th>
                                        <th style="background-color:  #3f4aa0;
                                       color: white; white-space: nowrap;     padding: 2px 7px !important;">Requested Amount </th>
                                        <th style="background-color:  #3f4aa0;
                                       color: white; white-space: nowrap;     padding: 2px 7px !important;">Payment Request</th>
                                        <th style="background-color:  #3f4aa0;
...
<script src="{{url('/')}}/resources/js/procurement/supplierPayment/add.js" type="text/javascript"></script>
<script>
