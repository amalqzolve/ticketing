                                    ...
                                    <form class="kt-form" id="kt_form" style="width: 100%; padding:0;">
                                        ...
                                        <table class="table table-striped table-hover table-checkable dataTable no-footer" id="internal_use_list">
                                            <thead>
                                                <tr>
                                                    <td>Sl No</td>
                                                    <td>Payment <br>Request ID</td>
                                                    <td>Payment <br> Requested date</td>
                                                    <td>Supplier Name</td>
                                                    <td>Supplier <br> Invoice ID</td>
                                                    <td>Supplier <br> Invoice Date</td>
                                                    <td>PO Number</td>
                                                    <td>PO Date</td>
                                                    <td>Requested <br> Amount</td>
                                                    <td>Payment Request <br> Current Status</td>
...
<script src="{{url('/')}}/resources/js/procurement/supplierPaymentApproval/list.js" type="text/javascript"></script>
<!-- end::Global Config -->
