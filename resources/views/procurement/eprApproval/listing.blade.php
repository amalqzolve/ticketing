        ...
        <div class="kt-portlet__head kt-portlet__head--lg">
            <div class="kt-portlet__head-label">
                ...
                <h3 class="kt-portlet__head-title">
                    Electronic Purchase Request Approval
                </h3>
            </div>
                            ...
                            <div class="kt-grid kt-wizard-v3 kt-wizard-v3--white" id="kt_wizard_v3" data-ktwizard-state="step-first">
                                ...
                                <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v3__wrapper">
                                    ...
                                    <form class="kt-form" id="kt_form" style="width: 100%; padding:0;">
                                        ...
                                        <table class="table table-striped table-hover table-checkable dataTable no-footer" id="pending">
                                            <thead>
                                                <tr>
...
<script src="{{url('/')}}/resources/js/procurement/eprApproval/list.js" type="text/javascript"></script>
<!-- end::Global Config -->
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#internal_use_list").wrap("<div class='table-responsive'></div>");
