        ...
        <div class="kt-portlet__head kt-portlet__head--lg">
            <div class="kt-portlet__head-label">
                ...
                <h3 class="kt-portlet__head-title">
                    Supplier Invoice Booking Resend PO#{{$MaterialRequest->po_id}}
                </h3>
            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <input type="text" name="" id="" class="form-control" value="{{$MaterialRequest->po_date}}" readonly>
                                    </div>
                                </div>
                            </div>
                            ...
                            <table class="table table-striped table-bordered table-hover" id="product_table" style="table-layout:fixed; width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" class="form-control quantity qtyCheck" name="quantity[]" id="quantity{{$key+1}}" data-id="{{$key+1}}" value="{{$reqProduct[$key]['quantity']}}" readonly>
                                        </td>
                                        <td><input type="text" class="form-control row_total" name="row_total[]" id="row_total{{$key+1}}" data-id="{{$key+1}}" readonly="" value="{{$reqProduct[$key]['total']}}"></td>
...
<script src="{{url('/')}}/resources/js/procurement/invoice/resubmit.js" type="text/javascript"></script>
<script>
