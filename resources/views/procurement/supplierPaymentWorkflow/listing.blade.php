...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
	...
	<div class="kt-portlet kt-portlet--mobile">
		<div class="kt-portlet__head kt-portlet__head--lg">
			<div class="kt-portlet__head-label">
				...
				<h3 class="kt-portlet__head-title">
					Supplier Payment Approval synthesis
				</h3>
			</div>
			<div class="kt-portlet__head-toolbar">
				<div class="kt-portlet__head-wrapper">
					<div class="kt-portlet__head-actions">
						@can('Supplier Payment Approval Synthesis ADD')
						<a href="{{url('/')}}/payment-workflow-add" class="btn btn-brand btn-elevate btn-icon-sm">
		...
		<div class="kt-portlet__body">
			<table class="table table-striped table-hover table-checkable dataTable no-footer" id="mrWorkflow">
				<thead>
					<tr>
...
<script src="{{url('/')}}/resources/js/procurement/supplierPaymentWorkflow/listing.js" type="text/javascript"></script>
@endsection