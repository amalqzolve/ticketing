        ...
        <div class="kt-portlet__body pl-2 pr-2 pb-0">
            ...
            <form class="kt-form" id="kt_form" name="kt_form">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane p-1 active" id="kt_tabs_2_1" role="tabpanel">
...
<script src="{{url('/')}}/resources/js/procurement/po/edit.js" type="text/javascript"></script>
<script>
