...
border: 1px solid transparent
      ...
      <div class="str">
                  ...
                  <tr style="background-color: white !important; ">
                    ...
                    <td style="border-color: white;background-color: white !important; width: 100%; padding: 0; ">
                      <table style="width:100%; background-color: white !important;">
                        ...
                        <tr style="background-color: white !important;">
                          <td style="border-color: white; padding: 0;background-color: white !important;"><b>Total VAT Amount </b></td>
                        ...
                        <tr style="background-color: white !important;">
                          <td style="border-color: white; padding: 0;background-color: white !important;"><b>Amount in words </b></td>
                          <td style="border-color: white; padding: 0;background-color: white !important;text-align:right;"><b>{{$totalDigits}}
                            </b></td>
                        </tr>
        ...
        <div class="row cen">
          This is a system Generated Purchase Order Hence doesnot required signature
        </div>
