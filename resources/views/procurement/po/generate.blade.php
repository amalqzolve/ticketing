        ...
        <div class="kt-portlet__body pl-2 pr-2 pb-0">
            ...
            <form class="kt-form" id="kt_form" name="kt_form">
                ...
                <ul class="nav nav-tabs nav-fill" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link " data-toggle="tab" href="#kt_tabs_2_2">Mr Details</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <div class="tab-pane p-2 active" id="kt_tabs_2_1" role="tabpanel">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    <div class="col-md-4">
                                        <label>PO Valid Till @lang('app.Date')</label>
                                    </div>
                                    <div class="col-md-8 input-group-sm">
                ...
                <div class="row p-0" style="background-color:#f2f3f8;">
                    <div class="col-12">
                        ...
                        <div class="table-responsive" style=" width: 100%;      background-color: #f2f3f8;   margin-top: -10px;">
                            <table class="table table-striped table-bordered table-hover" id="product_table" style="width: 100%; table-layout:fixed; width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="hidden" class="form-control eprProductId" name="eprProductId[]" id="eprProductId{{$key+1}}" data-id="{{$key+1}}" value="{{$cinvoice_products['id']}}">
...
<script src="{{url('/')}}/resources/js/procurement/po/submit.js" type="text/javascript"></script>
<script>
