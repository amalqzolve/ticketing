      ...
      <table style="table-layout: auto; " cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td style="border-color: white;   padding: 1px; text-align: center;">
            <h3 style="letter-spacing: 0px; margin: 0;">Purchase Index </h3>
          </td>
        </tr>
        <tr>
          <td style="border-color: white;   padding: 1px">
      ...
      <div class="str">
        <table>
          <tr>
            ...
            <td style="border-color: white;  padding: 0; text-align: left; width: 35%;">Description </td>
            <td style="border-color: white;  padding: 0; text-align: left; width: 7%;">Unit </td>
            <td style="border-color: white;  padding: 0; text-align: right; width: 7%;">Quantity </td>
            <td style="border-color: white;   padding: 0; text-align: right; width: 8%;">Purchased </td>
            <td style="border-color: white;   padding: 0; text-align: right; width: 7%;">Balance</td>
          </tr>
          <tr class="str">
          ...
          <tr class="str">
            ...
            <td style="border-color: white;   padding: 2px;">{{$cinvoice_products['unit']}}</td>
            <td style="border-color: white;   padding: 2px; text-align: right;">{{$cinvoice_products['quantity']}}</td>
            <td style="border-color: white;   padding: 2px; text-align: right">{{$cinvoice_products['purchased']}} </td>
            <td style="border-color: white;   padding: 2px; text-align: right">{{$cinvoice_products['balance']}} </td>
          </tr>
          @endforeach
