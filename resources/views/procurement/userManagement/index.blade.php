	...
	<div class="modal-dialog modal-md" role="document">
		<div class="modal-content">
							...
							<div class="col-lg-12">
								<div class="form-group  row pr-md-3">
									...
									<div class="col-md-10 input-group-sm">
										<select class="form-control single-select kt-selectpicker" name="usersList" id="usersList">
			...
			<div class="modal-footer">
				<button id="addRec" class="btn btn-brand kt-spinner--right kt-spinner--sm kt-spinner--light">New Record</button>
...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid mb-3">
	...
	<div class="kt-portlet kt-portlet--mobile">
		...
		<div class="kt-portlet__body">
			<table class="table table-striped table-hover table-checkable dataTable no-footer" id="usersTbl">
				<thead>
					<tr>
...
<script src="{{url('/')}}/resources/js/procurement/userManagement/list.js" type="text/javascript"></script>
<!-- end::Global Config -->
