        ...
        <div class="kt-portlet__head kt-portlet__head--lg">
            <div class="kt-portlet__head-label">
                ...
                <h3 class="kt-portlet__head-title">
                    Trashed electronic purchase request
                </h3>
            </div>
        ...
        <div class="kt-portlet__body">
            <div class="kt-grid kt-wizard-v3 kt-wizard-v3--white" id="kt_wizard_v3" data-ktwizard-state="first">
                ...
                <div class="kt-wizard-v3__content   fadeIn" data-ktwizard-type="step-content">
                    <div class="mt-3">
                        <table class="table table-striped table-hover table-checkable dataTable no-footer" id="trashedTable">
                            <thead>
                                <tr>
...
<script src="{{url('/')}}/resources/js/procurement/epr/eprTrash.js" type="text/javascript"></script>
<!-- end::Global Config -->
