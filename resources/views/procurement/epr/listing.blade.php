    ...
    <div class="kt-portlet kt-portlet--mobile">
            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    <div class="kt-portlet__head-actions">
                        @can('EPR ADD')
                        <a href="{{url('/')}}/material-request-add" class="btn btn-brand btn-elevate btn-icon-sm">
        ...
        <div class="kt-portlet__body">
            <div class="kt-grid kt-wizard-v3 kt-wizard-v3--white" id="kt_wizard_v3" data-ktwizard-state="first">
                            ...
                            <div class="kt-grid kt-wizard-v3 kt-wizard-v3--white" id="kt_wizard_v3" data-ktwizard-state="step-first">
                                ...
                                <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v3__wrapper">
                                    ...
                                    <form class="kt-form" id="kt_form" style="width: 100%; padding:0;">
                                        ...
                                        <table class="table table-striped table-hover table-checkable dataTable no-footer" id="boq_list">
                                            <thead>
                                                <tr>
                ...
                <div class="kt-wizard-v3__content   fadeIn" data-ktwizard-type="step-content">
                    <div class="mt-3">
                        <table class="table table-striped table-hover table-checkable dataTable no-footer" id="nonBoqTable">
                            <thead>
                                <tr>
                                    <th>@lang('app.Sl.No')</th>
                                    <th>EPR ID</th>
                ...
                <div class="kt-wizard-v3__content   fadeIn" data-ktwizard-type="step-content">
                    <div class="mt-3">
                        <table class="table table-striped table-hover table-checkable dataTable no-footer" id="stockRequestTable">
                            <thead>
                                <tr>
                                    <th>@lang('app.Sl.No')</th>
                                    <th>EPR ID</th>
...
<script src="{{url('/')}}/resources/js/procurement/epr/epr.js" type="text/javascript"></script>
<!-- end::Global Config -->
