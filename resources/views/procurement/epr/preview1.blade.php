    ...
    <div class="row" style="margin-top:100px;">
          ...
          <tr>
            ...
            <td style="border-color: white;   padding-top: 0; padding-right: 0; padding-bottom: 0;  ">
              ...
              <table style=" width: 100%; ">
                <tr>
                  <td style="border-color: white; padding: 0; font-weight: bold;  font-size:11px; width: 30%;">EPR ID.</td>
                  <td style="border-color: white; padding: 0;text-align: left;  font-size:11px; color: red;">&nbsp;EPR {{$MaterialRequest->id}}</td>
                </tr>
                <tr>
                  <td style="border-color: white; padding: 0; font-weight: bold;  font-size:11px;">Requested Date</td>
                  <td style="border-color: white; padding: 0;text-align:  left;  font-size:11px;">&nbsp;{{date('d-m-Y',strtotime($MaterialRequest->quotedate))}}</td>
                ...
                <tr>
                  <td style="border-color: white; padding: 0; font-weight: bold;  font-size:11px;">Required Date</td>
                  <td style="border-color: white; padding: 0;text-align:  left;  font-size:11px;">&nbsp;{{date('d-m-Y',strtotime($MaterialRequest->dateofsupply))}}</td>

                </tr>
                <tr>
                  <td style="border-color: white; padding: 0; font-weight: bold; font-size: 11px;"> Request type </td>
                  <td style="border-color: white; padding: 0;text-align: left; font-size: 11px;">&nbsp;{{($MaterialRequest->request_type==1)?'Internal use':''}}{{($MaterialRequest->request_type==2)?'Department use':''}}{{($MaterialRequest->request_type==3)?'Personal use':''}}{{($MaterialRequest->request_type==4)?'Project Purpose':''}}
                  </td>
                </tr>
                @if($MaterialRequest->request_type==4)
                <tr>
                  <td style=" border-color: white;padding: 0; font-size: 11px; font-weight: bold; ">Project </td>
                  <td style="border-color: white;padding: 0; font-size: 11px; text-align: left;">&nbsp;{{$MaterialRequest->projectname}}</td>
                </tr>
                @endif
                <tr>
                  <td style=" border-color: white;padding: 0; font-size: 11px; font-weight: bold; ">MR Category </td>
                  <td style="border-color: white;padding: 0; font-size: 11px; text-align: left;">&nbsp;{{$MaterialRequest->mr_category_name}}</td>
                </tr>
                    ...
                    <table style=" padding:0; width:100%;">
                        ...
                        <td rowspan="2" style="border-color: white; padding:0; width: 30%;">
                          <div class="visible-print text-center">
                           ...
                           <p class="text-center">
                              <br>
                              @php
                              $qrCode=QrCode::encoding('UTF-8')->size(71)->generate(url('/epr-pocess-list/'.encrypt($MaterialRequest->id)));
                      ...
                      <table>
                        <tr>
                          ...
                          <span style="font-weight: bold; text-align:right;">EPR</span>  
                          </td>
                        </tr>
                        <!-- <tr>
                          <td  style="border-color: white; padding:0; font-size: 32px; text-align:right"></td>
                          <td  style="border-color: white; padding:0; font-size: 32px; text-align:right">
                        
                            
                              @php
                              $qrCode=QrCode::encoding('UTF-8')->size(120)->generate(url('/epr-pocess-list/'.encrypt($MaterialRequest->id)));
                              $qrCode=str_replace('<?xml version="1.0" encoding="UTF-8"?>'," ",$qrCode);
                              @endphp
                             {!! $qrCode !!} 
                        ...
                        <tr>
                          ...
                          <td style="border-color: white; padding:0; text-align:right;"> <span style="font-weight: bold;">Requested by </span>:{{$MaterialRequest->created_name}} <br>Date: {{isset($MaterialRequest->quotedate)?date('d-m-Y',strtotime($MaterialRequest->quotedate)):''}}</td>
                        </tr>
                      </table>
                  </td>
                </tr>
      ...
      <table style="table-layout: auto; " cellspacing="0" cellpadding="0">
        <tr>
          <td style="border-color: white;   padding: 1px">
            <!-- <hr style="height: 1px; color:black;  background-color: black; margin-top: 1px;     margin-bottom: 1px;"> -->
          </td>
        </tr>
        <tr>
      ...
      <div class="str">
        ...
        <div class="row">
          ...
          <p style="text-align: justify; font-size: 10px;">{{$MaterialRequest->notes}}</p>
        ...
        <!-- <table width="100%">
          <tr>
            <td style="border-color: white;background-color: white !important; font-weight: b;">
            </td>
          </tr>
          <tr>
