...
<script src="{{url('/')}}/resources/js/procurement/epr/edit.js" type="text/javascript"></script>
...
<script>
 ...
 <td  style="background-color: white;">\
      <div class="kt-demo-icon__preview remove" data-id="' + rowcount + '" style="width: fit-content;    margin: auto;">\
