...

{
  ...
  $vatno = $invcustomer->vat_no;

  $buyerid_crno = $invcustomer->cr_no;

  $ar_vatno = $invcustomer->ar_vatno;

  $ar_buyerid_crno = $invcustomer->ar_buyerid_crno;

  $ar_cust_zip = $invcustomer->ar_cust_zip;

  $ar_cust_city = $invcustomer->ar_cust_city;

  $additionalno = $invcustomer->additionalno;

  $ar_additionalno = $invcustomer->ar_additionalno;

  $ar_cust_add1 = $invcustomer->ar_cust_add1;

  $ar_cust_name = $invcustomer->ar_cust_name;

  $ar_cust_add2 = $invcustomer->ar_cust_add2;

  $ar_cust_country = $invcustomer->ar_cust_country;

  $ar_cust_region = $invcustomer->ar_cust_region;

  $ar_cust_name = $invcustomer->ar_cust_name;

  $province_state = $invcustomer->province_state;

  $ar_province_state = $invcustomer->ar_province_state;
      ...
      <tr>
        ...
        <table style=" width: 100%; ">
                  ...
                  <tr>
                    ...
                    <td style="border-color: white; padding: 0; font-weight: bold;  font-size:11px; width: 30%;">Invoice Number.</td>

                    <td style="border-color: white; padding: 0;text-align: center;  font-size:11px; color: red;">{{$salesinvoice}}{{ $customer_id }}{{$salesinvoice_sufix}}</td> 
                  ...
                  <tr>
                    ...
                    <td style="border-color: white; padding: 0; font-weight: bold;  font-size:11px;">Invoice issue Date</td>
                    ...
                    <td style="border-color: white; padding: 0; font-weight: bold;  font-size:11px;"> Date of supply</td>

                    <td style="border-color: white; padding: 0;text-align:  center;  font-size:11px;">{{$dateofsupply}}</td>
  ...
  ?>
   ...
   <table style="width:100%; border-spacing: 0;" cellspacing="0" cellpadding="0">
         ...
         <center><h3>Buyer Details  </h3></h3>
          ...
          <table style="width:100%; border-color: white;  border-spacing: 0; /*padding: 2px;*/ " cellspacing="0" cellpadding="0">
            ...
            <tr style=" ">
              ...
              <td  style="border-color: white; border-color: white;   padding: 0px; font-size: 11px;"><?php echo  $customername; ?></td>
              ...
              <td  style="border-color: white; border-color: white;   padding: 0px; font-size: 11px; padding:0; "> <!-- <?php echo  $buldingname; ?> -->

                <table style=" width: 100%; margin: 0; padding:0;border-collapse: collapse; border-spacing: 0;">

                  <tr >

                    <td style="margin: 0; border-color: white; ; border-color: white;   padding: 0px;  font-size: 11px; " ><?php echo  $buldingname; ?>, 
      ...
      <tr>
          ...
          <!--    <td style=" border-color: white; ; border-color: white;   padding: 0px; font-size: 11px;"  width="2%"></td> -->
              ...
              <td  style="border-color: white; border-color: white;   padding: 0px; font-size: 11px;"><!-- <?php echo  $district; ?> -->
      ...
      <tr>
             ...
             <!--  <td style=" border-color: white; ; border-color: white;   padding: 0px; font-size: 11px;"  width="2%"></td> -->
              ...
              <td  style="border-color: white; border-color: white;   padding: 0px; font-size: 11px;"><!-- <?php echo  $city; ?> -->
                ...
                <table style=" width: 100%; border-collapse: collapse; border-spacing: 0;">
                  ...
                  <tr>
                    ...
                    <td style=" border-color: white; ; border-color: white;   padding: 0px;  font-size: 11px; " > 
                        ...
                        <?php echo  $postalcode; ?>,<?php echo  $additionalno; ?>
   ...
   <tr>
             ...
             <!--  <td style=" border-color: white; ; border-color: white;   padding: 0px; font-size: 11px;"  width="2%"></td> -->
              ...
              <td  style="border-color: white; border-color: white;   padding: 0px; font-size: 11px;"><!-- <?php echo  $postalcode; ?> -->
                ...
                <table style=" width: 100%; border-collapse: collapse; border-spacing: 0;">
                  ...
                  <tr>
                    ...
                    <td style=" border-color: white; ; border-color: white;   padding: 0px;  font-size: 11px; " >
                      ...
                      <?php echo  $city; ?>,<?php echo  $cntry_name; ?>
              ...
              <td  style="border-color: white; border-color: white;   padding: 0px; font-size: 11px; text-align: right; ">
                ...
                <table style=" width: 100%; margin: 0; padding:0;border-collapse: collapse; border-spacing: 0;">
                  ...
                  <tr >
                   ...
                   <?php echo  $ar_cust_add2; ?>,<?php echo  $ar_cust_add1; ?> 
                ...
                <table style=" width: 100%; margin: 0; padding:0;border-collapse: collapse; border-spacing: 0;">
                 ...
                 <tr >
                    ...
                    <td style="margin: 0; border-color: white; ; border-color: white;   padding: 0px; font-size: 11px; width: 60%; text-align: right;" >
                      ...
                      <?php echo  $ar_province_state; ?>,<?php echo  $ar_cust_region; ?> 
                ...
                <table style=" width: 100%; margin: 0; padding:0;border-collapse: collapse; border-spacing: 0;">
                   ...
                   <tr >
                    ...
                    <td style="margin: 0; border-color: white; ; border-color: white;   padding: 0px; font-size: 11px; width: 60%; text-align: right;" >
                      ...
                      <?php echo  $ar_additionalno; ?>,<?php echo  $postalcode; ?>
   ...
   <tr>
                ...
                <table style=" width: 100%; margin: 0; padding:0;border-collapse: collapse;">
                   ...
                   <tr >
                    ...
                    <td style="margin: 0; border-color: white; ; border-color: white;   padding: 0px; font-size: 11px; width: 60%; text-align: right;" >
                      ...
                      <?php echo  $ar_cust_country; ?>,<?php echo  $ar_cust_city; ?>
              ...
              <td  style="border-color: white; border-color: white;   padding: 0px;"><?php echo  $ar_additionalno; ?></td>
   ...
   <table>
     ...
     <tr>
       ...
       <td  style="border-color: white; text-align: left; width: 60%;">Nature of goods or Services<br> تفاصيل الخدمات         </td>
       ...
       <td  style="border-color: white; width: 7%; padding: 0;  background-color: white !important;; text-align:center; ">Tax Amount  <br> مبلغ الضريبة      </td>
        ...
        <td  style="border-color: white;  padding: 0; white: 6%;  background-color: white !important;width: 7%; text-align:right;">Item subtotal<br>(Including VAT)  <br>   المجموع (شامل ضريبة القيمة المضافة)    </td>
     ...
     <tr class="str">
       ...
       <?php if ($cinvoice_products->itemname == $data->product_id)

        {
            ...
            if ( ! $cinvoice_products->description ||$cinvoice_products->description=null) {

          $cinvoice_products->description = '';

      }

      

          echo $data->product_name.'-'.$cinvoice_products->description;
...
<tr style="background-color: white !important;">
 ...
 <div class="row">
  ...
  <h4 style="letter-spacing: 0px; margin: 0; text-align: left;"></h4>

  <?php

  $notes=str_replace(array(',', ''), '<br>', $notes);
  ...
  {{$preparedby}}  <br>  {{$quotedate}}
    ...
    <td style="border-color: white; text-align: right;background-color: white !important;"><span style="font-weight: bold;">Received by</span> <br> 
     ...
     <td style="border-color: white;background-color: white !important;"><p><br>  </p></td>
      ...
      <td style="border-color: white; text-align: right;background-color: white !important;"><p> <br> <br><br>  </p></td>
