    ...
    @case(1)
          ...
          <tr>
               <td>CRM</td>
                    ...
                    <td>
                     <a href="{{ URL::to('permissions/'.$permission->id.'/edit') }}" class="btn btn-info fa fa-edit btn-sm pull-left" style="margin-right: 3px;">Edit</a>

                    {!! Form::open(['method' => 'DELETE', 'route' => ['permissions.destroy', $permission->id] ]) !!}
                      <button type="submit" Onclick="return ConfirmDelete()" class="btn btn-danger fa fa-trash pull-left btn-sm"> Delete</button>                     
                    {!! Form::close() !!}
                    </td>
                </tr>
        @break
