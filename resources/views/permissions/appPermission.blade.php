            ...
            <div class="kt-portlet__body">
                ...
                <h3>Permission Rule</h3>
                 ...
                 <table class="table table-striped- table-bordered table-hover table-checkable tpad" >
                    ...
                    <tbody>
            <!-- {{ print_r($role_has_permissions) }} -->
<?php //dd($role_has_permissions); ?>
            ...
            <td>{{ $permission->name }}</td> 
                ...
                <?php    $per=''; $rr=''; ?>
                                    ...
                                    @foreach ($roles as $role)
                                      ...
                                      @foreach ($role_has_permissions as $role_per)
                                     <?php if($role->id == $role_per->role_id && $permission->id == $role_per->permission_id ){
                                         $per=$role_per->permission_id;
                                          $rr=$role_per->role_id;
                                     }?>
                                     @endforeach
                                    
                                        @if($role->id == $rr&&$permission->id==$per)
                                        
                                <td>
                                    <label class="contain">
                                            <input type="checkbox" class="per_checkbox" id="permission" name="permission[]" data-role="{{ $role->id }}" data-permision="{{ $permission->id }}" checked="">
                               ...
                               @else
                                 <td>
                                    <label class="contain">
                                            <input type="checkbox" class="per_checkbox" id="permission" name="permission[]" data-role="{{ $role->id }}" data-permision="{{ $permission->id }}">
                                            <span class="checkmark" ></span>
                                    </label>
                               </td>
                                         @endif 
...
<?php    $per='';   $rr='';?>
 ...
 <div class="col-md-5"  style="padding: 0px;">
                    <button class="btn btn-default" type="submit" id="permision_submit" onclick="permit_submit()">Submit</button>
                </div>
