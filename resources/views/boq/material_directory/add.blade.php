...
<script src="{{url('/')}}/resources/js/boq/material_directory/add.js" type="text/javascript"></script>
...
<td>\
                 ...
                 <td>\
                 <div class="input-group input-group-sm">\
                  <input type="text" class="form-control amount"  data-id="' + rowcount + '" name="amount[]" id="amount' + rowcount + '" value="">\
                 </div>\
                 </td>\
