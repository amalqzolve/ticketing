                           ...
                           <div class="form-group row pr-md-1">
                              ...
                              <div class="col-md-8">
                                 <div class="input-group  input-group-sm">
                                    <input type="text" class="form-control" placeholder="" id="date" name="date" autocomplete="off" value="{{date('d-m-Y')}}">
                                 </div>
                              </div>
                           </div>
                        </div>
...
<script src="{{url('/')}}/resources/js/boq/estimationPendingList.js" type="text/javascript"></script>
