      ...
      <div class="kt-portlet__head kt-portlet__head--lg">
         <div class="kt-portlet__head-label">
            ...
            <h3 class="kt-portlet__head-title">
               <a href="view-childen-estimation-completed?id={{$assent_id}}" class="" >
                  {{ $parent_name }}
               </a>
            </h3>
         </div>
...
<script src="{{url('/')}}/resources/js/boq/estimationCompletedListChild.js" type="text/javascript"></script>
