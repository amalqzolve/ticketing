                  ...
                  <table class="table table-striped table-bordered table-hover" id="product_table" style="width:100%">
                     <thead class="thead-light">
                        <tr>
                           ...
                           <th style="background-color:  #3f4aa0; color: white; white-space: nowrap; padding: 2px 7px !important;" width="450px">@lang('app.Description')</th>
                           <th style="background-color:  #3f4aa0; color: white; white-space: nowrap; padding: 2px 7px !important;" width="450px">@lang('app.Unit')</th>
                     ...
                     <tbody>
                        <tr>
                           ...
                           <td>
                              <input type="text" class="form-control ref" name="ref[]" id="ref">
                           </td>
                           <td>
                              <input type="text" class="form-control head_name" name="head_name[]" id="head_name1">
                           </td>
                           <td>
                              <textarea class="form-control" id="product_description1" name="product_description[]" rows="1" data-id="1" style=" height: 38px !important;"></textarea>
                           </td>
                           <td>
                              <div>
         ...
         <div class="kt-form__actions">
            <div class="row">
               ...
               <div class="col-lg-6 kt-align-right">
                  ...
                  <button id="innerboqsubmit" type="button" class="btn btn-primary">{{ __('product.Save') }}</button>
               </div>
            </div>
         </div>
      </div>
...
<script>
   ...
   $(document).on('click', '#innerboqsubmit', function(e) {
      e.preventDefault();
      var error = 0;
      ...
      if (!error) {
         ...
         $.ajax({
            ...
            success: function(data) {
               $('#innerboqsubmit').removeClass('kt-spinner');
               $('#innerboqsubmit').prop("disabled", false);
         ...
         toastr.warning('Error Fill Mandatory Fields');
   });
      ...
      $.ajax({
         ...
         success: function(data) {
            ...
            $.each(data, function(key, value) {
               ...
               <i class = "fa fa-trash badge-pill" id =""  style ="padding:0; cursor: pointer;" ></i>\
               </span >\
               </div>\
               </td >\
               </tr>';
   ...
   $(document).ready(function() {
      ...
      $('#newrow').click(function() {
         ...
         product += '<tr>\
                 ...
                 <td>\
                 <input type="text" class="form-control ref" name="ref[]" id="ref' + rowcount + '" data-id="' + rowcount + '" value="">\
                 </td>\
                 <td>\
                 <input type="text" class="form-control head_name" name="head_name[]" id="head_name' + rowcount + '" data-id="' + rowcount + '" value="">\
                 </td>\
                 <td><textarea class="form-control" id="product_description' + rowcount + '" name="product_description[]" rows="1" data-id=' + rowcount + ' style=" height: 38px !important;"></textarea>\</td>\
                 <td>\
                 <select class="form-control form-control-sm single-select unit kt-selectpicker"  data-id="' + rowcount + '" name="unit[]" id="unit' + rowcount + '">\
                 <option value="">select</option>\
             @foreach($unitlist as $data)\
