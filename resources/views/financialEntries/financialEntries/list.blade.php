@extends('financialEntries.common.layout')
@section('content')
                            ...
                            <div class="kt-grid kt-wizard-v3 kt-wizard-v3--white" id="kt_wizard_v3" data-ktwizard-state="step-first">
                                ...
                                <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v3__wrapper">
                                    ...
                                    <form class="kt-form" id="kt_form" style="width: 100%; padding:0;">
                                        <table class="table table-striped table-hover table-checkable dataTable no-footer" id="issuedTbl">
                                            <thead>
                                                <tr>
                                                    <td>Sl No</td>
                                                    <td>Payment id</td>
...
<script src="{{url('/')}}/resources/js/financialEntries/financialEntries/list.js" type="text/javascript"></script>
<!-- end::Global Config -->
