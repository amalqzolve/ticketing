											...
											<div class="kt-portlet__head-actions">
												<div class="dropdown dropdown-inline">
													<button type="button" class="btn btn-default btn-icon-sm dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
														<i class="la la-download"></i> {{ __('app.Export') }}
													</button>
												...
												<a href="{{url('/')}}/typetrash" type="button" class="btn btn-danger btn-elevate btn-icon-sm">
...
<!--begin: Datatable -->
<table class="table table-striped- table-bordered table-hover table-checkable" id="customertypedetails_list">
    <thead>
        <tr>
  ...
  <form class="kt-form kt-form--label-right" id="type-form" name="type-form">
      ...
      <div class="kt-portlet__body">
         <div class="form-group row">
            <div class="col-lg-4">
               <label>{{ __('app.Customer Title') }}</label>
               <input type="text" class="form-control" placeholder="{{ __('app.Customer Title') }}" id="title" name="title"  autocomplete="off">
            </div>
            <div class="col-lg-4">
               <label>{{ __('app.Description') }}</label>
               <input type="text" class="form-control" placeholder="{{ __('app.Description') }}" id="discription" name="discription" autocomplete="off">
            </div>
            <div class="col-lg-4">
               <label>{{ __('app.Color') }}</label>
...
<button id="Type_submit" class="btn btn-brand kt-spinner--right kt-spinner--sm kt-spinner--light">{{ __('app.Submit') }}</button>
											<button type="reset" class="btn btn-secondary float-right mr-2 closeBtn" data-dismiss="modal">{{ __('app.Cancel') }}</button>
