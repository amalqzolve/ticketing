...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
	...
	<div class="kt-portlet kt-portlet--mobile">
			...
			<div class="kt-portlet__head-toolbar">
				<div class="kt-portlet__head-wrapper">
					<div class="kt-portlet__head-actions">
						<!-- <a href="{{url('/')}}/rmnewusers" class="btn btn-brand btn-elevate btn-icon-sm"> <i
								class="la la-plus"></i>
							New Users</a> -->
						<a href="{{url('/')}}/rmexistingusers" class="btn btn-brand btn-elevate btn-icon-sm">
							<i class="la la-plus"></i> New Man Power
						</a>
						...
						<div class="dropdown dropdown-inline">
							...
							<div class="dropdown-menu dropdown-menu-right">
								<ul class="kt-nav">
									...
									<li class="kt-nav__item" id="departmentdetails_list_print"> <span href="#" class="kt-nav__link">
						...
						<!-- <a href="{{url('/')}}/rmdepartmenttrash" type="button"
		...
		<div class="kt-portlet__body">
			<table class="table table-striped table-hover table-checkable" id="employeesTbl">
				<thead>
					<tr role="row">
						<th>Sl.No</th>
						<th>Employee Name</th>
...
<script src="{{url('/')}}/resources/js/resourcemanagement/users/list.js" type="text/javascript"></script>
@endsection