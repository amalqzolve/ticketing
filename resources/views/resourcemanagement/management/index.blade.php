...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
	...
	<div class="kt-portlet kt-portlet--mobile">
			...
			<div class="kt-portlet__head-toolbar">
				<div class="kt-portlet__head-wrapper">
					<div class="kt-portlet__head-actions">
						<a href="{{url('rmnewmanagement')}}" class="btn btn-brand btn-elevate btn-icon-sm"> <i class="la la-plus"></i>
							New Record</a>
		...
		<div class="kt-portlet__body">
			<table class="table table-striped table-hover table-checkable" id="tblProject">
				<thead>
					<tr role="row">
						<th>Sl.No</th>
						<th>Project Name</th>
...
<script src="{{url('/')}}/resources/js/resourcemanagement/management/list.js" type="text/javascript"></script>
@endsection