...
<!--  -->
<div class="modal fade" id="kt_modal_4_5" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="min-width: 1024px;">
   <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content">
         <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel"> All Teams</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"></button>
         </div>
         <div class="modal-body">
            <form class="kt-form kt-form--label-right">
               <div class="kt-portlet__body">
                  ...
                  <table class="table table-striped table-hover table-checkable dataTable no-footer" id="teamTbl">
                     <thead>
                        <tr>
                  ...
                  <button type="button" class="btn btn-brand btn-elevate btn-icon-sm float-right ml-2" id="datatableaddTeam"><i class="la la-plus"></i>Add</button>
                  <button type="button" class="btn btn-secondary btn-icon-sm float-right" data-dismiss="modal" aria-label="Close"><svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x icon-16">
                        <line x1="18" y1="6" x2="6" y2="18"></line>
                        <line x1="6" y1="6" x2="18" y2="18"></line>
                     </svg> Cancel</button>
            ...
            <div class="row" style="padding-bottom: 6px;">
               ...
               <div class="col-lg-6">
                  <div class="form-group row pr-md-3">
                     ...
                     <div class="col-md-8 input-group input-group-sm">
                        <select class="form-control kt-selectpicker" id="project_id" name="project_id">
               ...
               <div class="col-lg-6">
                  <div class="form-group row pr-md-3">
                     ...
                     <div class="col-md-8 input-group input-group-sm">
                        <select class="form-control kt-selectpicker" id="project_leader" name="project_leader">
                           <option value="">Select</option>
                           @foreach($users as $user)
                           <option value="{{$user->id}}" {{($projects[0]->project_leader==$user->id)?'selected':''}}>{{$user->name}}</option>
                           @endforeach
                        </select>
                     </div>
                  </div>
               ...
               <div class=" pr-1 pl-1" style="width:100%">
                  ...
                  <table style="width:100%">
                     <tr>
                        ...
                        <td>
                           <button type="button" class="btn btn-brand btn-elevate btn-icon-sm  float-right" id="newTeam"><i class="la la-plus"></i>Add Team</button>
                        </td>
                        <td>
...
<script src="{{url('/')}}/resources/js/resourcemanagement/management/edit.js" type="text/javascript"></script>
@endsection