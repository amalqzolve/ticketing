			...
			<div class="kt-portlet__head-toolbar">
				<div class="kt-portlet__head-wrapper">
					<div class="kt-portlet__head-actions">
						...
						<a href="{{url('add-team')}}" class="btn btn-brand btn-elevate btn-icon-sm">
...
<script src="{{url('/')}}/resources/js/resourcemanagement/team/list.js" type="text/javascript"></script>
@endsection