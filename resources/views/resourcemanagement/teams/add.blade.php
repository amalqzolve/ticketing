            ...
            <div class="row" style="padding-bottom: 6px;">
                  ...
                  <div class="form-group row pr-md-3">
                     ...
                     <div class="col-md-8">
                        <div class="input-group input-group-sm">
                           <input type="text" class="form-control" name="name" id="name" placeholder="Team Name" autocomplete="off">
                        </div>
                     </div>
                  </div>
               </div>
               ...
               <div class="col-lg-6">
                  <div class="form-group row pr-md-3">
                     ...
                     <div class="col-md-8">
                        <div class="input-group input-group-sm">
                           <input type="text" class="form-control" name="decription" id="decription" placeholder="Description" autocomplete="off">
                        </div>
                     </div>
                  </div>
               </div>
...
<script src="{{url('/')}}/resources/js/resourcemanagement/team/add.js" type="text/javascript"></script>
@endsection