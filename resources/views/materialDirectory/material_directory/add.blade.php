                ...
                <table class="table table-striped table-bordered table-hover" id="product_table" style="table-layout:fixed; width:100%">
                    <thead class="thead-light">
                        <tr>
                            ...
                            <th style="background-color:  #3f4aa0; color: white; white-space: nowrap; padding: 2px 7px !important;" width="100px">Code</th>
                            ...
                            <th style="background-color:  #3f4aa0; color: white; white-space: nowrap; padding: 2px 7px !important;" width="125px">Valid Till</th>
...
<script src="{{url('/')}}/resources/js/materialDirectory/add.js" type="text/javascript"></script>
...
<input type="text" class="form-control single-select material_name kt-selectpicker" name="material_name[]" id="material_name' + rowcount + '" data-id="' + rowcount + '" value="">\
<div>\
</td>\
<td>\
<div class="input-group input-group-sm">\
<input type="text" class="form-control single-select description" name="description[]" id="description' + rowcount + '" data-id="' + rowcount + '" value="">\
<div>\
</td>\
<td>\
<div class="input-group input-group-sm">\
<input type="text" class="form-control single-select code" name="code[]" id="code' + rowcount + '" data-id="' + rowcount + '" value="">\
<div>\
</td>\
<td>\
<div class="input-group input-group-sm">\
<input type="text" class="form-control single-select unit" name="unit[]" id="unit' + rowcount + '" data-id="' + rowcount + '" value="">\
<div>\
</td>\
<td>\
<div class="input-group input-group-sm">\
<input type="text" class="form-control single-select category kt-selectpicker" name="category[]" id="category" data-id="' + rowcount + '" value="">\
</div>\
</td>\
<td>\
                 <div class="input-group input-group-sm">\
                  <input type="text" class="form-control group"  data-id="' + rowcount + '" name="group[]" id="group' + rowcount + '" value="">\
                 </div>\
                 </td>\
                 <td>\
                 <div class="input-group input-group-sm">\
                  <input type="text" class="form-control amount number"  data-id="' + rowcount + '" name="amount[]" id="amount' + rowcount + '" value="">\
                 </div>\
                 </td>\
                 <td>\
                 <div class="input-group input-group-sm">\
                  <input type="text" class="form-control valid_till kt_datetimepickerr"  data-id="' + rowcount + '" name="valid_till[]" id="valid_till' + rowcount + '" value="">\
                 </div>\
                 </td>\
