                ...
                <table class="table table-striped table-bordered table-hover" id="product_table" style="table-layout:fixed; width:100%">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <div class="input-group input-group-sm">
                                    <input type="text" class="form-control amount number" name="amount[]" id="amount" value="{{$mainData->amount}}">
                                </div>
                            </td>
                            <td>
                                <div class="input-group input-group-sm">
                                    <input type="text" class="form-control amount kt_datetimepickerr" name="valid_till[]" id="valid_till" value="{{isset($mainData->valid_till) ? \Carbon::parse($mainData->valid_till)->format('d-m-Y') : NULL }}">
                                </div>
                            </td>
                        </tr>
                    </tbody>
...
<script src="{{url('/')}}/resources/js/materialDirectory/edit.js" type="text/javascript"></script>
@endsection