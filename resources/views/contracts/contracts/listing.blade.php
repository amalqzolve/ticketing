...
<br/>
						...
						<a href="{{url('/')}}/contractadd" class="btn btn-brand btn-elevate btn-icon-sm">
													New Record
...
<table class="table table-striped table-hover table-checkable dataTable no-footer" id="contractdetails_list">
	<thead>
		<tr>
			<th>@lang('app.Sl.No')</th>
			<th>@lang('app.Contract Name')</th>
			<th>@lang('app.Starting Date')</th>
			<th>@lang('app.Ending Date')</th>
			<th>@lang('app.Amount')</th>
			<th>@lang('app.Customer Name')</th>
			<th>Status</th>
			<th>Action</th>
		</tr>
	</thead>
	...
	<tbody>
            ...
            <div class="kt-wizard-v3__content   fadeIn" data-ktwizard-type="step-content">
               <div class="mt-3">
               <table class="table table-striped table-hover table-checkable dataTable no-footer" id="contractdetails_list_January">
	<thead>
		<tr>
			<th>@lang('app.Sl.No')</th>
			<th>@lang('app.Contract Name')</th>
	...
	<tbody>
            ...
            <div class="kt-wizard-v3__content   fadeIn" data-ktwizard-type="step-content">
               <div class="mt-3">
             <table class="table table-striped table-hover table-checkable dataTable no-footer" id="contractdetails_list_February">
	<thead>
		<tr>
			<th>@lang('app.Sl.No')</th>
			<th>@lang('app.Contract Name')</th>
...
<table class="table table-striped table-hover table-checkable dataTable no-footer" id="contractdetails_list_March">
	<thead>
		<tr>
			<th>@lang('app.Sl.No')</th>
			<th>@lang('app.Contract Name')</th>
	...
	<tbody>
            ...
            <div class="kt-wizard-v3__content   fadeIn" data-ktwizard-type="step-content">
               <div class="mt-3">
                 <table class="table table-striped table-hover table-checkable dataTable no-footer" id="contractdetails_list_April">
	<thead>
		<tr>
			<th>@lang('app.Sl.No')</th>
			<th>@lang('app.Contract Name')</th>
	...
	<tbody>
            ...
            <div class="kt-wizard-v3__content   fadeIn" data-ktwizard-type="step-content">
               <div class="mt-3">
               <table class="table table-striped table-hover table-checkable dataTable no-footer" id="contractdetails_list_May">
	<thead>
		<tr>
			<th>@lang('app.Sl.No')</th>
			<th>@lang('app.Contract Name')</th>
...
<table class="table table-striped table-hover table-checkable dataTable no-footer" id="contractdetails_list_June">
	<thead>
		<tr>
			<th>@lang('app.Sl.No')</th>
			<th>@lang('app.Contract Name')</th>
...
<table class="table table-striped table-hover table-checkable dataTable no-footer" id="contractdetails_list_July">
	<thead>
		<tr>
			<th>@lang('app.Sl.No')</th>
			<th>@lang('app.Contract Name')</th>
...
<table class="table table-striped table-hover table-checkable dataTable no-footer" id="contractdetails_list_August">
	<thead>
		<tr>
			<th>@lang('app.Sl.No')</th>
			<th>@lang('app.Contract Name')</th>
...
<table class="table table-striped table-hover table-checkable dataTable no-footer" id="contractdetails_list_September">
	<thead>
		<tr>
			<th>@lang('app.Sl.No')</th>
			<th>@lang('app.Contract Name')</th>
...
<table class="table table-striped table-hover table-checkable dataTable no-footer" id="contractdetails_list_October">
	<thead>
		<tr>
			<th>@lang('app.Sl.No')</th>
			<th>@lang('app.Contract Name')</th>
...
<table class="table table-striped table-hover table-checkable dataTable no-footer" id="contractdetails_list_November">
	<thead>
		<tr>
			<th>@lang('app.Sl.No')</th>
			<th>@lang('app.Contract Name')</th>
...
<table class="table table-striped table-hover table-checkable dataTable no-footer" id="contractdetails_list_December">
	<thead>
		<tr>
			<th>@lang('app.Sl.No')</th>
			<th>@lang('app.Contract Name')</th>
