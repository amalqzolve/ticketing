...
<div class="row">
	<div class="col-lg-6">
									...
									@foreach($customers as $customerss) 
										<option value="{{$customerss->id}}"<?php if($customer == $customerss->id) { echo 'selected'; }?>>{{$customerss->cust_name}}</option>
										@endforeach
									</select>               
										</div>
										</div>
									...
									<div class="col-lg-6">
										...
										<div class="col-md-8  input-group-sm">
									<input type="text" class="form-control" name="contractname" id="contractname" value="{{$contractname}}">   
								...
								<input type="text" class="form-control kt_datetimepickerr" name="startingdate" id="startingdate" value="{{$startingdate}}">              
										</div>
										</div>
										</div>
								...
								<input type="text" class="form-control kt_datetimepickerr" name="endingdate" id="endingdate" value="{{$endingdate}}" >              
										</div>
										</div>
										</div>
									  ...
									  <div class="col-lg-6">
										...
										<div class="col-md-8  input-group-sm">
									<input type="text" class="form-control" name="contractamount" id="contractamount" value="{{$contractamount}}">   
									  ...
									  <div class="col-lg-6">
										...
										<div class="col-md-8  input-group-sm">
									<input type="text" class="form-control" name="contractvatamount" id="contractvatamount" value="{{$contractvatamount}}">   
									  ...
									  <div class="col-lg-6">
										...
										<div class="col-md-8  input-group-sm">
									<input type="text" class="form-control" name="contractno" id="contractno" value="{{$contractno}}">   
								...
								<option value="">Select</option>            
										...
										<option value="1" <?php if($contractreference == 1) echo "selected";?>>Sales Quotation</option>
										<option value="2" <?php if($contractreference == 2) echo "selected";?>>Sales Order</option>
										<option value="3" <?php if($contractreference == 3) echo "selected";?>>Sales Invoice</option>
