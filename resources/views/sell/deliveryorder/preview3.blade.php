...
<head>
  ...
  <?php
  foreach ($delivery as $key => $quotations) {
    $id = $quotations->id;
          ...
          <tr>
            ...
            <td style="border-color: white;   padding-top: 0; padding-right: 0; padding-bottom: 0;  ">
              ...
              <table style=" width: 100%; ">
                ...
                <tr>
                  <td style="border-color: white; padding: 0; font-weight: bold;  font-size:11px; width: 30%;">Delivery Order ID</td>
      ...
      <div class="str">
        ...
        <table>
          <tr>
            ...
            <td style="border-color: white;  padding: 0; width: 5%;text-align: center;">Delivery Quantity <br> الوحدة </td>
          ...
          @foreach($deliveryorder as $key=>$quotation_products)
          <?php $total += $quotation_products->delivery_quantity; ?>
          <tr class="str">
            ...
            <td style="border-color: white;   padding: 2px; text-align: center;">{{$quotation_products->delivery_quantity}}</td>
