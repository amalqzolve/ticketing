...
@section('content')
    ...
    <?php
    foreach ($deliveryorder as $deliveryorders) {
        $id = $deliveryorders->id;
        $quotedate = $deliveryorders->quotedate;
        $valid_till = $deliveryorders->valid_till;
        $qtn_ref = $deliveryorders->qtn_ref;
        $po_ref = $deliveryorders->po_ref;
        $delivery_period = $deliveryorders->delivery_period;
        $attention = $deliveryorders->attention;
        $salesman = $deliveryorders->salesman;
        $currency = $deliveryorders->currency;
        $currencyvalue = $deliveryorders->currencyvalue;
        $preparedby = $deliveryorders->preparedby;
        $approvedby = $deliveryorders->approvedby;
        $payment_terms = $deliveryorders->payment_terms;
        $customer = $deliveryorders->customer;
        $terms_conditions = $deliveryorders->terms_conditions;
        $notes = $deliveryorders->notes;
        $tpreview = $deliveryorders->tpreview;
        $delivery_date = $deliveryorders->delivery_date;
        $driver = $deliveryorders->driver;
        $vehicle = $deliveryorders->vehicle;
        $deliverynote = $deliveryorders->deliverynote;
        $saleorder_id = $deliveryorders->saleorder_id;
        $sodate = $deliveryorders->sodate;
        $quoteid = $deliveryorders->quoteid;
    }
                                    ...
                                    <div class="form-group  row pr-md-3">
                                        ...
                                        <div class="col-md-8 input-group-sm">
                                            ...
                                            <input type="text" class="form-control kt_datetimepickerr"
                                                name="delivery_date" id="delivery_date" value="{{ $delivery_date }}">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group  row pr-md-3">
                                        ...
                                        <div class="col-md-8 input-group-sm">
                                            ...
                                            <input type="text" class="form-control" name="deliverynote"
                                                id="deliverynote" value="{{ $deliverynote }}">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="product_table">
                                       ...
                                       color: white; white-space: nowrap;     padding: 2px 7px !important; "> @lang('app.Action') </th> -->
                                        ...
                                        <tbody>
                                            <?php
foreach($deliveryorder_products as $key=>$deliveryorder_productss)
{
    $remaining += $deliveryorder_productss->remaining_quantity;
   // if($remaining > 0)
   // {
    $delivery += $deliveryorder_productss->delivery_quantity;
    $quantity += $deliveryorder_productss->quantity;
    $delivered += $deliveryorder_productss->delivered_quantity;
   ...
   ?>
                                            ...
                                            <tr>
                                                ...
                                                <input type="hidden" class="form-control product_row_id"
                                                    ...
                                                    data-id="{{ $key + 1 }}"
                                                    value="{{ $deliveryorder_productss->id }}">
                                                <td>
                                                    <div class="input-group input-group-sm">
                                                        <input style="width: 4cm;" type="text"
                                                            ...
                                                            data-id="{{ $key + 1 }}"
                                                            value="{{ $deliveryorder_productss->product_name }}"
                                                            readonly>
                                                        <div>
                                                            <input type="hidden"
                                                                ...
                                                                data-id="{{ $key + 1 }}"
                                                                value="{{ $deliveryorder_productss->item_id }}">
                                                </td>
                                                <td>
                                                    <textarea class="form-control" id="description{{ $key + 1 }}" name="description[]" rows="1"
                                                        data-id={{ $key + 1 }} style=" height: 30px !important; width:3cm;">{{ $deliveryorder_productss->description }}</textarea>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="input-group input-group-sm">
                                                        <input type="text" style="width: 1cm;"
                                                            ...
                                                            value="{{ $deliveryorder_productss->quantity }}" readonly>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="input-group input-group-sm">
                                                        <input type="text" style="width: 1cm; width: 1cm;"
                                                            ...
                                                            data-id="{{ $key + 1 }}"
                                                            value="{{ $deliveryorder_productss->delivered_quantity }}"
                                                            readonly>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="input-group input-group-sm">
                                                        <input type="text" class="form-control delivery_quantity"
                                                            ...
                                                            id="delivery_quantity{{ $key + 1 }}"
                                                            value="{{ $deliveryorder_productss->delivery_quantity }}"
                                                            readonly>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="input-group input-group-sm">
                                                        <input type="text" class="form-control remaining_quantity"
                                                            ...
                                                            value="{{ $deliveryorder_productss->remaining_quantity }}"
                                                            readonly>
                                                    </div>
                                                </td>
                            ...
                            <div class="form-group  row pr-md-3">
                                ...
                                <div class="col-md-8 input-group-sm">
                                    ...
                                    <input type="text" class="form-control" name="grandtotal_delivery_quantity"
                                        id="grandtotal_delivery_quantity" value="{{ $delivery }}" readonly
                                        style=" text-align: right; font-size: 1.25rem; background-color: #f2f3f8;  height: calc(1.25em + 1rem + 2px);">
                        ...
                        <div class="kt-form__actions">
                            <div class="row">
                                ...
                                <div class="col-lg-12 kt-align-right">
                                    ...
                                    <button type="button" class="btn btn-primary" id="saleorder_delivery_edit"><svg
                                            xmlns="http://www.w3.org/2000/svg" width="15" height="15"
                                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                            stroke-linecap="round" stroke-linejoin="round"
    ...
    <script type="text/javascript">
        ...
        function totaldeliveryquantity(id) {
            ...
            if (delivery == "" || delivery == 0) {
                ...
                delivery = 0;
                $('#saleorder_delivery_update').attr('disabled', true);
                ...
                $('#saleorder_delivery_update').attr('disabled', false);
        ...
        $(document).on('click', '#saleorder_delivery_edit', function(e) {
            e.preventDefault();
            ...
            $.ajax({
                type: "POST",
                url: "saleorder_generate_delivery_edit",
                dataType: "text",
                data: {
                    _token: $('#token').val(),
                    del_id: $('#id').val(),
