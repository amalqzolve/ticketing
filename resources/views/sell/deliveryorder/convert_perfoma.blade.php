                                    ...
                                    <div class="form-group  row pr-md-3">
                                        ...
                                        <div class="col-md-8 input-group-sm">
                                            ...
                                            <input type="text" class="form-control kt_datetimepickerr"
                                                name="invoice_date" id="invoice_date" value="{{ date('d-m-Y') }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group row pr-md-3">
                                        ...
                                        <div class="col-md-8 input-group input-group-sm">
                                            ...
                                            <input type="number" class="form-control currency_value"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group  row pr-md-3">
                                        ...
                                        <div class="col-md-8 input-group-sm">
                                            ...
                                            <input type="text" class="form-control" name="poid" id="poid"
                                                value="{{ $id }}" readonly>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group  row pr-md-3">
                                        ...
                                        <div class="col-md-8 input-group-sm">
                                            ...
                                            <input type="text" class="form-control" name="podate" id="podate"
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group  row pr-md-3">
                                        ...
                                        <div class="col-md-8 input-group-sm">
                                            <select class="form-control single-select kt-selectpicker" id="qpreparedby"
                                                disabled="">
                                                <option value="">select</option>
                                                @foreach ($salesmen as $data)
                                                    <option
                                                        value="{{ $data->id }}"@if ($qpreparedby == $data->id) selected=""; @endif>
                                                        {{ $data->name }}</option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group  row pr-md-3">
                                        ...
                                        <div class="col-md-8 input-group-sm">
                                            <select class="form-control single-select kt-selectpicker" id="sopreparedby"
                                                disabled="">
                                                <option value="">select</option>
                                                @foreach ($salesmen as $data)
                                                    <option
                                                    ...
                                                    <tr>
                                                            ...
                                                            <div>
                                                                <select style="    width: 3cm;"
                                                                    ...
                                                                    @foreach ($unitlist as $data)
                                                                        <option
                                                                            value="{{ $data->id }}"@if ($saleorder_productss->unit == $data->id) selected="" @endif>
                                                        ...
                                                        <td>
                                                            <div class="input-group input-group-sm">
                                                                <input type="text" style="width: 1cm;"
                                                                    ...
                                                                    id="quantity{{ $key + 1 }}"
                                                                    value="{{ $saleorder_productss->invoice_remaining }}">
                                                                <input type="hidden" style="width: 1cm;"
                                                                    class="form-control oquantity"
                                                                    data-id="{{ $key + 1 }}" name="oquantity[]"
                                                                    id="oquantity{{ $key + 1 }}"
                                                                    value="{{ $saleorder_productss->invoice_remaining }}">
                                                                <input type="hidden" style="width: 1cm;"
                                                                    class="form-control originalquantity"
                                                                    data-id="{{ $key + 1 }}"
                                                                    name="originalquantity[]"
                                                                    id="originalquantity{{ $key + 1 }}"
                                                                    value="{{ $saleorder_productss->invoice_remaining }}">
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="input-group input-group-sm">
                                                                <input type="text" style="width: 1cm; width: 1cm;"
                                                                    ...
                                                                    id="rate{{ $key + 1 }}"
                                                                    data-id="{{ $key + 1 }}"
                                                                    value="{{ $saleorder_productss->rate }}"
                                                                    readonly>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="input-group input-group-sm">
                                                                <input type="text" class="form-control amount"
                                                                    ...
                                                                    value="{{ $saleorder_productss->amount }}">
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="input-group input-group-sm">
                                                                <input type="text"
                                                                    ...
                                                                    value="{{ $saleorder_productss->discount }}"
                                                                    readonly>
                                                            </div>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <select style="    width: 2cm;"
                                                                ...
                                                                id="vat_percentage{{ $key + 1 }}" disabled="">
                                                                <option value="">select</option>
                                                                @foreach ($vatlist as $data)
                                                                    <option
                                                                        value="{{ $data->total }}"@if ($saleorder_productss->vat_percentage == $data->total) selected="" @endif>
                                                                        {{ $data->total }}</option>
                                                                @endforeach
                                                            </select>
                                                        </td>
                                                        <td>
                                                            <input type="text"
                                                                ...
                                                                data-id={{ $key + 1 }}
                                                                value="{{ $saleorder_productss->vatamount }}" readonly>
                                                        </td>
                                                        <td>
                                                            <div class="input-group input-group-sm">
                                                                <input type="text" class="form-control row_total row_total_change"
                                                                    ...
                                                                    id="row_total{{ $key + 1 }}"
                                                                    value="{{ $saleorder_productss->totalamount }}">
                                                            </div>
                                                        </td>
                                ...
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        ...
                                        <input type="text" class="form-control" name="balanceamount"
                                            id="balanceamount" value="" readonly
                                            style=" text-align: right; font-size: 1.25rem; background-color: #f2f3f8;  height: calc(1.25em + 1rem + 2px);">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 kt-align-right">
                                    ...
                                    <button type="button" class="btn btn-primary"
                                        id="deliveryorder_performa_convert"><svg xmlns="http://www.w3.org/2000/svg"
...
@section('script')
    ...
    function findRevercCalculation(row) {
        ...
        $('body').on('keyup', '.quantity', function() {
            ...
            if (quantity == "" || quantity == 0) {
                $('#deliveryorder_performa_convert').attr('disabled', true);
                ...
                $('#deliveryorder_performa_convert').attr('disabled', false);
                row_vatcalculate(id);
                row_calculate(id);
                row_vatcalculate(id);
            }
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '#deliveryorder_performa_convert', function(e) {
            e.preventDefault();
            ...
            $.ajax({
                type: "POST",
                url: "deliveryorder_performa_sell",
                dataType: "text",
                data: {
                    _token: $('#token').val(),
                ...
                success: function(data) {
                    ...
                    toastr.success('Proforma Invoice Created successfuly');
                    $('#deliveryorder_performa_convert').prop("disabled", false);
