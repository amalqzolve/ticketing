                                    ...
                                    <div class="form-group row pr-md-3">
                                        ...
                                        <div class="col-md-8 input-group input-group-sm">
                                            ...
                                            <input type="text" class="form-control currency_value"
                                                name="currencyvalue" id="currencyvalue" value="{{ $currency_default }}"
                                                readonly>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group  row pr-md-3">
                                        ...
                                        <div class="col-md-8 input-group-sm">
                                            ...
                                            <select class="form-control single-select kt-selectpicker newcustomer"
                                                id="newcustomer">
                                                <option value="">select</option>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group row pl-md-3">
                                        ...
                                        <div class="col-md-8  input-group-sm">
                                            <select class="form-control single-select kt-selectpicker customer"
                                                id="customer" disabled="" name="customer">
                                                <option value="">select</option>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group row pr-md-3">
                                        ...
                                        <div class="col-md-8  input-group input-group-sm">
                                            <select class="form-control single-select Cust_category" id="cust_category"
                                                name="cust_category" disabled="">
                                                <option value="">{{ __('customer.Select') }}
                                                </option>
                                                @foreach ($areaList as $item)
                                                    <option
                                                        value="{{ $item->id }}"@if ($item->catdefault == 1) {{ 'selected' }} @endif>
                                        ...
                                        <div class="col-md-8 input-group input-group-sm">
                                            <select class="form-control single-select" id="cust_type" name="cust_type"
                                                ...
                                                @foreach ($areaLists as $key)
                                                    <option
                                                        value="{{ $key->id }}"@if ($key->typedefault == 1) {{ 'selected' }} @endif>
                                                        {{ $key->title }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-8  input-group input-group-sm">
                                            <select class="form-control single-select" name="cust_group" id="cust_group"
                                                ...
                                                @foreach ($group as $item)
                                                    <option
                                                        value="{{ $item->id }}"@if ($item->default_grp == 1) {{ 'selected' }} @endif>
                                                        {{ $item->title }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-group  input-group-sm">
                                                ...
                                                <input type="text" class="form-control"
                                                    ...
                                                    name="buyerid_crno" autocomplete="off">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row p-0" style="background-color:#f2f3f8;">
                     ...
                     border: 0;">
                            ...
                            <div class=" pr-1 pl-1"
                                ...
                                <div class="row m-2 p-2" style="background-color:#fff;">
                        ...
                        <div class="kt-form__actions">
                            <div class="row">
                                ...
                                <div class="col-lg-12 kt-align-right">
                                    ...
                                    <button type="button" class="btn btn-primary" id="invoice_submit"><svg
                                            xmlns="http://www.w3.org/2000/svg" width="15" height="15"
                                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                            stroke-linecap="round" stroke-linejoin="round"
...
@section('script')
    <script>
        ...
        $(document).on("change", ".product_names", function() {
    ...
    <script type="text/javascript">
        ...
        var product_list_table = $('#productdetails_list5').DataTable({
            processing: true,
            serverSide: true,
            bPaginate: true,
            dom: 'Blfrtip',
    ...
    <script type="text/javascript">
        ...
        $('#newrow').click(function() {
            ...
            product += '<tr>\
                ...
                rowcount + '" data-id="' + rowcount + '" >\
                     ...
                     <td><textarea  class="form-control" id="description' + rowcount +
                '" name="description[]" rows="1" data-id=' + rowcount + ' style=" height: 30px !important; width:3cm;"></textarea>\</td>\
                     <td>\
                     <div>\
        ...
        <select  style="    width: 2cm;" class="form-control form-control-sm single-select vat_percentage kt-selectpicker" data-id="' + rowcount +
                ...
                '" name="row_total[]" id="row_total' + rowcount + '">\
                     ...
                     <td  style="background-color: white;">\
                          <div class=" kt-demo-icon__preview remove" style="display: inline;">\
                                              <span class="badge badge-pill mbdg2 mr-1 ml-1 mt-1 shadow">\
                                              <i class="fa fa-trash badge-pill" id="" style="padding:0; cursor: pointer;"></i></span>\
                                           </div>\
                            </td>\
