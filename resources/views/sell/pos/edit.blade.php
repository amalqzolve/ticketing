                                ...
                                <div class="col-lg-6">
                                    <div class="form-group  row pr-md-3">
                                        ...
                                        <div class="col-md-8 input-group-sm">
                                            ...
                                            <input type="text" class="form-control kt_datetimepickerr" name="quotedate"
                                                id="quotedate" value="{{ date('d-m-Y') }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group  row pr-md-3">
                                        ...
                                        <div class="col-md-8 input-group-sm">
                                            ...
                                            <input type="text" class="form-control kt_datetimepickerr" name="valid_till"
                                                id="valid_till" value="{{ date('d-m-Y') }}">
                                    ...
                                    <div class="form-group  row pr-md-3">
                                        ...
                                        <div class="col-md-8 input-group-sm">
                                            ...
                                            <input type="text" class="form-control" name="invoicenumber"
                                                id="invoicenumber" value="{{ $invoice_number }}">
                                    ...
                                    <div class="form-group  row pr-md-3">
                                        ...
                                        <div class="col-md-8 input-group-sm">
                                            ...
                                            <select class="form-control single-select kt-selectpicker" id="approvedby">
                                                ...
                                                @foreach ($salesmen as $data)
                                                    <option
                                                        value="{{ $data->id }}"@if ($approvedby == $data->id) selected=""; @endif>
                                                        {{ $data->name }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="form-group  row pr-md-3">
                                        ...
                                        <div class="col-md-8 input-group-sm">
                                            ...
                                            <select class="form-control single-select kt-selectpicker" id="method">
                                                <option value="1"
                                                    @if ($sale_method == 1) selected="" @endif>Cash</option>
                                    ...
                                    <div class="form-group  row pr-md-3">
                                        ...
                                        <div class="col-md-8 input-group-sm">
                                            ...
                                            <select class="form-control single-select kt-selectpicker"
                                                id="warehouse_search" name="warehouse_search">

                                                @foreach ($warehouses as $data)
                                                    <option value="{{ $data->id }}">{{ $data->warehouse_name }}
                                                    </option>
                                                @endforeach
                                            </select>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group row pr-md-3">
                                        ...
                                        <div class="col-md-8  input-group input-group-sm">
                                            <input type="text" class="form-control single-select Cust_category"
                                                id="cust_category" name="cust_category" value="{{ $cust_category }}"
                                                readonly>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group row  pr-md-3">
                                        ...
                                        <div class="col-md-8 input-group input-group-sm">
                                            <input type="text" class="form-control single-select" id="cust_type"
                                                name="cust_type" value="{{ $cust_type }}" readonly>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group row pl-md-3">
                                        ...
                                        <div class="col-md-8  input-group input-group-sm">
                                            <input type="text" class="form-control single-select" name="cust_group"
                                                id="cust_group" value="{{ $cust_group }}" readonly>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group row pr-md-3">
                                        <div class="col-md-4">
                                            <label>{{ __('customer.Customer Name') }}<span
                                        ...
                                        <div class="col-md-8 ">
                                            <div class="input-group input-group-sm">
                                                ...
                                                <input type="text" class="form-control" id="building_no"
                                                    name="building_no" autocomplete="off"
                                                    placeholder="{{ __('customer.Building No') }}"
                                                    value="{{ $cust_add1 }}" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row pr-md-3">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-group  input-group-sm">
                                                ...
                                                <input type="text" class="form-control" id="cust_region"
                                                    name="cust_region" autocomplete="off"
                                                    placeholder="{{ __('customer.Street Name') }}"
                                                    value="{{ $cust_add2 }}" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row pl-md-3">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-group  input-group-sm">
                                                ...
                                                <input type="text" class="form-control" id="cust_district"
                                                    name="cust_district" autocomplete="off"
                                                    placeholder="{{ __('customer.District') }}"
                                                    value="{{ $cust_region }}"readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-group  input-group-sm">
                                                ...
                                                <input type="text" class="form-control" id="cust_city"
                                                    name="cust_city" autocomplete="off"
                                                    placeholder="{{ __('customer.City') }}" value="{{ $cust_city }}"
                                                    readonly>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group row pl-md-3">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-group  input-group-sm">
                                                <input type="text" name="cust_country"
                                                    id="cust_country"class="form-control single-select"
                                                    value="{{ $cust_country }}" readonly>
                                    ...
                                    <div class="form-group row pr-md-3">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-group  input-group-sm">
                                                ...
                                                <input type="text" class="form-control" id="cust_zip"
                                                    name="cust_zip" autocomplete="off"
                                                    placeholder="{{ __('customer.Postal Code') }}"
                                                    value="{{ $cust_zip }}" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-group  input-group-sm">
                                                ...
                                                <input type="text" class="form-control"
                                                    placeholder="{{ __('customer.Mobile') }}" id="mobile"
                                                    name="mobile" autocomplete="off" value="{{ $mobile }}"
                                                    readonly>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="row p-0" style="background-color:#f2f3f8;">
                        <div class="col-12 p-0">
                            ...
                            <div class=" pr-1 pl-1"
                                ...
                                <div class="row mt-2 mr-2 ml-2 mb-0 p-2" style="background-color:#fff;">
                                        ...
                                        <div class="form-group row pr-md-3">
                                            ...
                                            <div class="col-md-12  input-group-sm">
                                                <input type="text" class="form-control product_code"
                                                    name="product_code" id="product_code" autocomplete="off"
                                                    style="width: 100%;">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mr-2 ml-2 mt-0 p-0" style="background-color:#fff;">
                                    ...
                                    <div class="table-responsive pl-3 pr-3">
                                       ...
                                       color: white; white-space: nowrap;     padding: 2px 7px !important;">
                                                    ...
                                                    <th
                                                        style="background-color:  #3f4aa0;
                                       color: white; white-space: nowrap;     padding: 2px 7px !important; 
                                       width: 61px; display: inline-table;     height: 24px;">
                                                        <!-- @lang('app.Action') --></th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="input-group input-group-sm">
                                                                <input style="width: 4cm;" type="text"
                                                                    ...
                                                                    name="productname[]"
                                                                    id="productname{{ $key + 1 }}"
                                                                    data-id="{{ $key + 1 }}"
                                                                    value="{{ $invoice_products->product_name }}">
                                                                <div>
                                                                    <input type="hidden"
                                                                        class="form-control single-select item_id"
                                                                        name="item_id[]" id="item_id{{ $key + 1 }}"
                                                                        data-id="{{ $key + 1 }}"
                                                                        value="{{ $invoice_products->item_id }}">
                                                        </td>
                                                        <td>
                                                            <textarea class="form-control" id="description{{ $key + 1 }}" name="description[]" rows="1"
                                                                data-id={{ $key + 1 }} style=" height: 30px !important; width:3cm;">{{ $invoice_products->description }}</textarea>
                                                        </td>
                                                        <td>
                                                            <div>
                                                                <select style="    width: 3cm;"
                                                                    ...
                                                                    @foreach ($unitlist as $data)
                                                                        <option
                                                                            value="{{ $data->id }}"@if ($invoice_products->unit == $data->id) selected="" @endif>
                                                        ...
                                                        <td>
                                                            <div class="input-group input-group-sm">
                                                                <input type="text"
                                                                    ...
                                                                    value="{{ $invoice_products->discount }}">
                                                            </div>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <select style="    width: 2cm;"
                                                                ...
                                                                @foreach ($vatlist as $data)
                                                                    <option
                                                                        value="{{ $data->total }}"@if ($invoice_products->vat_percentage == $data->total) selected="" @endif>
                                                                        {{ $data->total }}</option>
                                                                @endforeach
                                                            </select>
                                                        </td>
                                                        <td>
                                                            <input type="text"
                                                                ...
                                                                data-id={{ $key + 1 }}
                                                                value="{{ $invoice_products->vatamount }}" readonly>
                                                        </td>
                                                        <td>
                                                            <div class="input-group input-group-sm">
                                                                <input type="text" class="form-control row_total row_total_change"
                                                                    ...
                                                                    id="row_total{{ $key + 1 }}"
                                                                    value="{{ $invoice_products->totalamount }}">
                                                            </div>
                                                        </td>
                                                        <td style="background-color: white;">
                                                            <div class="row">
                                                                <div class="col-md-6 kt-demo-icon__preview remove"
                                                                    ...
                                                                    <span
                                                                        class="badge badge-pill mbdg2 mr-1 ml-1 mt-1 shadow">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        ...
                                        <select class="form-control single-select kt-selectpicker useadvance"
                                            id="useadvance">
                                ...
                                <div class="form-group row pr-md-3">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group  input-group-sm">
                                            ...
                                            <input type="text" class="form-control" id="creditbalance"
                                                name="creditbalance" readonly value="0">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        ...
                                        <input type="text" class="form-control paidamount" name="paidamount"
                                            id="paidamount" value="{{ $paid_amount }}"
                                            style=" text-align: right; font-size: 1.25rem; background-color: #f2f3f8;  height: calc(1.25em + 1rem + 2px);">
                                ...
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        ...
                                        <input type="text" class="form-control" name="balanceamount"
                                            id="balanceamount" value="{{ $balance_amount }}" readonly
                                            style=" text-align: right; font-size: 1.25rem; background-color: #f2f3f8;  height: calc(1.25em + 1rem + 2px);">
                        ...
                        <div class="kt-form__actions">
                            <div class="row">
                                ...
                                <div class="col-lg-12 kt-align-right">
                                    ...
                                    <button type="button" class="btn btn-primary" id="invoice_edit_sell"><svg
                                            xmlns="http://www.w3.org/2000/svg" width="15" height="15"
                                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                            stroke-linecap="round" stroke-linejoin="round"
...
@section('script')
    <script>
        ...
        $(document).ready(function() {
            ...
            var bloodhound = new Bloodhound({
                ...
                remote: {
                    url: "{{ url('productcode_sales/find?q=%QUERY%') }}",
                    wildcard: '%QUERY%'
                },
            });

            $('.product_code').typeahead({
                hint: true,
                highlight: true,
                minLength: 3
            }, {
                ...
                display: function(data) {
                    return data.product_code //Input value to be set when you select a suggestion.
                },
                ...
                templates: {
                    ...
                    /* header: function(data) {
                       return '<table><tr>' + '<th>Sl No</th>'+'<th nowrap style="border-left:1px solid #ccc;padding:0px 3px;min-width:250px;">Itema Name</th>'+'<th nowrap style="border-left:1px solid #ccc;padding:0px 3px;min-width:250px;">Description</th>' + '<th nowrap style="border-left:1px solid #ccc;padding:0px 3px;min-width:250px;">Bar Code</th>'+'<th nowrap style="border-left:1px solid #ccc;padding:0px 3px;min-width:250px;">Part No</th>'+'<th nowrap style="border-left:1px solid #ccc;padding:0px 3px;min-width:250px;">Product Code</th>'+'<th nowrap style="border-left:1px solid #ccc;padding:0px 3px;min-width:250px;">Unit</th>'+'<th nowrap style="border-left:1px solid #ccc;padding:0px 3px;min-width:250px;">Product Price</th>'+'<th nowrap style="border-left:1px solid #ccc;padding:0px 3px;min-width:250px;">Selling Price</th>'+'<th nowrap style="border-left:1px solid #ccc;padding:0px 3px;min-width:250px;">Stock</th>'+'<th nowrap style="border-left:1px solid #ccc;padding:0px 3px;min-width:250px;">S/O</th>'+'</tr>';
                     },
                     suggestion: function(data) {
                        var no = sl++;
                       return '<tr>' + '<td>'+no+'</td>'+'<td nowrap style="border-left:1px solid #ccc;padding:0px 3px;min-width:250px;">' + data.product_name + '</td>'+'<td nowrap style="border-left:1px solid #ccc;padding:0px 3px;min-width:250px;">' + data.description + '</td>' + '<td nowrap style="border-left:1px solid #ccc;padding:0px 3px;min-width:250px;">' + data.barcode + '</td>' + '<td nowrap style="border-left:1px solid #ccc;padding:0px 3px;min-width:250px;">' + data.part_no + '</td>' + '<td nowrap style="border-left:1px solid #ccc;padding:0px 3px;min-width:250px;">' + data.product_code + '</td>' + '<td nowrap style="border-left:1px solid #ccc;padding:0px 3px;min-width:250px;">' + data.unit_name + '</td>' + '<td nowrap style="border-left:1px solid #ccc;padding:0px 3px;min-width:250px;">' + data.product_price + '</td>' + '<td nowrap style="border-left:1px solid #ccc;padding:0px 3px;min-width:250px;">' + data.selling_price + '</td>' + '<td nowrap style="border-left:1px solid #ccc;padding:0px 3px;min-width:250px;">' + data.available_stock + '</td>' + '<td nowrap style="border-left:1px solid #ccc;padding:0px 3px;min-width:250px;">' + data.available_stock + '</td>' + '</tr>';
                ...
                <div class="row">\
                   <div class="col-4 data"><b>Item Name</b></div>\
                   <div class="col-1 data"><b>Barcode</b></div>\
                   <div class="col-1 data" style="white-space: nowrap;"><b>Part No</b></div>\
                   <div class="col-1 data"><b>P.Code</b></div>\
                   <div class="col-1 data"><b>Unit</b></div>\
                   <div class="col-1 data"><b>P.Price</b></div>\
                   <div class="col-1 data"><b>S.price</b></div>\
                   <div class="col-1 data"><b>Stock</b></div>\
                   <div class="col-1 data"><b>SO</b></div>\
                </div>\
             </div> '
                            /* '<table class="table table-bordered mb-0" id="productdetails_list" role="grid" aria-describedby="productdetails_list_info" style="width:100%">\
                              <tr role="row">\
                              <td  aria-controls="productdetails_list" style="width:100px; text-align:left;  display: block;">Item Name</td>\
                              <td  aria-controls="productdetails_list" style="width:300px; text-align:left; ">Description</td>\
                              <td  aria-controls="productdetails_list" style="width:100px; text-align:left; display: block;">Barcode</td>\
                              <td  aria-controls="productdetails_list" style="width:150px; text-align:left; ">Part No</td>\
                              <td  aria-controls="productdetails_list" style="width:100px; text-align:left; display: block;">Product Code</td>\
                              <td  aria-controls="productdetails_list" style="width:150px; text-align:left; ">Unit</td>\
                              <td  aria-controls="productdetails_list" style="width:150px; text-align:left; display: block;">Product Price</td>\
                              <td  aria-controls="productdetails_list" style="width:150px; text-align:left; ">Selling price</td>\
                              <td  aria-controls="productdetails_list" style="width:150px; text-align:left; ">Stock</td>\
                              <td  aria-controls="productdetails_list" style="width:150px; text-align:left; ">S/O</td>\
                              </tr> <tbody></table>'   */
                        );
                    },
                    ...
                    suggestion: function(data) {
                        ...
                        //var product_name1= data.product_name.substr(0, 175) + '...';
                        var product_name1 = data.product_name;
                        var description1 = data.description;


                        return '<div class="container-fluid">\
                <div class="row">\
                   <div class="col-4" data>' + product_name1 + '<br>\
                   <span class="b">' + description1 + '</span></div>\
                   <div class="col-1 data">' + data.barcode + '</div>\
                   <div class="col-1 data">' + data.part_no + '</div>\
                   <div class="col-1 data">' + data.product_code + '</div>\
                   <div class="col-1 data">' + data.unit_name + '</div>\
                   <div class="col-1 data">' + data.product_price + '</div>\
                   <div class="col-1 data">' + data.selling_price + '</div>\
                   <div class="col-1 data">' + data.so + '</div>\
                   <div class="col-1 data">' + data.available_stock + '</div>\
                </div>\
             </div> '

                        /*'<table class="table table-bordered mb-0" id="productdetails_list" role="grid" aria-describedby="productdetails_list_info" style="width:100%">\
                        <tr role="row">\
                        <td  aria-controls="productdetails_list" style="width:100px; text-align:left;  display: block;">' + data.product_name + '</td>\
                        <td  aria-controls="productdetails_list" style="width:300px; text-align:left; ">' + data.description + '</td>\
                        <td  aria-controls="productdetails_list" style="width:100px; text-align:left; display: block;">' + data.barcode + '</td>\
                        <td  aria-controls="productdetails_list" style="width:150px; text-align:left; ">' + data.part_no + '</td>\
                        <td  aria-controls="productdetails_list" style="width:100px; text-align:left; display: block;">' + data.product_code + '</td>\
                        <td  aria-controls="productdetails_list" style="width:150px; text-align:left; ">' + data.unit_name + '</td>\
                        <td  aria-controls="productdetails_list" style="width:150px; text-align:left; display: block;">' + data.product_price + '</td>\
                        <td  aria-controls="productdetails_list" style="width:150px; text-align:left; ">' + data.selling_price + '</td>\
                        <td  aria-controls="productdetails_list" style="width:150px; text-align:left; ">' + data.so + '</td>\
                        <td  aria-controls="productdetails_list" style="width:150px; text-align:left; ">' + data.available_stock + '</td>\
                        </tr> <tbody></table>'*/
                        ;
        ...
        $('body').on('change', '.product_code', function() {
            ...
            warehouse = $('#warehouse_search').val();

            createproduct(product_code, warehouse);
        });
        ...
        function createproduct(product_code, warehouse) {

            $.ajax({
                url: "getproduct_product_code",
                method: "POST",
                data: {
                    _token: $('#token').val(),
                    id: product_code,
                ...
                success: function(data) {
                    ...
                    $.each(data, function(key, value) {
                     ...
                     <td><textarea  class="form-control" id="description' + rowcount +
                            ...
                            ' style=" height: 30px !important; width:3cm;">' + des + '</textarea>\</td>\
                     <td>\
                     <div>\
                     <select style="    width: 3cm;" class="form-control form-control-sm single-select unit kt-selectpicker" name="unit[]" id="unitvalue' + rowcount + '"  data-id="' +
                            rowcount + '">\
                     <option value="">select</option>\
             @foreach ($unitlist as $data)\
        ...
        <select  style="    width: 2cm;" class="form-control form-control-sm single-select vat_percentage kt-selectpicker" data-id="' + rowcount +
                ...
                <option value="">select</option>\
                @foreach ($vatlist as $data)\
                  <option value="{{ $data->total }}"  @if ($data->default_tax == 1) selected="" @endif>{{ $data->total }}</option>\
                  @endforeach\
    </select>\
    </td>\
                    <td>\
    ...
    <script src="{{ url('/') }}/resources/js/sell/pos.js" type="text/javascript"></script>
