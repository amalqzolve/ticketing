                                ...
                                <div class="col-12 p-0 table-responsive">
                                    <table class="table table-striped table-bordered table-hover" id="product_table"
                                       ...
                                       color: white; white-space: nowrap;     padding: 2px 7px !important;">
                                                ...
                                                <th style="background-color:  #3f4aa0;
                                       color: white; white-space: nowrap;     padding: 2px 7px !important;"
                                                    width="75px">@lang('app.Quantity')</th>
                                                <th style="background-color:  #3f4aa0;
                                       color: white; white-space: nowrap;     padding: 2px 7px !important;"
                                                    width="90px">@lang('app.Rate')</th>
                                                <th style="background-color:  #3f4aa0;
                                       color: white; white-space: nowrap;     padding: 2px 7px !important;"
                                                    width="75px;">@lang('app.Amount')</th>
                                                <th style="background-color:  #3f4aa0;
                                       color: white; white-space: nowrap;     padding: 2px 7px !important;"
                                                    width="75px">@lang('app.Discount')</th>
                                                <th style="background-color:  #3f4aa0;
                                       color: white; white-space: nowrap;     padding: 2px 7px !important; "
                                                    width="60px;">@lang('app.Vat (%)')</th>
                                                <th style="background-color:  #3f4aa0;
                                       color: white; white-space: nowrap;     padding: 2px 7px !important; width: ;"
                                                    width="75px;">@lang('app.VAT Amount')</th>
                                                <th style="background-color:  #3f4aa0;
                                       color: white; white-space: nowrap;     padding: 2px 7px !important;"
                                                    width="75px;">@lang('app.Total Amount')</th>
                                                <th style="background-color:  #3f4aa0;
                                       color: white; white-space: nowrap;     padding: 2px 7px !important; "
                                                    width="60px">@lang('app.Action')</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <input type="text" class="form-control product_code"
                                                        name="product_code[]" id="product_code1" data-id="1">
                                                ...
                                                <td>
                                                    ...
                                                    <input type="text" class="form-control form-control-sm"
                                                        data-id="1" name="productname[]" id="productname1">
                                                    <input type="hidden" class="form-control form-control-sm"
                                                        data-id="1" name="item_id[]" id="item_id1">


                                                </td>
                                                <td>
                                                    <textarea class="form-control" id="product_description1" name="product_description[]" rows="1" data-id="1"
                                                ...
                                                <td>
                                                    <div class="input-group input-group-sm"> <input type="text"
                                                            class="form-control quantity" data-id="1"
                                                            name="quantity[]" id="quantity1" value="1"> </div>
                                                </td>
                                                <td>
                                                    <div class="input-group input-group-sm"> <input type="text"
                                                            class="form-control rate" name="rate[]" id="rate1"
                                                            data-id="1" value="0"> </div>
                                                </td>
                                                <td>
                                                    <div class="input-group input-group-sm"> <input type="text"
                                                            class="form-control amount" name="amount[]" data-id="1"
                                                            id="amount1" readonly value="0"> </div>
                                                </td>
                                                <td>
                                                    <div class="input-group input-group-sm"> <input type="text"
                                                            class="form-control discountamount" data-id="1"
                                                            name="discountamount[]" id="discountamount1" value="0">
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <select
                                                        ...
                                                        data-id="1" name="vat_percentage[]" id="vat_percentage1">
                                                        <option value="">select</option>
                                                        @foreach ($vatlist as $data)
                                                            <option value="{{ $data->total }}">{{ $data->total }}
                                                            </option>
                                                        @endforeach
                                                ...
                                                <td> <input type="text" class="form-control vatamount form-control-sm"
                                                        name="vatamount[]" id="vatamount1" data-id="1" value="0"
                                                        readonly> </td>
                                                <td>
                                                    <div class="input-group input-group-sm"> <input type="text"
                                                            class="form-control row_total row_total_change" data-id="1"
                                                            name="row_total[]" id="row_total1" > </div>
                                                </td>
                                                <td style="background-color: white;">
                                                    <div class="kt-demo-icon__preview remove"
                                                        style="width: fit-content;    margin: auto;"> <span
                                                            class="badge badge-pill mbdg2 mr-1 ml-1 mt-1 shadow"> <i
                                                                class="fa fa-trash badge-pill" id=""
                                                                style="padding:0; cursor: pointer;"></i></span> </div>
                                                </td>
                                            </tr>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <button type="button"
                                                ...
                                                id="newrow"><i class="la la-plus"></i>Line Iteam</button>
...
@section('script')
    <script>
        ...
        // function createproduct(product_code){
        ...
        //                  <td>\
        //                  <div>\
        //                  <select style="    width: 3cm;" class="form-control form-control-sm single-select unit kt-selectpicker" name="unit[]" id="unitvalue'+rowcount+'"  data-id="'+rowcount+'">\
        //                  <option value="">select</option>\
        //          @foreach ($unitlist as $data)\
    ...
    <script type="text/javascript">
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $.each(data, function(key, value) {
                        ...
                        var selling_price = (value.selling_price != null) ? value
                            .selling_price : 0;
                        var so = (value.so != null) ? value.so : 0;
                        if (so == null) {
                            so = '-';
                        ...
                        $('#productname' + rid + '').val(value.product_name);
                        $('#product_description' + rid + '').val(des);
                        $('#so_stock' + rid + '').val(value.available_stock);
                        $('#unit' + rid + '').val(value.unit);
                        $('#item_id' + rid + ).val(value.product_id);
        ...
        $(document).ready(function() {
            $('#newrow').click(function() {
                ...
                product += '<tr>\
                     ...
                     <input type="text" class="form-control product_code" name="product_code[]" id="product_code' +
                    rowcount + '" data-id="' + rowcount + '" value="">\
                     </td>\
                     <td>\
                     <input type="text" class="form-control productname"  data-id="' + rowcount +
                    '" name="productname[]" id="productname' + rowcount + '">\
                     <input type="text" class="form-control item_id"  data-id="' + rowcount +
                    '" name="item_id[]" id="item_id' + rowcount + '">\
                     </td>\
                     <td><textarea class="form-control" id="product_description' + rowcount +
                    '" name="product_description[]" rows="1" data-id=' + rowcount + ' style=" height: 30px !important;"></textarea>\</td>\
                     <td>\
                     <select class="form-control form-control-sm single-select unit kt-selectpicker"  data-id="' +
                    rowcount + '" name="unit[]" id="unit' + rowcount + '">\
                     <option value="">select</option>\
             @foreach ($unitlist as $data)\
                  <option value="{{ $data->id }}">{{ $data->unit_name }}</option>\
                  @endforeach\
                    ...
                    '" id="amount' + rowcount + '" readonly value="0.00">\
                     </div>\
                     </td>\
                     <td>\
        ...
        <select class="form-control form-control-sm single-select vat_percentage kt-selectpicker" data-id="' + rowcount +
                ...
                $('#product_table').append(product);
                $('.vat_percentage').trigger("change");
                $('.product_code').typeahead('destroy');
                var bloodhound = new Bloodhound({
                    datumTokenizer: Bloodhound.tokenizers.whitespace,
                    queryTokenizer: Bloodhound.tokenizers.whitespace,
                    remote: {
                ...
                $('.product_code').typeahead({
                    ...
                    display: function(data) {
                        return data
                            .product_code //Input value to be set when you select a suggestion.
                    },
                    templates: {
                        empty: [
                            '<div class="list-group search-results-dropdown"><div class="list-group-item">Nothing found.</div></div>'
