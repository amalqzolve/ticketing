...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
	...
	<div class="kt-portlet kt-portlet--mobile">
		<div class="kt-portlet__head kt-portlet__head--lg">
			<div class="kt-portlet__head-label">
				...
				<h3 class="kt-portlet__head-title">
					Bill Settlement For - {{$customers->cust_name}}
				</h3>
			</div>
		...
		<div class="kt-portlet__body">
			...
			<input type="hidden" name="customer_select" id="customer_select" value="{{$customer_select}}">
			...
			<div id="results">
				<table class="table table-striped table-hover table-checkable dataTable no-footer">
					...
					<tbody id="maindetails_list">
						...
						<tr>
							<td><input type="checkbox" class="vcheck" id="{{$voucherss->vid}}" value="{{$voucherss->balance_amount}}" /></td>
							<td>{{$voucherss->vid}}</td>
							...
							<table class="table table-striped table-hover" id="modeofpaymenttable">
								...
								<tbody>
									<tr>
										...
										<td style="padding: 0;">
											<select class="form-control single-select modeofpayment kt-selectpicker" name="modeofpayment[]" id="modeofpayment0" data-id="0">
												<option value="">Select</option>
			...
			@else
			No Sale Order Fount For {{$customers->cust_name}}
			@endif
...
<script type="text/javascript">
	...
	$(document).on('click', '#bill_settlement_submit', function(e) {
		...
		function saveDetails(result) {
			...
			$.ajax({
				type: "POST",
				url: "sale_bill_settle_submit_sell",
				dataType: "json",
				data: {
					_token: $('#token').val(),
					customer_select: $('#customer_select').val(),
