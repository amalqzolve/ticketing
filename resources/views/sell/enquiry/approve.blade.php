                            ...
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <input type="text" class="form-control kt_datetimepickerr" name="podate" id="podate" value="{{ date('d-m-Y') }}">
                                        <!-- </div> -->
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        ...
                                        <input type="text" class="form-control" name="quotation_id" id="quotation_id" value="{{ $id }}" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        ...
                                        <input type="text" class="form-control" name="valid_till" id="valid_till" value="{{ $valid_till }}" readonly>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <select class="form-control single-select kt-selectpicker" id="" disabled="">
                                            <option value="">select</option>
                                            @foreach ($salesmen as $data)
                                ...
                                <table class="table table-striped table-bordered table-hover" id="product_table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <textarea readonly class="form-control" id="description{{ $key + 1 }}" name="description[]" rows="1" data-id={{ $key + 1 }} style=" height: 30px !important; width:3cm;">{{ $quotation_productss->description }}</textarea>
                                            </td>
                                            ...
                                            <td>
                                                <div class="input-group input-group-sm">
                                                    <input type="text" style="  style=" width: 1cm;" width: 1cm;" class="form-control rate" name="rate[]" id="rate{{ $key + 1 }}" data-id="{{ $key + 1 }}" value="{{ $quotation_productss->rate }}">
                                                </div>
                                            </td>
                                            <td>
                                                <div class="input-group input-group-sm">
                                            ...
                                            <td>
                                                <input type="text" class="form-control vatamount form-control-sm" name="vatamount[]" id="vatamount{{ $key + 1 }}" data-id={{ $key + 1 }} value="{{ $quotation_productss->vatamount }}">
                                            </td>
                                            <td>
                                                <div class="input-group input-group-sm">
                    ...
                    <div class="kt-form__actions">
                        <div class="row">
                            ...
                            <div class="col-lg-12 kt-align-right">
                                ...
                                <button type="button" class="btn btn-primary" id="enquiry_approve"><svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check-circle icon-16">
