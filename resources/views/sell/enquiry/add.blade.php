        ...
        <div class="kt-portlet__body pl-2 pr-2 pb-0">
            ...
            <form class="kt-form" id="kt_form">
                ...
                <ul class="nav nav-tabs nav-fill" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab" href="#kt_tabs_2_1">Enquiry Details</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <div class="kt-form__actions">
                        <div class="row">
                            ...
                            <div class="col-lg-12 kt-align-right">
                                ...
                                <button type="button" class="btn btn-primary" id="enquiry_submit"><svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check-circle icon-16">
    ...
    $(document).ready(function() {
        $(document).on('change', '.newcustomer', function() {
            ...
            if (customer == 1) { //new customer
                ...
                $('#account_ledger').val('').trigger('change').attr('disabled', false);
            }
            if (customer == 2) { //database
                ...
                $('#account_ledger').attr('disabled', true);
            }
        });
    });
</script>
