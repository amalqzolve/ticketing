                                ...
                                <table class="table table-striped table-bordered table-hover" id="product_table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-group input-group-sm">
                                                    <input style="width: 4cm;" type="text" class="form-control single-select productname kt-selectpicker" name="productname[]" id="productname{{ $key + 1 }}" data-id="{{ $key + 1 }}" value="{{ $quotation_productss->product_name }}" readonly>
                                                    <div>
                                                        <input type="hidden" class="form-control single-select item_id" name="item_id[]" id="item_id{{ $key + 1 }}" data-id="{{ $key + 1 }}" value="{{ $quotation_productss->item_id }}">
                                            </td>
                                            <td>
                                                <textarea class="form-control" id="description{{ $key + 1 }}" name="description[]" rows="1" data-id={{ $key + 1 }} style=" height: 30px !important; width:3cm;">{{ $quotation_productss->description }}</textarea>
                                            </td>
                                            <td>
                                                <div>
                                                    <select style="    width: 3cm;" class="form-control form-control-sm single-select unit kt-selectpicker" data-id="{{ $key + 1 }}" name="unit[]" id="unit">
                                                        ...
                                                        <option value="{{ $data->id }}" @if ($quotation_productss->unit == $data->id) selected="" @endif>
                                                            {{ $data->unit_name }}
                                                        </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <td>
                                                <div class="input-group input-group-sm">
                                                    <input type="text" style="width: 1cm;" class="form-control quantity" data-id="{{ $key + 1 }}" name="quantity[]" id="quantity{{ $key + 1 }}" value="{{ $quotation_productss->quantity }}">
                                                </div>
                                            </td>
                                            <td>
                                                <div class="input-group input-group-sm">
                                                    <input type="text" style="width: 1cm; width: 1cm;" class="form-control rate" name="rate[]" id="rate{{ $key + 1 }}" data-id="{{ $key + 1 }}" value="{{ $quotation_productss->rate }}">
                                                </div>
                                            </td>
                                            <td>
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control amount" name="amount[]" data-id="{{ $key + 1 }}" id="amount{{ $key + 1 }}" readonly value="{{ $quotation_productss->amount }}">
                                                </div>
                                            </td>
                                            <td>
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control discount_type_amount" data-id="{{ $key + 1 }}" name="discount_type_amount[]" id="discount_type_amount{{ $key + 1 }}" value="{{ $quotation_productss->discount }}">
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <select style="    width: 2cm;" class="form-control form-control-sm single-select vat_percentage kt-selectpicker" data-id="{{ $key + 1 }}" name="vat_percentage[]" id="vat_percentage{{ $key + 1 }}">
                                                    ...
                                                    <option value="{{ $data->total }}" @if ($quotation_productss->vat_percentage == $data->total) selected="" @endif>
                                                        {{ $data->total }}
                                                    </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <td>
                                                <input type="text" class="form-control vatamount form-control-sm" name="vatamount[]" id="vatamount{{ $key + 1 }}" data-id={{ $key + 1 }} value="{{ $quotation_productss->vatamount }}" readonly>
                                            </td>
                                            <td>
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control row_total row_total_change" data-id="{{ $key + 1 }}" name="row_total[]" id="row_total{{ $key + 1 }}" value="{{ $quotation_productss->totalamount }}">
                                                </div>
                                            </td>
                    ...
                    <div class="kt-form__actions">
                        <div class="row">
                            ...
                            <div class="col-lg-12 kt-align-right">
                                ...
                                <button type="button" class="btn btn-primary" id="sell_enquiry_update"><svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check-circle icon-16">
...
<script>
            ...
            success: function(data) {
                ...
                $.each(data, function(key, value) {
                    ...
                    product += '<tr>\
                        ...
                        rowcount + '" value="' + value.product_name + '" readonly>\
                         <div>\
    ...
    $('body').on('keyup', '.quantity', function() {
        ...
        if (quantity == "" || quantity == 0) {
            $('#sell_enquiry_update').attr('disabled', true);
            toastr.warning("Quantity Cannot be 0");
        } else {
            $('#sell_enquiry_update').attr('disabled', false);
            row_vatcalculate(id);
            row_calculate(id);
        }
    });
    ...
    function discount_calculate_new() {
        ...
        if (discount_type == 1) {
            ...
            $('.discount_type_amount').each(function() {
                ...
                calcPerc = (dispercentage / 100) * total;
...
<script type="text/javascript">
    ...
    $(document).on('click', '#sell_enquiry_update', function(e) {
        e.preventDefault();
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                //$('#sell_enquiry_update').removeClass('kt-spinner');

                //   $('#sell_enquiry_update').removeClass('kt-spinner');

                window.location.href = "enquiry_list";
                toastr.success('Enquiry ' + sucess_msg + ' successfuly');
                $('#sell_enquiry_update').prop("disabled", false);
