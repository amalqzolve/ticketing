    ...
    <div class="kt-portlet kt-portlet--mobile">
        ...
        <div class="kt-portlet__body pl-2 pr-2 pb-0">
            ...
            <form class="kt-form" id="kt_form">
                ...
                <input type="hidden" id="sales_order_id" name="sales_order_id" value="{{ $ticket->sales_order_id }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <input type="text" class="form-control" name="address" id="address" value="{{ $ticket->address }}">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <select class="form-control single-select kt-selectpicker" id="country" name="country">
                                            ...
                                            <option value="{{ $data->id }}" {{ $ticket->country == $data->id ? 'selected' : '' }}>
                                                {{ $data->cntry_name }}
                                            </option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <input type="text" class="form-control" name="passport_no" id="passport_no" value="{{ $ticket->passport_no }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <input type="text" class="form-control kt_datetimepickerr" name="issue_date" id="issue_date" value="{{ $ticket->issue_date != '' ? date('d-m-Y', strtotime($ticket->issue_date)) : '' }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <input type="text" class="form-control kt_datetimepickerr" name="expiry_date" id="expiry_date" value="{{ $ticket->expiry_date != '' ? date('d-m-Y', strtotime($ticket->expiry_date)) : '' }}">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                                ...
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <select class="form-control single-select kt-selectpicker" id="trip_details" name="trip_details">
                                            <option value="">select</option>
                                            <option value="Single" {{ $ticket->trip_details == 'Single' ? 'selected' : '' }}>Single
                                            </option>
                                            <option value="Round" {{ $ticket->trip_details == 'Round' ? 'selected' : '' }}>Round</option>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <input type="text" class="form-control" name="booking_id" id="booking_id" value="{{ $ticket->booking_id }}">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <select class="form-control single-select kt-selectpicker" id="booking_status" name="booking_status">
                                            <option value="">select</option>
                                            <option value="Confirmed" {{($ticket->booking_status=='Confirmed')?'selected':''}}>Confirmed</option>
                                            <option value="Pending" {{($ticket->booking_status=='Pending')?'selected':''}}>Pending</option>
                                            <option value="Booked" {{($ticket->booking_status=='Booked')?'selected':''}}>Pending</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <input type="text" class="form-control " name="class" id="class" value="{{ $ticket->class }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <input type="text" class="form-control" name="type" id="type" value="{{ $ticket->type }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <input type="text" class="form-control " name="seat" id="seat" value="{{ $ticket->seat }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <input type="text" class="form-control kt_datetimepicker_with_time" name="boarding_time" id="boarding_time" value="{{ $ticket->boarding_time != '' ? date('d-m-Y H:i', strtotime($ticket->boarding_time)) : '' }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <input type="text" class="form-control" name="notes" id="notes" value="{{ $ticket->notes }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <input type="text" class="form-control" name="baggage_allowances" id="baggage_allowances" value="{{ $ticket->baggage_allowances }}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <input type="text" class="form-control" name="extra_services" id="add_on_services" value="{{ $ticket->extra_services }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <input type="text" class="form-control" name="ticket_no" id="ticket_no" value="{{ $ticket->ticket_no }}">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <select class="form-control single-select kt-selectpicker" id="airlines" name="airlines">
                                            ...
                                            <option value="{{ $data->id }}" {{ $ticket->airlines == $data->id ? 'selected' : '' }}>
                                                {{ $data->name }}
                                            </option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <input type="text" class="form-control" name="airline_booking_reference" id="airline_booking_reference" value="{{ $ticket->airline_booking_reference }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <input type="text" class="form-control" name="agency" id="agency" value="{{ $ticket->agency }}">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <select class="form-control single-select kt-selectpicker" id="departure" name="departure">
                                            ...
                                            <option value="{{ $data->code }}" {{ $ticket->departure == $data->code ? 'selected' : '' }}>
                                                {{ $data->code }}~{{ $data->name }}
                                            </option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <input type="text" class="form-control kt_datetimepicker_with_time" name="departure_date" id="departure_date" value="{{ $ticket->departure_date != '' ? date('d-m-Y H:i', strtotime($ticket->departure_date)) : '' }}">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <select class="form-control single-select kt-selectpicker" id="arrival" name="arrival">
                                            <option value="">select</option>
                                            @foreach ($airports as $data)
                                            <option value="{{ $data->code }}" {{ $ticket->arrival == $data->code ? 'selected' : '' }}>
                                                {{ $data->code }}~{{ $data->name }}
                                            </option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <input type="text" class="form-control kt_datetimepicker_with_time" name="arrival_date" id="arrival_date" value="{{ $ticket->arrival_date != '' ? date('d-m-Y H:i', strtotime($ticket->arrival_date)) : '' }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group  row ">
                                <label class="kt-checkbox kt-checkbox--brand">
                                    <input type="checkbox" value="1" id="show_fair" name="show_fair" {{ $ticket->show_fair == 1 ? 'checked' : '' }}> Show Fare
                                    on Print
                                    <span></span>
                                </label>
                            </div>
                ...
                <div class=" pr-1 pl-1" style=" width: 100%;      background-color: #f2f3f8;   margin-top: -10px;">
                    <div class="table-responsive">
                        ...
                        <table class="table table-striped table-bordered table-hover" id="product_table">
                            ...
                            <tbody>
                                @foreach ($ticketMembers as $key => $value)
                                <tr>
                                    <td>1</td>
                                    <td><input type="text" class="form-control " name="add_passenger_name[]" value="{{ $value->add_passenger_name }}">
                                    </td>
                                    <td><input type="text" class="form-control " name="add_passenger_passport[]" value="{{ $value->add_passenger_passport }}"></td>
                                    <td><input type="text" class="form-control kt_datetimepickerr" name="add_passenger_passport_issue_date[]" value="{{ $value->add_passenger_passport_issue_date != '' ? date('d-m-Y', strtotime($value->add_passenger_passport_issue_date)) : '' }}"></td>
                                    <td><input type="text" class="form-control kt_datetimepickerr" name="add_passenger_passport_exp_date[]" value="{{ $value->add_passenger_passport_exp_date != '' ? date('d-m-Y', strtotime($value->add_passenger_passport_exp_date)) : '' }}"></td>
                                    <td><input type="text" class="form-control " name="add_passenger_ticket_number[]" value="{{ $value->add_passenger_ticket_number }}"></td>
                                    <td><input type="text" class="form-control " name="add_passenger_booking_id[]" value="{{ $value->add_passenger_booking_id }}"></td>
                                    <td><input type="text" class="form-control integerVal" name="add_fare[]" id="add_fare" value="{{ $value->add_fare }}"></td>
                                    <td>
        ...
        <div class="row mt-5">
            ...
            <div class="col-lg-6">
                <div class="form-group  row pr-md-3">
                    ...
                    <div class="col-md-8 input-group-sm">
                        <input type="text" class="form-control" name="total_amount" id="total_amount" value="{{$ticket->total_amount}}" readonly style="background-color: #ffffff00;  border: none;  text-align: right;  font-size: 1.75rem;font-weight: bold; color: #646c9a; padding-top: 0px;">
                    </div>
                </div>
            </div>
            ...
            product += '<tr> <td>' + rowcount +
                '</td>\
                    ...
                    <td><input type="text" class="form-control "\
                            name="add_passenger_ticket_number[]" \
                            value=""></td>\
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data.status == 0) {
                            ...
                            window.location.href = "../ticket_list/" + $('#sales_order_id').val();
                        }
