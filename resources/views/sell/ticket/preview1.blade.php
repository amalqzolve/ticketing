        ...
        <div class="row" style="margin-top:0px;">
                                            ...
                                            <tr>
                                                <td rowspan="2" style="border-color: white; padding:0; width: 30%;">
                                                    <div class="visible-print text-center">
                                                        <?php
                                                        $c = storage_path('app/public/' . str_slug($ticket->id) . '.svg');
                                                        ?>
                                                    </div>
                                                </td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="border-color: white; border-color: white;   padding: 0px; font-size: 11px; padding:0; ">
                                            <table style=" width: 100%; margin: 0; padding:0;border-collapse: collapse; border-spacing: 0;">
                                                <tr>
                                                    <td style="margin: 0; border-color: white; ; border-color: white;   padding: 0px;  font-size: 11px; ">
                                                        {{ $ticket->sup_add1 }}
                                                        <br>
                                                        {{ $ticket->sup_add2 }}
                                                        <br>
            ...
            <div class="str">
                                            ...
                                            <table style="width:100%; background-color: white !important;">
                                                ...
                                                <tr style="background-color: white !important;">
                                                    ...
                                                    <td style="border-color: white; padding: 0;background-color: white !important;text-align:right;">
                                                        {{ number_format($ticket->totalamount, 2, '.', ',') }}
                                                    </td>
                                                </tr>
                                                <tr style="background-color: white !important; ">
                ...
                <div class="row">
                    ...
                    <p style="text-align: justify; font-size: 10px;">{{ $ticket->notes }}</p>
                </div>
                <div class="row">
                </div>
            </div>
