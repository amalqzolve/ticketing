...
<head>
  ...
  foreach ($performainvoice as $key => $performainvoices) {
    ...
    $created_at = $performainvoices->created_at;
  }
              ...
              <center>
                ...
                <table style="width:100%; border-color: white;   padding: 2px; " cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td style="border-color: white; border-color: white;   padding: 0px;">{{$mobile}}</td>
      ...
      <div class="str">
        <table>
          <tr>
            ...
            <td style="border-color: white;  padding: 0; width: 7%;text-align: right;">Quantity <br> الوحدة </td>
            <td style="border-color: white;  padding: 0; width: 5%;text-align: right;">Unit price <br>سسعر الوحدة </td>
