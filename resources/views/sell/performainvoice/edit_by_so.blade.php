...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="product_table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-group input-group-sm">
                                                    ...
                                                    <div>
                                                        ...
                                                        <input type="hidden" class="form-control single-select so_item_id" name="so_item_id[]" id="so_item_id{{ $key + 1 }}" data-id="{{ $key + 1 }}" value="{{ $performainvoiceproductss->so_item_id }}">
                                                    </div>
                                            ...
                                            <td>
                                                <div class="input-group input-group-sm">
                                                    <input type="text" style="    width: 1cm;" class="form-control quantity" data-id="{{ $key + 1 }}" name="quantity[]" id="quantity{{ $key + 1 }}" value="{{ $performainvoiceproductss->quantity }}">
                                            ...
                                            <td>
                                                <div class="input-group input-group-sm">
                                                    <input type="text" style="  style=" width: 1cm;" width: 1cm;" class="form-control rate" name="rate[]" id="rate{{ $key + 1 }}" data-id="{{ $key + 1 }}" value="{{ $performainvoiceproductss->rate }}" readonly>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="input-group input-group-sm">
                            ...
                            <table style="width:100%">
                                <tr>
                                    <td>
                                        ...
                                        <a href="{{ url('/Add-Product') }}" target="_blank" class="btn btn-light btn-elevate btn-icon-sm float-right mr-2">New Product</a>
                                    </td>
    ...
    font-weight: bold; color: #646c9a; padding-top: 0px;" value="{{ $grandtotalamount }}">
                    ...
                    <div class="row mt-5 alert alert-custom alert-white alert-shadow fade show gutter-b" id="balance" style="display: none;">
                        <div class="col-lg-6">
                            <div class="form-group  row pr-md-3">
                                <div class="col-md-4">
                    ...
                    <div class="kt-form__actions">
                        <div class="row">
                            ...
                            <div class="col-lg-12 kt-align-right">
                                ...
                                <button type="button" class="btn btn-primary" id="performainvoice_update"><svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check-circle icon-16">
...
<script>
            ...
            success: function(data) {
                ...
                $.each(data, function(key, value) {
                    ...
                    product += '<tr>\
                     ...
                     <input type="hidden" class="form-control single-select so_item_id" name="so_item_id[]" id="so_item_id' +
    ...
    $('body').on('keyup', '.quantity', function() {
        ...
        if (quantity == "" || quantity == 0) {
            $('#performainvoice_update').attr('disabled', true);
            ...
            $('#performainvoice_update').attr('disabled', false);
            row_vatcalculate(id);
            row_calculate(id);
            row_vatcalculate(id);
        }
...
<script type="text/javascript">
    ...
    $("body").on("click", ".history", function(event) {
        var id = $(this).attr('data-id');
        var pid = $('#item_details_id' + id + '').val();
        // $('#kt_modal_4_6').modal('show');


        $.ajax({
            url: "producthistorylist",
            method: "POST",
            data: {
                _token: $('#token').val(),
        ...
        $.ajax({
            url: "productquotationhistorylist",
            method: "POST",
            data: {
                _token: $('#token').val(),
