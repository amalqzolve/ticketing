...
<head>
  ...
  <?php
  foreach ($performainvoice as $key => $performainvoices) {
          ...
          <tr>
            ...
            <td style="border-color: white;   padding-top: 0; padding-right: 0; padding-bottom: 0;  ">
              ...
              <table style=" width: 100%; ">
                ...
                <tr>
                  <td style="border-color: white; padding: 0; font-weight: bold;  font-size:11px; width: 30%;">Performa ID</td>
...
$qrtextof=str_replace('',"",$qrtextof);*/
            ...
            <td valign="top" style="border-color: white; ">
              ...
              <table style="width:100%; border-color: white;   padding: 2px; " cellspacing="0" cellpadding="0">
                ...
                <tr style=" ">
                  ...
                  <td style="border-color: white; border-color: white; text-align: center;  padding: 0px; font-size: 12px;"> {{$cust_name}}</td>
                ...
                <tr>
                  ...
                  <td style="border-color: white; border-color: white;  text-align: center;    padding: 0px; font-size: 12px;"> {{$cust_add1}}</td>
                ...
                <tr>
                  ...
                  <td style="border-color: white; border-color: white;  text-align: center;    padding: 0px; font-size: 12px;">{{$cust_add2}}</td>
                ...
                <tr>
                  ...
                  <td style="border-color: white; border-color: white;  text-align: center;    padding: 0px; font-size: 12px;">{{$cust_zip}}</td>
      ...
      <div class="str">
        ...
        <table>
          ...
          @foreach($performainvoiceproducts as $key=>$performainvoiceproducts)

          <tr class="str">
            <td style="border-color: white;   padding: 2px; text-align: left;">{{$key+1}}</td>
            <td style="border-color: white;   padding: 2px; text-align: left;">{{$performainvoiceproducts->product_name}}</td>
            <td style="border-color: white;   padding: 2px;">{{$performainvoiceproducts->description1}}</td>
            <td style="border-color: white;   padding: 2px; text-align: left;">@foreach($unitlist as $data)
              <?php if ($performainvoiceproducts->unit == $data->id) {
                echo $data->unit_name;
              } ?>
              @endforeach </td>
            <td style="border-color: white;   padding: 2px; text-align: center;">{{$performainvoiceproducts->quantity}}</td>
            <td style="border-color: white;   padding: 2px; text-align: right;"> {{number_format($performainvoiceproducts->rate,2,'.',',')}}</td>
            <td style="border-color: white;   padding: 2px; text-align: right;">{{number_format($performainvoiceproducts->amount,2,'.',',')}}</td>
            <td style="border-color: white;   padding: 2px; text-align: center; "> {{number_format($performainvoiceproducts->discount,2,',','.')}}</td>


            <td style="border-color: white;   padding: 2px; text-align: right;"> {{number_format($performainvoiceproducts->vatamount,2,'.',',')}}</td>
            <td style="border-color: white;   padding: 2px; text-align: right;"> {{number_format($performainvoiceproducts->totalamount,2,'.',',')}}</td>
          </tr>
