...
foreach ($performainvoice as $performainvoices) {
    ...
    $quotedate = date('d-m-Y', strtotime($performainvoices->quotedate));
    $valid_till = date('d-m-Y', strtotime($performainvoices->valid_till));
                                ...
                                <table class="table table-striped table-bordered table-hover" id="product_table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-group input-group-sm">
                                                    <input type="text" style="width: 1cm;width: 1cm;" class="form-control rate" name="rate[]" id="rate{{ $key + 1 }}" data-id="{{ $key + 1 }}" value="{{ $performainvoiceproductss->rate }}">
                                                </div>
                                            </td>
                                            <td>
                                                <div class="input-group input-group-sm">
