                                ...
                                <table class="table table-striped table-bordered table-hover" id="product_table">
                                    <thead class="thead-light">
                                        <tr>
                                            ...
                                            <th style="background-color:  #3f4aa0; color: white; white-space: nowrap; padding: 2px 7px !important;">Sales @lang('app.Rate')</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-group input-group-sm">
                                                    <input style="width: 4cm;" type="text" class="form-control single-select productname kt-selectpicker" name="productname[]" id="productname" data-id="{{ $key + 1 }}" value="{{ $performainvoiceproductss->product_name }}">
                                            ...
                                            <td>
                                                <div class="input-group input-group-sm">
                                                    <input type="text" style="  style=" width: 1cm;" width: 1cm;" class="form-control rate" name="rate[]" id="rate{{ $key + 1 }}" data-id="{{ $key + 1 }}" value="{{ $performainvoiceproductss->rate }}">
                                                </div>
                                            </td>
                                            <td>
                                                <div class="input-group input-group-sm">
                                            ...
                                            <td>
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control discount_type_amount" data-id="{{ $key + 1 }}" name="discount_type_amount[]" id="discount_type_amount{{ $key + 1 }}" value="{{ $performainvoiceproductss->discount }}">
                                                </div>
                                            </td>
