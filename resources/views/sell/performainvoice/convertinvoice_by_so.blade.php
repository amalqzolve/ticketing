...
<?php
foreach ($performainvoice as $performainvoices) {
    $id = $performainvoices->id;
    $saleorder_id = $performainvoices->saleorder_id;
    $quotedate = $performainvoices->quotedate;
    $valid_till = $performainvoices->valid_till;
    $qtn_ref = $performainvoices->qtn_ref;
    $po_ref = $performainvoices->po_ref;
    $delivery_period = $performainvoices->delivery_period;
    $attention = $performainvoices->attention;
    $salesman = $performainvoices->salesman;
    $currency = $performainvoices->currency;
    $currencyvalue = $performainvoices->currencyvalue;
    $preparedby = $performainvoices->preparedby;
    $approvedby = $performainvoices->approvedby;
    $payment_terms = $performainvoices->payment_terms;
    $discount_type = $performainvoices->discount_type;
    $customer = $performainvoices->customer;
    $terms_conditions = $performainvoices->terms_conditions;
    $notes = $performainvoices->notes;
    $internal_reference = $performainvoices->internal_reference;
    $tpreview = $performainvoices->tpreview;
    $totalamount = $performainvoices->totalamount;
    $discount = $performainvoices->discount;
    $amountafterdiscount = $performainvoices->amountafterdiscount;
    $vatamount = $performainvoices->vatamount;
    $grandtotalamount = $performainvoices->grandtotalamount;
    $sale_method = $performainvoices->sale_method;
    $paid_amount = $performainvoices->paid_amount;
    $balance_amount = $performainvoices->balance_amount;
}
...
?>
<input type="hidden" name="saleorder_id" id="saleorder_id" value="{{ $saleorder_id }}">
                ...
                <div class="tab-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <select class="form-control single-select kt-selectpicker" id="preparedby" disabled="">
                                            <option value="">select</option>
                                            @foreach ($salesmen as $data)
                            ...
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <select class="form-control single-select kt-selectpicker" id="approvedby" disabled="">
                                            <option value="">select</option>
                                            @foreach ($salesmen as $data)
                            ...
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <select class="form-control single-select kt-selectpicker" id="method" disabled="">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group  row pr-md-3">
                                ...
                                <div class="col-md-9 input-group-sm">
                                    <select class="form-control single-select kt-selectpicker" id="terms_conditions" name="terms_conditions" disabled="">
                                        <option value="">select</option>
                    ...
                    <div class="tab-pane p-3" id="kt_tabs_2_4" role="tabpanel">
                        <div class="row">
                            ...
                            <input type="hidden" name="customer_id" id="customer_id" value="{{ $customer }}">
                            <div class="col-lg-6">
                                <div class="form-group row pr-md-3">
                                    <div class="col-md-4">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group row pl-md-3">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group  input-group-sm">
                                            <input type="text" name="cust_country" id="cust_country" class="form-control single-select" value="{{ $cust_country }}" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class=" pr-1 pl-1" style=" width: 100%;      background-color: #f2f3f8;   margin-top: -10px;">
                            <div class="table-responsive">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="product_table">
                                    ...
                                    <tbody>
                                        @foreach ($performainvoiceproducts as $key => $performainvoiceproductss)
                                        <tr>
                                            <td>{{ $key + 1 }}</td>
                                            <td>
                                                <div class="input-group input-group-sm">
                                                    <input style="width: 4cm;" type="hidden" class="form-control single-select soid kt-selectpicker" name="soid[]" id="soid" data-id="{{ $key + 1 }}" value="{{ $performainvoiceproductss->saleorder_id }}" readonly>
                                                    <input style="width: 4cm;" type="hidden" class="form-control single-select so_item_id kt-selectpicker" name="so_item_id[]" id="so_item_id" data-id="{{ $key + 1 }}" value="{{ $performainvoiceproductss->so_item_id }}" readonly>

                                                    <input style="width: 4cm;" type="text" class="form-control single-select productname kt-selectpicker" name="productname[]" id="productname" data-id="{{ $key + 1 }}" value="{{ $performainvoiceproductss->product_name }}" readonly>

                                                    <div>
                                                        <input type="hidden" class="form-control single-select item_id" name="item_id[]" id="item_id{{ $key + 1 }}" data-id="{{ $key + 1 }}" value="{{ $performainvoiceproductss->item_id }}">
                                            </td>
                                            <td>
                                                <textarea class="form-control" id="description{{ $key + 1 }}" name="description[]" rows="1" data-id={{ $key + 1 }} style=" height: 30px !important; width:3cm;">{{ $performainvoiceproductss->description }}</textarea>
                                            </td>
                                            <td>
                                                <div>
                                                    <select style="    width: 3cm;" class="form-control form-control-sm single-select unit kt-selectpicker" data-id="{{ $key + 1 }}" name="unit[]" id="unit" disabled="">
                                                        ...
                                                        <option value="{{ $data->id }}" @if ($performainvoiceproductss->unit == $data->id) selected="" @endif>
                                                            {{ $data->unit_name }}
                                                        </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <td>
                                                <div class="input-group input-group-sm">
                                                    <input type="text" style="    width: 1cm;" class="form-control quantity" data-id="{{ $key + 1 }}" name="quantity[]" id="quantity{{ $key + 1 }}" value="{{ $performainvoiceproductss->quantity }}" readonly>
                                                    <input type="hidden" style="    width: 1cm;" class="form-control oquantity" data-id="{{ $key + 1 }}" name="oquantity[]" id="oquantity{{ $key + 1 }}" value="{{ $performainvoiceproductss->invoice_rem }}">
                                                </div>
                                            </td>
                                            <td>
                                                <div class="input-group input-group-sm">
                                                    <input type="text" style="width: 1cm;" class="form-control rate" name="rate[]" id="rate{{ $key + 1 }}" data-id="{{ $key + 1 }}" value="{{ $performainvoiceproductss->rate }}" readonly>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control amount" name="amount[]" data-id="{{ $key + 1 }}" id="amount{{ $key + 1 }}" readonly value="{{ $performainvoiceproductss->amount }}">
                                                </div>
                                            </td>
                                            <td>
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control discount_type_amount" data-id="{{ $key + 1 }}" name="discount_type_amount[]" id="discount_type_amount{{ $key + 1 }}" value="{{ $performainvoiceproductss->discount }}" readonly>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <select style="    width: 2cm;" class="form-control form-control-sm single-select vat_percentage kt-selectpicker" data-id="{{ $key + 1 }}" name="vat_percentage[]" id="vat_percentage{{ $key + 1 }}" disabled="">
                                                    ...
                                                    <option value="{{ $data->total }}" @if ($performainvoiceproductss->vat_percentage == $data->total) selected="" @endif>
                                                        {{ $data->total }}
                                                    </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <td>
                                                <input type="text" class="form-control vatamount form-control-sm" name="vatamount[]" id="vatamount{{ $key + 1 }}" data-id={{ $key + 1 }} value="{{ $performainvoiceproductss->vatamount }}" readonly>
                                            </td>
                                            <td>
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control row_total row_total_change" data-id="{{ $key + 1 }}" name="row_total[]" id="row_total{{ $key + 1 }}" value="{{ $performainvoiceproductss->totalamount }}">
                                                </div>
                                            </td>
                    ...
                    <div class="kt-form__actions">
                        <div class="row">
                            ...
                            <div class="col-lg-12 kt-align-right">
                                ...
                                <button type="button" class="btn btn-primary" id="performainvoice_convert"><svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check-circle icon-16">
...
<script src="{{ url('/') }}/resources/js/sell/performainvoice.js" type="text/javascript"></script>
<script>
    ...
    $('body').on('keyup', '.quantity', function() {
        ...
        if (quantity == "" || quantity == 0) {
            $('#performainvoice_convert').attr('disabled', true);
            ...
            $('#performainvoice_convert').attr('disabled', false);
            row_vatcalculate(id);
            row_calculate(id);
            row_vatcalculate(id);
        }
