      ...
      <div class="str">
        ...
        <table>
          ...
          <tr class="str">
            ...
            <td style="border-color: white;   padding: 2px; text-align: left;"><?php if ($advancepayment_metods->modeofpayment == 1) echo 'Cash'; ?>
              <?php if ($advancepayment_metods->modeofpayment == 2) echo 'Card'; ?>
              <?php if ($advancepayment_metods->modeofpayment == 3) echo 'Bank'; ?>
              <?php if ($advancepayment_metods->modeofpayment == 4) echo 'Cheque'; ?></td>
