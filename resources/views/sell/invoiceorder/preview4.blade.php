...
<head>
  ...
  foreach ($salesinvoice as $key => $quotations) {
    ...
    $quotedate = $quotations->invoice_date;
      ...
      <div class="str">
        ...
        <table>
          ...
          <tr>
            ...
            <td style="border-color: white;  padding: 0; width: 7%;text-align: center;">Quantity <br> الوحدة </td>
          ...
          <tr class="str">
            ...
            <td style="border-color: white;   padding: 2px; text-align: center;"> {{number_format($quotation_products->rate,2,'.',',')}}</td>

            <td style="border-color: white;   padding: 2px; text-align: center;">{{number_format($quotation_products->amount,2,'.',',')}}</td>
            ...
            <td style="border-color: white;   padding: 2px; text-align: center;"> {{number_format($quotation_products->vatamount,2,'.',',')}}</td>

            <td style="border-color: white;   padding: 2px; text-align: center;"> {{number_format($quotation_products->totalamount,2,'.',',')}}</td>
        ...
        <table width="100%">
          ...
          <tr>
            ...
            <td style="border-color: white;background-color: white !important; text-align: center;"><span style="font-weight: bold;">Received by</span> <br>
