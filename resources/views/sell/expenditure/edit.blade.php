            ...
            <div class="kt-portlet__head kt-portlet__head--lg">
                <div class="kt-portlet__head-label">
                    ...
                    <h3 class="kt-portlet__head-title">
                        Expenditure Edit #EXP - {{ $expenditure->id }}
                    </h3>
                </div>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane p-2 active" id="kt_tabs_2_1" role="tabpanel">
                            <div class="row">
                                ...
                                <input type="hidden" name="id" id="id" value="{{ $expenditure->id }}">
                                <div class="col-lg-6">
                                    <div class="form-group  row pr-md-3">
                                        ...
                                        <div class="col-md-8 input-group-sm">
                                            <input type="text" class="form-control kt_datetimepickerr" name="quotedate"
                                                id="quotedate"
                                                value="{{ $expenditure->quotedate != '' ? date('d-m-Y', strtotime($expenditure->quotedate)) : '' }}">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group  row pr-md-3">
                                        ...
                                        <div class="col-md-8 input-group-sm">
                                            <input type="text" class="form-control kt_datetimepickerr" name="valid_till"
                                                id="valid_till"
                                                value="{{ $expenditure->valid_till != '' ? date('d-m-Y', strtotime($expenditure->valid_till)) : '' }}">
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <select class="form-control single-select kt-selectpicker" id="salesman">
                                                ...
                                                @foreach ($salesmen as $data)
                                                    <option value="{{ $data->id }}"
                                                        {{ $expenditure->salesman == $data->id ? 'selected' : '' }}>
                                                        {{ $data->name }} </option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-8 input-group input-group-sm">
                                            <select class="form-control single-select currency kt-selectpicker"
                                                ...
                                                @foreach ($currencylist as $data)
                                                    <option value="{{ $data->id }}"
                                                        {{ $expenditure->currency == $data->id ? 'selected' : '' }}>
                                    ...
                                    <div class="form-group row pr-md-3">
                                        ...
                                        <div class="col-md-8 input-group input-group-sm">
                                            <input type="text" class="form-control currency_value"
                                                ...
                                                value="{{ $expenditure->currencyvalue }}" readonly>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group  row pr-md-3">
                                        ...
                                        <div class="col-md-8 input-group-sm">
                                            <select class="form-control single-select kt-selectpicker" id="preparedby">
                                                ...
                                                @foreach ($salesmen as $data)
                                                    <option value="{{ $data->id }}"
                                                        {{ $expenditure->preparedby == $data->id ? 'selected' : '' }}>
                                                        {{ $data->name }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="form-group  row pr-md-3">
                                        ...
                                        <div class="col-md-8 input-group-sm">
                                            ...
                                            <select class="form-control single-select kt-selectpicker" id="approvedby">
                                                ...
                                                @foreach ($salesmen as $data)
                                                    <option value="{{ $data->id }}"
                                                        {{ $expenditure->approvedby == $data->id ? 'selected' : '' }}>
                                                        {{ $data->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group  row pr-md-3">
                                        ...
                                        <div class="col-md-8 input-group-sm">
                                            <select class="form-control single-select kt-selectpicker" id="discount_type">
                                                <option value="1"
                                                    {{ $expenditure->discount_type == 1 ? 'selected' : '' }}>Flat</option>
                                                <option value="2"
                                                    {{ $expenditure->discount_type == 2 ? 'selected' : '' }}>Percentage
                                                </option>
                                            </select>
                                    ...
                                    <div class="form-group  row pr-md-3">
                                        ...
                                        <div class="col-md-8 input-group-sm">
                                            ...
                                            <select class="form-control single-select kt-selectpicker" id="method">
                                                <option value="1" {{ $expenditure->method == 1 ? 'selected' : '' }}>
                                                    Cash</option>
                                                <option value="2" {{ $expenditure->method == 2 ? 'selected' : '' }}>
                                                    Credit</option>
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group  row pr-md-3">
                                        ...
                                        <div class="col-md-8 input-group-sm">
                                            <textarea class="form-control" name="notes" id="notes">{{ $expenditure->notes }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group  row pr-md-3">
                                        ...
                                        <div class="col-md-8 input-group-sm">
                                            <textarea class="form-control" name="internal_reference" id="internal_reference">{{ $expenditure->internal_reference }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-9 input-group-sm">
                                        <select class="form-control single-select kt-selectpicker" id="terms_conditions"
                                            ...
                                            @foreach ($termslist as $data)
                                                <option value="{{ $data->id }}"
                                                    {{ $expenditure->terms_conditions == $data->id ? 'selected' : '' }}>
                                                    {{ $data->term }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group row pr-md-3">
                                        ...
                                        <div class="col-md-8  input-group input-group-sm">
                                            <select class="form-control single-select kt-selectpicker customer"
                                                id="customer1" name="customer">
                                                <option value="">select</option>
                                                @foreach ($suppliers as $data)
                                                    <option value="{{ $data->id }}"
                                                        {{ $expenditure->sup_id == $data->id ? 'selected' : '' }}>
                                                        {{ $data->sup_name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="product_table">
                                       ...
                                       color: white; white-space: nowrap;     padding: 2px 7px !important; ">
                                        ...
                                        <tbody>
                                            @foreach ($expenditureProduct as $key => $invoice_products)
                                                <tr>
                                                    <td>{{ $key + 1 }}</td>
                                                    <td>
                                                        <input style="width: 4cm;" type="hidden"
                                                            class="form-control single-select productrowid kt-selectpicker"
                                                            name="productrowid[]" id="productrowid{{ $key + 1 }}"
                                                            data-id="{{ $key + 1 }}"
                                                            value="{{ $invoice_products->id }}">
                                                        <div class="input-group input-group-sm">
                                                        ...
                                                        <select style="    width: 2cm;"
                                                            ...
                                                            @foreach ($vatlist as $data)
                                                                <option value="{{ $data->total }}"
                                                                    @if ($invoice_products->vat_percentage == $data->total) selected="" @endif>
                                                                    {{ $data->total }}</option>
                                                            @endforeach
                                                        </select>
                                                    </td>
                            ...
                            <div class="form-group  row pr-md-3">
                                ...
                                <div class="col-md-8 input-group-sm">
                                    <input type="text" class="form-control" name="totalamount" id="totalamount"
                                        value="{{ $expenditure->totalamount }}" readonly
                            ...
                            <div class="form-group  row pr-md-3">
                                ...
                                <div class="col-md-8 input-group-sm">
                                    <input type="text" class="form-control discount" name="discount" id="discount"
                                        readonly value="{{ $expenditure->discount }}"
                                        style=" text-align: right; font-size: 1.25rem; background-color: #f2f3f8;  height: calc(1.25em + 1rem + 2px);">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group  row pr-md-3">
                                ...
                                <div class="col-md-8 input-group-sm">
                                    ...
                                    <input type="text" class="form-control" name="amountafterdiscount"
                                        id="amountafterdiscount" readonly value="{{ $expenditure->amountafterdiscount }}"
                                        style=" text-align: right; font-size: 1.25rem; background-color: #f2f3f8;  height: calc(1.25em + 1rem + 2px);">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group  row pr-md-3">
                                ...
                                <div class="col-md-8 input-group-sm">
                                    ...
                                    <input type="text" class="form-control" name="totalvatamount" id="totalvatamount" value="{{ $expenditure->vatamount }}"
                                        readonly
                                        style=" text-align: right; font-size: 1.25rem; background-color: #f2f3f8;  height: calc(1.25em + 1rem + 2px);">
                                </div>
                            </div>
                            ...
                            <div class="form-group  row pr-md-3">
                                ...
                                <div class="col-md-8 input-group-sm">
                                    ...
                                    <input type="text" class="form-control" name="grandtotalamount"
                                        id="grandtotalamount" readonly value="{{ $expenditure->grandtotalamount }}"
...
@section('script')
                ...
                success: function(data) {
                    ...
                    $.each(data, function(key, value) {
                        ...
                        product +=
                            ...
                            rowcount +
                            '" name="discount_type_amount[]" id="discount_type_amount' + rowcount +
                            '" value="0">\
                                                                                                                                                                                                                                                                                             </div>\
                                                                                                                                                                                                                                                                                             </td>\
                                                                                                                                                                                                                                                                                             <td style=" display: none;">\
                                                                                                                                                                                                                                                                                             <div class="input-group input-group-sm">\
                                                                                                                                                                                                                                                                                             <input type="text" class="form-control discountamount"  data-id="' +
                            rowcount +
                            ...
                            ' value="0"    readonly>\
                                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                                              <td>\
                                                                                                                                                                                                                                                                                             <div class="input-group input-group-sm">\
                                                                                                                                                                                                                                                                                             <input type="text" class="form-control row_total row_total_change"  data-id="' +
                            rowcount +
    ...
    function findRevercCalculation(row) {
        ...
        $(document).ready(function() {
            ...
            //         $('#cust_category').val(catdefault).trigger('change').attr('disabled', true);
            //         $('#cust_type').val(typedefault).trigger('change').attr('disabled', true);
            //         $('#cust_group').val(default_grp).trigger('change').attr('disabled', true);
            //         $('#cust_name').val('').attr('readonly', false);
            //         $('#cust_code').val('').attr('readonly', false);
            ...
            $(document).on('change', '#customer1', function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $.each(data, function(key, value) {
                            $('#customer').val('');
                            $('#cust_category').val(value.sup_category).trigger(
                                'change').attr('disabled', true);
                            $('#cust_type').val(value.sup_type).trigger('change').attr(
                                'disabled', true);;
                            ...
                            $('#cust_country').val(value.sup_country).trigger('change')
                                .attr('disabled', true);
    ...
    <script src="{{ url('/') }}/resources/js/sell/expenditure.js" type="text/javascript"></script>
