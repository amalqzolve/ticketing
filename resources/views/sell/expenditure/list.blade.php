...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
    ...
    <div class="kt-portlet kt-portlet--mobile">
        <div class="kt-portlet__head kt-portlet__head--lg">
            <div class="kt-portlet__head-label">
                ...
                <h3 class="kt-portlet__head-title">
                    Expenditure #SO {{ $sales_invoice_id }}
                </h3>
            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    <div class="kt-portlet__head-actions">
                        ...
                        <!-- <a href="{{ url('expenditure-add', $sales_invoice_id) }}" class="btn btn-brand btn-elevate btn-icon-sm">
                        ...
                        <div class="dropdown dropdown-inline">
                            <button type="button" class="btn btn-brand btn-icon-sm dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <i class="la la-plus"></i> @lang('app.New Record')
                            </button>
                            <div class="dropdown-menu dropdown-menu-right">
                                <ul class="kt-nav">
                                    <li class="kt-nav__section kt-nav__section--first">
                                        <span class="kt-nav__section-text">Select the Type</span>
                                    </li>
                                    <li class="kt-nav__item">
                                        <a href="{{ url('expenditure-add', $sales_invoice_id) }}" class="kt-nav__link">
                                            <i class="kt-nav__link-icon la la-plus-square-o"></i>
                                            <span class="kt-nav__link-text">Normal </span>
                                        </a>
                                    </li>

                                    <li class="kt-nav__item">
                                        <a href="{{ url('expenditure-add-payment-link', $sales_invoice_id) }}" class="kt-nav__link">
                                            <i class="kt-nav__link-icon la la-cc-paypal"></i>
                                            <span class="kt-nav__link-text">Payment Link</span>
                                        </a>
                                    </li>
        ...
        <div class="kt-portlet__body">
            <input type="hidden" name="sales_order_id" id="sales_order_id" value="{{ $sales_invoice_id }}">
            <!--begin: Datatable -->
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        var invoiceorderdetails_list_table = $('#invoiceorderdetails_list1').DataTable({
            ...
            ajax: {
                "url": '../expenditure_list/' + $('#sales_order_id').val(),
                "type": "POST",
                "data": function(data) {
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        var j = '';
                        j = '<a href="../expenditure-edit/' + row.id +
