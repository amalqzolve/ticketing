...
<table style="width:100%; border-color: white;   padding: 2px; " cellspacing="0" cellpadding="0">
   ...
   <table>
     ...
     <td  style="border-color: white;  padding: 0; white: 8%;  background-color: white !important;width: 17%; text-align:right;">Service subtotal<br>(Including VAT)  <br>   المجموع (شامل ضريبة القيمة المضافة)    </td>
...
$des='';
  ...
  if ( $quotation_products->description=='null' || $quotation_products->description=='NULL') {
      ...
      //
          ...
          echo str_replace(',','<br />',$quotation_products->description);echo "<br>";
            
          }

 echo str_replace(',','<br />',$des);echo "<br>"; ?>
</td>   
...
<tr style="background-color: white !important;">
                  ...
                  <tr style="background-color: white !important; ">
                    <td style="border-color: white; padding: 0;background-color: white !important;text-align:left;font-size: 8pt; !important "><p style="font-size: 8pt;!important">{{$words}} only.</p></td>
                  </tr>
