                                    ...
                                    <div class="form-group  row pr-md-3">
                                        ...
                                        <div class="col-md-8 input-group-sm">
                                            ...
                                            <input type="text" class="form-control kt_datetimepickerr" name="valid_till"
                                                id="valid_till" value="{{ $valid_till }}">
                                    ...
                                    <div class="form-group row pr-md-3">
                                        ...
                                        <div class="col-md-8 input-group input-group-sm">
                                            ...
                                            <input type="text" class="form-control currency_value"
                                                name="currency_value" id="currency_value" value="{{ $currencyvalue }}"
                                                readonly>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-9 input-group-sm">
                                        ...
                                        <select class="form-control single-select kt-selectpicker" id="terms"
                                            name="terms">
                                            <option value="">select</option>
                                ...
                                <div class="col-12 p-0 table-responsive mb-2">
                                    <table class="table table-striped table-bordered table-hover" id="product_table"
                                       ...
                                       color: white; white-space: nowrap;     padding: 2px 7px !important;"
                                                ...
                                                <th style="background-color:  #3f4aa0;
                                       color: white; white-space: nowrap;     padding: 2px 7px !important;"
                                                    width="250px">Service</th>
                                                <th style="background-color:  #3f4aa0;
                                       color: white; white-space: nowrap;     padding: 2px 7px !important;"
                                                    width="150px">@lang('app.Description')</th>
                                                <th style="background-color:  #3f4aa0;
                                       color: white; white-space: nowrap;     padding: 2px 7px !important;"
                                                    width="70px">@lang('app.Unit')</th>
                                                <th style="background-color:  #3f4aa0;
                                       color: white; white-space: nowrap;     padding: 2px 7px !important;"
                                       ...
                                       color: white; white-space: nowrap;     padding: 2px 7px !important;"
                                                ...
                                                <th style="background-color:  #3f4aa0;
                                       color: white; white-space: nowrap;     padding: 2px 7px !important;"
                                                    width="100px">@lang('app.Amount')</th>
                                                <th style="background-color:  #3f4aa0;
                                       color: white; white-space: nowrap;     padding: 2px 7px !important;"
                                       ...
                                       color: white; white-space: nowrap;     padding: 2px 7px !important; "
                                                ...
                                                <th style="background-color:  #3f4aa0;
                                       color: white; white-space: nowrap;     padding: 2px 7px !important;"
                                                    width="100px">@lang('app.VAT Amount')</th>
                                                <th style="background-color:  #3f4aa0;
                                       color: white; white-space: nowrap;     padding: 2px 7px !important;"
                                                    width="100px">@lang('app.Total Amount')</th>
                                                <th style="background-color:  #3f4aa0;
                                       color: white; white-space: nowrap;     padding: 2px 7px !important; "
                                                    ...
                                                    <td>
                                                        <div class="input-group input-group-sm">
                                                            <input type="text" style="    width: 1cm;"
                                                                ...
                                                                id="quantity{{ $key + 1 }}"
                                                                value="{{ $saleorder_productss->quantity }}">
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="input-group input-group-sm">
                            ...
                            <div class="form-group  row pr-md-3">
                                ...
                                <div class="col-md-8 input-group-sm">
                                    ...
                                    <input type="text" class="form-control discount" name="discount" id="discount"
                                        readonly
                                        style=" text-align: right; font-size: 1.25rem; background-color: #f2f3f8;  height: calc(1.25em + 1rem + 2px);"value="{{ $discount }}">
                        ...
                        <div class="kt-form__actions">
                            <div class="row">
                                ...
                                <div class="col-lg-12 kt-align-right">
                                    ...
                                    <button type="button" class="btn btn-primary" id="convert_po"><svg
                                            xmlns="http://www.w3.org/2000/svg" width="15" height="15"
                                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                            stroke-linecap="round" stroke-linejoin="round"
...
@section('script')
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $.each(data, function(key, value) {
                        ...
                        var product = '';
                        product += '<tr>\
                     <td style="text-align: center;">' + rowcount +
                            '</td><td>\
                     <div class="input-group input-group-sm">\
                     ...
                     <td><textarea class="form-control" id="product_description' + rowcount +
                            ...
                            ' style=" height: 30px !important;">' + des + '</textarea>\</td>\
                     <td>\
                     <div>\
             ...
             @foreach ($unitlist as $data)\
                  ...
                  @endforeach\
                     ...
                     <td>\
                     <select class="form-control form-control-sm single-select vat_percentage kt-selectpicker" data-id="' +
                            rowcount + '" name="vat_percentage[]" id="vat_percentage' + rowcount + '">\
                <option value="">select</option>\
                @foreach ($vatlist as $data)\
    ...
    function findRevercCalculation(row) {
        ...
        //             console.log(data);
        //                $.each(data, function(key, value) {
        //                   $("#cust_code").val(value.sup_category+ '/'+value.increment);
        //                });
        //           },
        //           error:function()
        //           {
