...
<head>
  ...
  <?php
  foreach ($salesorder as $key => $quotations) {
    $id = $quotations->id;
          ...
          <tr>
            ...
            <td style="border-color: white;   padding-top: 0; padding-right: 0; padding-bottom: 0;  ">
              ...
              <table style=" width: 100%; ">
                ...
                <tr>
                  <td style="border-color: white; padding: 0; font-weight: bold;  font-size:11px; width: 30%;">Salesorder ID</td>
...
$qrtextof=str_replace('',"",$qrtextof);*/
      ...
      <div class="str">
        ...
        <table>
          ...
          @foreach($salesorder_products as $key=>$quotation_products)
