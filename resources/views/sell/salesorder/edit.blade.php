...
foreach ($salesorder as $quotations) {
    $id = $quotations->id;
                        ...
                        <div class=" pr-1 pl-1" style=" width: 100%;      background-color: #f2f3f8;   margin-top: -10px;">
                            <div class="table-responsive">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="product_table">
                                    ...
                                    <tbody>
                                        @foreach ($salesoreder_products as $key => $quotation_productss)
                                        <tr>
                                            <td>{{ $key + 1 }}</td>
                                            <td>
                                                <div class="input-group input-group-sm">
                                                    <input style="width: 4cm;" type="text" class="form-control single-select productname kt-selectpicker" name="productname[]" id="productname{{ $key + 1 }}" data-id="{{ $key + 1 }}" value="{{ $quotation_productss->product_name }}" >
                                                    <div>
...
<script src="{{ url('/') }}/resources/js/sell/saleorderaddedit.js" type="text/javascript"></script>
