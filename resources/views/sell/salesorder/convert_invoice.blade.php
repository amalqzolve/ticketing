                    ...
                    <div class="tab-pane p-2 active" id="kt_tabs_2_1" role="tabpanel">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    <div class="col-md-4">
                                        <label>@lang('app.Sales Method')</label>
                                    </div>
                                    <div class="col-md-8 input-group-sm">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group input-group-sm">
                                        ...
                                        <input type="text" class="form-control currency_value" name="currencyvalue" id="currencyvalue" value="{{ $currencyvalue }}">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="product_table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-group input-group-sm">
                                                    <input type="text" style="width: 1cm; width: 1cm;" class="form-control integerVal" name="purchaserate[]" id="purchaserate{{ $key + 1 }}" data-id="{{ $key + 1 }}" value="0">
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control discount_type_amount integerVal" data-id="{{ $key + 1 }}" name="discount_type_amount[]" id="discount_type_amount{{ $key + 1 }}" value="{{ $saleorder_productss->discount }}">
                                                </div>
                                            </td>
                                        ...
                                        <?php
                                        $rowSum += $saleorder_productss->totalamount;
                                        ?>
                                        @endif
                                        @endforeach
                            ...
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-4 useAdvance" style="display:none">
                                        ...
                                        <input type="hidden" name="creditBalance" id="creditBalance" value="{{$adwanceAmount}}">
                                    </div>
                                </div>
                            </div>
                        ...
                        <table class="table table-striped table-hover" id="modeofpaymenttable">
                            <thead style=" background-color: #306584; color: white;">
                                <tr>
                                    ...
                                    <th class="text-center" style="background-color:  #3f4aa0;     color: white; white-space: nowrap;     padding: 2px 7px !important;width: 15%;">Deposit Account</th>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style="padding: 0;">
                                        <select class="form-control" name="depositaccount[]" style="height: calc(1.1em + 1.3rem + 2px)!important;">
                                            <option value="">select</option>
                                            @foreach($depositLedjer as $ledger)
                        ...
                        <div class="row mt-5">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <input type="text" class="form-control totalinvoicedamount " name="totalinvoicedamount" id="totalinvoicedamount" value="{{$rowSum}}" readonly="" style="background-color: #ffffff00;  border: none;  text-align: right;  font-size: 1.5rem; font-weight: bold; color: #646c9a; padding-top: 0px;">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6"></div>
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <input type="text" class="form-control balanceamount " name="balanceamount" id="balanceamount" value="{{$rowSum}}" readonly="" style="background-color: #ffffff00;  border: none;  text-align: right;  font-size: 1.5rem; font-weight: bold; color: #646c9a; padding-top: 0px;">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="kt-form__actions">
                        <div class="row">
                            ...
                            <div class="col-lg-12 kt-align-right">
                                ...
                                <button type="button" class="btn btn-primary" id="saleorder_invoice_convert"><svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check-circle icon-16">
...
<script src="{{url('/')}}/resources/js/sell/invoicePaymentsCalculations.js" type="text/javascript"></script>
<script>
...
<script type="text/javascript">
    ...
    $(document).on('click', '#saleorder_invoice_convert', function(e) {
        e.preventDefault();
        ...
        $("input[name^='originalquantity[]']").each(function(input) {
        ...
        swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $('#saleorder_invoice_convert').removeClass('kt-spinner');
                $('#saleorder_invoice_convert').prop("disabled", false);
            }
        });

        function saveDetails(result) {
            var status = (result.isConfirmed) ? "Approved" : "Draft";
            $('#saleorder_invoice_convert').addClass('kt-spinner');
            $('#saleorder_invoice_convert').prop("disabled", true);
            if ($('#id').val()) {
