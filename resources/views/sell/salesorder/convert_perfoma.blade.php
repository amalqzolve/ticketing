...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        ...
                                        <input type="text" class="form-control kt_datetimepickerr" name="invoice_date" id="invoice_date" value="{{ date('d-m-Y') }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group input-group-sm">
                                        ...
                                        <input type="number" class="form-control currency_value" name="currencyvalue" id="currencyvalue" value="{{ $currencyvalue }}">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        ...
                                        <input type="text" class="form-control" name="poid" id="poid" value="{{ $id }}" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        ...
                                        <input type="text" class="form-control" name="quotedate" id="quotedate" value="{{ $quotedate }}" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        ...
                                        <input type="text" class="form-control" name="podate" id="podate" value="{{ $podate }}" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                        ...
                        <div class="row">
                            ...
                            <!--   <div class="col-lg-6">
                                              <div class="form-group row  pr-md-3">
                                                 ...
                                                 <div class="col-md-8 input-group input-group-sm">
                                                    <input type="text" class="form-control single-select"
                                                       id="cust_type" name="cust_type" value="{{ $cust_type }}">
                                           ...
                                           <div class="col-lg-6">
                                              <div class="form-group row pl-md-3">
                                                 ...
                                                 <div class="col-md-8  input-group input-group-sm">
                                                    <input type="text" class="form-control single-select"
                                                       name="cust_group" id="cust_group" value="{{ $cust_group }}">
                                                 ...
                                                 <div class="col-md-8 ">
                                                    <div class="input-group input-group-sm">
                                                       ...
                                                       <input type="text" class="form-control"
                                                          ...
                                                          autocomplete="off" placeholder="{{ __('customer.Building No') }}" value="{{ $cust_add1 }}">
                                                    </div>
                                                 </div>
                                              </div>
                                           </div>
                                                 ...
                                                 <div class="col-md-8">
                                                    <div class="input-group  input-group-sm">
                                                       ...
                                                       <input type="text" class="form-control"
                                                          ...
                                                          autocomplete="off"
                                                          placeholder="{{ __('customer.Street Name') }}" value="{{ $cust_add2 }}">
                                                    </div>
                                                 </div>
                                              </div>
                                           </div>
                                                 ...
                                                 <div class="col-md-8">
                                                    <div class="input-group  input-group-sm">
                                                       ...
                                                       <input type="text" class="form-control"
                                                          ...
                                                          autocomplete="off"
                                                          placeholder="{{ __('customer.District') }}" value="{{ $cust_region }}">
                                                    </div>
                                                 </div>
                                              </div>
                                           </div>
                                                 ...
                                                 <div class="col-md-8">
                                                    <div class="input-group  input-group-sm">
                                                       ...
                                                       <input type="text" class="form-control"
                                                          ...
                                                          placeholder="{{ __('customer.Postal Code') }}" value="{{ $cust_zip }}">
                                                    </div>
                                                 </div>
                                              </div>
                                           </div>
                                                 ...
                                                 <div class="col-md-8">
                                                    <div class="input-group  input-group-sm">
                                                       ...
                                                       <input type="text" class="form-control"
                                                          ...
                                                          id="mobile" name="mobile" autocomplete="off" value="{{ $mobile }}">
                                                    </div>
                                                 </div>
                                              </div>
                                           </div> -->
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="product_table">
                                    ...
                                    <tbody>
                                        ...
                                        @if ($saleorder_productss->invoice_remaining > 0)
                                        <tr>
                                            <td>{{ $key + 1 }}</td>
                                            <input type="hidden" class="form-control product_row_id" name="product_row_id[]" id="product_row_id{{ $key + 1 }}" data-id="{{ $key + 1 }}" value="{{ $saleorder_productss->id }}">
                                            <td>
                                                <div class="input-group input-group-sm">
                                                    <input style="width: 4cm;" type="text" class="form-control single-select productname kt-selectpicker" name="productname[]" id="productname{{ $key + 1 }}" data-id="{{ $key + 1 }}" value="{{ $saleorder_productss->product_name }}" >
                                                    <div>
                                                        <input type="hidden" class="form-control single-select item_id" name="item_id[]" id="item_id{{ $key + 1 }}" data-id="{{ $key + 1 }}" value="{{ $saleorder_productss->item_id }}">
                                            </td>
                                            <td>
                                                <textarea class="form-control" id="description{{ $key + 1 }}" name="description[]" rows="1" data-id={{ $key + 1 }} style=" height: 30px !important; width:3cm;">{{ $saleorder_productss->description }}</textarea>
                                            </td>
                                            ...
                                            <td>
                                                <div>
                                                    <select style="    width: 3cm;" class="form-control form-control-sm single-select unit kt-selectpicker" data-id="{{ $key + 1 }}" name="unit[]" id="unit" disabled="">
                                                        ...
                                                        <option value="{{ $data->id }}" @if ($saleorder_productss->unit == $data->id) selected="" @endif>
                                                            {{ $data->unit_name }}
                                                        </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <td>
                                                <div class="input-group input-group-sm">
                                                    <input type="text" style="width: 1cm;" class="form-control quantity" data-id="{{ $key + 1 }}" name="quantity[]" id="quantity{{ $key + 1 }}" value="{{ $saleorder_productss->invoice_remaining }}">
                                                    <input type="hidden" style="width: 1cm;" class="form-control oquantity" data-id="{{ $key + 1 }}" name="oquantity[]" id="oquantity{{ $key + 1 }}" value="{{ $saleorder_productss->invoice_remaining }}">
                                                    <input type="hidden" style="width: 1cm;" class="form-control originalquantity" data-id="{{ $key + 1 }}" name="originalquantity[]" id="originalquantity{{ $key + 1 }}" value="{{ $saleorder_productss->invoice_remaining }}">
                                                </div>
                                            </td>
                                            <td>
                                                <div class="input-group input-group-sm">
                                                    <input type="text" style="width: 1cm; width: 1cm;" class="form-control rate" name="rate[]" id="rate{{ $key + 1 }}" data-id="{{ $key + 1 }}" value="{{ $saleorder_productss->rate }}" readonly>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control amount" name="amount[]" data-id="{{ $key + 1 }}" id="amount{{ $key + 1 }}" readonly value="{{ $saleorder_productss->amount }}">
                                                </div>
                                            </td>
                                            <td>
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control discount_type_amount" data-id="{{ $key + 1 }}" name="discount_type_amount[]" id="discount_type_amount{{ $key + 1 }}" value="{{ $saleorder_productss->discount }}" readonly>
                                                </div>
                                            </td>
                                            <td style=" display: none;">
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control discountamount" data-id="{{ $key + 1 }}" name="discountamount[]" id="discountamount{{ $key + 1 }}" value="" readonly>
                                                </div>
                                            </td>
                                            <td>
                                                <select style="    width: 2cm;" class="form-control form-control-sm single-select vat_percentage kt-selectpicker" data-id="{{ $key + 1 }}" name="vat_percentage[]" id="vat_percentage{{ $key + 1 }}" disabled="">
                                                    <option value="">select</option>
                                                    @foreach ($vatlist as $data)
                                                    <option value="{{ $data->total }}" @if ($saleorder_productss->vat_percentage == $data->total) selected="" @endif>
                                                        {{ $data->total }}
                                                    </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <td>
                                                <input type="text" class="form-control vatamount form-control-sm" name="vatamount[]" id="vatamount{{ $key + 1 }}" data-id={{ $key + 1 }} value="{{ $saleorder_productss->vatamount }}" readonly>
                                            </td>
                                            <td>
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control row_total row_total_change" data-id="{{ $key + 1 }}" name="row_total[]" id="row_total{{ $key + 1 }}" value="{{ $saleorder_productss->totalamount }}">
                                                </div>
                                            </td>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group  row pr-md-3">
                            ...
                            <div class="col-md-8 input-group-sm">
                                ...
                                <input type="text" class="form-control" name="totalamount" id="totalamount" value="{{ $totalamount }}" readonly style=" text-align: right; font-size: 1.25rem; background-color: #f2f3f8;  height: calc(1.25em + 1rem + 2px);">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group  row pr-md-3">
                            ...
                            <div class="col-md-8 input-group-sm">
                                ...
                                <input type="text" class="form-control" name="amountafterdiscount" id="amountafterdiscount" value="{{ $amountafterdiscount }}" readonly style=" text-align: right; font-size: 1.25rem; background-color: #f2f3f8;  height: calc(1.25em + 1rem + 2px);">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group  row pr-md-3">
                            ...
                            <div class="col-md-8 input-group-sm">
                                ...
                                <input type="text" class="form-control" name="totalvatamount" id="totalvatamount" value="{{ $vatamount }}" readonly style=" text-align: right; font-size: 1.25rem; background-color: #f2f3f8;  height: calc(1.25em + 1rem + 2px);">
    ...
    font-weight: bold; padding-top:4px">@lang('app.Total Amount')</label>
                            ...
                            <div class="col-md-8 input-group-sm">
                                ...
                                <input type="text" class="form-control" name="grandtotalamount" id="grandtotalamount" value="{{ $grandtotalamount }}" readonly style="background-color: #ffffff00;  border: none;  text-align: right;  font-size: 1.75rem;font-weight: bold; color: #646c9a; padding-top: 0px;">
                    ...
                    <div class="kt-form__actions">
                        <div class="row">
                            ...
                            <div class="col-lg-12 kt-align-right">
                                ...
                                <button type="button" class="btn btn-primary" id="saleorder_performa_convert"><svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check-circle icon-16">
...
<script>
    ...
    function createproduct(product_name) {
        ...
        $.ajax({
            url: "getproduct_name_details_sell_saleorder",
            method: "POST",
            data: {
                _token: $('#token').val(),
                id: product_name
    ...
    $('body').on('keyup', '.quantity', function() {
        ...
        var oquantity = $("#oquantity" + id).val();
        var quantity = $("#quantity" + id).val();
        if (quantity == "" || quantity == 0) {
            $('#saleorder_performa_convert').attr('disabled', true);
            ...
            $('#saleorder_performa_convert').attr('disabled', false);
            row_vatcalculate(id);
            row_calculate(id);
            row_vatcalculate(id);
        }
...
<script type="text/javascript">
    ...
    $('body').on('keyup', '.paidamount', function() {
        ...
        if (parseFloat(grandtotalamount) >= parseFloat(paidamount)) {
            ...
            $('#paidamount').val(0);
            $('#balanceamount').val(grandtotalamount.toFixed(2));
        }
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $.each(data, function(key, value) {
                            ...
                            $('#creditbalance').val(total.toFixed(2));
                        });
                        sl++;
                    }
                })
...
<script type="text/javascript">
    ...
    $(document).on('click', '#saleorder_performa_convert', function(e) {
        e.preventDefault();
