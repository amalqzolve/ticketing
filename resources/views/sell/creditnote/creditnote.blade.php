                            ...
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        ...
                                        ?>
                                        <input type="text" class="form-control " name="quotedate" id="quotedate" value="{{ $quotedate2 }}" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <input type="text" class="form-control" name="valid_till" id="valid_till" value="{{ $dateofsupply2 }}" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                        ...
                        <div class="row">
                                ...
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <select class="form-control single-select kt-selectpicker" id="salesman">
                                            ...
                                            <option value="{{ $data->id }}" {{($salesman1 == $data->id)?'selected':''}}>{{ $data->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group input-group-sm">
                                        <input type="text" class="form-control discount_type" name="discount_type" id="discount_type" value="{{ $discount_type }}" readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group  row pr-md-3">
                                ...
                                <div class="col-md-9 input-group-sm">
                                    <select class="form-control single-select kt-selectpicker" id="terms" name="terms">
                                        ...
                                        <option value="{{ $data->id }}" {{($terms_conditions == $data->id)?'selected':''}}> {{ $data->term }} </option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class=" pr-1 pl-1" style=" width: 100%;      background-color: #f2f3f8;   margin-top: -10px;">
                            <table class="table table-striped table-bordered table-hover" id="product_table" style="table-layout:fixed; width:100%; ">
                                ...
                                <tbody>
                                    ...
                                    @if($cinvoice_products->quantity > $cinvoice_products->credit_created_quantity)
                                    <tr>
                                        <td>{{ $key + 1 }}</td>
                                        <td><input class="form-control kt-selectpicker productname" id="productname{{ $key + 1 }}" name="productname[]" data-id="{{ $key + 1 }}" value="{{ $cinvoice_products->product_name }}" readonly>
                                            <input type="hidden" class="form-control single-select item_id" name="item_id[]" id="item_id" data-id="{{ $key + 1 }}" value="{{ $cinvoice_products->product_id }}">
                                            <input type="hidden" class="form-control single-select qsell_saleinvoice_product_id" name="qsell_saleinvoice_product_id[]" id="qsell_saleinvoice_product_id" data-id="{{ $key + 1 }}" value="{{ $cinvoice_products->id }}">
                                        </td>
                                        <td>
                                            <textarea class="form-control" rows="1" name="description[]" id="description{{ $key + 1 }}" data-id="{{ $key + 1 }}" readonly>{{ $cinvoice_products->description }}</textarea>
                                        </td>
                                        <td>
                                        ...
                                        <td><input type="text" class="form-control returnedquantity" name="returnedquantity[]" id="returnedquantity{{ $key + 1 }}" data-id="{{ $key + 1 }}" value="{{$cinvoice_products->credit_created_quantity}}" readonly></td>
                                        <td><input type="text" class="form-control balancequantity" name="balancequantity[]" id="balancequantity{{ $key + 1 }}" data-id="{{ $key + 1 }}" value="{{$cinvoice_products->quantity - $cinvoice_products->credit_created_quantity}}" readonly></td>
                                        <td><input type="text" class="form-control quantity" name="quantity[]" id="quantity{{ $key + 1 }}" data-id="{{ $key + 1 }}" value="{{ $cinvoice_products->quantity - $cinvoice_products->credit_created_quantity }}"></td>
                                        ...
                                        <td><input type="text" class="form-control discountamount" name="discountamount[]" id="discountamount{{ $key + 1 }}" data-id="{{ $key + 1 }}" value="{{ ($cinvoice_products->discount!='')?$cinvoice_products->discount:0 }}" readonly></td>
                                        ...
                                        <td><input type="text" class="form-control row_total row_total_change" name="row_total[]" id="row_total{{ $key + 1 }}" data-id="{{ $key + 1 }}" value="{{ $cinvoice_products->totalamount }}" readonly></td>
                                        <td>
