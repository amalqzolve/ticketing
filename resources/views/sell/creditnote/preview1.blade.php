...
<head>
    ...
    foreach ($creditnote as $key => $quotations) {
        $id = $quotations->id;
                            ...
                            <table style=" width: 100%; ">
                                <tr>
                                    ...
                                    <td
                                        ...
                                        {{ $salesquotation }}{{ $id }}{{ $salesquotation_sufix }}</td>
                                    <td
...
$qrtextof=str_replace('',"",$qrtextof);*/
            ...
            <div class="str">
                <table>
                    ...
                    @foreach ($creditnoteproducts as $key => $quotation_products)
                        <tr class="str">
                                        ...
                                        <td
                                            ...
                                            <table style="width:100%; background-color: white !important;">
                                                ...
                                                <tr style="background-color: white !important;">
                                                    ...
                                                    <td
                                                        style="border-color: white; padding: 0;background-color: white !important;text-align:right;">
                                                        {{ number_format($amountafterdiscount, 2, '.', ',') }}</td>
                                                </tr>
 ...
 <div class="row">
  ...
  <p style="text-align: justify; font-size: 10px;">{{ $notes }}</p>
                ...
                <table width="100%">
                    <tr>
                        <td style="border-color: white;background-color: white !important; font-weight: b;"><span
                                style="font-weight: bold;">Prepared by</span><br>
                            {{ $quotedate }}
                        </td>
                        <td style="border-color: white;background-color: white !important; text-align: center;"><span
                                style="font-weight: bold;">Approved by</span> <br>
                            {{ $quotedate }} </td>
                        <td style="border-color: white; text-align: right;background-color: white !important;"><span
                                style="font-weight: bold;">Received by</span> <br>
                        </td>
                    </tr>
                    <tr>
