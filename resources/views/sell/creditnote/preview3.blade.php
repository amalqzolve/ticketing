                ...
                <table style="width:100%;" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td style="border-color: white;   padding-top: 0; padding-right: 0; padding-bottom: 0;  ">
                            ...
                            <table style=" width: 100%; ">
                                ...
                                <tr>
                                    ...
                                    <td style="border-color: white; padding: 0; font-weight: bold;  font-size:12px;"> CR
                                        No</td>

                                    <td style="border-color: white; padding: 0;text-align:  center;  font-size:12px;">
                                        {{ $cr_num }}</td>
                                ...
                                <tr>
                                    ...
                                    <td style="border-color: white; padding: 0; font-weight: bold;  font-size:12px;">
                                        VAT ID</td>
                        ...
                        <td cellspacing="0" cellpadding="0" valign="right"
                            style="padding: 0; border-color: white; width:50%;">
...
$qrtextof=str_replace('',"",$qrtextof);*/
                ...
                <table style="width:100%;" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td valign="top" style="border-color: white; ">
                            ...
                            <table style="width:100%; border-color: white;   padding: 2px; " cellspacing="0"
                                cellpadding="0">

                                <tr style=" ">

                                    <td style=" border-color: white; ; border-color: white;   padding: 0px; font-weight: bold; font-size: 12px;"
                                        width="30%"> Name </td>

                                    <td
                                        style="border-color: white; border-color: white; text-align: center;  padding: 0px; font-size: 12px;">
                                        {{ $cust_name }}</td>
                                    <td
                                        style="border-color: white; border-color: white;  padding: 0px; font-size: 12px;">
                                        {{ $ar_cust_name }}</td>

                                    <td style=" border-color: white; text-align: right; ; border-color: white;   padding: 0px;  font-size: 12px;"
                                        width="30%"> الإسم </td>
                                ...
                                <tr>
                                    ...
                                    <td
                                        style=" border-color: white; ; border-color: white;   padding: 0px; font-weight: bold; font-size: 12px;">
                                        Building No </td>
                                    ...
                                    <td
                                        style=" border-color: white; text-align: right; ; border-color: white;   padding: 0px; font-size: 12px;">
                                        رقم المبني </td>
              ...
              <td style=" border-color: white; text-align: right; ; border-color: white;   padding: 0px;" >      الرقم الإضافي للعنوان     </td>
                                ...
                                <tr>
                                    ...
                                    <td
                                        style=" border-color: white; text-align:right; ; border-color: white;   padding: 0px; font-size: 12px;">
                                        رقم تسجيل ضريبة القيمة المضافة </td>
