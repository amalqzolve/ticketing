        ...
        <div class="kt-portlet__body pl-2 pr-2 pb-0">
            ...
            <form class="kt-form" id="kt_form">
                ...
                <ul class="nav nav-tabs nav-fill" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab" href="#kt_tabs_2_1">Credit Note Details</a>
                    </li>
                    <li class="nav-item">
                            ...
                            <div class="form-group  row pr-md-3">
                                ...
                                <div class="col-md-9 input-group-sm">
                                    ...
                                    <select class="form-control single-select kt-selectpicker" id="terms" name="terms">
                                        ...
                                        <option value="{{ $data->id }}" <?php if ($terms_conditions == $data->id) {
                                                                            echo 'selected';
                                                                        } ?>>
                                            {{ $data->term }}
                                        </option>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><input class="form-control kt-selectpicker productname" id="productname{{ $key + 1 }}" name="productname[]" data-id="{{ $key + 1 }}" value="{{ $data->product_name }}">
                                            ...
                                            <input type="hidden" class="form-control single-select product_id" name="product_id[]" id="product_id" data-id="{{ $key + 1 }}" value="{{ $cinvoice_products->id }}">
                                        ...
                                        <td><input type="text" class="form-control discountamount" name="discountamount[]" id="discountamount{{ $key + 1 }}" data-id="{{ $key + 1 }}" value="{{ ($cinvoice_products->discount!='')?$cinvoice_products->discount:0 }}"></td>
                    ...
                    <div class="kt-form__actions">
                        <div class="row">
                            ...
                            <div class="col-lg-12 kt-align-right">
                                ...
                                <button type="button" class="btn btn-primary" id="convertcreditnote_submit"><svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check-circle icon-16">
