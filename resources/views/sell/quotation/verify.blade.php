                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="input-group input-group-sm">
                                                            <input style="width: 4cm;" type="text"
                                                                ...
                                                                data-id="{{ $key + 1 }}"
                                                                value="{{ $quotation_productss->product_name }}"
                                                                readonly>
                                                            <div>
                                                                <input type="hidden"
                                                    ...
                                                    <td>
                                                        <input type="text"
                                                            ...
                                                            data-id={{ $key + 1 }}
                                                            value="{{ $quotation_productss->vatamount }}" readonly>
                                                    </td>
                                                    <td>
                                                        <div class="input-group input-group-sm">
                        ...
                        <div class="kt-form__actions">
                            <div class="row">
                                ...
                                <div class="col-lg-12 kt-align-right">
                                    ...
                                    <button type="button" class="btn btn-primary" id="quotation_verify"><svg
                                            xmlns="http://www.w3.org/2000/svg" width="15" height="15"
                                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                            stroke-linecap="round" stroke-linejoin="round"
...
@section('script')
    ...
    function findRevercCalculation(row) {
        ...
        $('body').on('keyup', '.quantity', function() {
            ...
            if (quantity == "" || quantity == 0) {
                $('#quotation_verify').attr('disabled', true);
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '#quotation_verify', function(e) {
            e.preventDefault();
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    //$('#quotation_update').removeClass('kt-spinner');

                    //   $('#quotation_update').removeClass('kt-spinner');

                    window.location.href = "quotation_list";
                    toastr.success('Quotation ' + sucess_msg + ' successfuly');
                    $('#quotation_verify').prop("disabled", false);
