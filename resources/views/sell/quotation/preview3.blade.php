                            ...
                            <table style=" width: 100%; ">
                                ...
                                <tr>
                                    <td style="border-color: white; padding: 0; font-weight: bold;  font-size:11px; width: 30%;">
                                        Quote ID</td>
                                    <td style="border-color: white; padding: 0;text-align: center;  font-size:11px; color: red;">
                                        {{ $salesquotation }}{{ $id }}{{ $salesquotation_sufix }}
                                    </td>
                        ...
                        <td valign="top" style="border-color: white; ">
                            ...
                            <table style="width:100%; border-color: white;   padding: 2px; " cellspacing="0" cellpadding="0">
                                ...
                                <tr style=" ">
                                    ...
                                    <td style="border-color: white; border-color: white; text-align: center;  padding: 0px; font-size: 12px;">
                                        {{ $cust_name }}
                                    </td>
            ...
            <div class="str">
                ...
                <table>
                    <tr>
                        ...
                        <td style="border-color: white;  padding: 0; background-color: white !important;; text-align:center; width: 10%;">
                            Discount <br> خصومات </td>
                        <td style="border-color: white;  padding: 0;  background-color: white !important;; text-align:center; width: 10%;">
                            VAT Amount <br> نسبة الضريبة </td>
                        <td style="border-color: white; width: 10%; padding: 0;  background-color: white !important;; text-align:center; ">
                            Total Amount <br></td>
                    ...
                    <tr class="str">
                        ...
                        <td style="border-color: white;   padding: 2px; text-align: right;">
                            {{ number_format($quotation_products->rate, 2, '.', ',') }}
                        </td>
                        <td style="border-color: white;   padding: 2px; text-align: right;">
                            {{ number_format($quotation_products->amount, 2, '.', ',') }}
                        </td>
                        <td style="border-color: white;   padding: 2px; text-align: center; ">
                            {{ number_format($quotation_products->discount, 2, ',', '.') }}
                        </td>


                        <td style="border-color: white;   padding: 2px; text-align: right;">
                            {{ number_format($quotation_products->vatamount, 2, '.', ',') }}
                        </td>
                        <td style="border-color: white;   padding: 2px; text-align: right;">
                            {{ number_format($quotation_products->totalamount, 2, '.', ',') }}
                        </td>
                    </tr>
                    @endforeach
