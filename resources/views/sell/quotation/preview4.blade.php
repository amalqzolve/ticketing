...
$qrtextof=str_replace('',"",$qrtextof);*/
      ...
      <table style="table-layout: auto; " cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td style="border-color: white;   padding: 1px; text-align: center;">
            <h3 style="letter-spacing: 0px; margin: 0;">Quote Details فتفاصيل الاقتباس </h3>
          </td>
        </tr>
        <tr>
          <td style="border-color: white;   padding: 1px">
      ...
      <div class="str">
        ...
        <table width="100%">
          ...
          <td style="border-color: white;background-color: white !important;">
            <p>@if ($status=='Approved')
              <img src="{{ asset('pdfheader/kant-seal.png') }}" style="float: left; margin: 100 100 0 0">
              @else
              <img src="{{ asset('pdfheader/kant-seal.png') }}" style="float: left; margin-top: -50px;">
              @endif
            </p>
          </td>
          <td style="border-color: white;background-color: white !important; font-weight: b;"><span style="font-weight: bold;">Approved by</span><br>
            <br> {{$quotedate}}
          </td>
          <td style="border-color: white;background-color: white !important;">
            <p>@if ($status=='Approved')
              <img width='100' height='100' src='{{ asset('pdfheader/s3.png') }}'>
              @else
              <img width='100' height='100' src='{{ asset('pdfheader/s3.png') }}'>
              @endif
            </p>
     ...
     <td style="border-color: white;background-color: white !important;"><p><br>  </p></td>
      <td style="border-color: white;background-color: white !important;"><p><img src="{{ asset('pdfheader/kant-seal.png') }}"   style="float: left; margin: -100 100 0 0" > </p></td>
     <td style="border-color: white;background-color: white !important;"><p><br>  </p></td>
      <td style="border-color: white; text-align: right;background-color: white !important;"><p> <br> <br><!-- Name, Signature & Date --> <br> </p>
          </td>
          </tr>-->
        </table>
