                        ...
                        <div class="kt-form__actions">
                            <div class="row">
                                ...
                                <div class="col-lg-12 kt-align-right">
                                    ...
                                    <button type="button" class="btn btn-primary" id="quotation_revise"><svg
                                            xmlns="http://www.w3.org/2000/svg" width="15" height="15"
                                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                            stroke-linecap="round" stroke-linejoin="round"
    ...
    function findRevercCalculation(row) {
        ...
        $('body').on('keyup', '.quantity', function() {
            ...
            if (quantity == "" || quantity == 0) {
                $('#quotation_revise').attr('disabled', true);
                toastr.warning("Quantity Cannot be 0");
            } else {
                $('#quotation_revise').attr('disabled', false);
                row_vatcalculate(id);
                row_calculate(id);
                row_vatcalculate(id);
            }
