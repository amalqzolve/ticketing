...
<br/>
							<div class="kt-portlet kt-portlet--mobile">
								<div class="kt-portlet__head kt-portlet__head--lg">
									...
									Invoice Settlement - Receipt Vouchers
</h3>
									</div>
						...
						<!-- <a href="{{url('/')}}/cashsales_report_list" class="btn btn-brand btn-elevate btn-icon-sm">
													Cash Sales
													
												</a>
						 <a href="{{url('/')}}/creditsales_report_list" class="btn btn-brand btn-elevate btn-icon-sm">
													Credit Sales
												</a> -->
...
<table class="table table-striped table-hover table-checkable dataTable no-footer" id="paymentdetails_list">
	<thead>
		<tr>
			...
			<th>@lang('app.Total Amount')</th>
			<th>@lang('app.Paid Amount')</th>
			<th>@lang('app.Due Amount')</th>
	...
	<tbody>
            ...
            <div class="kt-wizard-v3__content   fadeIn" data-ktwizard-type="step-content">
               <div class="mt-3">
<table class="table table-striped table-hover table-checkable dataTable no-footer" id="cashsalesdetails_list">
	<thead>
		<tr>
			<th>@lang('app.Sl.No')</th>
			<th>@lang('app.InvoiceID')</th>
	...
	<tbody>
            ...
            <div class="kt-wizard-v3__content   fadeIn" data-ktwizard-type="step-content">
               <div class="mt-3">
     <table class="table table-striped table-hover table-checkable dataTable no-footer" id="creditsalesdetails_list">
	<thead>
		<tr>
			<th>@lang('app.Sl.No')</th>
			<th>@lang('app.InvoiceID')</th>
