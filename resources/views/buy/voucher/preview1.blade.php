  ...
  ?>
   ...
   <table style="width:100%; border-spacing: 0;" cellspacing="0" cellpadding="0">
      ...
      <tr>
         ...
         <center><h3>Supplier Details   </h3></h3>
            ...
            <tr style=" ">
              ...
              <td  style="border-color: white; border-color: white;   padding: 0px; font-size: 11px; padding:0; "> 
                <table style=" width: 100%; margin: 0; padding:0;border-collapse: collapse; border-spacing: 0;">
                  <tr >
                    <td style="margin: 0; border-color: white; ; border-color: white;   padding: 0px;  font-size: 11px; " ><?php if(isset($sup_add1)){echo  $sup_add1;echo "<br>";} ?> 
                      <?php if(isset($sup_add2)){ echo  $sup_add2;echo "<br>";} ?>
                    </td>
                  </tr>
                </table>
          ...
          <!--    <td style=" border-color: white; ; border-color: white;   padding: 0px; font-size: 11px;"  width="2%"></td> -->
              <td  style="border-color: white; border-color: white;   padding: 0px; font-size: 11px;">
                <table style=" width: 100%;border-collapse: collapse; border-spacing: 0; ">
                  <tr>
                    <td style=" border-color: white; ; border-color: white;   padding: 0px;  font-size: 11px; " >
                       <?php if(isset($sup_region)){echo  $sup_region;echo "<br>";} ?>
             ...
             <!--  <td style=" border-color: white; ; border-color: white;   padding: 0px; font-size: 11px;"  width="2%"></td> -->
              <td  style="border-color: white; border-color: white;   padding: 0px; font-size: 11px;">
                <table style=" width: 100%; border-collapse: collapse; border-spacing: 0;">
                  <tr>
                    <td style=" border-color: white; ; border-color: white;   padding: 0px;  font-size: 11px; " > 
                        <?php if(isset($sup_zip)){echo  $sup_zip;echo "<br>";} ?>
   ...
   <tr>
                ...
                <table style=" width: 100%; border-collapse: collapse; border-spacing: 0;">
                  <tr>
                    <td style=" border-color: white; ; border-color: white;   padding: 0px;  font-size: 11px; " >
                      ...
                      <?php if(isset($sup_city)){echo  $sup_city;echo "<br>";} ?><?php if(isset($cntry_name)){echo  $cntry_name;echo "<br>";} ?>
                    </td>
                  </tr>
                </table>
              </td>
            ...
            <tr>
              ...
              <!-- <td style=" border-color: white; ; border-color: white;   padding: 0px; font-size: 11px;"  width="2%">:</td> -->
              <td  style="border-color: white; border-color: white;   padding: 0px; font-size: 11px;">{{$vat_no}}</td>
   ...
   <tr>
             ...
             <!--  <td style=" border-color: white; ; border-color: white;   padding: 0px; font-size: 11px;"  width="2%">:</td> -->
              <td  style="border-color: white;  border-color: white;   padding: 0px; font-size: 11px;">{{$cr_no}}</td>
              ...
              <td  style="border-color: white; border-color: white;   padding: 0px; font-size: 11px; text-align: right; ">
                <table style=" width: 100%; margin: 0; padding:0;border-collapse: collapse; border-spacing: 0;">
                  <tr >
                   ...
                   <?php if(isset($sup_add1_ar)){echo $sup_add1_ar;echo "<br>";} ?><?php if(isset($sup_add2_ar)){echo  $sup_add2_ar;echo "<br>";} ?> 
      ...
      <tr>
              ...
              <td  style="border-color: white; border-color: white;   padding: 0px; font-size: 11px; text-align: right; ">
                <table style=" width: 100%; margin: 0; padding:0;border-collapse: collapse; border-spacing: 0;">
                 <tr >
                    <td style="margin: 0; border-color: white; ; border-color: white;   padding: 0px; font-size: 11px; width: 60%; text-align: right;" >
                      <?php if(isset($sup_region_ar)){echo  $sup_region_ar;echo "<br>";} ?> 
      ...
      <tr>
              <td  style="border-color: white; border-color: white;   padding: 0px; font-size: 11px; text-align: right; ">
                <table style=" width: 100%; margin: 0; padding:0;border-collapse: collapse; border-spacing: 0;">
                   <tr >
                    <td style="margin: 0; border-color: white; ; border-color: white;   padding: 0px; font-size: 11px; width: 60%; text-align: right;" >
                      <?php if(isset($sup_zip_ar)){echo  $sup_zip_ar;echo "<br>";} ?>
   ...
   <tr>
              ...
              <td  style="border-color: white; border-color: white;   padding: 0px; font-size: 11px; text-align: right; border-spacing: 0; ">
                <table style=" width: 100%; margin: 0; padding:0;border-collapse: collapse;">
                   <tr >
                    <td style="margin: 0; border-color: white; ; border-color: white;   padding: 0px; font-size: 11px; width: 60%; text-align: right;" >
                      <?php if(isset($sup_city_ar)){echo  $sup_city_ar;echo "<br>";} ?><?php if(isset($sup_country_ar)){echo  $sup_country_ar;echo "<br>";} ?>
                       </td>
   ...
   <table style="table-layout: auto; " cellspacing="0" cellpadding="0" >
    ...
    <tr>
      <td  style="border-color: white;   padding: 1px; text-align: center;">
        <h3 style="letter-spacing: 0px; margin: 0;"> Credit Note</h3>
      </td>
    </tr>
    <tr>
      <td  style="border-color: white;   padding: 1px">
   ...
   <table>
     ...
     <tr class="str">
       ...
       <td  style="border-color: white;   padding: 2px;">
          ...
          <td  style="border-color: white;   padding: 2px;">
            {{$voucher_metods->product_description}}
</td>   
