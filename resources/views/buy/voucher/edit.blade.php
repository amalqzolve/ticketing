...
<?php
foreach($buyvoucher as $buyvoucher)
{
$id = $buyvoucher->id;
$voucher_type = $buyvoucher->voucher_type;
$purchase_type = $buyvoucher->purchase_type;
$bill_id = $buyvoucher->bill_id;
$quotedate = $buyvoucher->quotedate;
$entrydate = $buyvoucher->entrydate;
$dateofsupply = $buyvoucher->dateofsupply;
$po_wo_ref = $buyvoucher->po_wo_ref;
$salesman = $buyvoucher->salesman;
$currency = $buyvoucher->currency;
$currencyvalue = $buyvoucher->currencyvalue;
$notes = $buyvoucher->notes;
$internalreference = $buyvoucher->internalreference;
$totalamount = $buyvoucher->totalamount;
$discount = $buyvoucher->discount;
$amountafterdiscount = $buyvoucher->amountafterdiscount;
$totalvatamount = $buyvoucher->totalvatamount;
$grandtotalamount = $buyvoucher->grandtotalamount;
$paidamount = $buyvoucher->paidamount;
$balanceamount = $buyvoucher->balanceamount;

}
foreach($pname as $pname)
{
   $supid = $pname->id;
   $sup_code = $pname->sup_code;
...
<div class="tab-content">
   ...
   <div class="col-lg-6">
         ...
         @foreach($vouchers as $data)
            <option value="{{$data->id}}"@if($voucher_type == $data->id) selected="" @endif>{{$data->voucher_name}}</option>
            @endforeach
                                 </select>
   ...
   <div class="col-lg-6">
         ...
         <option value="1"@if($purchase_type == 1) selected="" @endif>Cash</option>
          <option value="2"@if($purchase_type == 2) selected="" @endif>Credit</option>
...
<div class="col-lg-6">
                        ...
                        <input type="text" class="form-control" name="bill_id" id="bill_id" value="{{$bill_id}}">
                              </div>
                              </div>
                              </div>
   ...
   <div class="col-lg-6">
                        ...
                        <input type="text" class="form-control kt_datetimepickerr" name="quotedate" id="quotedate" value="{{$quotedate}}">
                              </div>
                              </div>
                              </div>
                        ...
                        <input type="text" class="form-control kt_datetimepickerr" name="entrydate" id="entrydate" value="{{$entrydate}}">
                              </div>
                              </div>
                              </div>
...
Due Date</label>
                        ...
                        <input type="text" class="form-control kt_datetimepickerr" name="dateofsupply" id="dateofsupply" value="{{$dateofsupply}}">
         ...
         @foreach($salesmen as $data)
            <option value="{{$data->id}}" @if($salesman == $data->id) selected="" @endif>{{$data->name}}</option>
            @endforeach
                                 </select>
...
<div class="col-lg-12">
                              ...
                              <div class="col-md-8 input-group-sm">
                                 ...
                                 <textarea class="form-control" name="internalreference" id="internalreference">{{$internalreference}}</textarea>
                        ...
                        <div class="col-lg-6">
                                          <div class="form-group row pr-md-3">
                                             ...
                                             <div class="col-md-8  input-group input-group-sm">
                                                <input type="text" class="form-control single-select Cust_category"
                                                   id="cust_category" name="cust_category" value="{{$category}}">
                                    ...
                                    <div class="input-group input-group-sm">
                                                   ...
                                                   <input type="text" class="form-control branch"
                                                      ...
                                                      autocomplete="off" readonly="" value="{{$sup_code}}">
                                                </div>
                                             </div>
                                          </div>
                                       </div>
                                       <div class="col-lg-6">
                                          <div class="form-group row  pr-md-3">
                                             ...
                                             <div class="col-md-8 input-group input-group-sm">
                                                <input type="text" name=""class="form-control single-select"id="cust_type" name="cust_type" value="{{$type}}">
                                       ...
                                       <div class="col-lg-6">
                                          <div class="form-group row pr-md-3">
                                             ...
                                             <div class="col-md-8 ">
                                                <div class="input-group input-group-sm">
<input type="hidden" id="customer1" name="customer1" value="{{$supid}}">
                                                   <input type="text" class="form-control"
                                                      id="cust_name" name="cust_name"
                                                      autocomplete="off"
                                                      placeholder="{{ __('customer.Customer Name/Company name') }}" value="{{$sup_name}}">
                                                </div>
                                             </div>
                                          </div>
                                       </div>
                                             ...
                                             <div class="col-md-8 ">
                                                <div class="input-group input-group-sm">
                                                   ...
                                                   <input type="text" class="form-control"
                                                      ...
                                                      autocomplete="off" placeholder="{{ __('customer.Building No') }}" value="{{$sup_add1}}">
                                                </div>
                                             </div>
                                          </div>
                                       </div>
                                             ...
                                             <div class="col-md-8">
                                                <div class="input-group  input-group-sm">
                                                   ...
                                                   <input type="text" class="form-control"
                                                      ...
                                                      autocomplete="off"
                                                      placeholder="{{ __('customer.Street Name') }}" value="{{$sup_add2}}">
                                                </div>
                                             </div>
                                          </div>
                                       </div>
                                             ...
                                             <div class="col-md-8">
                                                <div class="input-group  input-group-sm">
                                                   ...
                                                   <input type="text" class="form-control"
                                                      ...
                                                      autocomplete="off"
                                                      placeholder="{{ __('customer.District') }}" value="{{$sup_region}}">
                                                </div>
                                             </div>
                                          </div>
                                       </div>
                                             ...
                                             <div class="col-md-8">
                                                <div class="input-group  input-group-sm">
                                                   ...
                                                   <input type="text" class="form-control"
                                                      ...
                                                      autocomplete="off"
                                                      placeholder="{{ __('customer.City') }}" value="{{$sup_city}}">
                                                </div>
                                             </div>
                                          </div>
                                       </div>
                                             ...
                                             <div class="col-md-8">
                                                <div class="input-group  input-group-sm">
                                                   <input type="text" name="cust_country" id="cust_country"
                                                      class="form-control single-select" value="{{$cntry_name}}">
                                                </div>
                                             </div>
                                          </div>
                                       </div>
                                             ...
                                             <div class="col-md-8">
                                                <div class="input-group  input-group-sm">
                                                   ...
                                                   <input type="text" class="form-control"
                                                      ...
                                                      placeholder="{{ __('customer.Postal Code') }}" value="{{$sup_zip}}">
                                                </div>
                                             </div>
                                          </div>
                                       </div>
                                             ...
                                             <div class="col-md-8">
                                                <div class="input-group  input-group-sm">
                                                   ...
                                                   <input type="text" class="form-control"
                                                      ...
                                                      id="mobile" name="mobile" autocomplete="off" value="{{$mobile1}}">
                                                </div>
                                             </div>
                                          </div>
                                       </div>
                                             ...
                                             <div class="col-md-8">
                                                <div class="input-group  input-group-sm">
                                                   ...
                                                   <input type="text" class="form-control"
                                                      ...
                                                      id="vatno" name="vatno" autocomplete="off" value="{{$vat_no}}">
                                                </div>
                                             </div>
                                          </div>
                                       </div>
                                             ...
                                             <div class="col-md-8">
                                                <div class="input-group  input-group-sm">
                                                   ...
                                                   <input type="text" class="form-control"
                                                      ...
                                                      id="buyerid_crno" name="buyerid_crno" autocomplete="off" value="{{$cr_no}}">
                                                </div>
                                             </div>
                                          </div>
                                       </div>
                  ...
                  <br>
                          ...
                          <table class="table table-striped table-bordered table-hover" id="product_table"  style="width:100%">
                                    ...
                                    <tbody>
   @foreach($buyvoucherproducts as $key=>$buyvoucherproductss)
                                    <tr>
   <td style="text-align: center;">{{$key+1}}</td>
   <td>
@foreach($accounthead as $data)
@if($buyvoucherproductss->head_name == $data->id)
<input type="text" class="form-control head_name" name="head_name[]" id="head_name1" value="{{$data->head_name}}">
@endif              
@endforeach
          ...
          <select class="form-control form-control-sm single-select ledger kt-selectpicker" data-id="1" name="ledger[]" id="ledger1">
            ...
            <option value="">select</option>
             @foreach($subledgertables as $data)
              <option value="{{$data->id}}" @if($buyvoucherproductss->ledger == $data->id) selected="" @endif>{{$data->name}}</option>
              @endforeach
         </select>
   ...
   <td><textarea class="form-control" id="product_description1" name="product_description[]" rows="1" data-id="1" style=" height: 30px !important;">{{$buyvoucherproductss->product_description}}</textarea></td>
   <td>
      <div>
         <select class="form-control form-control-sm single-select unit kt-selectpicker" data-id="1" name="unit[]" id="unit1">
            ...
            @foreach($unitlist as $data)
              <option value="{{$data->id}}"@if($buyvoucherproductss->unit == $data->id) selected="" @endif>{{$data->unit_name}}</option>
              @endforeach
   ...
   <td>
      <div class="input-group input-group-sm">                  <input type="text" class="form-control quantity" data-id="1" name="quantity[]" id="quantity1" value="{{$buyvoucherproductss->quantity}}">                 </div>
   </td>
   <td>
      <div class="input-group input-group-sm">                 <input type="text" class="form-control rate" name="rate[]" id="rate1" data-id="1" value="{{$buyvoucherproductss->rate}}">                 </div>
   </td>
   <td>
      <div class="input-group input-group-sm">                 <input type="text" class="form-control amount" name="amount[]" data-id="1" id="amount1" readonly="" value="{{$buyvoucherproductss->amount}}">                 </div>
   </td>
   <td>
      <div class="input-group input-group-sm">                 <input type="text" class="form-control discountamount" data-id="1" name="discountamount[]" id="discountamount1" value="{{$buyvoucherproductss->rdiscount}}">                 </div>
   </td>
   ...
   <td>
     ...
     <select class="form-control form-control-sm single-select vat_percentage kt-selectpicker" data-id="1" name="vat_percentage[]" id="vat_percentage1">
            ...
            @foreach($vatlist as $data)
              <option value="{{$data->total}}"@if($buyvoucherproductss->vat_percentage == $data->id) selected="" @endif>{{$data->total}}</option>
              @endforeach
   ...
   <td>                 <input type="text" class="form-control vatamount form-control-sm" name="vatamount[]" id="vatamount1" data-id="1" value="{{$buyvoucherproductss->vatamount}}" readonly="">                 </td>
   <td>
      <div class="input-group input-group-sm">                 <input type="text" class="form-control row_total" data-id="1" name="row_total[]" id="row_total1" readonly="" value="{{$buyvoucherproductss->row_total}}">                 </div>
   </td>
...
@endforeach
                  ...
                  <div class="row mt-5">
                    ...
                    <input type="text" class="form-control" name="totalvatamount" id="totalvatamount" value="{{$totalvatamount}}" readonly style=" text-align: right; font-size: 1.25rem; background-color: #f2f3f8;  height: calc(1.25em + 1rem + 2px);">
                    ...
                    <input type="text" class="form-control paidamount" name="paidamount" id="paidamount" value="{{$paidamount}}" style=" text-align: right; font-size: 1.25rem; background-color: #f2f3f8;  height: calc(1.25em + 1rem + 2px);">
    ...
    font-weight: bold; padding-top:4px">@lang('app.Total Amount')</label>
                    ...
                    <input type="text" class="form-control" name="grandtotalamount" id="grandtotalamount" value="{{$grandtotalamount}}" readonly style="background-color: #ffffff00;  border: none;  text-align: right;  font-size: 1.75rem;
...
<div class="col-lg-6">
                    ...
                    <input type="text" class="form-control" name="balanceamount" id="balanceamount" readonly value="{{$balanceamount}}" style=" text-align: right; font-size: 1.25rem; background-color: #f2f3f8;  height: calc(1.25em + 1rem + 2px);">
...
//    });
    ...
    if(quantity == "" || quantity == 0)
    {
      ...
      $('#voucher_update').attr('disabled',true);
        row_calculate(id);
    }
    else
    {
      $('#voucher_update').attr('disabled',false);
           row_vatcalculate(id);
    }
...
$(document).on('click', '#voucher_update', function(e) {
    e.preventDefault();
  ...
  var ledger = [];
    ...
    $.ajax({
        ...
        success: function(data) {
             ...
             $('#voucher_update').removeClass('kt-spinner');
             $('#voucher_update').prop("disabled", false);
             location.reload();
