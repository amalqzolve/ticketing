...
<tr style=" ">
              ...
              <td  style="border-color: white; border-color: white;   padding: 0px; font-size: 11px; padding:0; "> 
                 {{$sup_add1}}<br>{{$sup_add2}}<br>{{$sup_region}}<br>{{$sup_city}}<br>{{$cntry_name}}<br>{{$sup_zip}}
            ...
            <tr>
              ...
              <td  style="border-color: white; border-color: white;   padding: 0px; font-size: 11px; padding:0; "> 
                <table style=" width: 100%; margin: 0; padding:0;border-collapse: collapse; border-spacing: 0;">
                  <tr >
                    <td style="margin: 0; border-color: white; ; border-color: white;   padding: 0px;  font-size: 11px; " >{{$vat_no}}
                    </td>
                  </tr>
                </table>
              </td>
            ...
            <tr>
              ...
              <td  style="border-color: white; border-color: white;   padding: 0px; font-size: 11px; padding:0; "> 
                <table style=" width: 100%; margin: 0; padding:0;border-collapse: collapse; border-spacing: 0;">
                  <tr >
                    <td style="margin: 0; border-color: white; ; border-color: white;   padding: 0px;  font-size: 11px; " >{{$cr_no}}
                    </td>
                  </tr>
                </table>
              </td>
            ...
            <tr style=" ">
              ...
              <td  style="border-color: white; border-color: white;   padding: 0px; font-size: 11px; text-align: right; ">
                <table style=" width: 100%; margin: 0; padding:0;border-collapse: collapse; border-spacing: 0;">
                  ...
                  {{$sup_add1_ar}}<br>{{$sup_add2_ar}}<br>{{$sup_region_ar}}<br>{{$sup_city_ar}}<br>{{$sup_country_ar}}<br>{{$sup_zip_ar}}
