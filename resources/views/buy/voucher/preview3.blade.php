  ...
  ?>
   ...
   <table style="width:100%;" cellspacing="0" cellpadding="0">
         ...
         <td valign="top" style="border-color: white; ">
          ...
          <table style="width:100%; border-color: white;   padding: 2px; " cellspacing="0" cellpadding="0">
            ...
            <tr style=" ">
              ...
              <td  style="border-color: white; border-color: white; text-align: center;  padding: 0px; font-size: 12px;"> {{$sup_name}}</td>
              <td  style="border-color: white; border-color: white;  padding: 0px; font-size: 12px;"> {{$sup_name_ar}}</td>
              ...
              <td  style="border-color: white; border-color: white;  text-align: center;    padding: 0px; font-size: 12px;"> {{$sup_add1}}</td>
              <td  style="border-color: white; border-color: white;  padding: 0px; font-size: 12px;">{{$sup_add1_ar}}</td>
      ...
      <tr>
              ...
              <td  style="border-color: white; border-color: white;  text-align: center;    padding: 0px; font-size: 12px;">{{$sup_add2}}</td>
<td  style="border-color: white; border-color: white;  padding: 0px; font-size: 12px;">{{$sup_add2_ar}}</td>
      ...
      <tr>
              ...
              <td  style="border-color: white; border-color: white; text-align: center;   padding: 0px; font-size: 12px;">{{$sup_region}}</td>
<td  style="border-color: white; border-color: white;  padding: 0px; font-size: 12px;">{{$sup_region_ar}}</td>
      ...
      <tr>
              ...
              <td  style="border-color: white; border-color: white;  text-align: center;    padding: 0px; font-size: 12px;">{{$sup_city}}</td>
<td  style="border-color: white; border-color: white;  padding: 0px; font-size: 12px;"> {{$sup_city_ar}}</td>
   ...
   <tr>
              ...
              <td  style="border-color: white; border-color: white; text-align: center;    padding: 0px; font-size: 12px;">{{$cntry_name}}</td>
<td  style="border-color: white; border-color: white;  padding: 0px; font-size: 12px;">{{$sup_country_ar}}</td>
   ...
   <tr>
              ...
              <td  style="border-color: white; border-color: white;  text-align: center;    padding: 0px; font-size: 12px;">{{$sup_zip}}</td>
<td  style="border-color: white; border-color: white;  padding: 0px; font-size: 12px;">{{$sup_zip_ar}}</td>
   ...
   <tr>
              ...
              <td  style="border-color: white; border-color: white;  text-align: center;    padding: 0px; font-size: 12px;">{{$vat_no}}</td>
<td  style="border-color: white; border-color: white;  padding: 0px; font-size: 12px;">{{$vatno_ar}} </td>
   ...
   <tr>
              ...
              <td  style="border-color: white;  border-color: white; text-align: center;  padding: 0px; font-size: 12px;">{{$cr_no}}</td>
<td  style="border-color: white; border-color: white;  padding: 0px; font-size: 12px;"> {{$buyerid_crno_ar}}</td>
   ...
   <table>
      <tr>
       ...
       <td  style="border-color: white; text-align: left; width: 30%;">Account Name<br></td>
       <td  style="border-color: white; text-align: left; width: 30%;">Ledger<br></td>
     ...
     <tr class="str">
       ...
       <td  style="border-color: white;   padding: 2px; text-align: left;">{{$voucher_metods->head_names}}</td>
       <td  style="border-color: white;   padding: 2px;">
            {{$voucher_metods->name}}
</td>   
          <td  style="border-color: white;   padding: 2px;"> {{$voucher_metods->product_description}}
</td>   
       ...
       <?php if ($voucher_metods->unit == $data->id)
{
    echo $data->unit_name;
            ...
            @endforeach </td>
       <td  style="border-color: white;   padding: 2px; text-align: center;">{{$voucher_metods->quantity}}</td>
