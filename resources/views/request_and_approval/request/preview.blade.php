    ...
    <div class="row" style="margin-top:100px;">
            ...
            <td style="border-color: white;   padding-top: 0; padding-right: 0; padding-bottom: 0;  ">
              ...
              <table style=" width: 100%; ">
                <tr>
                  ...
                  <td style="border-color: white; padding: 0;text-align: left;  font-size:11px; color: red;">&nbsp;REQ {{$request->id}}</td>
                </tr>
                <tr>
                  <td style="border-color: white; padding: 0; font-weight: bold;  font-size:11px;">Request Tittle</td>
                  <td style="border-color: white; padding: 0;text-align:  left;  font-size:11px;">&nbsp;{{$request->request_tittle}}</td>
                ...
                <tr>
                  ...
                  <td style="border-color: white; padding: 0;text-align:  left;  font-size:11px;">&nbsp;{{date('d-m-Y',strtotime($request->required_on))}}</td>

                </tr>
                <tr>
                  <td style="border-color: white; padding: 0; font-weight: bold; font-size: 11px;">Priority </td>
                  <td style="border-color: white; padding: 0;text-align: left; font-size: 11px;">&nbsp;{{($request->request_priority==1)?'Low':''}}{{($request->request_priority==2)?'Medium':''}}{{($request->request_priority==3)?'High':''}}{{($request->request_priority==4)?'Top':''}}
                  </td>
                </tr>

                <tr>
                  <td style=" border-color: white;padding: 0; font-size: 11px; font-weight: bold; ">Request against </td>
                  <td style="border-color: white;padding: 0; font-size: 11px; text-align: left;">&nbsp;{{($request->request_against==1)?'Personal':''}}{{($request->request_against==2)?'Client':''}}{{($request->request_against==3)?'Project':''}}{{($request->request_against==4)?'Department':''}}{{($request->request_against==5)?'Official':''}}</td>
                </tr>
                          ...
                          <table>
                            <tr>
                              ...
                              <td style="height:40px; border-color: white; padding:0; font-size: 32px; text-align:right; padding:0;">
                                <span style="font-weight: bold; text-align:right;">REQUEST</span>
                              </td>
                            </tr>
                            ...
                            <tr>
                              ...
                              <td style="border-color: white; padding:0; text-align:right;"> <span style="font-weight: bold;">Created by </span>:{{$request->name}} <br>Date: {{isset($request->created_at)?date('d-m-Y',strtotime($request->created_at)):''}}</td>
                            </tr>
                          </table>
                        </td>
                      </tr>
      ...
      <div class="str">
        <table>
          ...
          @foreach($requestItems as $key=>$cinvoice_products)
          <tr class="str">
        ...
        <div class="row">
          ...
          <div class="row">
            ...
            <p style="text-align: justify; font-size: 10px;">{{$request->notes}}</p>
