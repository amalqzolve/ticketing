                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <select class="form-control form-control-sm single-select unit kt-selectpicker" data-id="{{$key+1}}" name="users[]" id="user{{$key+1}}">
                                                ...
                                                <option value="{{$data->id}}" {{($data->id==$value->user)?'selected':''}}>{{$data->name}} - {{$data->email}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="input-group input-group-sm">
                                            <select class="form-control form-control-sm single-select kt-selectpicker" data-id="{{$key+1}}" name="approve_type[]" id="approve_type{{$key+1}}">
                                                <option value="1" {{($value->approve_type==1)?'selected':''}}>Approver</option>
                                                <option value="2" {{($value->approve_type==2)?'selected':''}}>Notifier</option>
                                            </select>
                                        </div>
                                    </td>
...
<script src="{{url('/')}}/resources/js/request_and_approval/request/edit.js" type="text/javascript"></script>
