		...
		<div class="kt-portlet__head kt-portlet__head--lg">
			<div class="kt-portlet__head-label">
				...
				<h3 class="kt-portlet__head-title">
					Clone Request Category Approval synthesis
				</h3>
			</div>
		</div>
					...
					<div class="kt-form__actions">
						<div class="row">
							...
							<div class="col-lg-6 kt-align-right">
								<button type="submit" name="tax_submit" id="saveMrWorkFlow" class="btn btn-primary">Clone</button>
...
<script src="{{url('/')}}/resources/js/request_and_approval/request_category_synthesis/mrWorkflowClone.js" type="text/javascript"></script>
