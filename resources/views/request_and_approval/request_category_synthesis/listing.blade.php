		...
		<div class="kt-portlet__head kt-portlet__head--lg">
			<div class="kt-portlet__head-label">
				...
				<h3 class="kt-portlet__head-title">
					Request Category Approval synthesis
				</h3>
			</div>
			<div class="kt-portlet__head-toolbar">
				<div class="kt-portlet__head-wrapper">
					<div class="kt-portlet__head-actions">
						<a href="{{url('/')}}/request-category-synthesis-add" class="btn btn-brand btn-elevate btn-icon-sm">
...
<script src="{{url('/')}}/resources/js/request_and_approval/request_category_synthesis/listing.js" type="text/javascript"></script>
@endsection