		...
		<div class="kt-portlet__head kt-portlet__head--lg">
			<div class="kt-portlet__head-label">
				...
				<h3 class="kt-portlet__head-title">
					New Request Category Approval synthesis
				</h3>
			</div>
		</div>
...
<script src="{{url('/')}}/resources/js/request_and_approval/request_category_synthesis/mrWorkflow.js" type="text/javascript"></script>
