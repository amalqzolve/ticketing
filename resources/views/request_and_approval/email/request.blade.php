...
<head>
  ...
  <page size="A4">
    <form action="{{ route('mark-desc-request') }}" id="frmAction" method="POST" style="padding-block: 73px;  padding-left: 20px;  padding-right: 20px;">
      @csrf
      <input type="hidden" name="token" value="{{$token}}">
      <input type="hidden" name="request_id" value="{{$mainData->id}}">
              ...
              <tr>
                ...
                <td style="border-color: white;   padding-top: 0; padding-right: 0; padding-bottom: 0;  ">
                  ...
                  <table style=" width: 100%; ">
                    <tr>
                      <td style="border-color: white; padding: 0; font-weight: bold;  font-size:11px; width: 30%;">Request ID.</td>
                      <td style="border-color: white; padding: 0;text-align: left;  font-size:11px; color: red;">&nbsp;REQ {{$mainData->id}}</td>
                    </tr>
                    <tr>
                      <td style="border-color: white; padding: 0; font-weight: bold;  font-size:11px;">Request Tittle</td>
                      <td style="border-color: white; padding: 0;text-align:  left;  font-size:11px;">&nbsp;{{$mainData->request_tittle}}</td>
                    ...
                    <tr>
                      <td style="border-color: white; padding: 0; font-weight: bold;  font-size:11px;">Required on</td>
                      <td style="border-color: white; padding: 0;text-align:  left;  font-size:11px;">&nbsp;{{date('d-m-Y',strtotime($mainData->required_on))}}</td>

                    </tr>
                    <tr>
                      <td style="border-color: white; padding: 0; font-weight: bold; font-size: 11px;">Priority </td>
                      <td style="border-color: white; padding: 0;text-align: left; font-size: 11px;">&nbsp;{{($mainData->request_priority==1)?'Low':''}}{{($mainData->request_priority==2)?'Medium':''}}{{($mainData->request_priority==3)?'High':''}}{{($mainData->request_priority==4)?'Top':''}}
                      </td>
                    </tr>

                    <tr>
                      <td style=" border-color: white;padding: 0; font-size: 11px; font-weight: bold; ">Request against </td>
                      <td style="border-color: white;padding: 0; font-size: 11px; text-align: left;">&nbsp;{{($mainData->request_against==1)?'Personal':''}}{{($mainData->request_against==2)?'Client':''}}{{($mainData->request_against==3)?'Project':''}}{{($mainData->request_against==4)?'Department':''}}{{($mainData->request_against==5)?'Official':''}}</td>
                    </tr>
                      ...
                      <td colspan="2" style="border-color: white; ">
                        ...
                        <table style=" padding:0">
                          ...
                          <tr>
                            ...
                            <td style="border-color: white; padding:0;">&nbsp;</td>
                            <!-- <td style="border-color: white; padding:0; text-align:right;"> <span style="font-weight: bold;">Requested by </span>:{{$mainData->created_name}} <br>Date: {{isset($mainData->quotedate)?date('d-m-Y',strtotime($mainData->quotedate)):''}}</td> -->
                            <td style="border-color: white; padding:0; text-align:right;"> <span style="font-weight: bold;">Created by </span>:{{$mainData->name}} <br>Date: {{isset($mainData->created_at)?date('d-m-Y',strtotime($mainData->created_at)):''}}</td>
                  ...
                  <center>
                    ...
                    <table style="width:100%; border-color: white;  border-spacing: 0; /*padding: 2px;*/ " cellspacing="0" cellpadding="0">
                      <tr style=" ">
                        ...
                        <!-- <td style=" border-color: white; text-align: left; ; border-color: white;   padding: 0px;  font-size: 11px;" width="30%"> الإسم </td> -->
                      </tr>
          ...
          <table style="table-layout: auto; " cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td style="border-color: white;   padding: 1px; text-align: center;">
                <h3 style="letter-spacing: 0px; margin: 0;"> Request </h3>
              </td>
            </tr>
            <tr>
              <td style="border-color: white;   padding: 1px">
          ...
          <div class="str">
            <table>
              <tr>
                ...
                <td style="border-color: white; text-align: left; width: 30%;">Request </td>
              ...
              <tr class="str">
                ...
                <td style="border-color: white;   padding: 2px;">{{$cinvoice_products->item_description}}</td>
              </tr>
              @endforeach
            </table>
            ...
            <div class="row">
              <p style="text-align: justify; font-size: 10px;">{{$mainData->note}}</p>
