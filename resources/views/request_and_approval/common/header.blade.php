                    ...
                    <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
                        <ul class="kt-menu__nav ">
                            ...
                            <li class="kt-menu__item dashboard" aria-haspopup="true">
                                <a href="{{url('/request-approval')}}" class="kt-menu__link ">
                            ...
                            <!-- <li class="kt-menu__item request-list" aria-haspopup="true">
                                <a href="{{url('/request-list')}}" class="kt-menu__link ">
                                    <span class="kt-menu__link-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                <polygon points="0 0 24 0 24 24 0 24" />
                                    ...
                                    <span class="kt-menu__link-text">Requests</span>
                                </a>
                            </li> -->
                            ...
                            <li class="kt-menu__item approval-list" aria-haspopup="true">
                                <a href="{{url('/request-approval-list')}}" class="kt-menu__link ">
                                    <span class="kt-menu__link-icon">
                                        <!-- <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                <polygon points="0 0 24 0 24 24 0 24" />
                            ...
                            <!-- <li class="kt-menu__item  kt-menu__item--submenu settings" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon">
                                ...
                                <div class="kt-menu__submenu  "><span class="kt-menu__arrow"></span>
                                    <ul class="kt-menu__subnav">
                                        <li class="kt-menu__item request-category" aria-haspopup="true">
                                            <a href="{{url('/request-category')}}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Request Category</span>
                                            </a>
                                        </li>
                                        <li class="kt-menu__item request-category-synthesis" aria-haspopup="true">
                                            <a href="{{url('/request-category-synthesis')}}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Approval Synthesis</span>
                                            </a>
                                        </li>
