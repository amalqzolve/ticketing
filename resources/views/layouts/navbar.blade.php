            ...
            <div class="bg-red-700 absolute top-0 right-0 mt-12 -mr-6 shadow rounded-bl rounded-br">
                <div class="hidden h-24 w-48" id="navdropdown">
                    <div class="px-8 py-4 border-t border-red-800">
                        <a href="{{ route('profile') }}" class="flex hover:bg-red-800 items-center pb-3 text-sm text-gray-200 font-semibold">
                        ...
                        <form action="{{ route('logout') }}" method="POST" class="pb-2 hover:bg-red-800">
                            @csrf
