...
<br/>
                         ...
                         <a href="{{url('/')}}/addcustomerdetails" class="btn btn-brand btn-elevate btn-icon-sm">
													<i class="la la-plus"></i>
													{{ __('app.New Record') }}
												</a>

												<a href="{{url('/')}}/customertrash" type="button" class="btn btn-danger btn-elevate btn-icon-sm">
...
<!--begin: Datatable -->
<table class="table table-striped- table-bordered table-hover table-checkable" id="customerdetails_list">
    <thead>
        <tr>
            ...
            <th>{{ __('customer.Customer Category') }} </th>
            <th>{{ __('customer.Sales man') }}</th>
            <th>{{ __('customer.Key Accounts') }}</th>
            <th>{{ __('customer.Customer Name/Company name') }}</th>
            <th>{{ __('customer.Address 1') }}</th>
            <th>{{ __('customer.Address 2') }}</th>
            <th>{{ __('customer.Country') }}</th>
            <th>{{ __('customer.Region') }}</th>
            <th>{{ __('customer.City') }}</th>
            <th>{{ __('customer.Zipcode') }}</th>
            <th>{{ __('customer.Email 1') }}</th>
            <th>{{ __('customer.Email 2') }}</th>
            <th>{{ __('customer.Office Phone 1') }}</th>
            <th>{{ __('customer.Office Phone 2') }}</th>
            <th>{{ __('customer.Mobile 1') }}</th>
            <th>{{ __('customer.Mobile 2') }}</th>
            <th>{{ __('customer.Fax') }} </th>
            <th>{{ __('customer.Website') }}</th>
            <th>{{ __('customer.Contact Person') }}</th>
            <th>{{ __('customer.Person in Charge') }}</th>
            <th>{{ __('customer.Mobile') }}</th>
            <th>{{ __('customer.Office Charge') }}</th>
            <th>{{ __('customer.Department') }}</th>
            <th>{{ __('customer.Email') }}</th>
            <th>{{ __('customer.Location') }}</th>
            
            <th>{{ __('customer.Portal URL') }}</th>
            <th>{{ __('customer.Username') }}</th>
            <th>{{ __('customer.Email') }}</th>
            <th>{{ __('customer.Password') }}</th>

            <th>{{ __('customer.Customer Note') }}</th>
