    ...
    <div class="row" style="margin-top:100px;">
          ...
          <tr>
            <td style="border-color: white;   padding-top: 0; padding-right: 0; padding-bottom: 0;  ">
              <table style=" width: 100%; ">
                <tr>
                  <td style="border-color: white; padding: 0; font-weight: bold;  font-size:11px; width: 30%;">Payment ID.</td>
                  <td style="border-color: white; padding: 0;text-align: left;  font-size:11px; color: red;"> ISS-P {{$mainData->id}}</td>
                  <td style="border-color: white; padding: 0;text-align: right;  font-size:11px; width: 30%;"></td>
                </tr>

                <tr>
                  <td style="border-color: white; padding: 0; font-weight: bold;  font-size:11px; width: 30%;">Receiver Name</td>
                  <td style="border-color: white; padding: 0;text-align: left;  font-size:11px;"> {{$mainData->receiver_name}}</td>
                  <td style="border-color: white; padding: 0;text-align: right;  font-size:11px; width: 30%;"></td>
                </tr>

                <tr>
                  <td style="border-color: white; padding: 0; font-weight: bold;  font-size:11px; width: 30%;"></td>
                  <td style="border-color: white; padding: 0;text-align: left;  font-size:11px;"></td>
                  <td style="border-color: white; padding: 0;text-align: right;  font-size:11px; width: 30%;"></td>
                </tr>
                  ...
                  <td style="border-color: white; ">
                    <table style=" padding:0">
                      ...
                      <tr>
                        ...
                        <td style="border-color: white; padding:0;">&nbsp;</td>
                        <td style="border-color: white; padding:0; text-align:right;"> <span style="font-weight: bold;">Issued by </span>:{{$mainData->created_name}} <br>Date: {{isset($mainData->issued_date)?date('d-m-Y',strtotime($mainData->issued_date)):''}}</td>
                      </tr>
                </tr>
              </table>
            </td>
      ...
      <table>
        <tr>
          ...
          <td style="border-color: white; text-align: left; width: 20%;">Relation With Supplier </td>
          <td style="border-color: white; text-align: left; width: 15%;">Designation </td>
          <td style="border-color: white;  padding: 0; text-align: left; width: 20%;">Department </td>
          <td style="border-color: white;   padding: 0; text-align:  right; width: 7%;">National Id </td>
          <td style="border-color: white;   padding: 0; text-align:  right; width: 7%;">Phone number</td>
          <td style="border-color: white;   padding: 0; text-align:  right; width: 7%;">Issued Date </td>
        </tr>
        <tr class="str">
        ...
        <tr class="str">
          ...
          <td style="border-color: white;   padding: 2px;">{{$mainData->relation_with_supplier}} </td>
          <td style="border-color: white;   padding: 2px;">{{$mainData->designation}}</td>
          <td style="border-color: white;   padding: 2px;">{{$mainData->department}}</td>
          <td style="border-color: white;   padding: 2px; text-align: right">{{$mainData->national_id}}</td>
          <td style="border-color: white;   padding: 2px; text-align: right">{{$mainData->phone_number}}</td>
          <td style="border-color: white;   padding: 2px; text-align: right">{{date('d-m-Y',strtotime($mainData->issued_date))}}</td>
        </tr>
      </table>
      <br>
      <br>
      ...
      <br>
      <div class="row">
        <h4 style="letter-spacing: 0px; margin: 0; text-align: left;">Comments</h4>
        <p style="text-align: justify; font-size: 10px;">{{$mainData->comments}}</p>
      </div>
