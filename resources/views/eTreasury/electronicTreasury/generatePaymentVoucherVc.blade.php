                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <input type="hidden" name="supplier_id" id="supplier_id" class="form-control" value=" {{$mainData->cust_id}}" readonly>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <input type="text" name="amount" id="amount" class="form-control" value="{{$mainData->balanceamount}}" readonly>
                                    </div>
                                </div>
                            </div>
...
<script src="{{url('/')}}/resources/js/e_treasury/electronicTreasury/generatePaymentVoucherVc.js" type="text/javascript"></script>
@endsection