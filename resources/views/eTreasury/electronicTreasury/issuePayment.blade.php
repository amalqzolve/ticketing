            ...
            <form class="kt-form" id="kt_form" name="kt_form">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane p-2 active" id="kt_tabs_2_1" role="tabpanel">
                        ...
                        <input type="hidden" name="voucher_id" id="voucher_id" value="{{$MaterialRequest->id}}">
                        <input type="hidden" name="amount" id="amount" value="{{$MaterialRequest->amount}}">
                        <input type="hidden" name="supplier_id" id="supplier_id" value="{{$MaterialRequest->supplier_id}}">
                        <div class="row">
                            <div class="col-lg-6">
...
<script src="{{url('/')}}/resources/js/e_treasury/electronicTreasury/issuePaymentAdd.js" type="text/javascript"></script>
@endsection