...
foreach($storeavailabe as $storeavailabes)

{

$store = $storeavailabes->storeavailable;
...

{
        ...
        $dateofsupply = $value->dateofsupply;
...
$balanceamount = $value->due_amount;
...

{
  ...
  $buyerid_crno = $invcustomer->cr_no;

  $ar_cust_name = $invcustomer->ar_cust_name;

  $ar_buldingname = $invcustomer->ar_cust_add1;

  $ar_streetname = $invcustomer->ar_cust_add2;

  $ar_cntry_name = $invcustomer->ar_cust_country;

  $ar_district = $invcustomer->ar_cust_region;

  $ar_city = $invcustomer->ar_cust_city;

  $ar_postalcode = $invcustomer->ar_cust_zip;
      ...
      <tr>
        ...
        <table style=" width: 100%; ">
                  ...
                  <tr>
                    ...
                    <td style="border-color: white; padding: 0; font-weight: bold;  font-size:12px;">Invoice Number.</td>



                    <td style="border-color: white; padding: 0;text-align: center;  font-size:12px; color: red;">{{$salesinvoice}}{{ $customer_id }}{{$salesinvoice_sufix}}</td> 
                  ...
                  <tr>
                    ...
                    <td style="border-color: white; padding: 0; font-weight: bold;  font-size:12px;">Invoice issue Date</td>



                    <td style="border-color: white; padding: 0;text-align:  center;  font-size:12px;">{{$quotedate}}</td>



                    <td style="border-color: white; padding: 0;text-align:  right;  font-size:12px;">   تاريخ إصدار الفاتورة     </td>
                    ...
                    <td style="border-color: white; padding: 0; font-weight: bold;  font-size:12px;"> Date of supply</td>



                    <td style="border-color: white; padding: 0;text-align:  center;  font-size:12px;">{{$dateofsupply}}</td>
                   ...
                   <tr>
                    ...
                    <td style="border-color: white; padding: 0;text-align:  center;  font-size:11px;">{{$qtnref}}</td>
                  ...
                  <tr>
                    ...
                    <td style="border-color: white; padding: 0; font-weight: bold;  font-size:11px;">PO/WO Ref</td>



                    <td style="border-color: white; padding: 0;text-align:  center;  font-size:11px;">{{$po_wo_ref}}</td>
  ...
  ?>
    ...
    <img src='{{  $c }}' style="width:80px" >
                  ...
                  <tr>    
                    ...
                    <td style="height:60px; border-color: white; padding:0; font-size: 32px; text-align:right;">
                      ...
                      <strong> Tax Invoice </strong><br> فاتورة ضريبية       </td>
   ...
   <table style="width:100%;" cellspacing="0" cellpadding="0">
         ...
         <td valign="top" style="border-color: white; ">
          ...
          <table style="width:100%; border-color: white;   padding: 2px; " cellspacing="0" cellpadding="0">
            ...
            <tr style=" ">
              ...
              <td  style="border-color: white; border-color: white; text-align: center;  padding: 0px; font-size: 12px;"> <?php echo  $customername; ?></td>
              ...
              <td  style="border-color: white; border-color: white;  text-align: center;    padding: 0px; font-size: 12px;"> <?php echo  $buldingname; ?></td>

              <td  style="border-color: white; border-color: white;  padding: 0px; font-size: 12px;"> <?php echo  $ar_buldingname; ?></td>
      ...
      <tr>
              ...
              <td  style="border-color: white; border-color: white;  text-align: center;    padding: 0px; font-size: 12px;"><?php echo  $streetname; ?></td>

<td  style="border-color: white; border-color: white;  padding: 0px; font-size: 12px;"> <?php echo  $ar_streetname; ?></td>
      ...
      <tr>
              ...
              <td  style="border-color: white; border-color: white; text-align: center;   padding: 0px; font-size: 12px;"><?php echo  $district; ?></td>

<td  style="border-color: white; border-color: white;  padding: 0px; font-size: 12px;"> <?php echo  $ar_district; ?></td>
      ...
      <tr>
              ...
              <td  style="border-color: white; border-color: white;  text-align: center;    padding: 0px; font-size: 12px;"><?php echo  $city; ?></td>

<td  style="border-color: white; border-color: white;  padding: 0px; font-size: 12px;"> <?php echo  $ar_city; ?></td>
   ...
   <tr>
              ...
              <td  style="border-color: white; border-color: white; text-align: center;    padding: 0px; font-size: 12px;"><?php echo  $cntry_name; ?></td>

<td  style="border-color: white; border-color: white;  padding: 0px; font-size: 12px;"> <?php echo  $ar_cntry_name; ?></td>
   ...
   <tr>
              ...
              <td  style="border-color: white; border-color: white;  text-align: center;    padding: 0px; font-size: 12px;"><?php echo  $postalcode; ?></td>

<td  style="border-color: white; border-color: white;  padding: 0px; font-size: 12px;"> <?php echo  $ar_postalcode; ?></td>
   ...
   <tr>
              ...
              <td  style="border-color: white; border-color: white;  text-align: center;    padding: 0px; font-size: 12px;"><?php echo  $vatno; ?></td>
...
<td  style="border-color: white; border-color: white;  padding: 0px; font-size: 12px;"> </td>
   ...
   <tr>
              ...
              <td  style="border-color: white;  border-color: white; text-align: center;  padding: 0px; font-size: 12px;"><?php echo  $buyerid_crno; ?></td>
   ...
   <table>
      ...
      <tr>
       ...
       <td   style="border-color: white;  width: 3%;text-align:left; white-space: nowrap;">#</td>
        ...
        <td  style="border-color: white;  padding: 0;  width: 10%;text-align: left;">Store Name <br> متجر</td>
       ...
       <td  style="border-color: white; text-align: left; width: 25%;">Nature of goods or Services<br> تفاصيل الخدمات         </td>

          <td  style="border-color: white;  padding: 0;  width: 35%;text-align: left;">Description  <br> وصف  </td>
       ...
       <td  style="border-color: white;  padding: 0; width: 5%;text-align: center;">Qty   <br>   الوحدة       </td>

       <td  style="border-color: white;  padding: 0; width: 8%;text-align: center;">Unit price <br>سسعر الوحدة     </td> 

       <td  style="border-color: white;   padding: 0; text-align: center; width: 8%;">Taxable Amount <br>  المبلغ الخاضع للضريبة       </td> 

       <!-- <td  style="border-color: white;   padding: 1px;">VAT%</td> -->

       <td  style="border-color: white;  padding: 0; background-color: white !important;; text-align:center; width: 7%;">Discount   <br>  خصومات       </td>

       <td  style="border-color: white;  padding: 0;  background-color: white !important;; text-align:center; width: 5%;">Tax Rate  <br>  نسبة الضريبة   </td>

       <td  style="border-color: white; width: 7%; padding: 0;  background-color: white !important;; text-align:center; ">Tax Amount  <br> مبلغ الضريبة      </td>

        <td  style="border-color: white;  padding: 0; white: 6%;  background-color: white !important;width: 9%; text-align:right;">Item subtotal<br>(Including VAT)  <br>   المجموع (شامل ضريبة القيمة المضافة)    </td>
     ...
     <tr class="str">
       ...
       <td  style="border-color: white;   padding: 2px; text-align: left;">{{$key+1}}</td>
        ...
        @if($store == 1)
         ...
         @foreach($stores as $data)
          ...
          @if($cinvoice_products->store == $data->id) 
       ...
       <td  style="border-color: white;   padding: 2px; text-align: left;">@foreach($productlist as $data)

       <?php if ($cinvoice_products->itemname == $data->product_id)

        {

          echo $data->product_name; 

          // if(isset($cinvoice_products->description)&&!empty($cinvoice_products->description)&&$cinvoice_products->description!='null'){  echo "-"; echo $cinvoice_products->description;}
            ...
            @endforeach</td>
             ...
             <td  style="border-color: white;   padding: 2px; text-align: justify;"> {{$cinvoice_products->description}} </td>

            

       <td  style="border-color: white;   padding: 2px; text-align: left;"> @foreach($unitlist as $data)

       <?php if ($cinvoice_products->unit == $data->id)

        {

           $uunit= $data->unit_name;
...
<?php if(isset($uunit)&& !empty($uunit)){
...
?>
       ...
       <td  style="border-color: white;   padding: 2px; text-align: center;"> {{$cinvoice_products->quantity}} </td>

       <td  style="border-color: white;   padding: 2px; text-align: right;"> {{$cinvoice_products->rate}}</td> 

       <td  style="border-color: white;   padding: 2px; text-align: right;">{{$cinvoice_products->amount}}</td>

       <td  style="border-color: white;   padding: 2px; text-align: center; "> {{$cinvoice_products->rdiscount}}</td>

        <td  style="border-color: white;   padding: 2px; text-align: center;">15%</td>



       <td  style="border-color: white;   padding: 2px; text-align: right;"> {{$cinvoice_products->vatamount}}</td>

       <td  style="border-color: white;   padding: 2px; text-align: right;"> {{$cinvoice_products->totalamount}}</td>
              ...
              <td style="border-color: white;background-color: white !important; width: 100%; padding: 0; ">
                ...
                <table style="width:100%; background-color: white !important;">
                  ...
                  <tr style="background-color: white !important;">
                    ...
                    <td style="border-color: white; padding: 0;background-color: white !important;text-align:right;">{{$totalamount}}</td>
                   ...
                   <tr style="background-color: white !important;">
                    ...
                    <td style="border-color: white; padding: 0;background-color: white !important;text-align:right;">{{$discount}} </td>
...
<tr style="background-color: white !important;">
                    ...
                    <td style="border-color: white; padding: 0;background-color: white !important;text-align:right;">{{$amountafterdiscount}}</td>
                  ...
                  <tr style="background-color: white !important;">
                    ...
                    <td style="border-color: white; padding: 0;background-color: white !important;text-align:right;">{{$totalvatamount}} </td>
                   ...
                   <tr style="background-color: white !important; ">
                    ...
                    <td style="border-color: white; padding: 0;background-color: white !important;text-align:right; color:red;">{{$grandtotalamount}}</td>
...

                  {
                    ...
                    <td style="border-color: white; padding: 0;background-color: white !important; color:red;">Paid Amount</td>

                    <td style="border-color: white; padding: 0;background-color: white !important;text-align:right; color:red;">{{$paidamount}}</td>

                  </tr>

                  <tr style="background-color: white !important; ">

                    <td style="border-color: white; padding: 0;background-color: white !important; color:red;">Balance Amount</td>

                    <td style="border-color: white; padding: 0;background-color: white !important;text-align:right; color:red;">{{$balanceamount}}</td>
