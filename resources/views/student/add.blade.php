...
<div class="tab-content">
	...
	<div class="col-lg-6">
										...
										<div class="col-md-4">
										<label>@lang('app.Issue Date')</label>
										</div>  
   ...
   <div class="modal-dialog modal-xl" role="document">
    ...
    <thead>
        <tr>
            ...
            <th>Product price</th>
            <th>Selling price</th>            <th>Stock</th>
            <th>WH</th>
            <th>Store</th>
            <th>Rack</th>
            <th>Category</th>
  ...
  // alert(product_name);
      ...
      success: function(data) { 
         ...
         product += '<tr>\
                 ...
                 <td>\
                 <div>\
                 <input type="text" class="form-control form-control-sm single-select unit"  data-id="'+rowcount+'" name="unit[]" id="unit">\
                  </div>\
                 <div class="input-group input-group-sm">\
                 ...
                 <input type="text" class="form-control discountamount"  data-id="'+rowcount+'" name="discountamount[]" id="discountamount'+rowcount+'" value="0">\
                              ...
                              <td><input type="text" class="form-control vat_percentage form-control-sm" name="vat_percentage[]" id="vat_percentage'+rowcount+'" data-id='+rowcount+' value="" >\
                <td>\
