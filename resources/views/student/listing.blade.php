...
<br/>
					   ...
					   <a href="{{url('/')}}/Add-newinvoice" class="btn btn-brand btn-elevate btn-icon-sm">
...
<!--begin: Datatable -->
<table class="table table-striped table-hover table-checkable dataTable no-footer" id="studentinvoicedetails_list">
	<thead>
		<tr>
