			...
			<div class="kt-portlet__head-toolbar">
				<div class="kt-portlet__head-wrapper">
					...
					<div class="kt-portlet__head-actions">
						...
						<a href="{{url('/')}}/vendorgrouptrash" type="button" class="btn btn-secondary btn-hover-warning btn-icon-sm">@lang('app.Trash')
						</a>
					</div>
				</div>
			</div>
	...
	<div class="modal-dialog modal-xl" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel">{{ __('vendor.VendorGroupDetailsForm') }}</h5>
						...
						<div class="form-group row">
							<div class="col-lg-6">
								<div class="form-group row pr-md-3">
									<div class="col-md-4">
										<label>{{ __('vendor.Title') }}<span style="color: red">*</span></label>
									</div>
									<div class="col-md-8">
										<div class="input-group  input-group-sm">
											<input type="text" class="form-control" placeholder="{{ __('vendor.Title') }}" id="title" name="title" autocomplete="">
										</div>
									</div>
								</div>
							</div>
							<div class="col-lg-6">
								<div class="form-group row pl-md-3">
									...
									<div class="col-md-8">
										<div class="input-group  input-group-sm">
											<input type="text" class="form-control" placeholder="Color" id="color" name="color" data-wheelcolorpicker="" autocomplete="" style="padding-top: 0px;">
										</div>
									</div>
								</div>
							</div>
			...
			<div class="modal-footer">
				<button id="VendorGroup_submit" class="btn btn-brand kt-spinner--right kt-spinner--sm kt-spinner--light">{{ __('app.Save') }}</button>
...
<script src="{{url('/')}}/resources/js/crm/VendorGroup.js" type="text/javascript"></script>
@endsection