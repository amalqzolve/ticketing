			...
			<div class="kt-portlet__body kt-portlet__body--fit nborder">
												...
												<div class="row" style="padding-bottom: 6px;">
													...
													<div class="col-lg-6">
														<div class="form-group row pr-md-3">
															...
															<div class="col-md-8">
																<div class="input-group input-group-sm">
																	<input type="text" class="form-control" placeholder="{{ __('salesman.Place') }} " id="place" name="place" autocomplete="off">
																</div>
															</div>
														</div>
													</div>
			 ...
			 <option value="{{$key->id}}">{{$key->name}}
									  ...
									  <div class="form-group row pl-md-3">
										...
										<div class="col-md-8">
											<div class="input-group input-group-sm">
											  <input type="text" class="form-control" placeholder="{{ __('salesman.Department Head') }} " id="department_head" name="department_head" autocomplete="off">
											</div>
										</div>
									  </div>
									</div> -->
															...
															<div class="col-md-8">
																<div class="input-group input-group-sm">
																	<select class="form-control single-select" id="salesman_route" name="salesman_route">
																		<option value="">{{ __('customer.Select') }}
																		</option>@foreach ($salesman_route as $key)
																		<option value="{{$key->id}}">{{$key->routename}}
																		</option>@endforeach
																	</select>
																</div>
															</div>
													...
													<div class="col-lg-6">
														<div class="form-group row pl-md-3">
															...
															<div class="col-md-8">
																<div class="input-group input-group-sm">
																	<input type="number" class="form-control" placeholder="{{ __('salesman.Salesman Commission') }} " id="commission" name="commission" autocomplete="off">
																</div>
															</div>
														</div>
													</div>
													...
													<div class="col-lg-6">
														<div class="form-group row pr-md-3">
															...
															<div class="col-md-8">
																<div class="input-group input-group-sm">
																	<input type="number" class="form-control" placeholder="{{ __('app.Target') }} " id="target" name="target" autocomplete="off">
																</div>
															</div>
														</div>
													</div>
								...
								<div class="row">
									...
									<div class="col-lg-6">
									  <div class="form-group row pr-md-3">
										...
										<div class="col-md-8">
											<div class="input-group input-group-sm">
											  <input type="text" class="form-control" name="ledgercode" id="ledgercode" placeholder="Ledger Code">
											</div>
										</div>
									  </div>
									</div>
