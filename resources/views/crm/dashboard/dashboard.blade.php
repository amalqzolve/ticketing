				...
				<div class="kt-grid__item kt-grid__item--fluid kt-wizard-v3__wrapper" style="background-color: #f2f3f8;">
					...
					<form class="kt-form" id="kt_form" style="width: 100%; padding:0;">
						...
						<div class="kt-wizard-v3__content fadeIn" data-ktwizard-type="step-content" data-ktwizard-state="current">
							<div class="row mt-3">
								<div class="col-md-4">
									<a href="{{url('/')}}/customerdetails" class="white-link">
								...
								<div class="col-md-4">
									<a href="{{url('/')}}/supplierdetails" class="white-link">
										<div class="card  dashboard-icon-widget">
											<div class="card-body">
								...
								<div class="col-md-4">
									<a class="contact-widget-link" data-filter="logged_in_seven_days" href="{{url('/')}}/salesmandetailssettings">
										<div class="card dashboard-icon-widget">
											<div class="card-body">
							...
							<div class="row mt-3">
								<div class="col-md-6">
									<a class="client-widget-link" data-filter="has_unpaid_invoices" href="{{url('/')}}/salesmanroutesettings">
										<div class="card">
								...
								<div class="col-md-6">
									<a class="client-widget-link" data-filter="has_partially_paid_invoices" href="{{url('/')}}/settingsDepartment">
										<div class="card">
											<div class="card-body p20">
												<div class="widget-title p0 text-default">
							...
							<div class="row mt-3">
									...
									<div class="card bg-white">
										...
										<div class="card-body pt0 rounded-bottom ps" id="projects-container" style="height: 182px; position: relative;">
											<ul class="list-group list-group-flush">
												<a class="client-widget-link" data-filter="has_open_projects" href="{{url('/')}}/settingscustomergroup">
													<li class="list-group-item text-default">
														...
														Customer Group <span class="float-end text-primary">{{$cgroup}}</span>
													</li>
												</a>
												<a class="client-widget-link" data-filter="has_completed_projects" href="{{url('/')}}/settingscustomertypedetails">
													<li class="list-group-item border-top text-default">
														...
														Customer Type <span class="float-end text-success">{{$ctype}}</span>
													</li>
												</a>
												<a class="client-widget-link" data-filter="has_any_hold_projects" href="{{url('/')}}/settingscustomercategorydetails">
													<li class="list-group-item border-top text-default">
														...
														Customer Category <span class="float-end text-warning">{{$ccategory}}</span>
													</li>
												</a>
								...
								<div class="col-md-6 mb-3">
									<div class="card bg-white">
										...
										<div class="card-body pt0 rounded-bottom ps" id="projects-container" style="height: 182px; position: relative;">
											<ul class="list-group list-group-flush">
												<a class="client-widget-link" data-filter="has_open_projects" href="{{url('/')}}/settingssuppliergroup">
													<li class="list-group-item text-default">
														<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-grid icon-18 me-2">
															<rect x="3" y="3" width="7" height="7"></rect>
															<rect x="14" y="3" width="7" height="7"></rect>
														...
														Supplier Group<span class="float-end text-primary">{{$sgroup}}</span>
													</li>
												</a>
												<a class="client-widget-link" data-filter="has_completed_projects" href="{{url('/')}}/settingssupplier_type">
													<li class="list-group-item border-top text-default">
														<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check-circle icon-18 me-2">
															<path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path>
															<polyline points="22 4 12 14.01 9 11.01"></polyline>
														</svg>
														Supplier Type <span class="float-end text-success">{{$stype}}</span>
													</li>
												</a>
												<a class="client-widget-link" data-filter="has_any_hold_projects" href="{{url('/')}}/settingssuppliercategory">
													<li class="list-group-item border-top text-default">
														<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-pause-circle icon-18 me-2">
															<circle cx="12" cy="12" r="10"></circle>
															<line x1="10" y1="15" x2="10" y2="9"></line>
														...
														Supplier Category <span class="float-end text-warning">{{$scategory}}</span>
													</li>
												</a>
								...
								<div class="col-md-6 mb-3">
									<div class="card bg-white">
										...
										<div class="card-body pt0 rounded-bottom ps" id="projects-container" style="height: 182px; position: relative;">
											<ul class="list-group list-group-flush">
												<a class="client-widget-link" data-filter="has_open_projects" href="{{url('/')}}/crmcustomerdocuments">
													<li class="list-group-item text-default">
														<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-grid icon-18 me-2">
															<rect x="3" y="3" width="7" height="7"></rect>
															<rect x="14" y="3" width="7" height="7"></rect>
														...
														Total Documents <span class="float-end text-primary">{{$total}}</span>
													</li>
												</a>
												<a class="client-widget-link" data-filter="has_completed_projects" href="{{url('/')}}/crmcustomerdocuments">
													<li class="list-group-item border-top text-default">
														<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check-circle icon-18 me-2">
															<path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path>
															<polyline points="22 4 12 14.01 9 11.01"></polyline>
														</svg>
														Total Active Documents <span class="float-end text-success">{{$ac}}</span>
													</li>
												</a>
												<a class="client-widget-link" data-filter="has_any_hold_projects" href="{{url('/')}}/crmcustomerdocuments">
													<li class="list-group-item border-top text-default">
														<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-pause-circle icon-18 me-2">
															<circle cx="12" cy="12" r="10"></circle>
															<line x1="10" y1="15" x2="10" y2="9"></line>
														...
														Total Expired Documents <span class="float-end text-warning">{{$exp}}</span>
													</li>
												</a>
								...
								<div class="col-md-6 mb-3">
									<div class="card bg-white">
										...
										<div class="card-body pt0 rounded-bottom ps" id="estiamte-widget-container" style="height: 182px; position: relative;">
											<ul class="list-group list-group-flush">
												<a class="client-widget-link" data-filter="has_open_estimates" href="{{url('/')}}/supplierdocuments">
													<li class="list-group-item text-default">
														...
														Total documents <span class="float-end text-warning">{{$totals}}</span>
													</li>
												</a>
												<a class="client-widget-link" data-filter="has_accepted_estimates" href="{{url('/')}}/supplierdocuments">
													<li class="list-group-item border-top text-default">
														<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check-circle icon-18 me-2">
															<path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path>
															<polyline points="22 4 12 14.01 9 11.01"></polyline>
														</svg>
														Total Active Documents <span class="float-end text-success">{{$acs}}</span>
													</li>
												</a>
												<a class="client-widget-link" data-filter="has_new_estimate_requests" href="{{url('/')}}/supplierdocuments">
													<li class="list-group-item border-top text-default">
														...
														Total Expired Documents <span class="float-end text-primary">{{$exps}}</span>
													</li>
												</a>
...
@section('script')
<script>
	$('.crm').addClass('kt-menu__item--active');
</script>
