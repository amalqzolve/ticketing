					...
					<div class="kt-portlet__head">
						<div class="kt-portlet__head-label"> <span class="kt-portlet__head-icon kt-hide">
							...
							<h3 class="kt-portlet__head-title">
								{{ __('customer.Customer Information') }}
							</h3>
						</div>
					</div>
							...
							<div class="kt-section__content">
								...
								<div class="row">
									<div class="col-md-8 about-me section">
										<h2><?php echo isset($data->cust_name) ? $data->cust_name : ''; ?></h2>
										<blockquote>
											<p class="lede"><?php echo isset($data->cust_code) ? $data->cust_code : ''; ?></p>
										...
										<ul class="soft-skills">
											<li class="skill">
												<div>
													<h3><?php echo isset($data->custcategory) ? $data->custcategory : '';  ?></h3><br>
													<p>
														Customer Category
													</p>
												</div>
											...
											<li class="skill">
												<div>
													<h3><?php echo isset($data->customertype) ? $data->customertype : '';  ?></h3><br>
													<p>
														Customer Type
													</p>
												</div>
