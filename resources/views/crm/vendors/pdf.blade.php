...
<?php
	...
	<div class="col-md-4 personal-info section">
					<h2>{{ __('customer.General Information') }}</h2>
						<table class="address">
						<tr>
							<th>{{ __('customer.Vendor Code') }}</th>
							<td><?php echo isset($data->vendor_code) ? $data->vendor_code : ''; ?></td>

						</tr>
						<tr>
							<th>{{ __('customer.Category') }}</th>
							<td><?php echo isset($data->vendorcategory) ? $data->vendorcategory : ''; ?></td>
						...
						<tr>
							...
							<td><?php echo isset($data->vendortype) ? $data->vendortype : ''; ?> </td>
		...
		<h2>{{ __('customer.Contact Information') }}</h2>
						<table>
								...
								<th>{{ __('customer.Designation') }}</th>
										...
										<tbody>
											<tr>
												<td>{{$vendorcontacts->	contact_personvalue}}</td>
