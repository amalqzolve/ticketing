@extends('crm.common.layout')
	@section('content')
	<style>@import url(https://fonts.googleapis.com/css?family=Roboto:400,300,100,500,500italic,400italic,300italic,100italic);
	...
	foreach($users as $data)
	{
		...
		<div class="row">
				<div class="col-md-8 about-me section">
						<h2><?php echo isset($data->vendor_name) ? $data->vendor_name : ''; ?></h2>
						<blockquote>
								<p class="lede"><?php echo isset($data->vendor_code) ? $data->vendor_code : ''; ?></p>
						...
						<ul class="soft-skills">
								<li class="skill">
										<div>
												<h3><?php echo isset($data->vendorcategory) ? $data->vendorcategory : '';  ?></h3><br>
												<p>
														Vendor Category
												</p>
										</div>
								...
								<li class="skill">
										<div>
												<h3><?php echo isset($data->grouptitle) ? $data->grouptitle : ''; ?></h3><br>
												<p>
														Vendor Group
												</p>
										</div>
								...
								<li class="skill">
										<div>
												<h3><?php echo isset($data->vendortype) ? $data->vendortype : '';  ?></h3><br>
												<p>
														Vendor Type
												</p>
										</div>
				...
				<div class="col-md-4 personal-info section">
						<h2>{{ __('customer.Vendor Information') }}</h2>
						<table class="address">
						<tr>
							<th>{{ __('customer.Vendor Name') }}</th>
							<td><?php echo isset($data->vendor_name) ? $data->vendor_name : ''; ?></td>
						</tr>
						<tr>
							<th>{{ __('customer.Address') }}</th>
							<td><?php echo isset($data->vendor_add1) ? $data->vendor_add1 : ''; ?>&nbsp;<?php echo isset($data->vendor_add2) ? $data->vendor_add2 : ''; ?>&nbsp;<?php echo isset($data->vendor_region) ? $data->vendor_region : ''; ?>&nbsp;<?php echo isset($data->vendor_city) ? $data->vendor_city : ''; ?>&nbsp;<?php echo isset($data->country) ? $data->country : ''; ?>&nbsp;<?php echo isset($data->vendor_zip) ? $data->vendor_zip : ''; ?></td>
						...
						<tr>
							...
							<td><?php echo isset($data->mobile1) ? $data->mobile1 : ''; ?> &nbsp; <?php echo isset($data->mobile2) ? $data->mobile2 : ''; ?></td></tr>
						<tr>
						...
						<!-- <dl class="info-lines">
								<ul>
										...
										<li class="info-line">
												...
												<dd><?php echo isset($data->vendor_name) ? $data->vendor_name : ''; ?></dd>
										</li>
										<li class="info-line">
		...
		<div class="row footer">
				...
				<h2>{{ __('customer.Contact Information') }}</h2>
						<table class="table"  style="color: white; font-size: 10px;">
								<thead>
								<tr>
								<th><h5><b>{{ __('customer.Contact Person') }}</b></h5></th>
								<th><h5><b>{{ __('customer.Mobile Number') }}</b></h5></th>
								<th><h5><b>{{ __('customer.Office Number') }}</b></h5></th>
								<th><h5><b>{{ __('customer.Email') }}</b></h5></th>
								<th><h5><b>{{ __('customer.Department') }}</b></h5></th>
								<th><h5><b>{{ __('customer.Designation') }}</b></h5></th>
										</tr>
								</thead>
								
										@foreach($vendorcontact as $vendorcontacts)
										<tbody>
											<tr>
												<td>{{$vendorcontacts->contact_person_incharges}}</td>
												<td>{{$vendorcontacts->mobiles}}</td>
												<td>{{$vendorcontacts->offices}}</td>
												<td>{{$vendorcontacts->emails}}</td>
												<td>{{$vendorcontacts->departments}}</td>
												<td>{{$vendorcontacts->locations}}</td>
