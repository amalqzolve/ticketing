	...
	<div class="kt-portlet kt-portlet--mobile">
		<div class="kt-portlet__head kt-portlet__head--lg">
			<div class="kt-portlet__head-label"> <span class="kt-portlet__head-icon">
				...
				<h3 class="kt-portlet__head-title">{{ __('vendor.Vendor Information') }}
										</h3>
			</div>
			<div class="kt-portlet__head-toolbar">
				<div class="kt-portlet__head-wrapper">
					<div class="kt-portlet__head-actions">
						...
						<a href="{{url('/')}}/addvendordetails" class="btn btn-brand btn-elevate btn-icon-sm"> <i class="la la-plus"></i>
							{{ __('vendor.NewRecord') }}</a>
						...
						<a href="vendorInfoTrash" type="button" class="btn btn-secondary btn-hover-warning btn-icon-sm"> @lang('app.Trash')
						</a>
					</div>
				</div>
			</div>
		...
		<div class="kt-portlet__body">
			<table class="table table-striped  table-hover table-checkable" id="vendordetails_list">
				<thead>
					<tr>
					   
						<th>{{ __('app.Sl. No') }}</th>
						<th>{{ __('vendor.VendorName') }}</th>
						<th>{{ __('customer.Name Alias') }}</th>
						<th>{{ __('customer.Mobile') }}</th>
						<th>{{ __('customer.Group') }}</th>
						<th>{{ __('vendor.Category') }}</th>
