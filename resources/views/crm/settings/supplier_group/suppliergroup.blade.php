...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
	...
	<div class="kt-portlet kt-portlet--mobile">
			...
			<div class="kt-portlet__head-toolbar">
				<div class="kt-portlet__head-wrapper">
					<div class="kt-portlet__head-actions">
						@can('Supplier Group Add')
						<button type="button" class="btn btn-brand btn-elevate btn-icon-sm" data-type="add" data-toggle="modal" data-target="#kt_modal_4_10"><i class="la la-plus"></i>{{ __('app.New Records') }}</button>@endcan
						...
						<!-- <a href="{{url('/')}}/settingssuppliertrashshows" type="button" class="btn btn-secondary btn-hover-warning btn-icon-sm">@lang('app.Trash')
						</a> -->
					</div>
				</div>
			</div>
		...
		<div class="kt-portlet__body">
			<table class="table table-striped  table-hover table-checkable" id="suppliergroup_list">
				<thead>
					<tr>
						<th><strong>{{ __('app.S.No') }}</strong></th>
						<th><strong>{{ __('app.Supplier Group') }}</strong></th>
	...
	<div class="modal-dialog modal-xl" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel">{{ __('supplier.Supplier Group') }}</h5>
						...
						<div class="form-group row">
								...
								<div class="form-group row pr-md-3">
									...
									<div class="col-md-8">
										<div class="input-group  input-group-sm">
											<input type="text" class="form-control" placeholder="{{ __('supplier.Supplier Group') }} " id="title" name="title">
										</div>
									</div>
								</div>
							</div>
							<div class="col-lg-6">
								<div class="form-group row pl-md-3">
									...
									<div class="col-md-8">
										<div class="input-group  input-group-sm">
											<input type="text" data-wheelcolorpicker="" class="form-control " id="color" name="colour" placeholder="{{ __('app.Colour') }}" autocomplete="off">
										</div>
									</div>
								</div>
							</div>
			...
			<div class="modal-footer">
				...
				<button type="submit" id="suppliergroupdetail_submit" class="btn btn-primary float-right mr-2"><svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check-circle icon-16">
...
<script>
	...
	$('.settingssuppliergroup').addClass('kt-menu__item--active');
</script>
@endsection