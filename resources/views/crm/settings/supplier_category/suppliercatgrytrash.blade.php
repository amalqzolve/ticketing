...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
	...
	<div class="kt-portlet kt-portlet--mobile">
		<div class="kt-portlet__head kt-portlet__head--lg">
			<div class="kt-portlet__head-label">
				...
				<h3 class="kt-portlet__head-title">
					{{ __('app.Supplier Category Trash Details List') }}
				</h3>
			</div>
						...
						<div class="dropdown dropdown-inline">
							...
							<div class="dropdown-menu dropdown-menu-right">
								<ul class="kt-nav">
									...
									<li class="kt-nav__item" id="trashdetailslistsuppliercategory_print"> <span href="#" class="kt-nav__link">
											<i class="kt-nav__link-icon la la-print"></i>
											<span class="kt-nav__link-text">@lang('app.Print')</span>
										</span>
									</li>
									<li class="kt-nav__item" id="trashdetailslistsuppliercategory_copy"> <span class="kt-nav__link">
											<i class="kt-nav__link-icon la la-copy"></i>
											<span class="kt-nav__link-text">@lang('app.Copy')</span>
										</span>
									</li>
									<li class="kt-nav__item" id="trashdetailslistsuppliercategory_csv">
										<a href="#" class="kt-nav__link"> <i class="kt-nav__link-icon la la-file-text-o"></i>
											<span class="kt-nav__link-text">@lang('app.CSV')</span>
										</a>
									</li>
									<li class="kt-nav__item" id="trashdetailslistsuppliercategory_pdf"> <span class="kt-nav__link">
		...
		<div class="kt-portlet__body">
			<table class="table table-striped  table-hover table-checkable" id="sup_ctgrytrashtype">
				<thead>
					<tr>
						<th>{{ __('supplier.S.No') }}</th>
						<th>{{ __('supplier.Supplier Category') }}</th>
						<th>{{ __('app.Note') }}</th>
						<th>{{ __('app.Colour') }}</th>
