    ...
    <div class="kt-portlet__head kt-portlet__head--lg">
      ...
      <div class="kt-portlet__head-toolbar">
        ...
        <span class="kt-nav__link-text">@lang('app.PDF')</span>
            ...
            <a href="{{url('/')}}/paymentmenttrashdetails" type="button" class="btn btn-secondary btn-hover-warning btn-icon-sm">@lang('app.Trash')
            </a>
          </div>
        </div>
      </div>
  ...
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">@lang('customer.Payment Details Form')</h5>
...
<script src="{{url('/')}}/resources/js/crm/PaymentTerms.js" type="text/javascript"></script>@endsection