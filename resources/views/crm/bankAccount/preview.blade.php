    ...
    <div class="row" style="margin-top:100px;">
          ...
          <tr>
            <td style="border-color: white;   padding-top: 0; padding-right: 0; padding-bottom: 0;  ">
              <table style=" width: 100%; ">
                ...
                <tr>
                  <td style="border-color: white; padding: 0; font-weight: bold;  font-size:11px; width: 30%;">Beneficiary Name</td>
                  <td style="border-color: white; padding: 0;text-align: left;  font-size:11px; color: red;"> {{$mainData->beneficiary_name}}</td>
                  <td style="border-color: white; padding: 0;text-align: right;  font-size:11px; width: 30%;"></td>
                </tr>
                <tr>
                  <td style="border-color: white; padding: 0; font-weight: bold;  font-size:11px; width: 30%;">Account Number</td>
                  <td style="border-color: white; padding: 0;text-align: left;  font-size:11px;"> {{$mainData->account_number}}</td>
                  <td style="border-color: white; padding: 0;text-align: right;  font-size:11px; width: 30%;"></td>
                </tr>
                <tr>
                  <td style="border-color: white; padding: 0; font-weight: bold;  font-size:11px; width: 30%;">IBAN/ Siwft</td>
                  <td style="border-color: white; padding: 0;text-align: left;  font-size:11px;"> {{$mainData->iban_swift_code}}</td>
                  <td style="border-color: white; padding: 0;text-align: right;  font-size:11px; width: 30%;"></td>
                </tr>
              </table>
            </td>
                  ...
                  <td style="border-color: white; ">
                    <table style=" padding:0">
                      ...
                      <tr>
                        ...
                        <td style="border-color: white; padding:0;">&nbsp;</td>
                        <td style="border-color: white; padding:0; text-align:right;"> <span style="font-weight: bold;">Created by </span>:{{$mainData->created_name}} <br>Date: {{isset($mainData->created_at)?date('d-m-Y',strtotime($mainData->created_at)):''}}</td>
                      </tr>
                </tr>
              </table>
            </td>
      ...
      <table style="table-layout: auto; " cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td style="border-color: white;   padding: 1px; text-align: center;">
            <h3 style="letter-spacing: 0px; margin: 0;">Bank Details </h3>
          </td>
        </tr>
        <tr>
          <td style="border-color: white;   padding: 1px">
      ...
      <div class="str">
        <table>
          ...
          <!-- <tr class="str">
            <td style="border-color: white;   padding: 2px;" width="20%">Account Number</td>
            <td style="border-color: white;   padding: 2px;" width="80%">{{$mainData->account_number}}</td>
          </tr> -->
          <tr class="str">
            <td style="border-color: white;   padding: 2px;" width="30%">Bank Name</td>
            <td style="border-color: white;   padding: 2px;" width="70%">{{$mainData->bank_name}}</td>
          </tr>
          <tr class="str">
            <td style="border-color: white;   padding: 2px;" width="30%">Branch Name</td>
            <td style="border-color: white;   padding: 2px;" width="70%">{{$mainData->branch_name}}</td>
          </tr>
          <tr class="str">
            <td style="border-color: white;   padding: 2px;" width="30%">Branch Code</td>
            <td style="border-color: white;   padding: 2px;" width="70%">{{$mainData->branch_code}}</td>
          </tr>
          <!-- <tr class="str">
            <td style="border-color: white;   padding: 2px;" width="30%">IBAN/ Siwft</td>
            <td style="border-color: white;   padding: 2px;" width="70%">{{$mainData->iban_swift_code}}</td>
          </tr> -->
          <tr class="str">
            <td style="border-color: white;   padding: 2px;" width="30%">Bank Address</td>
            <td style="border-color: white;   padding: 2px;" width="70%">{{$mainData->bank_address}}</td>
          </tr>
          <tr class="str">
            <td style="border-color: white;   padding: 2px;" width="30%">@lang('app.Notes')</td>
            <td style="border-color: white;   padding: 2px;" width="70%">{{$mainData->notes}}</td>
          </tr>
