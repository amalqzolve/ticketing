...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
	...
	<div class="kt-portlet kt-portlet--mobile">
		<div class="kt-portlet__head kt-portlet__head--lg">
			<div class="kt-portlet__head-label"> <span class="kt-portlet__head-icon">
				...
				<h3 class="kt-portlet__head-title">
					{{ __('customer.Documents & Contracts') }}
				</h3>
			</div>
						...
						<div class="dropdown dropdown-inline">
							...
							<div class="dropdown-menu dropdown-menu-right">
								<ul class="kt-nav">
									...
									<li class="kt-nav__item" id="supplierdocuments_list_print"> <span href="#" class="kt-nav__link">
											<i class="kt-nav__link-icon la la-print"></i>
											<span class="kt-nav__link-text">Print</span>
										</span>
									</li>
									<li class="kt-nav__item" id="supplierdocuments_list_copy"> <span class="kt-nav__link">
											<i class="kt-nav__link-icon la la-copy"></i>
											<span class="kt-nav__link-text">Copy</span>
										</span>
									</li>
									<li class="kt-nav__item" id="supplierdocuments_list_csv">
										<a href="#" class="kt-nav__link"> <i class="kt-nav__link-icon la la-file-text-o"></i>
											<span class="kt-nav__link-text">CSV</span>
										</a>
									</li>
									<li class="kt-nav__item" id="supplierdocuments_list_pdf"> <span class="kt-nav__link">
		...
		<div class="kt-portlet__body">
			<table class="table table-striped  table-hover table-checkable" id="supplierdocuments_list">
				<thead>
					<tr role="row">

						<th class="dt-left sorting_disabled">{{ __('customer.S.No') }}</th>
						<th>{{ __('supplier.Supplier Name') }}</th>
						<th>{{ __('customer.Total Documents') }}</th>
						<th>{{ __('customer.Total Expired') }}</th>
						<th>{{ __('customer.Total Active') }}</th>
