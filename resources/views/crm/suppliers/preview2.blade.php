...
<head>
  ...
  foreach ($users as $data) {
    ...
    $customername = $data->sup_name;
    $cust_add1 = $data->sup_add1;
    $cust_add2 = $data->sup_add2;
    $cust_region = $data->sup_region;
    $cust_city = $data->sup_city;
    $cust_country = $data->country;
    $cust_zip = $data->sup_zip;
    $vatno = $data->vatno;
    $crno = $data->buyerid_crno;
    $additionalno = $data->additionalno;
    $province_state = $data->sup_state;

    $ar_cust_name = $data->sup_name_ar;
    $ar_cust_add1 = $data->sup_add1_ar;
    $ar_cust_add2 = $data->sup_add2_ar;
    $ar_cust_region = $data->sup_region_ar;
    $ar_cust_city = $data->sup_city_ar;
    $ar_cust_zip = $data->sup_zip_ar;
    $ar_cust_country = $data->sup_country_ar;
    $ar_additionalno = $data->additionalno_ar;
    $ar_vatno = $data->vatno_ar;
    $ar_crno = $data->buyerid_crno_ar;
    $ar_province_state = $data->sup_state_ar;
    ...
    <div class="row" style="margin-top:0px;">
          ...
          <tr>
            ...
            <td style="border-color: white;   padding-top: 0; padding-right: 0; padding-bottom: 0; padding-left: 20; ">
              ...
              <table style=" width: 100%; ">
                <tr>
                  <td style="border-color: white; padding: 0; font-weight: bold;  font-size:11px; width: 30%;">Supplier Code</td>
                  <td style="border-color: white; padding: 0;text-align: center;  font-size:11px; color: red;">{{$custcode}}</td>
                  <td style="border-color: white; padding: 0;text-align: right;  font-size:11px; width: 30%;">كود المورد
                  </td>
            ...
            <td valign="top" style="border-color: white; ">
              ...
              <table style="width:100%; border-color: white;   padding: 2px; " cellspacing="0" cellpadding="0">
                ...
                <tr>
                  ...
                  <td style="border-color: white;  border-color: white;   padding: 0px; font-size: 12px;">{{$ar_crno}}</td>
      ...
      <table style=" width: 100%; ">
        <tr>
          ...
          <td style="border-color: white; padding: 0;text-align: center;  font-size:11px; color: red;">{{$email1}}</td>
      ...
      <div class="str">
        <table>
          ...
          @foreach($suppliercontact as $key=>$customercontacts)
