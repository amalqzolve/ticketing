...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
	...
	<div class="kt-portlet kt-portlet--mobile">
		...
		<div class="kt-portlet__body">
			<table class="table table-striped table-hover table-checkable" id="supplier_docs_details_list">
				<thead>
					<tr role="row">
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		var supplier_docs_details_list_table = $('#supplier_docs_details_list').DataTable({
			processing: true,
			serverSide: false,
