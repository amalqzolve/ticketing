				...
				<div class="kt-grid kt-wizard-v1 kt-wizard-v1--white" id="kt_wizard_v1" data-ktwizard-state="step-first">
					<div class="kt-grid__item">
						<div class="kt-wizard-v1__nav">
							...
							if (isset($userInfo->sup_country)) {
								$sup_country = $userInfo->sup_country;
							} else {
								$sup_country = '';
							}
							...
							if (isset($userInfo->invoice_country)) {
								$invoice_country = $userInfo->invoice_country;
							} else {
								$invoice_country = '';
							}
							if (isset($userInfo->shipping_country)) {
								$shipping_country = $userInfo->shipping_country;
							} else {
								$shipping_country = '';
							}
							if (isset($userInfo->sup_note)) {
								$sup_note = $userInfo->sup_note;
							} else {
								$sup_note = '';
							}

							$account_ledger = $userInfo->account_ledger;
							?>
								...
								<form class="kt-form" id="kt_form">
														...
														<div class="form-group row  pr-md-3">
															...
															<div class="col-md-8 input-group input-group-sm">
																<select class="form-control single-select" id="sup_type" name="sup_type">
																	<option value="">{{ __('supplier.Select') }}</option>
																	@foreach($areaLists as $item)
																	<?php if ($item->id != $sup_type) { ?>
																		<option value="{{$item->id}}">{{$item->title}}</option>
																	<?php } else { ?>
																		<option value="{{$item->id}}" selected>{{$item->title}}</option>
																	<?php } ?>
														...
														<div class="form-group row pl-md-3">
															...
															<div class="col-md-8  input-group input-group-sm">
																<select class="form-control single-select" name="sup_note" id="sup_note">
																	...
																	<option value="{{$grp->id}}" @if($sup_note==$grp->
																		id) {{"selected"}} @endif>
																		{{$grp->title}}
																	</option>@endforeach
																</select>
														...
														<div class="form-group row  pl-md-3">
															...
															<div class="col-md-8 input-group input-group-sm">
																<select class="form-control single-select" id="key_account" name="key_account">
																	...
																	<option value="{{$item->id}}" <?php if ($key_ac == $item->id) {
																										echo "selected";
																									}
																									?>>
																		{{$item->name}}
									...
									<div class="kt-wizard-v1__content p-0" data-ktwizard-type="step-content">
											...
											<div class="kt-wizard-v1__form">
												...
												<div class="row">
														...
														<div class="form-group row pr-md-3">
															...
															<div class="col-md-8 ">
																<div class="input-group input-group-sm">
																	...
																	<input type="text" class="form-control" id="sup_name" name="sup_name" autocomplete="off" placeholder="{{ __('supplier.Supplier Name/Company name') }}" value="{{isset($userInfo->sup_name)?$userInfo->sup_name:''}}">
																</div>
															</div>
														</div>
													</div>
													<div class="col-lg-6">
														<div class="form-group row pr-md-3">
															<div class="col-md-4">
																<label>{{ __('supplier.Supplier Name') }}{{ __('customer.Arabic') }}<span style="color: red">*</span></label>
															</div>
															<div class="col-md-8 ">
																<div class="input-group input-group-sm">
														...
														<div class="form-group row pr-md-3">
															...
															<div class="col-md-8">
																<div class="input-group  input-group-sm">
																	...
																	<input type="text" class="form-control" autocomplete="off" id="sup_add1" name="sup_add1" onchange="myFunctions(this.value)" value="{{isset($userInfo->sup_add1)?$userInfo->sup_add1:''}}" placeholder="{{ __('customer.Building No') }}">
																</div>
															</div>
														</div>
													</div>
														...
														<div class="form-group row pr-md-3">
															...
															<div class="col-md-8">
																<div class="input-group  input-group-sm">
																	...
																	<input type="text" class="form-control" autocomplete="off" placeholder="{{ __('customer.Building No') }}{{ __('customer.Arabic') }}" id="sup_add1_ar" name="sup_add1_ar" onchange="myFunctions(this.value)" value="{{isset($userInfo->sup_add1_ar)?$userInfo->sup_add1_ar:''}}">
																</div>
															</div>
														</div>
													</div>
														...
														<div class="form-group row pr-md-3">
															...
															<div class="col-md-8">
																<div class="input-group  input-group-sm">
																	...
																	<input type="text" class="form-control" autocomplete="off" id="sup_add2" name="sup_add2" onchange="myFunctionadd(this.value)" value="{{isset($userInfo->sup_add2)?$userInfo->sup_add2:''}}" placeholder="{{ __('customer.Street Name') }}">
																</div>
															</div>
														</div>
													</div>
														...
														<div class="form-group row pr-md-3">
															...
															<div class="col-md-8">
																<div class="input-group  input-group-sm">
																	...
																	<input type="text" class="form-control" autocomplete="off" placeholder="{{ __('customer.Street Name') }}{{ __('customer.Arabic') }}" id="sup_add2_ar" name="sup_add2_ar" onchange="myFunctionadd(this.value)" value="{{isset($userInfo->sup_add2_ar)?$userInfo->sup_add2_ar:''}}">
																</div>
															</div>
														</div>
													</div>
														...
														<div class="form-group row pr-md-3">
															...
															<div class="col-md-8">
																<div class="input-group  input-group-sm">
																	...
																	<input type="text" class="form-control" id="sup_region_ar" name="sup_region_ar" autocomplete="off" placeholder="{{ __('customer.District') }}{{ __('customer.Arabic') }}" onchange="myFunctionregion(this.value)" value="{{isset($userInfo->sup_region_ar)?$userInfo->sup_region_ar:''}}">
																</div>
															</div>
														</div>
													</div>
														...
														<div class="form-group row pr-md-3">
															...
															<div class="col-md-8">
																<div class="input-group  input-group-sm">
																	...
																	<input type="text" class="form-control" id="sup_state" name="sup_state" autocomplete="off" placeholder="{{ __('customer.Province / State') }}" onchange="myFunctioncity(this.value)" value="{{isset($userInfo->sup_state)?$userInfo->sup_state:''}}">
																</div>
															</div>
														</div>
													</div>
														...
														<div class="form-group row pr-md-3">
															...
															<div class="col-md-8">
																<div class="input-group  input-group-sm">
																	...
																	<input type="text" class="form-control" id="sup_state_ar" name="sup_state_ar" autocomplete="off" placeholder="{{ __('customer.Province / State') }}{{ __('customer.Arabic') }}" onchange="myFunctioncity(this.value)" value="{{isset($userInfo->sup_state_ar)?$userInfo->sup_state_ar:''}}">
																</div>
															</div>
														</div>
													</div>
														...
														<div class="form-group row pr-md-3">
															...
															<div class="col-md-8">
																<div class="input-group  input-group-sm">
																	...
																	<input type="text" class="form-control" id="sup_city" name="sup_city" autocomplete="off" placeholder="{{ __('supplier.City') }}" onchange="myFunctioncity(this.value)" value="{{isset($userInfo->sup_city)?$userInfo->sup_city:''}}">
																</div>
															</div>
														</div>
													</div>
														...
														<div class="form-group row pr-md-3">
															...
															<div class="col-md-8">
																<div class="input-group  input-group-sm">
																	...
																	<input type="text" class="form-control" id="sup_city_ar" name="sup_city_ar" autocomplete="off" placeholder="{{ __('customer.City') }}{{ __('customer.Arabic') }}" onchange="myFunctioncity(this.value)" value="{{isset($userInfo->sup_city_ar)?$userInfo->sup_city_ar:''}}">
																</div>
															</div>
														</div>
													</div>
													<div class="col-lg-6">
														<div class="form-group row pr-md-3">
															<div class="col-md-4">
																<label>{{ __('supplier.Country') }}<span style="color: red">*</span></label>
															</div>
															<div class="col-md-8">
																<div class="input-group  input-group-sm">
										...
										class="fa fa-globe" aria-hidden="true"></i></span>
																	...
																	<select class="form-control single-select" id="sup_country" name="sup_country">
																		<option value="">Select</option>@foreach($country as $coun)
																		<option value="{{$coun->id}}" @if($sup_country==$coun->id)
																			{{"selected"}} @endif>
																			{{$coun->cntry_name}}
																		</option>
																		@endforeach
													...
													<div class="col-lg-6">
														<div class="form-group row pr-md-3">
															<div class="col-md-4">
																<label>{{ __('supplier.Country') }}{{ __('customer.Arabic') }}</label>
															</div>
															<div class="col-md-8">
																<div class="input-group  input-group-sm">

																	<input type="text" class="form-control" id="sup_country_ar" name="sup_country_ar" autocomplete="off" placeholder="{{ __('supplier.Country') }}{{ __('customer.Arabic') }}" onchange="myFunctioncity(this.value)" value="{{isset($userInfo->sup_country_ar)?$userInfo->sup_country_ar:''}}">
																</div>
															</div>
														</div>
													</div>
														...
														<div class="form-group row pr-md-3">
															...
															<div class="col-md-8">
																<div class="input-group  input-group-sm">
																	...
																	<input type="text" class="form-control" id="sup_zip" name="sup_zip" autocomplete="off" placeholder="{{ __('supplier.Zipcode') }}" onchange="myFunctionzip(this.value)" value="{{isset($userInfo->sup_zip)?$userInfo->sup_zip:''}}">
																</div>
															</div>
														</div>
													</div>
														...
														<div class="form-group row pr-md-3">
															...
															<div class="col-md-8">
																<div class="input-group  input-group-sm">
																	...
																	<input type="text" class="form-control" id="sup_zip_ar" name="sup_zip_ar" autocomplete="off" placeholder="{{ __('supplier.Zip Code') }}{{ __('customer.Arabic') }}" onchange="myFunctionzip(this.value)" value="{{isset($userInfo->sup_zip_ar)?$userInfo->sup_zip_ar:''}}">
																</div>
															</div>
														</div>
													</div>
														...
														<div class="form-group row pr-md-3">
															...
															<div class="col-md-8">
																<div class="input-group  input-group-sm">
																	...
																	<input type="text" class="form-control" id="additionalno" name="additionalno" autocomplete="off" placeholder="{{ __('customer.Additional Number') }}" value="{{isset($userInfo->additionalno)?$userInfo->additionalno:''}}">
																</div>
															</div>
														</div>
													</div>
														...
														<div class="form-group row pr-md-3">
															...
															<div class="col-md-8">
																<div class="input-group  input-group-sm">
																	...
																	<input type="text" class="form-control" id="additionalno_ar" name="additionalno_ar" autocomplete="off" placeholder="{{ __('customer.Additional Number') }}{{ __('customer.Arabic') }}" value="{{isset($userInfo->additionalno_ar)?$userInfo->additionalno_ar:''}}">
																</div>
															</div>
														</div>
													</div>
														...
														<div class="form-group row pr-md-3">
															...
															<div class="col-md-8">
																<div class="input-group  input-group-sm">
																	...
																	<input type="text" class="form-control" id="vatno" name="vatno" autocomplete="off" placeholder="{{ __('customer.Vat No') }}" value="{{isset($userInfo->vatno)?$userInfo->vatno:''}}">
																</div>
															</div>
														</div>
													</div>
														...
														<div class="form-group row pr-md-3">
															...
															<div class="col-md-8">
																<div class="input-group  input-group-sm">
																	...
																	<input type="text" class="form-control" id="vatno_ar" name="vatno_ar" autocomplete="off" placeholder="{{ __('customer.Vat No') }}{{ __('customer.Arabic') }}" value="{{isset($userInfo->vatno_ar)?$userInfo->vatno_ar:''}}">
																</div>
															</div>
														</div>
													</div>
														...
														<div class="form-group row pr-md-3">
															...
															<div class="col-md-8">
																<div class="input-group  input-group-sm">
																	...
																	<input type="text" class="form-control" id="buyerid_crno" name="buyerid_crno" autocomplete="off" placeholder="{{ __('customer.Buyer ID / CR No') }}" value="{{isset($userInfo->buyerid_crno)?$userInfo->buyerid_crno:''}}">
																</div>
															</div>
														</div>
													</div>
														...
														<div class="form-group row pr-md-3">
															...
															<div class="col-md-8">
																<div class="input-group  input-group-sm">
																	...
																	<input type="text" class="form-control" id="buyerid_crno_ar" name="buyerid_crno_ar" autocomplete="off" placeholder="{{ __('customer.Buyer ID / CR No') }}{{ __('customer.Arabic') }}" value="{{isset($userInfo->buyerid_crno_ar)?$userInfo->buyerid_crno_ar:''}}">
																</div>
															</div>
														</div>
													</div>
														...
														<div class="form-group row pr-md-3">
															...
															<div class="col-md-8">
																<div class="input-group  input-group-sm">
																	...
																	<input type="text" class="form-control" id="email1" name="email1" onchange="myFunction(this.value)" autocomplete="off" placeholder="{{ __('supplier.Email') }}" value="{{isset($userInfo->email1)?$userInfo->email1:''}}">
																</div>
															</div>
														</div>
													</div>
														...
														<div class="form-group row pr-md-3">
															...
															<div class="col-md-8">
																<div class="input-group  input-group-sm">
																	...
																	<input type="text" class="form-control" id="office_phone1" name="office_phone1" autocomplete="off" placeholder="{{ __('supplier.Office Phone 1') }}" onchange="myFunctionphone(this.value)" value="{{isset($userInfo->office_phone1)?$userInfo->office_phone1:''}}">
																</div>
															</div>
														</div>
													</div>
														...
														<div class="form-group row pl-md-3">
															...
															<div class="col-md-8">
																<div class="input-group  input-group-sm">
																	...
																	<input type="text" class="form-control" id="office_phone2" name="office_phone2" autocomplete="off" placeholder="{{ __('supplier.Office Phone 2') }}" onchange="myFunctionphone2(this.value)" value="{{isset($userInfo->office_phone2)?$userInfo->office_phone2:''}}">
																</div>
															</div>
														</div>
													</div>
											...
											<div class="kt-wizard-v1__form">
												...
												<div class="row">
														...
														<div class="form-group row pl-md-3">
															...
															<div class="col-md-8">
																<div class="input-group input-group-sm">
																	...
																	<input type="text" class="form-control" placeholder="{{ __('supplier.Contact Person') }} " id="contact_persons" name="contact_persons" autocomplete="off" value="">
																</div>
															</div>
														</div>
													</div>
													<div class="col-md-6">
														<div class="form-group row pr-md-3">
															<div class="col-md-4">
																<label>{{ __('supplier.Mobile') }}</label>
															</div>
															<div class="col-md-8">
																<div class="input-group  input-group-sm">

																	<input type="text" class="form-control" placeholder="{{ __('supplier.Mobile') }}" id="mobile" name="mobile" autocomplete="off" value="">
																</div>
															</div>
														</div>
													</div>
														...
														<div class="form-group row pl-md-3">
															...
															<div class="col-md-8">
																<div class="input-group input-group-sm ">
																	...
																	<input type="text" class="form-control" placeholder="{{ __('supplier.Office Number') }}" id="office" name="office" autocomplete="off" value="">
																</div>
															</div>
														</div>
													</div>
														...
														<div class="form-group row pr-md-3">
															...
															<div class="col-md-8">
																<div class="input-group  input-group-sm">
																	...
																	<input type="text" class="form-control" placeholder="{{ __('supplier.Email') }}" id="email" name="email" autocomplete="off" value="">
																</div>
															</div>
														</div>
													</div>
														...
														<div class="form-group row pl-md-3">
															...
															<div class="col-md-8">
																<div class="input-group  input-group-sm">
																	...
																	<input type="text" class="form-control" placeholder="{{ __('supplier.Department') }}" id="contact_department" name="contact_department" autocomplete="off" value="">
																</div>
															</div>
														</div>
													</div>
													<div class="col-md-6">
														<div class="form-group row pr-md-3">
															<div class="col-md-4">
																<label>{{ __('supplier.Location') }}</label>
															</div>
															<div class="col-md-8">
																<div class="input-group input-group-sm ">

																	<input type="text" class="form-control" placeholder="{{ __('app.Designation') }}" id="location" name="location" autocomplete="off" value="">
																</div>
															</div>
														</div>
													</div>
															...
															<tbody id="tbadd">
																<?php foreach ($datas as $key => $datas) { ?>
																	...
																	<tr class="addmore">
																		<td></td>
																		<td>
																			<input type="text" value="<?php echo $datas->contact_personvalue ?>" id="contact_personvalue" name="contact_person[0]" placeholder="Contact Person Incharge" class="skill form-control contact_personvalue" readonly />
																		</td>
																		<td>
																			<input type="text" value="<?php echo $datas->mobiles ?>" id="mobiles" name="mobiles[0]" placeholder="Mobile Number" class="skill form-control mobiles" readonly />
																		</td>
																		<td>
																			<input type="text" value="<?php echo $datas->offices ?>" id="offices" name="offices[0]" placeholder="Office Number" class="skill form-control offices" readonly />
																		</td>
																		<td>
																			<input type="text" value="<?php echo $datas->emails ?>" id="emails" name="emails[0]" placeholder="Email" class="skill form-control emails" readonly />
																		</td>
																		<td>
																			<input type="text" value="<?php echo $datas->departments ?>" id="departments" name="departments[0]" placeholder="Department" class="skill form-control departments" readonly />
																		</td>
																		<td>
																			<input type="text" value="<?php echo $datas->locations ?>" id="locations" name="locations[0]" placeholder="Location" class="skillValue form-control locations" readonly />
																		</td>

																		<td><button class='btn btn-dark btn_remove' name="remove" id='remove'><i class='fa fa-trash' style='padding-right: 0;'></i></button></td>
																	</tr>
															</tbody>
														<?php } ?>
														</table>
											...
											<div class="kt-wizard-v1__form">
												...
												<div class="row">
													...
													<div class="col-lg-6">
														<div class="form-group row pl-md-3">
															<div class="col-md-4">
																<label>{{ __('supplier.Username') }}</label>
															</div>
															<div class="col-md-8">
																<div class="input-group  input-group-sm kt-input-icon kt-input-icon--right" id="spintog">

																	<input type="text" class="form-control" placeholder="{{ __('supplier.Username') }}" id="username" name="username" autocomplete="off" value="{{isset($userInfo->username)?$userInfo->username:''}}"> <span class="kt-input-icon__icon kt-input-icon__icon--right">
																		<span>
																			<div class="spinner-border" id="spin" style="z-index: 10000; display:none;"></div>
																		</span>
																	</span>
																</div>
															</div>
													...
													<div class="col-lg-6">
														<div class="form-group row pl-md-3">
															<div class="col-md-4">
																<label>{{ __('supplier.Password') }}</label>
															</div>
															<div class="col-md-8">
																<div class="input-group  input-group-sm">


																	<input type="password" class="form-control" placeholder="{{ __('supplier.Password') }}" id="password " name="password" autocomplete="off" value="{{isset($userInfo->password)?$userInfo->password:''}}">
																</div>
															</div>
														</div>
													</div>
			...
			$.ajax({
				...
				success: function(data) {
					$.each(data, function(key, value) {
						$("#sup_code").val(value.title + '/' + value.increment);
					});
				},
				error: function() {}
			});
	...
	$(document).ready(function() {
		$("#Checkedinvoice").change(function() {
			if (this.checked) {
				...
				$('#invoice_country').val($val14).trigger('change');;
...
<script type="text/javascript">
	$(document).on('click', '#Supplier_submit', function(e) {
		...
		if (sup_category == "") {
			$('#sup_category').next().find('.select2-selection').addClass('is-invalid');
			toastr.warning('Supplier Category is Required.');
			$("#generalinfo").trigger("click");
			return false;
		} else {
			$('#sup_category').next().find('.select2-selection').removeClass('is-invalid');
		}
		if (sup_code == "") {
		...
		if (sup_type == "") {
			$('#sup_type').next().find('.select2-selection').addClass('is-invalid');
			toastr.warning('Supplier Type is Required.');
			$("#generalinfo").trigger("click");
			return false;
		} else {
			$('#sup_type').next().find('.select2-selection').removeClass('is-invalid');
		}
		if (sup_name == "") {
		...
		if (sup_country == "") {
			$('#sup_country').next().find('.select2-selection').addClass('is-invalid');
			toastr.warning('Supplier Country is Required.');
			$("#supplierinfo").trigger("click");
			return false;
		} else {
			$('#sup_country').next().find('.select2-selection').removeClass('is-invalid');
		}
