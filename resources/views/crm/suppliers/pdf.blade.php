	...
	<div id="content">
		...
		?>
			<div class="col-md-4 personal-info section">
				...
				<table class="address">
					<tr>
						<th>{{ __('customer.Supplier Code') }}</th>
						<td><?php echo isset($data->sup_code) ? $data->sup_code : ''; ?></td>

					</tr>
					<tr>
						<th>{{ __('customer.Category') }}</th>
						<td><?php echo isset($data->supplier_category) ? $data->supplier_category : ''; ?></td>

					</tr>

					<tr>
						<th>{{ __('customer.Type') }}</th>
						<td><?php echo isset($data->suppliertype) ? $data->suppliertype : ''; ?> </td>
