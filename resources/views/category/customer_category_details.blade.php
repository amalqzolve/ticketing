									...
									<div class="kt-portlet__head-toolbar">
										<div class="kt-portlet__head-wrapper">
											<div class="kt-portlet__head-actions">
												...
												<a href="{{url('/')}}/categorytrash" type="button" class="btn btn-danger btn-elevate btn-icon-sm">
...
<!--begin: Datatable -->
<table class="table table-striped- table-bordered table-hover table-checkable" id="customercategorydetails_list">
	<thead>
		<tr>
...
<button id="Category_submit" class="btn btn-brand kt-spinner--right kt-spinner--sm kt-spinner--light">{{ __('customer.Submit') }}</button>
