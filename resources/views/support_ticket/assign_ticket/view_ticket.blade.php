...
<div class="col-6">
    <div class="dropdown mt-3">
        ...
        <div class="dropdown-menu dropdown-menu-right p-0">
            ...
            @php
                if(($ticketdet->delegation_flag == 0 || $ticketdet->delegation_flag == 2) && $ticketdet->assign_ticketstatus == 1) {
            @endphp
                <a class="dropdown-item closeticket" data-toggle="tooltip" data-placement="bottom" data-id="{{ $ticketdet->id }}" data-asid="{{ $ticketdet->assignid }}" title="Close Ticket"><i class="flaticon-circle" aria-hidden="true"></i> @lang("support_ticket.Close Ticket")</a>
            @php
                }
            @endphp
        </div>
            ...
            <div class="media border border-right-0 border-left-0 p-3">
                ...
                <div class="media-body pt-3">
                    <div class="form-group">
                        ...
                        <input type="hidden" name="assigniid" id="cmnt_assignid" value="{{ $ticketdet->assignid }}" />
