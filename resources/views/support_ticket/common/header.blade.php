                    ...
                    <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
                        <ul class="kt-menu__nav ">
                            ...
                            <li class="kt-menu__item dashboard" aria-haspopup="true">
                                <a href="{{url('support_ticket/dashboard')}}" class="kt-menu__link ">
                            ...
                            <li class="kt-menu__item create_ticket" aria-haspopup="true">
                                <a href="{{ url('support_ticket/create_ticket') }}" class="kt-menu__link ">
                                    <span class="kt-menu__link-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                <polygon points="0 0 24 0 24 24 0 24" />
                                    ...
                                    <span class="kt-menu__link-text">@lang('support_ticket.Ticket')</span>
                                </a>
                            </li>

                            <li class="kt-menu__item assign_ticket" aria-haspopup="true">
                                <a href="{{ url('support_ticket/assign_ticket') }}" class="kt-menu__link ">
                                    <span class="kt-menu__link-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                <polygon points="0 0 24 0 24 24 0 24" />
                                    ...
                                    <span class="kt-menu__link-text">@lang('support_ticket.Assigned Ticket')</span>
                                </a>
                            </li>

                            <li class="kt-menu__item open_orclose" aria-haspopup="true">
                                <a href="{{ url('support_ticket/open_or_close') }}" class="kt-menu__link ">
                                    <span class="kt-menu__link-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                <polygon points="0 0 24 0 24 24 0 24" />
                                    ...
                                    <span class="kt-menu__link-text">@lang('support_ticket.open_or_close_tickets')</span>
                                </a>
                            </li>

                            <li class="kt-menu__item  kt-menu__item--submenu settings" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><i class="kt-menu__link-icon flaticon-settings-1"></i><span class="kt-menu__link-text">Settings</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
                                <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                                    <ul class="kt-menu__subnav">
                                        <li class="kt-menu__item  kt-menu__item--parent" aria-haspopup="true"><span class="kt-menu__link"><span class="kt-menu__link-text">@lang('support_ticket.Settings')</span></span></li>

                                        <li class="kt-menu__item tickettype" aria-haspopup="true"><a href="{{ url('support_ticket/ticket_type') }}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span class="kt-menu__link-text">@lang('support_ticket.Ticket Type')</span></a></li>
                                        <li class="kt-menu__item ticketctg" aria-haspopup="true"><a href="{{ url('support_ticket/ticket_category') }}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span class="kt-menu__link-text">@lang('support_ticket.Ticket Category')</span></a></li>
                                        <li class="kt-menu__item tickettags" aria-haspopup="true"><a href="{{ url('support_ticket/ticket_tags') }}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span class="kt-menu__link-text">@lang('support_ticket.Tag')</span></a></li>
                                        <li class="kt-menu__item ticketstats" aria-haspopup="true"><a href="{{ url('support_ticket/ticket_status') }}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span class="kt-menu__link-text">@lang('support_ticket.Ticket Status')</span></a></li>
                                        <li class="kt-menu__item emailsettng" aria-haspopup="true"><a href="{{ url('support_ticket/emailsetting') }}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span class="kt-menu__link-text">@lang('support_ticket.Email Settings')</span></a></li>
                                    </ul>
                                </div>
                            </li>
