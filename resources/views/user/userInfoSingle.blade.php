								...
								<div class="modal-dialog modal-xl" role="document">
									<div class="modal-content">
										<div class="modal-header">
											<h5 class="modal-title" id="exampleModalLabel">Customer Information details form</h5>
...
@section('script')
    ...
    <script src="{{url('/')}}/assets/js/pages/crud/datatables/basic/userSingle.js" type="text/javascript"></script>
