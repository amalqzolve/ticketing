                    ...
                    <div class="kt-widget kt-widget--user-profile-1">
                        <div class="kt-widget__head">
                            <div class="kt-widget__media">
                                <img src="{{ URL::asset('assets') }}/media/users/100_13.jpg" alt="image">
                            </div>
                        ...
                        <div class="kt-widget__body">
                            ...
                            <div class="kt-widget__items">
                                <a href="{{url('/')}}/custom/apps/user/profile-1/overview.html" class="kt-widget__item ">
                                    ...
                                    <div class="dropdown dropdown-inline">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <ul class="kt-nav">
                                                ...
                                                <li class="kt-nav__item">
                                                    <a href="{{url('/')}}/profilePdfDownload/{{isset($userInfo->id)?$userInfo->id:''}}" class="kt-nav__link">
