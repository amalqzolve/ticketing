...
$c=storage_path('app/public/'.str_slug($customer_id).'.svg');
 ...
 <tr>
                    ...
                    <td style="border-color: white; padding: 0; font-weight: bold;  font-size:12px;"> Salesman</td>

                    <td style="border-color: white; padding: 0;text-align:  center;  font-size:12px;">{{$salesman1}}</td>
 ...
 <tr>
   ...
   <table style="width:100%;" cellspacing="0" cellpadding="0">
         ...
         <center><h3><u>Buyer</u></h3></h3>
          ...
          <table style="width:100%; border-color: white;   padding: 2px; " cellspacing="0" cellpadding="0">
            ...
            <tr style=" ">
              ...
              <td  style="border-color: white; border-color: white;   padding: 0px; font-size: 12px;"> <?php echo  $buldingname; ?></td>
      ...
      <tr>
              ...
              <td  style="border-color: white; border-color: white;   padding: 0px; font-size: 12px;"><?php echo  $streetname; ?></td>
      ...
      <tr>
              ...
              <td  style="border-color: white; border-color: white;   padding: 0px; font-size: 12px;"><?php echo  $district; ?></td>
      ...
      <tr>
              ...
              <td  style="border-color: white; border-color: white;   padding: 0px; font-size: 12px;"><?php echo  $city; ?></td>
   ...
   <tr>
              ...
              <td  style="border-color: white; border-color: white;   padding: 0px; font-size: 12px;"><?php echo  $cntry_name; ?></td>
   ...
   <tr>
              ...
              <td  style="border-color: white; border-color: white;   padding: 0px; font-size: 12px;"><?php echo  $vatno; ?></td>
   ...
   <tr>
              ...
              <td  style="border-color: white;  border-color: white;   padding: 0px; font-size: 12px;"><?php echo  $buyerid_crno; ?></td>
