      ...
      <div class="kt-portlet__head kt-portlet__head--lg">
         <div class="kt-portlet__head-label">
            ...
            <h3 class="kt-portlet__head-title">
               <a href="cost-estimation-child?id={{$assent_id}}" class="" >
                  {{ $parent_name }}
               </a>
            </h3>
         </div>
         <div class="kt-portlet__head-toolbar">
            <div class="kt-portlet__head-wrapper">
               <div class="kt-portlet__head-actions">
                  <a class="btn btn-brand btn-elevate btn-icon-sm" href="{{url('direct-cost-estimation')}}/{{$parent}}"><i class="la la-plus"></i>Direct Estimation </a>
...
<script src="{{url('/')}}/resources/js/costing/listChild.js" type="text/javascript"></script>
@endsection