                ...
                <div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
                    <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
                        <ul class="kt-menu__nav ">
                            ...
                            <li class="kt-menu__item dashboard" aria-haspopup="true"><a href="{{url('/cost-estimation/dashboard')}}" class="kt-menu__link ">
                            ...
                            <li class="kt-menu__item  cost-estimation" aria-haspopup="true">
                                <a href="{{url('/cost-estimation')}}" class="kt-menu__link ">
                                    ...
                                    <span class="kt-menu__link-text">Estimation</span>
                                </a>
                            </li>

                            <!-- Estimation setting -->
                            <li class="kt-menu__item  kt-menu__item--submenu estimationSettings" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    ...
                                    </span><span class="kt-menu__link-text">Estimation Settings</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
                                <div class="kt-menu__submenu  "><span class="kt-menu__arrow"></span>
                                    <ul class="kt-menu__subnav">
                                        <li class="kt-menu__item catColumns" aria-haspopup="true"><a href="{{url('/estimation-column')}}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Cost Category</span></a></li>
                                        <li class="kt-menu__item costmatrix" aria-haspopup="true"><a href="{{url('/costmatrix')}}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Cost Matrix</span></a></li>
                                    </ul>
                                </div>
                            </li>
                            <!-- ./Estimation Settings -->
