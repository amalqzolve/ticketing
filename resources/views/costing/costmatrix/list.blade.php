...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
	...
	<div class="kt-portlet kt-portlet--mobile">
			...
			<div class="kt-portlet__head-toolbar">
				<div class="kt-portlet__head-wrapper">
					<div class="kt-portlet__head-actions">
						...
						<a href="{{url('/')}}/Add_costmatrix" class="btn btn-brand btn-elevate btn-icon-sm">
		...
		<div class="kt-portlet__body">
			<table class="table table-striped table-hover table-checkable dataTable no-footer" id="costmatrixdetails_list">
				<thead>
					<tr>
...
<script src="{{url('/')}}/resources/js/costing/costmatrix.js" type="text/javascript"></script>
@endsection