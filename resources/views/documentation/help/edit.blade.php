...
<br/>
							...
							@foreach($data as $datas)
									...
									<input type="text" class="form-control" name="tax_name" placeholder="Tax Name" id="tax_name" value="<?php echo $datas->taxname;?>">
									</div>
									</div>
									</div>
									<div class="col-lg-6">
									...
									<div class="col-md-8 input-group input-group-sm">
									<input type="text" class="form-control" name="tax_percentage" placeholder="Tax Percentage" id="tax_percentage" value="<?php echo $datas->tax_percentage;?>">
									</div>
									</div>
									</div>
