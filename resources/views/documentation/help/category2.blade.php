     ...
     <div class="kt-footer  kt-grid__item kt-grid kt-grid--desktop kt-grid--ver-desktop">
        <div class="row">
            ...
            <div class="col-lg-8" style="padding-left: 25px; margin-top: 15px;">
                <div>
                    <h1>Help desk</h1>
                    <h5>All useful information about our team.</h5>
                </div>
                <div>
                    <ul class="list-group">
                        <li class="list-group-item"><a href="help_category_view3">How to use help desk?</a></li>
                        <li class="list-group-item"><a href="help_category_view4">How to share your knowledge with team?</a></li>
                    </ul>
                </div>
            </div>
        </div>
