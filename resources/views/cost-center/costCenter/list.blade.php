   ...
   <div class="modal-dialog modal-lg" role="document" style="width: 900px !important">
      <div class="modal-content">
         <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel"> Cost Center </h5>
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-lg-6">
                        <div class="form-group row pl-0">
                           ...
                           <div class="col-md-8 input-group input-group-sm">
                              <input type="text" class="form-control" name="name" id="name" maxlength="255" placeholder="Cost Center Name">
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="col-lg-6">
                        <div class="form-group row pl-0">
                           ...
                           <div class="col-md-8 input-group input-group-sm">
                              <input type="text" class="form-control" name="code" id="code" maxlength="50" placeholder="Cost Center Code">
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="col-lg-6">
                        <div class="form-group row pl-0">
                           ...
                           <div class="col-md-8 input-group input-group-sm">
                              <select class="form-control single-select kt-selectpicker" name="department" id="department">
                     ...
                     <div class="col-lg-6">
                        <div class="form-group row pl-0">
                           ...
                           <div class="col-md-8 input-group input-group-sm">
                              <input type="text" class="form-control" placeholder="Business Area" id="business_area" name="business_area" autocomplete="off" maxlength="255">
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="col-lg-6">
                        <div class="form-group row pr-md-1">
                           <div class="col-md-4">
                              <label style="text-align: left;">Functional Area</label>
                           </div>
                           <div class="col-md-8">
                              <div class="input-group  input-group-sm">
                                 <input type="text" class="form-control" placeholder="Functional Area" id="functional_area" name="functional_area" autocomplete="off" maxlength="255">
                              </div>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="col-lg-6">
                        <div class="form-group row pr-md-1">
                           <div class="col-md-4 ">
                              <label style="text-align: left;">Responsible Person</label>
                           </div>
                           <div class="col-md-8">
                              <div class="input-group  input-group-sm">
                                 <input type="text" class="form-control" placeholder="Responsible Person" id="responsible_person" name="responsible_person" autocomplete="off" maxlength="255">
                              </div>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="col-lg-12">
                        <div class="form-group row pl-0">
                           ...
                           <div class="col-md-10 input-group input-group-sm">
                              <!-- <input type="text"> -->
                              <textarea class="form-control" name="description" id="description" maxlength="500" cols="30" rows="3"></textarea>
                           </div>
...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
   ...
   <script src="{{url('/')}}/resources/js/cost-center/costCenter/list.js" type="text/javascript"></script>
   @endsection