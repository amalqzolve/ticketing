                    ...
                    <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
                        <ul class="kt-menu__nav ">
                            ...
                            <li class="kt-menu__item home" aria-haspopup="true">
                                <a href="{{url('/tenders/home')}}" class="kt-menu__link ">
                            ...
                            <li class="kt-menu__item tenders" aria-haspopup="true">
                                <a href="{{url('/tenders/tender')}}" class="kt-menu__link ">
                                    <span class="kt-menu__link-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                <polygon points="0 0 24 0 24 24 0 24" />
                                    ...
                                    <span class="kt-menu__link-text">Tenders</span>
                                </a>
                            </li>
                            ...
                            <li class="kt-menu__item approval" aria-haspopup="true">
                                <a href="{{url('/tenders/tender-approve-list')}}" class="kt-menu__link ">
                                    <span class="kt-menu__link-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                <polygon points="0 0 24 0 24 24 0 24" />
                                    ...
                                    <span class="kt-menu__link-text">Tenders Approval</span>
                                </a>
                            </li>

                            <li class="kt-menu__item tenderParticipation" aria-haspopup="true">
                                <a href="{{url('/tenders/participation-list')}}" class="kt-menu__link ">
                                    <span class="kt-menu__link-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                <polygon points="0 0 24 0 24 24 0 24" />
                                    ...
                                    <span class="kt-menu__link-text">Tender participation</span>
                                </a>
                            </li>


                            <li class="kt-menu__item estimated-boq-list" aria-haspopup="true">
                                <a href="{{url('/tenders/estimated-boq-list')}}" class="kt-menu__link ">
                                    <span class="kt-menu__link-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                <polygon points="0 0 24 0 24 24 0 24" />
                                    ...
                                    <span class="kt-menu__link-text">Estimated BOQ</span>
                                </a>
                            </li>


                            <!-- Sales Proposal-->
                            <li class="kt-menu__item  kt-menu__item--submenu salesProposal" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    ...
                                    </span><span class="kt-menu__link-text">Sales Proposal</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
                                <div class="kt-menu__submenu  "><span class="kt-menu__arrow"></span>
                                    <ul class="kt-menu__subnav">
                                        <li class="kt-menu__item sales-proposal-list" aria-haspopup="true"><a href="{{url('/tenders/sales-proposal-list')}}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Tender</span></a>
                                        </li>
                                        <li class="kt-menu__item sales-proposal-list-project" aria-haspopup="true"><a href="{{url('tenders/sales-proposal-list-project')}}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Project</span></a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="kt-menu__item sales-proposal-approve-list" aria-haspopup="true">
                                <a href="{{url('/tenders/sales-proposal-approve-list')}}" class="kt-menu__link ">
                                    <span class="kt-menu__link-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                <polygon points="0 0 24 0 24 24 0 24" />
                                    ...
                                    <span class="kt-menu__link-text">Sales Proposal Approval</span>
                                </a>
                            </li>


                            <li class="kt-menu__item sales-order-list" aria-haspopup="true">
                                <a href="{{url('/tenders/sales-order-list')}}" class="kt-menu__link ">
                                    <span class="kt-menu__link-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                <polygon points="0 0 24 0 24 24 0 24" />
                                    ...
                                    <span class="kt-menu__link-text">Sales Order</span>
                                </a>
                            </li>
                            ...
                            <li class="kt-menu__item  kt-menu__item--submenu settings" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon">
                                ...
                                <div class="kt-menu__submenu  "><span class="kt-menu__arrow"></span>
                                    <ul class="kt-menu__subnav">
                                        <li class="kt-menu__item category" aria-haspopup="true"><a href="{{url('/tenders/category')}}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Tender Category</span></a>
                                        </li>
                                        <li class="kt-menu__item categorySynthesis" aria-haspopup="true"><a href="{{url('tenders/category-synthesis')}}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Tender Approval synthesis</span></a>
                                        </li>
                                        <li class="kt-menu__item sales-proposal-category" aria-haspopup="true"><a href="{{url('/tenders/sales-proposal-category')}}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Proposal Category</span></a>
                                        </li>
                                        <li class="kt-menu__item sales-proposal-synthesis" aria-haspopup="true"><a href="{{url('tenders/sales-proposal-synthesis')}}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Proposal Approval synthesis</span></a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
