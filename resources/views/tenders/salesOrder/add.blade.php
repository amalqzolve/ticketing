...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
	...
	<div class="kt-portlet kt-portlet--mobile">
		...
		<div class="kt-portlet__body">
			<input type="hidden" name="sales_prop_id" id="sales_prop_id" value="{{$id}}">
...
<script src="{{url('/')}}/resources/js/tenders/salesOreder/add.js" type="text/javascript"></script>
@endsection