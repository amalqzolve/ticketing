	...
	<div class="kt-portlet kt-portlet--mobile">
		<div class="kt-portlet__head kt-portlet__head--lg">
			<div class="kt-portlet__head-label">
				...
				<h3 class="kt-portlet__head-title"> New Sales Order </h3>
			</div>
				...
				<div class="row" style="padding-bottom: 6px;">
					<div class="col-lg-6">
						<div class="form-group row pr-md-3">
							...
							<div class="col-md-8 input-group input-group-sm">
								<select class="form-control single-select kt-selectpicker" id="client_id" name="client_id">
					...
					<div class="col-lg-6">
						<div class="form-group row pr-md-3">
							...
							<div class="col-md-8 input-group input-group-sm">
								<input type="text" name="clients_po_number" id="clients_po_number" class="form-control">
							</div>
						</div>
					</div>
					...
					<div class="col-lg-6">
						<div class="form-group row pr-md-3">
							...
							<div class="col-md-8 input-group input-group-sm">
								<input type="text" class="form-control" name="sovalue" id="sovalue">
							</div>
						</div>
					</div>
					<div class="col-lg-6">
						<div class="form-group row pr-md-3">
							...
							<div class="col-md-8 input-group input-group-sm">
								<input type="text" class="form-control kt_datetimepickerr" name="sodate" id="sodate">
							</div>
						</div>
					</div>
					<div class="col-lg-6">
