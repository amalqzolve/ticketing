...
<head>
  ...
  <page size="A4">
    <form action="{{ route('mark.dec.salesproposal') }}" id="frmAction" method="POST" style="padding-block: 73px;  padding-left: 20px;  padding-right: 20px;">
      @csrf
              ...
              <tr>
                <td style="border-color: white;   padding-top: 0; padding-right: 0; padding-bottom: 0;  ">
                  <table style=" width: 100%; ">
                    <tr>
                      <td style="border-color: white; padding: 0; font-weight: bold;  font-size:11px; width: 30%;">Proposal ID.</td>
                      <td style="border-color: white; padding: 0;text-align: left;  font-size:11px; color: red;"> PROP {{$mainData->id}}</td>
                      <td style="border-color: white; padding: 0;text-align: right;  font-size:11px; width: 30%;"></td>
                    </tr>
                    <tr>
                      <td style="border-color: white; padding: 0; font-weight: bold;  font-size:11px; width: 30%;"> Proposal Date</td>
                    ...
                    <tr>
                      ...
                      <td style="border-color: white; padding: 0;text-align: left;  font-size:11px; "> {{date('d-m-Y',strtotime($mainData->valid_till))}} </td>
                      <td style="border-color: white; padding: 0;text-align: right;  font-size:11px; width: 30%;"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td style="border-color: white; padding: 0; font-weight: bold;  font-size:11px; width: 30%;">Salesman</td>
                      <td style="border-color: white; padding: 0;text-align: left;  font-size:11px; "> {{$mainData->salesman}}</td>
                      <td style="border-color: white; padding: 0;text-align: right;  font-size:11px; width: 30%;"></td>
                    </tr>
                    <tr>
                      <td style="border-color: white; padding: 0; font-weight: bold;  font-size:11px; width: 30%;">Attention</td>
                      <td style="border-color: white; padding: 0;text-align: left;  font-size:11px; "> {{$mainData->attention}}</td>
                      <td style="border-color: white; padding: 0;text-align: right;  font-size:11px; width: 30%;"></td>
                    </tr>
                    <tr>
                      <td style="border-color: white; padding: 0; font-weight: bold;  font-size:11px; width: 30%;">Reference</td>
                      <td style="border-color: white; padding: 0;text-align: left;  font-size:11px; "> {{$mainData->reference}}</td>
                      <td style="border-color: white; padding: 0;text-align: right;  font-size:11px; width: 30%;"></td>
                    </tr>
                        ...
                        <table style=" padding:0">
                          ...
                          <tr>
                            ...
                            <td colspan="2" style="height:60px; border-color: white; padding:0; font-size: 32px; text-align:right;">
                              <strong>Sales Proposal </strong><br>
                            </td>
                          </tr>
                          <tr>
                            <td style="border-color: white; padding:0;">&nbsp;</td>
                            <td style="border-color: white; padding:0;">&nbsp;</td>
                            <td style="border-color: white; padding:0; text-align:right;"> <span style="font-weight: bold;">Generated by </span>:{{$mainData->created_name}} <br>Date: {{isset($mainData->quotedate)?date('d-m-Y',strtotime($mainData->quotedate)):''}}</td>
                          </tr>
                    </tr>
                  </table>
                </td>
          ...
          <table style="table-layout: auto; " cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td style="border-color: white;   padding: 1px; text-align: center;">
                <h3 style="letter-spacing: 0px; margin: 0;">Sales Proposal </h3>
              </td>
            </tr>
            <tr>
              <td style="border-color: white;   padding: 1px">
          ...
          <div class="str">
            <table>
              <tr>
                ...
                <td style="border-color: white; text-align: left; width: 30%;">Item Name</td>
              ...
              <tr class="str">
                ...
                <td style="border-color: white;   padding: 2px;">{{$cinvoice_products->item_name}}</td>
                      ...
                      <tr style="background-color: white !important; ">
                        ...
                        <td style="border-color: white;background-color: white !important; width: 100%; padding: 0; ">
                          <table style="width:100%; background-color: white !important;">
                            <tr style="background-color: white !important;">
                              <td style="border-color: white; padding: 0;background-color: white !important;"><b>Line total amount</b></td>
                              <td style="border-color: white; padding: 0;background-color: white !important;text-align:right;"><b>{{number_format($mainData->linetotalamount,2,'.',',')}}</b></td>
                            </tr>

                            <tr style="background-color: white !important;">
                              <td style="border-color: white; padding: 0;background-color: white !important;"><b>Estimated Amount</b></td>
                              <td style="border-color: white; padding: 0;background-color: white !important;text-align:right;"><b>{{number_format($mainData->estimated_amount,2,'.',',')}}</b></td>
                            </tr>

                            <tr style="background-color: white !important;">
                              <td style="border-color: white; padding: 0;background-color: white !important;"><b>Net Amount</b></td>
                              <td style="border-color: white; padding: 0;background-color: white !important;text-align:right;"><b>{{number_format($mainData->net_amount,2,'.',',')}}</b></td>
                            </tr>

                            <tr style="background-color: white !important;">
                              <td style="border-color: white; padding: 0;background-color: white !important;"><b>Profit Amount</b></td>
                              <td style="border-color: white; padding: 0;background-color: white !important;text-align:right;"><b>{{number_format($mainData->profit_amount,2,'.',',')}}</b></td>
                            </tr>

                            <tr style="background-color: white !important;">
                              <td style="border-color: white; padding: 0;background-color: white !important;"><b>Discount Amount</b></td>
                              <td style="border-color: white; padding: 0;background-color: white !important;text-align:right;"><b>{{number_format($mainData->discount_amount,2,'.',',')}}</b></td>
                            </tr>

                            <tr style="background-color: white !important;">
                              <td style="border-color: white; padding: 0;background-color: white !important;"><b>Amount After Discount</b></td>
                              <td style="border-color: white; padding: 0;background-color: white !important;text-align:right;"><b>{{number_format($mainData->amount_after_discount,2,'.',',')}}</b></td>
                            </tr>

                            <tr style="background-color: white !important;">
                              <td style="border-color: white; padding: 0;background-color: white !important;"><b>Vat Amount</b></td>
                              <td style="border-color: white; padding: 0;background-color: white !important;text-align:right;"><b>{{number_format($mainData->vat_amount,2,'.',',')}}</b></td>
                            </tr>
                            <tr style="background-color: white !important;">
                              <td style="border-color: white; padding: 0;background-color: white !important; color:red;"><b>Total (Inclusive VAT Amount) </b></td>
