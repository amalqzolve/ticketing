            ...
            <form class="kt-form" id="kt_form" name="kt_form">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane p-2 active" id="kt_tabs_2_1" role="tabpanel">
                        ...
                        <div class="row">
                            <input type="hidden" name="id" id="id" value="{{$tender->id}}">
                                ...
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <select name="client" id="client" class="form-control single-select kt-selectpicker">
                                            ...
                                            <option value="{{$value->id}}" {{($tender->client==$value->id)?'selected':''}}>{{$value->cust_name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <input type="text" class="form-control" name="project_name" id="project_name" value="{{$tender->project_name}}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <select name="category_id" id="category_id" class="form-control single-select kt-selectpicker">
                                            ...
                                            <option value="{{$value->id}}" {{($tender->category_id==$value->id)?'selected':''}}>{{$value->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <input type="text" class="form-control kt_datetimepickerr" id="date_of_submission" name="date_of_submission" value=" {{($tender->date_of_submission !='')?date('d-m-Y',strtotime($tender->date_of_submission)):date('d-m-Y')}}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <input type="text" class="form-control kt_datetimepickerr" id="date_of_release" name="date_of_release" value=" {{($tender->date_of_release!='')?date('d-m-Y',strtotime($tender->date_of_release)):date('d-m-Y')}}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <input type="text" class="form-control" name="reference" id="reference" value="{{$tender->reference}}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <input type="text" class="form-control kt_datetimepickerr" id="bid_extension_date" name="bid_extension_date" value=" {{($tender->bid_extension_date!='')?date('d-m-Y',strtotime($tender->bid_extension_date)):date('d-m-Y')}}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <input type="text" class="form-control kt_datetimepickerr" value="{{date('d-m-Y')}}" id="bid_submission_date" name="bid_submission_date" value="{{($tender->bid_submission_date!='')?date('d-m-Y',strtotime($tender->bid_submission_date)):date('d-m-Y')}}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <textarea cols="30" class="form-control" rows="2" id="bid_bond" name="bid_bond"> {{$tender->bid_bond}}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <textarea cols="30" class="form-control" rows="2" id="consultant" name="consultant"> {{$tender->consultant}}</textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-10 input-group-sm">
                                        <textarea cols="30" class="form-control" rows="2" id="scope_of_work" name="scope_of_work">{{$tender->scope_of_work}}</textarea>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <textarea class="form-control" name="internalreference" id="internalreference">{{$tender->internalreference}}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <textarea class="form-control" name="notes" id="notes">{{$tender->notes}}</textarea>
                                    </div>
                                </div>
                            </div>
...
<script src="{{url('/')}}/resources/js/tenders/tender/edit.js" type="text/javascript"></script>
