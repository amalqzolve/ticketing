                ...
                <div class="kt-portlet__head-wrapper">
                    <div class="kt-portlet__head-actions">
                        <div class="dropdown dropdown-inline">
                            <a href="{{url('tenders/tender-add')}}" class="btn btn-brand btn-elevate btn-icon-sm">
...
<script src="{{url('/')}}/resources/js/tenders/tender/list.js" type="text/javascript"></script>
<!-- end::Global Config -->
