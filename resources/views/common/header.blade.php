...
<html lang="{{$locale}}">
   ...
   <head>
      ...
      <style>
         ...
         background-image: url("{{ URL::asset('assets') }}/media/bg/brope.jpg");
         }
         .userimg
         {
            overflow: hidden; 
      ...
      <div class="kt-aside  kt-aside--fixed  kt-grid__item kt-grid kt-grid--desktop kt-grid--hor-desktop" id="kt_aside">
         ...
         <div class="kt-aside__brand kt-grid__item " id="kt_aside_brand">
            <div class="kt-aside__brand-logo">
               <a href="{{url('/')}}">
               <img alt="Logo" src="{{ URL::asset('assets') }}/media/company-logos/logo-2.png" />
               </a>
            </div>
         ...
         <div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
            <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
               <ul class="kt-menu__nav ">
                  <li class="kt-menu__item " aria-haspopup="true"><a href="{{url('/')}}/users" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Users</span></a></li>
                  <li class="kt-menu__item " aria-haspopup="true"><a href="{{url('/')}}/userInfo" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Users Info</span></a></li>
                  <li class="kt-menu__item " aria-haspopup="true"><a href="{{url('/')}}/userInfoSingle" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Signle Users Info</span></a></li>
                  <li class="kt-menu__item " aria-haspopup="true"><a href="{{url('/')}}/roles" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Roles</span></a></li>
                  <li class="kt-menu__item " aria-haspopup="true"><a href="{{url('/')}}/permissions_menu" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Permissions</span></a></li>
                  <li class="kt-menu__item " aria-haspopup="true"><a href="{{url('/')}}/appPermission" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">App Permission</span></a></li>
                  <li class="kt-menu__item " aria-haspopup="true"><a href="{{url('/')}}/userActivity" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">User Activity</span></a></li>
                  <li class="kt-menu__item " aria-haspopup="true"><a href="{{url('/')}}/changelog" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Change Log</span></a></li>
               </ul>
            </div>
         </div>
         <!-- end:: Aside Menu -->
      ...
      <div id="kt_header" class="kt-header kt-grid__item  kt-header--fixed ">
         ...
         <div class="kt-header-menu-wrapper" id="kt_header_menu_wrapper">
            <div id="kt_header_menu" class="kt-header-menu kt-header-menu-mobile  kt-header-menu--layout-default ">
               <!-- <ul class="kt-menu__nav ">
                  <li class="kt-menu__item  kt-menu__item--open kt-menu__item--here kt-menu__item--submenu kt-menu__item--rel kt-menu__item--open kt-menu__item--here kt-menu__item--active" data-ktmenu-submenu-toggle="click" aria-haspopup="true"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-text">{{ __('app.Pages') }}</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
                  ...
                  <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel" data-ktmenu-submenu-toggle="click" aria-haspopup="true"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-text">{{ __('app.Features') }}</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
                  ...
                  <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel" data-ktmenu-submenu-toggle="click" aria-haspopup="true"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-text">{{ __('app.Apps') }}</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
                     <div class="kt-menu__submenu kt-menu__submenu--classic kt-menu__submenu--left">
                        <ul class="kt-menu__subnav">
                           <li class="kt-menu__item " aria-haspopup="true"><a href="javascript:;" class="kt-menu__link "><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                     <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
         ...
         <div class="kt-header__topbar">
            ...
            <div class="dropdown mt-3">
               ...
               <div class="dropdown-menu">
                  ...
                  <a class="dropdown-item" href="{{url('/')}}/userInfo">Users Info</a>
                  <a class="dropdown-item" href="{{url('/')}}/userInfoSingle">Single User</a>
                  <a class="dropdown-item" href="{{url('/')}}/roles">Roles</a>
                  <a class="dropdown-item" href="{{url('/')}}/permissions_menu">Permissions</a>
                  <a class="dropdown-item" href="{{url('/')}}/appPermission">App Permission</a>
                  <a class="dropdown-item" href="{{url('/')}}/userActivity">User Activity</a>
                  <a class="dropdown-item" href="{{url('/')}}/changelog">Change Log</a>
               </div>
            </div>
            <!-- </span>
               </div>
            ...
            <!-- <div class="kt-header__topbar-item dropdown">
               ...
               <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl">
                  <form>
                     ...
                     <div class="kt-head kt-head--skin-dark" style="background-image: url(public/assets/media/misc/bg-1.jpg)">
                        <h3 class="kt-head__title">
                           User Quick Actions
                  ...
                  <form>
                     ...
                     Profile info, Timeline etc
                                 ...
                                 <a href="#" class="kt-mycart__pic">
                                    <img src="{{ URL::asset('assets') }}/media/products/product9.jpg" title="">
                                 </a>
                              </div>
                           </div>
                           <div class="kt-mycart__item">
                     ...
                     For PHoto & Others
                                 ...
                                 <a href="#" class="kt-mycart__pic">
                                    <img src="{{ URL::asset('assets') }}/media/products/product13.jpg" title="">
                                 </a>
                              </div>
                           </div>
                           <div class="kt-mycart__item">
                     ...
                     Profile info, Timeline etc
                                 ...
                                 <a href="#" class="kt-mycart__pic">
                                    <img src="{{ URL::asset('assets') }}/media/products/product16.jpg" title="">
                                 </a>
                              </div>
                           </div>
                           <div class="kt-mycart__item">
                     ...
                     For PHoto & Others
                                 ...
                                 <a href="#" class="kt-mycart__pic">
                                    <img src="{{ URL::asset('assets') }}/media/products/product15.jpg" title="" alt="">
                                 </a>
                              </div>
                           </div>
                        </div>
            ...
            <div class="kt-header__topbar-item kt-header__topbar-item--user">
               <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="0px,0px" aria-expanded="true">
                  <div class="kt-header__topbar-user">
                     ...
                     <span class="kt-badge kt-badge--username kt-badge--unified-success kt-badge--lg kt-badge--rounded kt-badge--bold"><?php $str = Auth::user()->name; ?>
                     <i class="fa fa-user-alt"></i></span>
                  </div>
               </div>
               <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(837px, 39px, 0px);     width: 264px !important;">
                  <!--begin: Head -->
                  <div class="kt-user-card kt-user-card--skin-dark kt-notification-item-padding-x p-5" >
                     <div class="kt-user-card__avatar mt-5">
                     </div>
                  ...
                  <div class="kt-notification">
                     <div class="mx-auto mb-5 rounded-circle userimg">
                        <img src="{{ URL::to('/') }}/public/{{Session::get('profile.0')}}" class="img-fluid " alt="NYC" >
                     </div >
                     <div class="row mt-5 pb-3 pt-5">
                        ...
                        <div class="col-12 text-center">
                           Login Date : DD/MM/YYYY
                        </div>

                     </div>
                     <div class="kt-notification__custom kt-space-between mt-3 row border border-0">
                        <div class="col-6">
                           <button type="button" class="btn btn-primary btn-sm  btn-block">View Profile</button>
                        </div>
                        <div class="col-6">
