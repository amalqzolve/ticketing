		...
		<div class="kt-portlet__head kt-portlet__head--lg">
			<div class="kt-portlet__head-label">
				...
				<h3 class="kt-portlet__head-title">
					Proposal Project synthesis
				</h3>
			</div>
			<div class="kt-portlet__head-toolbar">
				<div class="kt-portlet__head-wrapper">
					<div class="kt-portlet__head-actions">
						@can('project add-project-category-synthesis')
						<a href="{{url('project-category-synthesis-add')}}" class="btn btn-brand btn-elevate btn-icon-sm">
...
<script src="{{url('/')}}/resources/js/projects/projectCategorySynthesis/listing.js" type="text/javascript"></script>
@endsection