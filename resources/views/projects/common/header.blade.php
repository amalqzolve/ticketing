                ...
                <div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
                    <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
                        <ul class="kt-menu__nav ">
                            ...
                            <!-- Projects -->
                            @can('project main menu')
                            <li class="kt-menu__item  kt-menu__item--submenu projects" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    ...
                                    </span><span class="kt-menu__link-text"> Projects</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
                                <div class="kt-menu__submenu  "><span class="kt-menu__arrow"></span>
                                    <ul class="kt-menu__subnav">
                                        @can('project all-project menu')
                                        <li class="kt-menu__item projectlist" aria-haspopup="true">
                                            <a href="{{url('/projectlist')}}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">All Projects</span>
                                            </a>
                                        </li>
                                        @endcan
                                        @can('project project-approval menu')
                                        <li class="kt-menu__item project-approve-list" aria-haspopup="true">
                                            <a href="{{url('/project-approve-list')}}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Approval</span>
                                            </a>
                                        </li>
                                        @endcan
                                        @can('project project-awarded menu')
                                        <li class="kt-menu__item projects-awarded-list" aria-haspopup="true">
                                            <a href="{{url('/projects-awarded-list')}}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Awarded Projects</span>
                                            </a>
                                        </li>
                                        @endcan
                            ...
                            <!-- Tasks -->
                            @can('project task menu')
                            <li class="kt-menu__item task-list" aria-haspopup="true">
                                <a href="{{url('/task-list')}}" class="kt-menu__link ">
                                    <span class="kt-menu__link-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                <polygon points="0 0 24 0 24 24 0 24" />
                            ...
                            <!-- Projects Materials-->
                            @can('project project-materials menu')
                            <li class="kt-menu__item  kt-menu__item--submenu projectMaterials" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                <rect x="0" y="0" width="24" height="24" />
                                                <circle fill="#000000" opacity="0.3" cx="12" cy="12" r="10" />
                                    ...
                                    </span><span class="kt-menu__link-text"> Project Materials</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
                                <div class="kt-menu__submenu  "><span class="kt-menu__arrow"></span>
                                    <ul class="kt-menu__subnav">
                                        @can('project warehouse-inbound menu')
                                        <li class="kt-menu__item warehouse-inbound-list" aria-haspopup="true">
                                            <a href="{{url('/warehouse-inbound-list')}}" class="kt-menu__link ">
                                                <i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i>
                                                <span class="kt-menu__link-text">Warehouse Inbound</span>
                                            </a>
                                        </li>
                                        @endcan
                                        @can('project procurement-inbound menu')
                                        <li class="kt-menu__item procurement-stock-in-to-project" aria-haspopup="true">
                                            <a href="{{url('/procurement-stock-in-to-project')}}" class="kt-menu__link ">
                                                <i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i>
                                                <span class="kt-menu__link-text">Procurement Inbound</span>
                                            </a>
                                        </li>
                                        @endcan
                                    </ul>
                            ...
                            <li class="kt-menu__item  kt-menu__item--submenu settings" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon">
                                ...
                                <div class="kt-menu__submenu  "><span class="kt-menu__arrow"></span>
                                    <ul class="kt-menu__subnav">
                                        @can('project manage-labels menu')
                                        <li class="kt-menu__item managelabels" aria-haspopup="true">
                                            <a href="{{url('/managelabels')}}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Manage Labels</span>
                                            </a>
                                        </li>
                                        @endcan
                                        @can('project project-category menu')
                                        <li class="kt-menu__item project-category" aria-haspopup="true">
                                            <a href="{{url('/project-category')}}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Project Category</span>
                                            </a>
                                        </li>
                                        @endcan
                                        @can('project project-approval-synthesis menu')
                                        <li class="kt-menu__item project-category-synthesis" aria-haspopup="true">
                                            <a href="{{url('/project-category-synthesis')}}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Project Approval synthesis</span>
                                            </a>
                                        </li>
                                        @endcan
                                        @can('project task-state menu')
                                        <li class="kt-menu__item task-state" aria-haspopup="true">
                                            <a href="{{url('/task-state')}}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Task State</span>
                                            </a>
                                        </li>
                                        @endcan
                        ...
                        <div class="kt-header__topbar-item kt-header__topbar-item--user">
                            ...
                            <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl shadow">
                                ...
                                <div class="col-12" style="height: 168px;">
                                    <div class="mx-auto myavt" style="background-image: url('{{url('public')}}/{{ $usr->image }}');">
