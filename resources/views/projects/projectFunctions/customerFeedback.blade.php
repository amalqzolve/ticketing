			...
			<div class="kt-portlet__head">
				<div class="kt-portlet__head-toolbar">
					<ul class="nav nav-tabs nav-tabs-line nav-tabs-line-primary nav-tabs-line-2x" role="tablist">
						...
						<li class="nav-item">
							<a class="nav-link active" data-toggle="tab" href="{{URL::to('project-customer-feedback',$projectId)}}" role="tab">
			...
			<div class="kt-portlet__body">
				<div class="tab-content">
					...
					<div class="tab-pane active" role="tabpanel">
						...
						<!--Commenting  Section -->
						@can('project post-project-main-customer-feedback')
							...
							<div class="media-body">
								<form action="" id="data-from-main-comment">
									<div class="form-group">
										<textarea class="form-control" rows="5" id="comment" name="comment" maxlength="500" placeholder="Write a feedback...."></textarea>
						...
						<!--Commenting  Section -->
						<!--Comment  List -->
						@foreach ($projectCustomerComments as $key => $value)
						<div class="media border p-3 grp" id="">
							...
							<div class="media-body">
								...
								@can('project delete-project-main-customer-feedback')
								...
								<p>{{$value->comment}}</p>
								@if($value->file_path != '')
								<img src="{{url::to('public/project_customer_feedback_files',$project->id)}}/{{$value->file_path}}" style="width: 25%;" />
								@endif
								<div class="col-12 pt-2">
									@can('project post-project-replay-customer-feedback')
									...
									<div class="media p-3">
										...
										<div class="media-body">
											<div class="float-right dropdown">
												@can('project delete-project-replay-customer-feedback')
												<button type="button" class="btn dropdown-toggle" data-toggle="dropdown"></button>
												<div class="dropdown-menu">
											...
											<img src="{{url::to('public/project_sub_customer_feedback_files',$project->id)}}/{{$subComments->sub_file_path}}" style="width: 25%;" />
											@endif
										</div>
									</div>
									@endforeach
								...
								<div class="media p-3 cmnt" style="display:none;" id="3">
									...
									<div class="mr-3 mt-3 rounded-circle navatar2" style="background-image: url('{{url::to('public')}}/{{Auth::user()->image}}');"></div>
									<div class="media-body">
										<div class="form-group">
...
@endsection
@section('script')
<script src="{{url('/')}}/resources/js/projects/projectFunctions/customerFeedback.js" type="text/javascript"></script>
@endsection