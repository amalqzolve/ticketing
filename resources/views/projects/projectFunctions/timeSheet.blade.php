	...
	<div class="modal-dialog modal-xl" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="modalLabel">Add Time Sheet</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"></button>
			</div>
			<div class="modal-body">
				<form class="kt-form kt-form--label-right" id="data-from" name="data-from" autocomplete="off">
							...
							<div class="col-lg-6">
								<div class="form-group row pr-md-3">
									...
									<div class="col-md-8 input-group input-group-sm">
										<select class="form-control kt-selectpicker" id="task" name="task">
								...
								<div class="form-group row pr-md-3">
									...
									<div class="col-md-10">
										<div class="input-group  input-group-sm">
											<textarea class="form-control" name="description" id="description" cols="30" rows="5" maxlength="500"></textarea>
										</div>
									</div>
								</div>
							</div>
			...
			<div class="modal-footer">
				...
				<button type="button" id="btnSaveTimeSheet" class="btn btn-brand kt-spinner--left kt-spinner--sm kt-spinner--light">
			...
			<div class="kt-portlet__head">
				<div class="kt-portlet__head-toolbar">
					<ul class="nav nav-tabs nav-tabs-line nav-tabs-line-primary nav-tabs-line-2x" role="tablist">
						...
						<li class="nav-item">
							<a class="nav-link active" data-toggle="tab" href="{{URL::to('project-time-sheet',$projectId)}}" role="tab">
					...
					<div class="tab-pane active" role="tabpanel">
						...
						<div class="kt-portlet__head ">
							<div class="kt-portlet__head-label">
								<h5 class="kt-portlet__head-title">Time Sheet</h5>
							</div>
							<div class="kt-portlet__head-toolbar">
								<div class="kt-portlet__head-wrapper">
									<div class="kt-portlet__head-actions">
										@can('project add-project-time-sheet')
										<button type="button" id="btnAdd" class="btn btn-default btn-brand btn-elevate btn-icon-sm" data-type="add"><i class="la la-plus"></i>Time Sheet</button>
										@endcan
									</div>
								</div>
							</div>
						...
						<table class="table table-striped  table-hover table-checkable" id="timeSheetTbl">
							<thead>
								<tr>
...
<script src="{{url('/')}}/resources/js/projects/projectFunctions/timeSheet.js" type="text/javascript"></script>
@endsection