			...
			<div class="kt-portlet__head">
				<div class="kt-portlet__head-toolbar">
					<ul class="nav nav-tabs nav-tabs-line nav-tabs-line-primary nav-tabs-line-2x" role="tablist">
						...
						<li class="nav-item">
							<a class="nav-link active" data-toggle="tab" href="{{URL::to('project-invoices',$projectId)}}" role="tab">
...
@endsection
@section('script')
<script src="{{url('/')}}/resources/js/projects/projectFunctions/invoices.js" type="text/javascript"></script>
@endsection