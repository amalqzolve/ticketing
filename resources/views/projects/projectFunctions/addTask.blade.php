    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Add Task - {{$project->projectname}}</h5>
                                    ...
                                    <div class="col-md-8 pl-4">
                                        <div class="input-group  input-group-sm">
                                            <select class="form-control single-select kt-selectpicker" id="milestone" name="milestone">
                                                ...
                                                @foreach($milestone as $mileston)
                                                <option value="{{$mileston->id}}">{{$mileston->milestone_title}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-8 pl-4">
                                        <div class="input-group  input-group-sm">
                                            <select class="form-control single-select kt-selectpicker" id="assign_to" name="assign_to">
                                                ...
                                                <option value="{{$member->id}}">{{$member->employee_name_field}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
