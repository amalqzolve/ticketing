	...
	<div class="modal-dialog modal-xl" role="document">
		<div class="modal-content">
						...
						<div class="form-group row">
								...
								<div class="form-group row pr-md-3">
									...
									<div class="col-md-8 pl-4">
										<div class="input-group  input-group-sm">
											<input type="text" class="form-control" placeholder="{{ __('customer.Title') }} " id="milestone_title" name="milestone_title" autocomplete="off">
										</div>
									</div>
								</div>
							</div>
							...
							<div class="col-lg-6">
								<div class="form-group row pr-md-3">
									...
									<div class="col-md-8 input-group input-group-sm">
										<input type="text" class="form-control kt_datetimepicker" value="{{date('d-m-Y')}}" name="milestone_due_date" id="milestone_due_date">
									</div>
								</div>
							</div>
							...
							<div class="col-lg-12">
								<div class="form-group row pr-md-3">
									...
									<div class="col-md-10">
										<div class="input-group  input-group-sm">
											<textarea class="form-control" name="milestone_description" id="milestone_description" cols="30" rows="5" maxlength="500"></textarea>
										</div>
									</div>
								</div>
							</div>
			...
			<div class="modal-footer">
				...
				<button type="button" id="btnSaveMilestone" class="btn btn-brand kt-spinner--left kt-spinner--sm kt-spinner--light">
			...
			<div class="kt-portlet__head">
				<div class="kt-portlet__head-toolbar">
					<ul class="nav nav-tabs nav-tabs-line nav-tabs-line-primary nav-tabs-line-2x" role="tablist">
						...
						<li class="nav-item">
							<a class="nav-link active" data-toggle="tab" href="{{URL::to('project-milestones',$projectId)}}" role="tab">
					...
					<div class="tab-pane active" role="tabpanel">
						...
						<div class="kt-portlet__head ">
							<div class="kt-portlet__head-label">
								<h5 class="kt-portlet__head-title">Milestones</h5>
							</div>
							<div class="kt-portlet__head-toolbar">
								<div class="kt-portlet__head-wrapper">
									<div class="kt-portlet__head-actions">
										@can('project add-project-milestone')
										<button type="button" id="btnAdd" class="btn btn-default btn-brand btn-elevate btn-icon-sm" data-type="add"><i class="la la-plus"></i>New Milestone</button>
										@endcan
									</div>
								</div>
							</div>
						...
						<table class="table table-striped  table-hover table-checkable" id="milestonesTbl">
							<thead>
								<tr>
...
<script src="{{url('/')}}/resources/js/projects/projectFunctions/milestones.js" type="text/javascript"></script>
@endsection