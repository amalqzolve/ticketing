	...
	<div class="modal-dialog modal-xl" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="modalLabel">Upload Contract</h5>
				...
				<form class="kt-form kt-form--label-right">
					<div class="kt-portlet__body">
						<div class="form-group row">
							<input type="hidden" name="projectContractData" id="projectContractData" value="" />
							<div id="choose-project-contract" style="width: 100%;">
								<input type="file" id="project_contract" name="project_contract[]" accept="image/*" />
							</div>
...
<div class="modal fade" id="kt_modal_4_6" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
	<div class="modal-dialog modal-xl" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="modalLabel">Edit Contract Details</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"></button>
			</div>
			<div class="modal-body">
								...
								<div class="form-group row pr-md-3">
									...
									<div class="col-md-10">
										<div class="input-group  input-group-sm">
											<textarea class="form-control" name="description" id="description" cols="30" rows="8" maxlength="1000"></textarea>
										</div>
									</div>
								</div>
							</div>
			...
			<div class="modal-footer">
				...
				<button type="button" id="btnSave" class="btn btn-brand kt-spinner--left kt-spinner--sm kt-spinner--light">
...
<link rel="stylesheet" type="text/css" href="{{ URL::asset('assets') }}/plugins/datatables/datatables.bundle.css" />
			...
			<div class="kt-portlet__head">
				<div class="kt-portlet__head-toolbar">
					<ul class="nav nav-tabs nav-tabs-line nav-tabs-line-primary nav-tabs-line-2x" role="tablist">
						...
						<li class="nav-item">
							<a class="nav-link active" data-toggle="tab" href="{{URL::to('project-contracts',$projectId)}}" role="tab">
					...
					<div class="tab-pane active" role="tabpanel">
						...
						<div class="kt-portlet__head ">
							<div class="kt-portlet__head-label">
								<h5 class="kt-portlet__head-title">Contracts</h5>
							</div>
							<div class="kt-portlet__head-toolbar">
								<div class="kt-portlet__head-wrapper">
									<div class="kt-portlet__head-actions">
										@can('project add-project-contracts')
										<button type="button" id="btnAdd" class="btn btn-default btn-brand btn-elevate btn-icon-sm" data-type="add"><i class="la la-plus"></i>New Contract</button>
										@endcan
									</div>
								</div>
							</div>
						...
						<input type="hidden" name="project_id" id="project_id" value="{{$project->id}}">
						<table class="table table-striped  table-hover table-checkable" id="contarctTbl">
							<thead>
								<tr>
...
<script src="{{url('/')}}/resources/js/projects/projectFunctions/contracts.js" type="text/javascript"></script>
@endsection