...
<head>
  ...
  <page size="A4">
    <form action="{{ route('mark-desc-project') }}" id="frmAction" method="POST" style="padding-block: 73px;  padding-left: 20px;  padding-right: 20px;">
      @csrf
      <input type="hidden" name="token" value="{{$token}}">
      <input type="hidden" name="project_id" value="{{$mainData->id}}">
                ...
                <td style="border-color: white;   padding-top: 0; padding-right: 0; padding-bottom: 0;  ">
                  ...
                  <table style=" width: 100%; ">
                    <tr>
                      ...
                      <td style="border-color: white; padding: 0;text-align: left;  font-size:11px; color: red;">&nbsp;PRJ {{$mainData->id}}</td>
                    </tr>
                    <tr>
                      <td style="border-color: white; padding: 0; font-weight: bold;  font-size:11px;">Start Date</td>
                      <td style="border-color: white; padding: 0;text-align:  left;  font-size:11px;">&nbsp;{{date('d-m-Y',strtotime($mainData->startdate))}}</td>
                    ...
                    <tr>
                      ...
                      <td style="border-color: white; padding: 0;text-align:  left;  font-size:11px;">&nbsp;{{date('d-m-Y',strtotime($mainData->enddate))}}</td>
                    ...
                    <tr>
                      ...
                      <td style="border-color: white;padding: 0; font-size: 11px; text-align: left;">&nbsp;{{$mainData->poject_category}}</td>
                    </tr>
                      ...
                      <td colspan="2" style="border-color: white; ">
                        ...
                        <table style=" padding:0">
                          ...
                          <tr>
                            ...
                            <td style="border-color: white; padding:0;">&nbsp;</td>
                            <td style="border-color: white; padding:0; text-align:right;"> <span style="font-weight: bold;">Created by </span>:{{$mainData->created_name}} <br>Date: {{ $mainData->created_on }}</td>
                      </td>
                    </tr>
                  </table>
                </td>
