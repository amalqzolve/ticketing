        ...
        <div class="kt-portlet__head kt-portlet__head--lg">
            <div class="kt-portlet__head-label">
                ...
                <h3 class="kt-portlet__head-title">
                    Procurement Inbound To Project
                </h3>
            </div>
        ...
        <div class="kt-portlet__body pl-2 pr-2 pb-0">
            ...
            <form class="kt-form" id="kt_form" name="kt_form">
                ...
                <ul class="nav nav-tabs nav-fill" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab" href="#kt_tabs_2_1">Receive Details</a>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        ...
                                        <input type="text" name="supplier_name" id="supplier_name" class="form-control" value="{{$MaterialRequest->sup_name}}" readonly>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <input type="text" name="transfer_type" id="transfer_type" class="form-control" value="{{$MaterialRequest->transfer_type}}" readonly>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <input type="text" name="projectname" id="projectname" class="form-control" value="{{$MaterialRequest->projectname}}" readonly>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <input type="text" id="warehouse_transfer_date" name="warehouse_transfer_date" value="{{isset($MaterialRequest->warehouse_transfer_date)?date('d-m-Y',strtotime($MaterialRequest->warehouse_transfer_date)):date('d-m-Y')}}" class="form-control" readonly>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <input type="hidden" name="project_id" id="project_id" value="{{$MaterialRequest->project_id}}">
                                        <input type="text" name="projectname" id="projectname" class="form-control" value="{{$MaterialRequest->projectname}}" readonly>
                                    </div>
                                </div>
                            </div>
                                ...
                                <thead class="thead-light">
                                    <tr>
                                       ...
                                       color: white; white-space: nowrap;     padding: 2px 7px !important;">@lang('app.Unit')</th>
                                        <th style="background-color:  #3f4aa0;
                                       color: white; white-space: nowrap;     padding: 2px 7px !important;" width="75px">Quantity</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @php
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="hidden" class="form-control rate" name="rate[]" id="rate{{$key+1}}" data-id="{{$key+1}}" value="{{$cinvoice_products['rate']}}" readonly>
                                            <input type="hidden" class="form-control qinventory_product_id" name="qinventory_product_id[]" id="qinventory_product_id{{$key+1}}" data-id="{{$key+1}}" value="{{$cinvoice_products['qinventory_product_id']}}" readonly>
                                            <input type="hidden" class="form-control eprPoProductId" name="eprPoProductId[]" id="eprPoProductId{{$key+1}}" data-id="{{$key+1}}" value="{{$cinvoice_products['epr_po_product_id']}}" readonly>
                                        ...
                                        <td><input type="text" class="form-control receivedQty" name="receivedQty[]" id="receivedQty{{$key+1}}" data-id="{{$key+1}}" value="{{$cinvoice_products['receivedquantity']}}" readonly></td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
...
<script src="{{url('/')}}/resources/js/projects/receiveStockToProject/add.js" type="text/javascript"></script>
@endsection