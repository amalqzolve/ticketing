			...
			<div class="kt-portlet__head-toolbar">
				<div class="kt-portlet__head-wrapper">
					<div class="kt-portlet__head-actions">
						...
						<a href="{{url('/')}}/addprojects" class="btn btn-brand btn-elevate btn-icon-sm">
						...
						<ul class="nav nav-tabs nav-tabs-line nav-tabs-line-primary nav-tabs-line-2x" role="tablist">
							...
							<li class="nav-item">
								<a class="nav-link" data-toggle="tab" href="#kt_portlet_base_demo_1_2_tab_content" role="tab">
									<i class="la la-mail-forward"></i> Send
								</a>
							</li>
							<li class="nav-item">
								<a class="nav-link" data-toggle="tab" href="#kt_portlet_base_demo_1_3_tab_content" role="tab">
									<i class="la la-check-circle-o"></i>Approved
								</a>
							</li>
							<li class="nav-item">
								<a class="nav-link" data-toggle="tab" href="#kt_portlet_base_demo_1_4_tab_content" role="tab">
									<i class="la la-times-circle-o"></i>Rejected
								</a>
							</li>
						</ul>
					</div>
				...
				<div class="kt-portlet__body">
					<div class="tab-content">
						<div class="tab-pane active" id="kt_portlet_base_demo_1_1_tab_content" role="tabpanel">
							<table class="table table-striped table-hover table-checkable dataTable no-footer" id="projects_list">
								<thead>
									<tr>
						...
						<div class="tab-pane" id="kt_portlet_base_demo_1_2_tab_content" role="tabpanel">
							<table class="table table-striped table-hover table-checkable dataTable no-footer" id="projects_list_send">
								<thead>
									<tr>
										<th>{{ __('product.S.No') }}</th>
										<th>Client</th>
						...
						<div class="tab-pane" id="kt_portlet_base_demo_1_3_tab_content" role="tabpanel">
							<table class="table table-striped table-hover table-checkable dataTable no-footer" id="projects_list_approved">
								<thead>
									<tr>
										<th>{{ __('product.S.No') }}</th>
										<th>Client</th>
						...
						<div class="tab-pane" id="kt_portlet_base_demo_1_4_tab_content" role="tabpanel">
							<table class="table table-striped table-hover table-checkable dataTable no-footer" id="projects_list_rejected">
								<thead>
									<tr>
										<th>{{ __('product.S.No') }}</th>
										<th>Client</th>
