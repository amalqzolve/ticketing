@extends('projects.common.layout') @section('content')
...
foreach ($projects as $projects) {
	...
	$poject_category_id = $projects->poject_category_id;
	$ponumber = $projects->ponumber;
	$povalue = $projects->povalue;
	$podate = $projects->podate;
	$internal_ref = $projects->internal_ref;
			...
			<div class="row" style="padding-bottom: 6px;">
					...
					<div class="form-group row pr-md-3">
						...
						<div class="col-md-8 input-group input-group-sm">
							<select class="form-control single-select kt-selectpicker" id="poject_category_id" name="poject_category_id">
								...
								<option value="{{$categoryValue->id}}" {{($categoryValue->id==$poject_category_id)?'selected':''}}>{{$categoryValue->name}}</option>
								@endforeach
							</select>
				...
				<div class="col-lg-6">
					<div class="form-group row pr-md-3">
						...
						<div class="col-md-8 input-group input-group-sm">
							<input type="text" class="form-control number" name="ponumber" id="ponumber" value="{{$ponumber}}">
						</div>
					</div>
				</div>
				...
				<div class="col-lg-12">
					<div class="form-group row pr-md-3">
						...
						<div class="col-md-10 input-group input-group-sm">
							<textarea name="internal_ref" id="internal_ref" class="form-control" cols="30" rows="3">{{$internal_ref}}</textarea>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-12">
					<div class="form-group row pr-md-3">
						...
						<div class="col-md-10 input-group input-group-sm">
							<textarea name="notes" id="notes" class="form-control" cols="30" rows="3">{{$notes}}</textarea>
						</div>
					</div>
				</div>
