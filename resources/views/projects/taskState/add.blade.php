				...
				<div class="row" style="padding-bottom: 6px;">
					...
					<div class="col-lg-6">
						<div class="form-group row pr-md-3">
							...
							<div class="col-md-8 input-group input-group-sm">
								<input type="text" class="form-control integerVal" name="data_order" placeholder="Data Order" id="data_order" maxlength="3">
							</div>
						</div>
					</div>
					...
					<div class="col-lg-6">
						<div class="form-group row pl-md-3">
							...
							<div class="col-md-8 input-group input-group-sm">
								<input type="text" class="form-control" name="decription" placeholder="Decription" id="decription" maxlength="200">
							</div>
						</div>
					</div>
				</div>
