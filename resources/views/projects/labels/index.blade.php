...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
	...
	<div class="kt-portlet kt-portlet--mobile">
		...
		<div class="kt-portlet__body">
			<table class="table table-striped  table-hover table-checkable" id="labels_details_list">
				<thead>
					<tr>
	...
	<div class="modal-dialog modal-xl" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button id="label_submit" class="btn btn-brand kt-spinner--right kt-spinner--sm kt-spinner--light">{{ __('app.Save') }}</button>
...
<script src="{{url('/')}}/resources/js/projects/labels.js" type="text/javascript"></script>
@endsection