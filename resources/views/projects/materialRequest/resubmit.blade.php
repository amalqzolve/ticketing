            ...
            <form class="kt-form" id="kt_form" name="kt_form">
                ...
                <div class="tab-content">
                    <div class="tab-pane p-2 active" id="kt_tabs_2_1" role="tabpanel">
                        ...
                        <input type="hidden" id="epr_id" name="epr_id" value="{{$MaterialRequest->epr_id}}">
                        <input type="hidden" id="id" name="id" value="{{$MaterialRequest->id}}">
                        <!-- ./DOCUMENT DETAILS -->
                            ...
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <input type="text" class="form-control kt_datetimepickerr" name="t_req_date" id="t_req_date" value="{{date('d-m-Y',strtotime($MaterialRequest->quotedate))}}">
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group input-group-sm">
                                                <input type="hidden" class="form-control single-select product_id kt-selectpicker" name="product_id[]" id="product_id" data-id="{{$key+1}}" value="{{$product->product_id}}" readonly>
                                                <input type="text" class="form-control single-select productname kt-selectpicker" name="productname[]" id="productname" data-id="{{$key+1}}" value="{{$product->itemname}}" readonly>
                                        </td>
                                        <td><textarea class="form-control" id="product_description{{$key+1}}" name="product_description[]" rows="1" data-id='{{$key+1}}' style=" height: 30px !important;">{{$product->description}}</textarea>
                                        </td>
                                        <td>
                                            <div>
                                                <select class="form-control form-control-sm single-select unit kt-selectpicker" data-id="{{$key+1}}" name="unit[]" id="unit{{$key+1}}">
                                                    ...
                                                    <option value="{{$data->id}}" {{($data->id==$product->unit)?'selected':''}}>{{$data->unit_name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="input-group input-group-sm">
                                            ...
                                            <div class="input-group input-group-sm">
                                                <input type="hidden" class="form-control quantity_value" name="quantity_value[]" id="quantity_value{{$key+1}}" data-id="{{$key+1}}" value="{{$product->quantity}}">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="input-group input-group-sm">
                                                <input type="text" class="form-control quantity" data-id="{{$key+1}}" name="quantity[]" id="quantity{{$key+1}}" value="{{$product->quantity}}">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="input-group input-group-sm">
                                                <input type="text" class="form-control warehouse" data-id="{{$key+1}}" name="warehouse[]" id="warehouse{{$key+1}}" value="{{$product->warehouse_name}}" readonly>
                                                <input type="hidden" class="form-control warehouse_id" data-id="{{$key+1}}" name="warehouse_id[]" id="warehouse_id{{$key+1}}" value="{{$MaterialRequest->warehouse}}">
                                            </div>
                                        </td>
...
<script src="{{url('/')}}/resources/js/projects/materialRequest/resubmit.js" type="text/javascript"></script>
<script>
