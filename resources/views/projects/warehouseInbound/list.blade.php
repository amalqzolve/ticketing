...
<link href="{{ URL::asset('assets/datatables/buttons.dataTables.min.css') }}" rel="stylesheet" type="text/css">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalLabel">Receive To Project</h5>
                        ...
                        <div class="form-group row">
                                ...
                                <div class="form-group row pr-md-3">
                                    ...
                                    <div class="col-md-9 pl-4">
                                        <div class="input-group  input-group-sm">
                                            <input type="text" class="form-control kt_datetimepicker" placeholder="d-m-y" id="received_date" name="received_date" autocomplete="off">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="form-group row pr-md-3">
                                    ...
                                    <div class="col-md-9 pl-4">
                                        <div class="input-group  input-group-sm">
                                            <textarea class="form-control" id="comment" name="comment" cols="30" rows="5" maxlength="500"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script src="{{url('resources/js/projects/warehouseInbound/list.js')}}" type="text/javascript"></script>
<!-- end::Global Config -->
