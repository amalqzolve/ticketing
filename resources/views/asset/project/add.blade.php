...
<div class="col-lg-6">
									...
									<input type="text" class="form-control ktdatepicker" name="projectdate" id="projectdate">
									</div>
									</div>
									</div>
									</div>
												...
												<div class="kt-form__actions">
													<div class="row">
														...
														<div class="col-lg-6 kt-align-right">
															<button type="submit" name="projects_submit" id="projects_submit" class="btn btn-primary float-right">
...
<script src="{{url('/')}}/resources/js/asset/project.js" type="text/javascript"></script>
