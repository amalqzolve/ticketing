...
<br/>
                       ...
                       <a href="{{url('/')}}/assetdepartment" class="btn btn-brand btn-elevate btn-icon-sm">
...
<table class="table table-striped table-hover table-checkable dataTable no-footer" id="departmentdetails_list">
    <thead>
        <tr>
