...
<br/>
                       ...
                       <a href="{{url('/')}}/geolocation" class="btn btn-brand btn-elevate btn-icon-sm">
...
<table class="table table-striped table-hover table-checkable dataTable no-footer" id="geolocationdetails_list">
    <thead>
        <tr>
