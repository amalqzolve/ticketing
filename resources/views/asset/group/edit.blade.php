							...
							<div class="kt-portlet kt-portlet--mobile">
                                ...
                                <form class="kt-form" id="kt_form">
                                 <div class="row" style="padding-bottom: 6px;">
                                    ...
                                    <div class="col-md-8 input-group input-group-sm">
                                    <textarea class="form-control" rows="1" name="description" id="description">{{$description}}</textarea>
                                    </div>
                                    </div>
                                    </div>
                                 ...
                                 <div class="kt-portlet__foot mr-0">
												<div class="kt-form__actions">
													<div class="row">
														<div class="col-lg-6">
														</div>
														<div class="col-lg-6 kt-align-right">
															<button type="submit" name="assetgroup_submit" id="assetgroup_submit" class="btn btn-primary float-right">
															...
															<button type="reset" class="btn btn-secondary float-right mr-1" onclick="goPrev()">
...
<!-- <script src="{{url('/')}}/resources/js/custom/select2.js" type="text/javascript"></script>
 -->
<script src="{{url('/')}}/resources/js/asset/group.js" type="text/javascript"></script>
