...
<br/>
                       ...
                       <a href="{{url('/')}}/assetrack" class="btn btn-brand btn-elevate btn-icon-sm">
...
<table class="table table-striped table-hover table-checkable dataTable no-footer" id="rackmanagement_list">
    <thead>
        <tr>
            ...
            <th>{{ __('rackmanagement.Warehouse') }}</th>
            <th>{{ __('rackmanagement.Store') }}</th>
            <th>{{ __('rackmanagement.Rack Name') }}</th>
            <th>{{ __('rackmanagement.Rack Manager') }}</th>
            <th>{{ __('rackmanagement.Rack In Charge') }}</th>
