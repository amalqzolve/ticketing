...
<tr >
   <td >{{$i}}</td>
   <td   style="cursor: pointer;"  class="viewchilden">{{ $component->asset_name  }}</td>
      <td   style="cursor: pointer;"  class="viewchilden">{{ $component->id  }}</td>
      <td   style="cursor: pointer;"  class="viewchilden">{{ $component->tag  }}</td><td   style="cursor: pointer;"  class="viewchilden">{{ $component->component_date  }}</td>
      


 <td   style="cursor: pointer;"  class="viewchilden">
      @if($component->component_date >=  Carbon\Carbon::today())
...
<td><span style="overflow: visible; position: relative; width: 80px;">
            <div class="dropdown"><a data-toggle="dropdown" class="btn btn-sm btn-clean btn-icon btn-icon-md">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                        <ul class="kt-nav">
                        <a href="{{url('/')}}/componentupdate?id={{$component->cid}}" data-type="edit" data-target="#kt_form"><li class="kt-nav__item">
                        <span class="kt-nav__link">
