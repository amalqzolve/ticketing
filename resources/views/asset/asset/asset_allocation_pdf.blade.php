    ...
    <table style="width:100%;" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <table style=" width: 100%; ">
                  <tr>
                    <td style="border-color: white; padding: 0; font-weight: bold;  font-size:11px; width: 30%;">Allocation Number</td>
              ...
              <tr>
                    ...
                    <td style="border-color: white; padding: 0;text-align:  right;  font-size:11px;">
                          ...
                          <tr>
                    <td style="border-color: white; padding: 0; font-weight: bold;  font-size:11px;">Allocated By</td>
                    <td style="border-color: white; padding: 0;text-align:  center;  font-size:11px;">{{ $sname}}</td>
                    <td style="border-color: white; padding: 0;text-align:  right;  font-size:11px;">
                ...
                <table  style=" padding:0">
                  ...
                  <tr>    
                    ...
                    <td style="height:60px; border-color: white; padding:0; font-size: 32px; text-align:right;">
                      <strong>Asset Allocation</strong><br>     </td>
                  </tr>
   ...
   <table style="table-layout: auto; " cellspacing="0" cellpadding="0" >
    ...
    <tr>
      <td  style="border-color: white;   padding: 1px; text-align: center;">
        <h3 style="letter-spacing: 0px; margin: 0;">Allocation Details </h3>
      </td>
    </tr>
    <tr>
      <td  style="border-color: white;   padding: 1px">
