...
<table class="table table-striped table-hover table-checkable dataTable no-footer" id="assetcategorydetails_list">
    <thead>
       <tr>
            <th>S.No</th>
            <th>Asset Name</th>
...
<script type="text/javascript">
   ...
   $(document).ready(function() {
      ...
      var assetcategorydetails_list_table = $('#assetcategorydetails_list').DataTable({
        processing: true,
         serverSide: false,
