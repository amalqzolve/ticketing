...
$("#productdetails_list_print").on("click", function() {
    ...
    asset_category_list_table.button('.buttons-print').trigger();
});


$("#productdetails_list_copy").on("click", function() {
    asset_category_list_table.button('.buttons-copy').trigger();
});

$("#productdetails_list_csv").on("click", function() {
    asset_category_list_table.button('.buttons-csv').trigger();
});

$("#productdetails_list_pdf").on("click", function() {
    asset_category_list_table.button('.buttons-pdf').trigger();
});
