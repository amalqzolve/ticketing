...
{
	$id = $parts->id;
	$name = $parts->part_name;
$date = $parts->part_date;
$days = $parts->reminderdays;
$notes = $parts->notes;
}
...
<div class="col-lg-6">
									...
									<input type="text" class="form-control ktdatepicker" name="partdate" id="partdate" value="{{$date}}">
									</div>
									</div>
									</div>
									</div>
									...
									<div class="col-md-8">
									<div class="input-group input-group-sm">
									<input type="text" class="form-control" name="description" id="description" placeholder="Notes" value="{{$notes}}">
									</div>
									</div>
									</div>
									</div>
												...
												<div class="kt-form__actions">
													<div class="row">
														...
														<div class="col-lg-6 kt-align-right">
															<button type="submit" name="parts_submit" id="parts_submit" class="btn btn-primary float-right">
