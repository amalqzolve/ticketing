...
<table class="table table-striped table-hover table-checkable dataTable no-footer" id="asset_service_list">
<thead>
<tr>
...
<tbody>
      <?php $i=1; ?>
       ...
       @foreach($service_assets as $asset)
<tr >
   <td >{{$i}}</td>
   <td   style="cursor: pointer;"  class="viewchilden">{{ $asset->asset_code  }}</td>
      <td   style="cursor: pointer;"  class="viewchilden">{{ $asset->asset_name  }}</td>
       ...
       <td  style="cursor: pointer;"  class="viewchilden"><?php
...
<tbody>
      <?php $i=1; ?>
       ...
       @foreach($maitenance_assets as $asset)
<tr >
   <td >{{$i}}</td>
   <td   style="cursor: pointer;"  class="viewchilden">{{ $asset->asset_code  }}</td>
   <td   style="cursor: pointer;"  class="viewchilden">{{ $asset->tag  }}</td>
      <td   style="cursor: pointer;"  class="viewchilden">{{ $asset->asset_name  }}</td>
         <td  style="cursor: pointer;"  class="viewchilden">{{$asset->tag}}</td>  
       <td  style="cursor: pointer;"  class="viewchilden">{{$asset->availability_status}}</td>
 ...
 <?php $i++; ?>
    @endforeach
            ...
            <div class="kt-wizard-v3__content   fadeIn" data-ktwizard-type="step-content">
               <div class="mt-3">
      <table class="table table-striped table-hover table-checkable dataTable no-footer" id="asset_warranty_list">
<thead>
<tr>
       <th>@lang('app.Sl.No')</th>
    <th>Asset ID</th>
...
<tbody>
      <?php $i=1; ?>
       ...
       @foreach($warranty_assets as $asset)
<tr >
   <td >{{$i}}</td>
   <td   style="cursor: pointer;"  class="viewchilden">{{ $asset->asset_code  }}</td>
      <td   style="cursor: pointer;"  class="viewchilden">{{ $asset->asset_name  }}</td>
 ...
 <?php $i++; ?>
    @endforeach
            ...
            <div class="kt-wizard-v3__content   fadeIn" data-ktwizard-type="step-content">
               <div class="mt-3">
      <table class="table table-striped table-hover table-checkable dataTable no-footer" id="asset_out_of_warranty_list">
<thead>
<tr>
        <th>@lang('app.Sl.No')</th>
    <th>Asset ID</th>
...
<tbody>
      <?php $i=1; ?>
       ...
       @foreach($outofWarranty_assets as $asset)
<tr >
   <td >{{$i}}</td>
   <td   style="cursor: pointer;"  class="viewchilden">{{ $asset->asset_code  }}</td>
      <td   style="cursor: pointer;"  class="viewchilden">{{ $asset->asset_name  }}</td>
 ...
 <?php $i++; ?>
    ...
    <div class="kt-wizard-v3__content   fadeIn" data-ktwizard-type="step-content">
               <div class="mt-3">
      <table class="table table-striped table-hover table-checkable dataTable no-footer" id="asset_damaged_list">
<thead>
<tr>
        <th>@lang('app.Sl.No')</th>
    <th>Asset ID</th>
...
<tbody>
      <?php $i=1; ?>
       ...
       @foreach($damaged_assets as $asset)
<tr >
   <td >{{$i}}</td>
   <td   style="cursor: pointer;"  class="viewchilden">{{ $asset->asset_code  }}</td>
      <td   style="cursor: pointer;"  class="viewchilden">{{ $asset->asset_name  }}</td>
 ...
 <?php $i++; ?>
    @endforeach
                ...
                <div class="kt-wizard-v3__content   fadeIn" data-ktwizard-type="step-content">
               <div class="mt-3">
      <table class="table table-striped table-hover table-checkable dataTable no-footer" id="asset_stolen_list">
<thead>
<tr>
        <th>@lang('app.Sl.No')</th>
    <th>Asset ID</th>
...
<tbody>
      <?php $i=1; ?>
       ...
       @foreach($stolen_assets as $asset)
<tr >
   <td >{{$i}}</td>
   <td   style="cursor: pointer;"  class="viewchilden">{{ $asset->asset_code  }}</td>
      <td   style="cursor: pointer;"  class="viewchilden">{{ $asset->asset_name  }}</td>
 ...
 <?php $i++; ?>
    @endforeach
                ...
                <div class="kt-wizard-v3__content   fadeIn" data-ktwizard-type="step-content">
               <div class="mt-3">
      <table class="table table-striped table-hover table-checkable dataTable no-footer" id="asset_scrap_list">
<thead>
<tr>
        <th>@lang('app.Sl.No')</th>
    <th>Asset ID</th>
...
<script type="text/javascript">
   ...
   $(document).ready(function() {
    var asset_service_list_table = $('#asset_service_list').DataTable({
        processing: true,
         serverSide: false,
    ...
    var asset_warranty_list_table = $('#asset_warranty_list').DataTable({
        processing: true,
         serverSide: false,
         pagingType: "full_numbers",
          scrollX: true,
    ...
    var asset_out_of_warranty_list_table = $('#asset_out_of_warranty_list').DataTable({
        processing: true,
         serverSide: false,
         pagingType: "full_numbers",
          scrollX: true,
    ...
    var asset_damaged_list_table = $('#asset_damaged_list').DataTable({
        processing: true,
         serverSide: false,
         pagingType: "full_numbers",
          scrollX: true,
    ...
    var asset_stolen_list_table = $('#asset_stolen_list').DataTable({
        processing: true,
         serverSide: false,
         pagingType: "full_numbers",
          scrollX: true,
    ...
    var asset_scrap_list_table = $('#asset_scrap_list').DataTable({
        processing: true,
         serverSide: false,
         pagingType: "full_numbers",
          scrollX: true,
