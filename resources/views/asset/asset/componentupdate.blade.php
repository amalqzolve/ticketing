...
$date = $component->component_date;
$days = $component->reminderdays;
...
<div class="col-lg-6">
									...
									<div class="col-md-4">
									<label>Component Date </label>
									</div>
									<div class="col-md-8">
									<div class="input-group input-group-sm">
									<input type="text" class="form-control ktdatepicker" name="componentdate" id="componentdate" value="{{$date}}">
									</div>
									</div>
									</div>
									</div>
									...
									<div class="col-md-8">
									<div class="input-group input-group-sm">
									<input type="text" class="form-control" name="days" id="days" value="{{$days}}">
									</div>
									</div>
									</div>
									</div>
												...
												<div class="kt-form__actions">
													<div class="row">
														...
														<div class="col-lg-6 kt-align-right">
															<button type="submit" name="component_submit" id="component_submit" class="btn btn-primary float-right">
...
<script src="{{url('/')}}/resources/js/asset/component.js" type="text/javascript"></script>
