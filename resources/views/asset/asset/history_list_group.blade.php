...
<table class="table table-striped table-hover table-checkable dataTable no-footer" id="asset_group_list">
<thead>
<tr>
...
<script type="text/javascript">
    $(document).ready(function(){
     ...
     $(document).ready(function() {
      ...
      var asset_group_list_table = $('#asset_group_list').DataTable({
        processing: true,
         serverSide: false,
...
$("#productdetails_list_print").on("click", function() {
    ...
    asset_group_list_table.button('.buttons-print').trigger();
});


$("#productdetails_list_copy").on("click", function() {
    asset_group_list_table.button('.buttons-copy').trigger();
});

$("#productdetails_list_csv").on("click", function() {
    asset_group_list_table.button('.buttons-csv').trigger();
});

$("#productdetails_list_pdf").on("click", function() {
    asset_group_list_table.button('.buttons-pdf').trigger();
});
