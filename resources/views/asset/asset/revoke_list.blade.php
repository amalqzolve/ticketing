                           ...
                           <div class="kt-portlet__head-toolbar">
                              <div class="kt-portlet__head-wrapper">
                                 <div class="kt-portlet__head-actions">
                                    <!--  <a type="button" class="btn btn-brand btn-elevate btn-icon-sm" href="{{url('/')}}/asset_revoke_add" ><i class="la la-plus"></i>{{ __('customer.New Record') }}</a>  -->
...
<tr >
   <td >{{$i}}</td>
   <td   style="cursor: pointer;"  class="viewchilden">{{$revoke->asset_name}}</td>
      <td   style="cursor: pointer;"  class="viewchilden">{{$revoke->asset_code}}</td>
      <td   style="cursor: pointer;"  class="viewchilden">{{$revoke->tag}}</td>
      <td   style="cursor: pointer;"  class="viewchilden">{{$revoke->f_name}}</td>
       <td  style="cursor: pointer;"  class="viewchilden">{{$revoke->allocation_date}}</td>
        <td  style="cursor: pointer;"  class="viewchilden">{{$revoke->return_date}}</td>
          ...
          <td><span style="overflow: visible; position: relative; width: 80px;">
            <div class="dropdown"><a data-toggle="dropdown" class="btn btn-sm btn-clean btn-icon btn-icon-md">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                        <ul class="kt-nav">
                           <a href="{{url('/')}}/asset_revoke_pdf?id={{$revoke->id}}" data-type="edit"  target="_blank" data-target="#kt_form"><li class="kt-nav__item">
                        <span class="kt-nav__link">
                        <i class="kt-nav__link-icon flaticon2-file-1"></i>
                        <span class="kt-nav__link-text" data-id="" >PDF</span>
                        </span></li></a>
                        <!-- <a href="#?id=" data-type="edit" data-toggle="modal" data-target="#kt_modal_4_5_1"><li class="kt-nav__item">
                        <span class="kt-nav__link">
                        <i class="kt-nav__link-icon flaticon2-edit"></i>
                        <span class="kt-nav__link-text boqupdate" data-id="" >Edit</span>
                        </span></li></a>
                         <a href="#?id=" data-type="edit" data-target="#kt_form"><li class="kt-nav__item">
                        <span class="kt-nav__link">
                        <i class="kt-nav__link-icon flaticon-background"></i>
                        <span class="kt-nav__link-text" data-id="" >Movement History</span>
                        </span></li></a>
                         <a href="#?id=" data-type="edit" data-target="#kt_form"><li class="kt-nav__item">
                        <span class="kt-nav__link">
