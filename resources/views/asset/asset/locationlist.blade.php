...
<table class="table table-striped table-hover table-checkable dataTable no-footer" id="assetlocationdetails_list">
    <thead>
       <tr>
            <th>S.No</th>
            <th>Asset Name</th>
...
<script type="text/javascript">
   ...
   $(document).ready(function() {
      ...
      var assetlocationdetails_list_table = $('#assetlocationdetails_list').DataTable({
        processing: true,
         serverSide: false,
