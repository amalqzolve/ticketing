...
<table class="table table-striped table-hover table-checkable dataTable no-footer" id="assetwarehousedetails_list">
    <thead>
       <tr>
            <th>S.No</th>
            <th>Asset Name</th>
...
<script type="text/javascript">
   ...
   $(document).ready(function() {
      ...
      var assetwarehousedetails_list_table = $('#assetwarehousedetails_list').DataTable({
        processing: true,
         serverSide: false,
