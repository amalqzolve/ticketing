...
<table class="table table-striped table-hover table-checkable dataTable no-footer" id="assetprojectdetails_list">
    <thead>
       <tr>
            <th>S.No</th>
            <th>Asset Name</th>
...
<script type="text/javascript">
   ...
   $(document).ready(function() {
      ...
      var assetprojectdetails_list_table = $('#assetprojectdetails_list').DataTable({
        processing: true,
         serverSide: false,
