								...
								<div class="kt-portlet__head kt-portlet__head--lg">
									...
									<div class="kt-portlet__head-toolbar">
										<div class="kt-portlet__head-wrapper">
                                         ...
                                         <!--        <a href="{{url('/')}}/rfqlisting" class="btn btn-brand btn-elevate">
                                                    <i class="la la-plus"></i>
                                                    @lang('app.RFQ')
                                                </a> -->
													<!-- <a href="{{url('/')}}/revised_quotation" class="btn btn-brand btn-elevate btn-icon-sm">
													
													@lang('sales.Revised Quotation')
												</a> -->
...
<table class="table table-striped table-hover table-checkable dataTable no-footer" id="asset_main_list">
<thead>
<tr>
...
<tr >
   <td >{{$i}}</td>
   <td   style="cursor: pointer;"  class="viewchilden">{{$all_asset->asset_code}}</td>
      <td   style="cursor: pointer;"  class="viewchilden">{{$all_asset->asset_name}}</td>
       <td  style="cursor: pointer;"  class="viewchilden">{{$all_asset->tag}}</td>  
       <td  style="cursor: pointer;"  class="viewchilden">{{$all_asset->f_name}}</td>
        <td  style="cursor: pointer;"  class="viewchilden"><?php if($all_asset->type=="Allocation"){ echo "<span style='color: green'>Allocated</span>"; }else{ echo "<span style='color: orange'>Revoked</span>"; } ?></td>
 ...
 <?php $i++; ?>
    ...
    @endforeach
            ...
            <div class="kt-wizard-v3__content   fadeIn" data-ktwizard-type="step-content">
               <div class="mt-3">
<table class="table table-striped table-hover table-checkable dataTable no-footer" id="asset_maingroup_list">
<thead>
<tr>
        <th>@lang('app.Sl.No')</th>
    <th>Group ID</th>
...
<tbody>
      <?php $i=1; ?>
 @foreach($all_assets_group as $all_asset)


<tr >
   <td >{{$i}}</td>
   <td   style="cursor: pointer;"  class="viewchilden">{{$all_asset->asset_gid}}</td>
      <td   style="cursor: pointer;"  class="viewchilden">{{$all_asset->asset_gname}}</td>
       <td  style="cursor: pointer;"  class="viewchilden">{{$all_asset->total}}</td> 
          ...
          <td><span style="overflow: visible; position: relative; width: 80px;">
            <div class="dropdown"><a data-toggle="dropdown" class="btn btn-sm btn-clean btn-icon btn-icon-md">
                        ...
                        <ul class="kt-nav">
                         ...
                         <a href="{{url('/')}}/asset_history_group?id={{$all_asset->asset_gid}}" data-type="edit"><li class="kt-nav__item">
                        <span class="kt-nav__link">
 ...
 <?php $i++; ?>
    ...
    @endforeach
            ...
            <div class="kt-wizard-v3__content   fadeIn" data-ktwizard-type="step-content">
               <div class="mt-3">
      <table class="table table-striped table-hover table-checkable dataTable no-footer" id="asset_category_list">
<thead>
<tr>
      <th>@lang('app.Sl.No')</th>
    <th>Category ID</th>
...
<tbody>
      <?php $i=1; ?>
 @foreach($all_assets_category as $all_asset)
...
<tr >
      ...
      <td><span style="overflow: visible; position: relative; width: 80px;">
            <div class="dropdown"><a data-toggle="dropdown" class="btn btn-sm btn-clean btn-icon btn-icon-md">
                        ...
                        <ul class="kt-nav">
                         ...
                         <a href="{{url('/')}}/asset_history_category?id={{$all_asset->asset_gid}}" data-type="edit"><li class="kt-nav__item">
                        <span class="kt-nav__link">
                        <i class="kt-nav__link-icon flaticon2-file-1"></i>
                        <span class="kt-nav__link-text" data-id="" >View</span>
                        </span></li></a>
 ...
 <?php $i++; ?>
    ...
    @endforeach
            ...
            <div class="kt-wizard-v3__content   fadeIn" data-ktwizard-type="step-content">
               <div class="mt-3">
      <table class="table table-striped table-hover table-checkable dataTable no-footer" id="asset_historytype_list">
<thead>
<tr>
        <th>@lang('app.Sl.No')</th>
    <th>Type ID</th>
...
<tbody>
      <?php $i=1; ?>
 @foreach($all_assets_type as $all_asset)
       ...
       <td><span style="overflow: visible; position: relative; width: 80px;">
            <div class="dropdown"><a data-toggle="dropdown" class="btn btn-sm btn-clean btn-icon btn-icon-md">
                        ...
                        <ul class="kt-nav">
                         ...
                         <a href="{{url('/')}}/asset_history_type?id={{$all_asset->asset_gid}}" data-type="edit"><li class="kt-nav__item">
                        <span class="kt-nav__link">
                        <i class="kt-nav__link-icon flaticon2-file-1"></i>
                        <span class="kt-nav__link-text" data-id="" >View</span>
                        </span></li></a>
...
<script type="text/javascript">
     ...
     $(document).ready(function() {
        var asset_main_list_table = $('#asset_main_list').DataTable({
        processing: true,
         serverSide: false,
...
var asset_maingroup_list_table = $('#asset_maingroup_list').DataTable({
        processing: true,
         serverSide: false,
         pagingType: "full_numbers",
          scrollX: true,
...
var asset_category_list_table = $('#asset_category_list').DataTable({
        processing: true,
         serverSide: false,
         pagingType: "full_numbers",
          scrollX: true,
 ...
 var asset_type_list_table = $('#asset_historytype_list').DataTable({
        processing: true,
         serverSide: false,
         pagingType: "full_numbers",
          scrollX: true,
 ...
 $("#productdetails_list_print").on("click", function() {
    ...
    asset_main_list_table.button('.buttons-print').trigger();
});


$("#productdetails_list_copy").on("click", function() {
    asset_main_list_table.button('.buttons-copy').trigger();
});

$("#productdetails_list_csv").on("click", function() {
    asset_main_list_table.button('.buttons-csv').trigger();
});

$("#productdetails_list_pdf").on("click", function() {
    asset_main_list_table.button('.buttons-pdf').trigger();
});
