                  ...
                  <div class="kt-portlet__head-toolbar">
                              <div class="kt-portlet__head-wrapper">
                                 <div class="kt-portlet__head-actions">
                                     <a type="button" class="btn btn-brand btn-elevate btn-icon-sm" href="{{url('/')}}/asset_allocation_add" ><i class="la la-plus"></i>{{ __('customer.New Record') }}</a> 
            ...
            <div class="kt-wizard-v3__nav border border-0">
                <div class="kt-wizard-v3__nav-items kt-wizard-v3__nav-items--clickable pl-2">
                   ...
                   <div class="kt-wizard-v3__nav-item" data-ktwizard-type="step" data-ktwizard-state="">
                      <div class="kt-wizard-v3__nav-body pb-0">
                         <div class="kt-wizard-v3__nav-label">
                            <!-- <span>1</span> -->     Borrower Allocation
                         </div>
                         <div class="kt-wizard-v3__nav-bar"></div>
                      </div>
                   </div>
                      ...
                      <div class="kt-wizard-v3__nav-body pb-0">
                         <div class="kt-wizard-v3__nav-label">
                            <!-- <span>1</span> -->   Allocated Materials
                         </div>
                         <div class="kt-wizard-v3__nav-bar"></div>
                      </div>
                   </div>
...
<tr >
   <td >{{$i}}</td>
      <td   style="cursor: pointer;"  class="viewchilden">#{{$allocation->id}}</td>

      <td   style="cursor: pointer;"  class="viewchilden">#{{$allocation->aid}}</td>
      <td   style="cursor: pointer;"  class="viewchilden">{{$allocation->asset_name}}</td>
      <td   style="cursor: pointer;"  class="viewchilden">{{$allocation->tag}}</td>

       <td  style="cursor: pointer;"  class="viewchilden">{{$allocation->f_name}}</td>  
       <td  style="cursor: pointer;"  class="viewchilden">{{$allocation->allocation_date}}</td>
      
       <td  style="cursor: pointer;"  class="viewchilden">{{$allocation->project_name}}</td>
        <td  style="cursor: pointer;"  class="viewchilden">{{$allocation->gname}}</td>
        <td  style="cursor: pointer;"  class="viewchilden">{{$allocation->sname}}</td>
          ...
          <td><span style="overflow: visible; position: relative; width: 80px;">
            <div class="dropdown"><a data-toggle="dropdown" class="btn btn-sm btn-clean btn-icon btn-icon-md">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                        <ul class="kt-nav">
                         <a href="{{url('/')}}/asset_revoke_add?id={{$allocation->id}}" data-type="edit" data-target="#kt_form"><li class="kt-nav__item">
                        <span class="kt-nav__link">
                        <i class="kt-nav__link-icon flaticon-background"></i>
                        <span class="kt-nav__link-text" data-id="" >Revoke</span>
                        </span></li></a>
                        <?php if(isset($allocation->location) && !empty($allocation->location)){?>
                         <a href="{{$allocation->location}}"  target="_blank"><li class="kt-nav__item">
                        <span class="kt-nav__link">
                        <i class="kt-nav__link-icon flaticon2-trash"></i>
                        <span class="kt-nav__link-text kt_child_delete" id="" data-id="">Active Location</span></span></li></a>
                       
                      <?php } ?>
                         <a href="{{url('/')}}/asset_allocation_pdf?id={{$allocation->id}}" data-type="edit" target="_blank"><li class="kt-nav__item">
                        <span class="kt-nav__link">
 ...
 <?php $i++; ?>
    ...
    @endforeach
            ...
            <div class="kt-wizard-v3__content   fadeIn" data-ktwizard-type="step-content">
               <div class="mt-3">
<table class="table table-striped table-hover table-checkable dataTable no-footer" id="asset_maitenance_list">
<thead>
<tr>
...
<tbody>
 ...
 <?php $i=1;  ?>
 @foreach($allocations_borrower as $allocation)
...
<tr >
   <td >{{$i}}</td>
      ...
      <td   style="cursor: pointer;"  class="viewchilden">{{$allocation->total}}</td>
          ...
          <td><span style="overflow: visible; position: relative; width: 80px;">
            <div class="dropdown"><a data-toggle="dropdown" class="btn btn-sm btn-clean btn-icon btn-icon-md">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                        <ul class="kt-nav">
                         <a href="{{url('/')}}/asset_allocation_borrower?id={{$allocation->borrower}}" data-type="edit" data-target="#kt_form"><li class="kt-nav__item">
                        <span class="kt-nav__link">
                        <i class="kt-nav__link-icon flaticon-background"></i>
                        <span class="kt-nav__link-text" data-id="" >View More</span>
                        </span></li></a>
...
<table class="table table-striped table-hover table-checkable dataTable no-footer" id="asset_maitenance_list">
 <thead>
    ...
    <tbody>
      <?php $i=1; ?>
 @foreach($allocations_materials as $allocation)
...
$("#productdetails_list_pdf").on("click", function() {
   ...
   $(document).ready(function() {
      ...
      var asset_maitenance_list_table = $('#asset_maitenance_list').DataTable({
        processing: true,
         serverSide: false,
          bAutoWidth: true,
         pagingType: "full_numbers",
...
$("#asset_maitenance_list_print").on("click", function() {
   
    asset_maitenance_list_table.button('.buttons-print').trigger();
});


$("#asset_maitenance_list_copy").on("click", function() {
    asset_maitenance_list_table.button('.buttons-copy').trigger();
});

$("#asset_maitenance_list_csv").on("click", function() {
    asset_maitenance_list_table.button('.buttons-csv').trigger();
});

$("#asset_maitenance_list_pdf").on("click", function() {
    asset_maitenance_list_table.button('.buttons-pdf').trigger();
});
