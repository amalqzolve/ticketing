...
<br/>
            ...
            <a type="button" class="btn btn-brand btn-elevate btn-icon-sm" href="{{url('/')}}/om_add" ><i class="la la-plus"></i>{{ __('customer.New Record') }}</a>
            ...
            <div class="kt-wizard-v3__nav border border-0">
                <div class="kt-wizard-v3__nav-items kt-wizard-v3__nav-items--clickable pl-2">
                    <div class="kt-wizard-v3__nav-item" data-ktwizard-type="step" data-ktwizard-state="current">
                      <div class="kt-wizard-v3__nav-body pb-0">
                         <div class="kt-wizard-v3__nav-label">
                            <!-- <span>1</span> --> Allocation Available
                         </div>
                   ...
                   <div class="kt-wizard-v3__nav-item" data-ktwizard-type="step" data-ktwizard-state="">
                      <div class="kt-wizard-v3__nav-body pb-0">
                         <div class="kt-wizard-v3__nav-label">
                            <!-- <span>1</span> --> Allocation Unavailable 
                         </div>
                         <div class="kt-wizard-v3__nav-bar"></div>
                      </div>
                   </div>
                   ...
                   </div>      <div class="kt-wizard-v3__nav-item" data-ktwizard-type="step" data-ktwizard-state="">
                      <div class="kt-wizard-v3__nav-body pb-0">
                         <div class="kt-wizard-v3__nav-label">
                            <!-- <span>1</span> --> Components
                         </div>
                         <div class="kt-wizard-v3__nav-bar"></div>
                      </div>
                   </div>
                     <div class="kt-wizard-v3__nav-item" data-ktwizard-type="step" data-ktwizard-state="">
                      <div class="kt-wizard-v3__nav-body pb-0">
                         <div class="kt-wizard-v3__nav-label">
                            <!-- <span>1</span> --> Operations & Maitenance
                         </div>
                         <div class="kt-wizard-v3__nav-bar"></div>
                      </div>
                   </div>
...
<tr >
    ...
    <td  style="cursor: pointer;"  class="viewchilden">{{ $asset->asset_status  }}</td>
          <td><span style="overflow: visible; position: relative; width: 80px;">
            <div class="dropdown"><a data-toggle="dropdown" class="btn btn-sm btn-clean btn-icon btn-icon-md">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                        <ul class="kt-nav">
                        <a href="asset_status_edit?id={{ $asset->id  }}"><li class="kt-nav__item">
                        <span class="kt-nav__link">
                        <i class="kt-nav__link-icon flaticon2-edit"></i>
                        <span class="kt-nav__link-text boqupdate" data-id="" >Update</span>
                        </span></li></a>
 ...
 <?php $i++; ?>
    @endforeach
            ...
            <div class="kt-wizard-v3__content   fadeIn" data-ktwizard-type="step-content">
               <div class="mt-3">
<table class="table table-striped table-hover table-checkable dataTable no-footer" id="umaindetails_list">
    <thead>
        <tr>
            <th>S.No</th>
            <th>Name</th>
...
<tr >
 ...
 <?php $i++; ?>
    @endforeach
        ...
        <div class="kt-wizard-v3__content   fadeIn" data-ktwizard-type="step-content">
               <div class="mt-3">
<table class="table table-striped table-hover table-checkable dataTable no-footer" id="parts_list">
    <thead>
    ...
    <tbody>
      <?php $i=1; ?>
       ...
       @foreach($asset_parts as $asset)
<tr >
   <td >{{$i}}</td>
   <td   style="cursor: pointer;"  class="viewchilden">{{ $asset->part_name  }}</td>
      <td   style="cursor: pointer;"  class="viewchilden">{{ $asset->asset_name  }}</td>
       <td  style="cursor: pointer;"  class="viewchilden">{{ $asset->asset_code  }}</td>
    <td   style="cursor: pointer;"  class="viewchilden">{{ $asset->tag  }}</td>
       <td  style="cursor: pointer;"  class="viewchilden">{{ $asset->part_date  }}</td>
       <td><?php $today = date("Y-m-d");
$expire =$asset->part_date;

$today_time = strtotime($today);
$expire_time = strtotime($expire);

if ($expire_time > $today_time) { echo ' Active'; }

 else {
    echo ' Expired';
} ?></td>
        <td  style="cursor: pointer;"  class="viewchilden">{{ $asset->reminderdays  }}</td>
</tr>
 <?php $i++; ?>
    @endforeach
            ...
            <div class="kt-wizard-v3__content   fadeIn" data-ktwizard-type="step-content">
               <div class="mt-3">
<table class="table table-striped table-hover table-checkable dataTable no-footer" id="components_list">
    <thead>
    ...
    <tbody>
      <?php $i=1; ?>
       ...
       @foreach($asset_components as $asset)
<tr >
   <td >{{$i}}</td>
   <td   style="cursor: pointer;"  class="viewchilden">{{ $asset->component_name  }}</td>
      <td   style="cursor: pointer;"  class="viewchilden">{{ $asset->asset_name  }}</td>
       <td  style="cursor: pointer;"  class="viewchilden">{{ $asset->asset_code  }}</td>
    <td   style="cursor: pointer;"  class="viewchilden">{{ $asset->tag  }}</td>
       <td  style="cursor: pointer;"  class="viewchilden">{{ $asset->component_date  }}</td>
       <td><?php $today = date("Y-m-d");
$expire =$asset->component_date;
...
if ($expire_time > $today_time) { echo ' Active'; }
 ...
 <?php $i++; ?>
    ...
    <div class="kt-wizard-v3__content   fadeIn" data-ktwizard-type="step-content">
               <div class="mt-3">
<table class="table table-striped table-hover table-checkable dataTable no-footer" id="services_list">
    <thead>
    ...
    <tbody>
      <?php $i=1; ?>
       ...
       @foreach($asset_services as $asset)
<tr >
   <td >{{$i}}</td>
   <td   style="cursor: pointer;"  class="viewchilden">{{ $asset->service_name  }}</td>
      <td   style="cursor: pointer;"  class="viewchilden">{{ $asset->asset_name  }}</td>
       <td  style="cursor: pointer;"  class="viewchilden">{{ $asset->asset_code  }}</td>
    <td   style="cursor: pointer;"  class="viewchilden">{{ $asset->tag  }}</td>
       <td  style="cursor: pointer;"  class="viewchilden">{{ $asset->service_date  }}</td>
       <td><?php $today = date("Y-m-d");
$expire =$asset->service_date;
...
<script type="text/javascript">
    $(document).ready(function(){
     ...
     $(document).ready(function() {
      ...
      var services_list_table = $('#services_list').DataTable({
        processing: true,
         serverSide: false,
    ...
    $(document).ready(function() {
      ...
      var components_list_table = $('#components_list').DataTable({
        processing: true,
         serverSide: false,
         pagingType: "full_numbers",
          scrollX: true,
   ...
   { "width": "20%" },
    ...
    $(document).ready(function() {
      ...
      var parts_list_table = $('#parts_list').DataTable({
        processing: true,
         serverSide: false,
         pagingType: "full_numbers",
          scrollX: true,
    ...
    $(document).ready(function() {
      ...
      var umaindetails_list_table = $('#umaindetails_list').DataTable({
        processing: true,
         serverSide: false,
         pagingType: "full_numbers",
          scrollX: true,
