...
<table class="table table-striped table-hover table-checkable dataTable no-footer" id="assettypedetails_list">
    <thead>
       <tr>
            <th>S.No</th>
            <th>Asset Name</th>
...
<script type="text/javascript">
   ...
   $(document).ready(function() {
      ...
      var assettypedetails_list_table = $('#assettypedetails_list').DataTable({
        processing: true,
         serverSide: false,
