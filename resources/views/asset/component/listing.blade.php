...
<br/>
                       ...
                       <a href="{{url('/')}}/assetcomponent" class="btn btn-brand btn-elevate btn-icon-sm">
...
<table class="table table-striped table-hover table-checkable dataTable no-footer" id="componentsdetails_list">
    <thead>
        <tr>
