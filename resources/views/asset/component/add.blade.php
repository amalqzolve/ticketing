...
<div class="col-lg-6">
									...
									<div class="col-md-4">
									<label style="white-space: nowrap;">Component Date </label>
									</div>
									<div class="col-md-8">
									<div class="input-group input-group-sm">
									<input type="text" class="form-control ktdatepicker" name="componentdate" id="componentdate">
									</div>
									</div>
									</div>
									</div>
									...
									<div class="col-md-8">
									<div class="input-group input-group-sm">
									<input type="text" class="form-control" name="description" id="description" placeholder="Notes">
									</div>
									</div>
									</div>
									</div>
