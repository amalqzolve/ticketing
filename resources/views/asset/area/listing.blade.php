...
<br/>
                       ...
                       <a href="{{url('/')}}/assetarea" class="btn btn-brand btn-elevate btn-icon-sm">
...
<table class="table table-striped table-hover table-checkable dataTable no-footer" id="areadetails_list">
    <thead>
        <tr>
