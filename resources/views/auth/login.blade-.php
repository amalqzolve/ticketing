    ...
    <form method="POST" action="{{ route('login') }}" class="bg-white shadow rounded px-8 pt-6 pb-8 mb-4">
        ...
        <div class="mb-6">
            <label class="block text-gray-500 font-bold">
                <input type="checkbox" name="remember" class="mr-2 leading-tight" value="{{ old('remember') ? 'checked' : '' }}">
                <span class="text-sm">
                    Remember Me
                </span>
            </label>
        ...
        <div class="flex items-center justify-between">
            ...
            <a class="inline-block align-baseline font-bold text-sm text-red-500 hover:text-red-800" href="{{route('password.update')}}">
                Forgot Password?
            </a>
        </div>
    </form>
