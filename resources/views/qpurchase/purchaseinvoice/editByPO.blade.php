                           ...
                           <table class="table table-striped table-bordered table-hover" id="costhead_table">
                              ...
                              <tbody>
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                       <select class="form-control costtax_group kt-selectpicker" name="costtax_group[]" id="costtax_group{{$key+1}}" data-id={{$key+1}}>
                     ...
                     <table class="table table-striped table-bordered table-hover" id="product_table" style="table-layout:fixed; width:100%; ">
                        <thead class="thead-light">
                           <tr>
                              ...
                              <th style="background-color:  #3f4aa0;  color: white; white-space: nowrap;     padding: 2px 7px !important;" width="75px">So Qty</th>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <td>{{$key+1}}</td>
                              <td>
                                 <input type="hidden" name="qbuy_purchase_order_product_id[]" id="qbuy_purchase_order_product_id" value="{{$pi_product->qbuy_purchase_order_product_id}}">
                              ...
                              <td><input type="text" class="form-control tquantity " name="tquantity[]" id="tquantity{{$key+1}}" data-id="{{$key+1}}" value="{{$pi_product->poquantity}}" readonly></td>
                              <td><input type="text" class="form-control bquantity " name="bquantity[]" id="bquantity{{$key+1}}" data-id="{{$key+1}}" value="{{$pi_product->pi_remaining_quantity+$pi_product->quantity}}" readonly></td>
               ...
               <div class="kt-form__actions">
                  <div class="row">
                     ...
                     <div class="col-lg-12 kt-align-right">
                        ...
                        <button type="button" class="btn btn-primary" id="pi_updateByPO"><svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check-circle icon-16">
...
<script>
   ...
   function checkBalanceAvailable(id) {
      ...
      var remainQty = $('#bquantity' + id + '').val();
      var error = 0;
      ...
      $(".addmorecosthead").click(function() {
         ...
         costs += '<tr>\
            ...
            <input type="text" class="form-control costrate integerVal" name="costrate[]" id="costrate' + rowcount + '"  data-id=' + rowcount + ' value="0">\
             ...
             <td>\
            <select class="form-control costtax_group kt-selectpicker" name="costtax_group[]" id="costtax_group' + rowcount + '" data-id=' + rowcount + '>\
               @foreach($taxgrouplist as $data)\
