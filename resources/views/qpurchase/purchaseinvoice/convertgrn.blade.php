   ...
   <div class="kt-portlet kt-portlet--mobile">
      ...
      <div class="kt-portlet__body pl-2 pr-2 pb-0">
         ...
         <form class="kt-form" id="kt_form">
            ...
            <input type="hidden" name="inv_id" id="inv_id" value="{{$purchaseInvoice->id}}">
            <input type="hidden" name="source" id="source" value="By Invoice">
                  ...
                  <div class="row">
                     ...
                     <div class="col-lg-6">
                        <div class="form-group  row pr-md-3">
                           ...
                           <div class="col-md-8 input-group-sm">
                              <input type="text" class="form-control " value="{{ $purchaseInvoice->id }}" readonly>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="col-lg-6">
                        <div class="form-group  row pr-md-3">
                           ...
                           <div class="col-md-8 input-group-sm">
                              <input type="text" class="form-control " value="{{ ($purchaseInvoice->bill_entry_date!='')?date('d-m-Y', strtotime($purchaseInvoice->bill_entry_date)):'' }}" readonly>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="col-lg-6">
                        <div class="form-group  row pr-md-3">
                           ...
                           <div class="col-md-8 input-group-sm">
                              <input type="text" class="form-control" value="{{$purchaseInvoice->qtnref}}" readonly>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="col-lg-6">
                        <div class="form-group  row pr-md-3">
                           ...
                           <div class="col-md-8 input-group-sm">
                              <input type="text" class="form-control " value="{{ $purchaseInvoice->po_wo_ref }}" readonly>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="col-lg-6">
                        <div class="form-group  row pr-md-3">
                           ...
                           <div class="col-md-8 input-group-sm">
                              <input type="text" class="form-control" value="{{ $purchaseInvoice->attention }}" readonly>
                           </div>
                        </div>
                     </div>
                     <div class="col-lg-6">
                        <div class="form-group  row pr-md-3">
                           ...
                           <div class="col-md-8 input-group-sm">
                              <input type="text" class="form-control" value="{{ $purchaseInvoice->purchasebillid }}" readonly>
                           </div>
                        </div>
                     </div>
                        ...
                        <div class="form-group  row pr-md-3">
                           ...
                           <div class="col-md-8 input-group-sm">
                              <select class="form-control kt-selectpicker" disabled>
                                 <option value="">select</option>
                                 @foreach($salesmen as $data)
                                 <option value="{{$data->id}}" {{($purchaseInvoice->purchaser == $data->id)?'selected':""}}>{{$data->name}}</option>
                                 @endforeach
                              </select>
                           </div>
                        </div>
                  ...
                  <div class=" pr-1 pl-1" style=" width: 100%;      background-color: #f2f3f8;   margin-top: -10px;">
                     <table class="table table-striped table-bordered table-hover" id="product_table" style="table-layout:fixed; width:100%; ">
                        ...
                        <tbody>
                           ...
                           ?>
                           @foreach($purchaseInvoiceProduct as $key=>$cinvoice_products)
                           @if($cinvoice_products->grn_remaining_quantity>0)
                           <tr>
                              <td>{{$key+1}}</td>
                              <td>
                                 ...
                                 <input type="hidden" class="form-control single-select purchase_invoice_products_id" name="purchase_invoice_products_id[]" id="purchase_invoice_products_id" data-id="{{$key+1}}" value="{{$cinvoice_products->purchase_invoice_products_id}}">
                              </td>
                              @if($branch_settings->inventory_stock_affect_at=='at-delivey-or-grn')
                              <td>
               ...
               <div class="kt-form__actions">
                  <div class="row">
                     ...
                     <div class="col-lg-12 kt-align-right">
                        ...
                        <button type="button" class="btn btn-primary" id="btnSaveFromInvoice"><svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check-circle icon-16">
...
<script>
   ...
   function totalCalculate() {
      ...
      $("input[name^='total_quantity[]']").each(function(input) {
         grandtotal_so_quantity += parseInt(getNum($(this).val()));
      });
      var grandtotal_received_quantity = 0;
      $("input[name^='recquantity[]']").each(function(input) {
         grandtotal_received_quantity += parseInt(getNum($(this).val()));
      });
      ...
      $('#grandtotal_so_quantity').val(grandtotal_so_quantity);
      $('#grandtotal_received_quantity').val(grandtotal_received_quantity);
