                  ...
                  <div class="row">
                     ...
                     <div class="col-lg-6">
                        <div class="form-group  row pr-md-3">
                           ...
                           <div class="col-md-8 input-group-sm">
                              ...
                              <input type="text" class="form-control" name="qtnref" id="qtnref" value="">
                           </div>
                        </div>
                     </div>
                     <div class="col-lg-6">
                        <div class="form-group  row pr-md-3">
                           ...
                           <div class="col-md-8 input-group-sm">
                              ...
                              <input type="text" class="form-control" name="po_wo_ref" id="po_wo_ref" value="">
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="col-lg-6">
                        <div class="form-group row pr-md-3">
                           ...
                           <div class="col-md-8 input-group input-group-sm">
                              <input type="text" class="form-control currency_value" name="currency_value" id="currency_value" value="" readonly>
                           </div>
                        </div>
                     </div>
                     ...
                     <input type="hidden" name="suppliernames" id="suppliernames" value="">
                     <div class="col-lg-6">
                        <div class="form-group row pr-md-3">
                           <div class="col-md-4">
            ...
            <div class="row mt-5">
               ...
               <div class="col-lg-6">
                  <div class="form-group  row pr-md-3">
                     ...
                     <div class="col-md-8 input-group-sm">
                        <input type="text" class="form-control" name="totalamount" id="totalamount" readonly style=" text-align: right; font-size: 1.25rem; background-color: #f2f3f8;  height: calc(1.25em + 1rem + 2px);" value="">
                     </div>
                  </div>
               </div>
               <div class="col-lg-6">
               ...
               <div class="col-lg-6">
                  <div class="form-group  row pr-md-3">
                     ...
                     <div class="col-md-8 input-group-sm">
                        <input type="text" class="form-control discount" name="discount" id="discount" value="" readonly style=" text-align: right; font-size: 1.25rem; background-color: #f2f3f8;  height: calc(1.25em + 1rem + 2px);">
                     </div>
                  </div>
               </div>
               <div class="col-lg-6">
               ...
               <div class="col-lg-6">
                  <div class="form-group  row pr-md-3">
                     ...
                     <div class="col-md-8 input-group-sm">
                        <input type="text" class="form-control" name="amountafterdiscount" id="amountafterdiscount" readonly style=" text-align: right; font-size: 1.25rem; background-color: #f2f3f8;  height: calc(1.25em + 1rem + 2px);" value="">
                     </div>
                  </div>
               </div>
               <div class="col-lg-6">
               ...
               <div class="col-lg-6">
                  <div class="form-group  row pr-md-3">
                     ...
                     <div class="col-md-8 input-group-sm">
                        <input type="text" class="form-control" name="totalvatamount" id="totalvatamount" readonly style=" text-align: right; font-size: 1.25rem; background-color: #f2f3f8;  height: calc(1.25em + 1rem + 2px);" value="">
                     </div>
                  </div>
               </div>
               <div class="col-lg-6">
               ...
               <div class="col-lg-6">
                  <div class="form-group  row pr-md-3">
                     ...
                     <div class="col-md-8 input-group-sm">
                        <input type="text" class="form-control" name="grandtotalamount" id="grandtotalamount" readonly value="" style="background-color: #ffffff00;  border: none;  text-align: right;  font-size: 1.75rem;  font-weight: bold; color: #646c9a; padding-top: 0px;">
                     </div>
                  </div>
               </div>
            </div>
                     ...
                     <div class="col-lg-6">
                        <div class="form-group  row pr-md-3">
                           ...
                           <div class="col-md-4 useAdvance" style="display:none">
                              Debit Balance : <div id="balance">0</div>
                              <input type="hidden" name="debitBalance" id="debitBalance" value="0">
                           </div>
                        </div>
                     </div>
                  ...
                  <div class="row mt-5">
                     ...
                     <div class="col-lg-6">
                        <div class="form-group  row pr-md-3">
                           ...
                           <div class="col-md-8 input-group-sm">
                              <input type="text" class="form-control totalinvoicedamount " name="totalinvoicedamount" id="totalinvoicedamount" value="0" readonly="" style="background-color: #ffffff00;  border: none;  text-align: right;  font-size: 1.5rem; font-weight: bold; color: #646c9a; padding-top: 0px;">
                           </div>
                        </div>
                     </div>
                     <div class="col-lg-6"></div>
                     <div class="col-lg-6">
                        <div class="form-group  row pr-md-3">
                           ...
                           <div class="col-md-8 input-group-sm">
                              <input type="text" class="form-control balanceamount " name="balanceamount" id="balanceamount" value="0" readonly="" style="background-color: #ffffff00;  border: none;  text-align: right;  font-size: 1.5rem; font-weight: bold; color: #646c9a; padding-top: 0px;">
                           </div>
                        </div>
                     </div>
               ...
               <div class="kt-form__actions">
                  <div class="row">
                     ...
                     <div class="col-lg-12 kt-align-right">
                        ...
                        <button type="button" class="btn btn-primary" id="pi_submit"><svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check-circle icon-16">
...
<script>
         ...
         success: function(data) {
            $.each(data, function(key, value) {
               ...
               product += '<tr>\
                 ...
                 <td>\
                 <div class="input-group input-group-sm">\
                 <input type="text" class="form-control integerVal discountamount "  data-id="' + rowcount + '" name="discountamount[]" id="discountamount' + rowcount + '" value="0">\
                 </div>\
                 </td>\
                 <td>\
   ...
   $(document).ready(function() {
      ...
      $(".addmorecosthead").click(function() {
         ...
         var SlNum = sl + 1;
         costs += '<tr>\
            <td class="row_count text-center pt-2" id="rowcount">' + SlNum + '</td>\
            <td>\
            ...
            <td>\
            <input type="text" class="form-control integerVal costrate" name="costrate[]" id="costrate' + rowcount + '"  data-id=' + rowcount + ' value="0">\
           </td>\
             <td>\
            <select class="form-control form-control single-select costtax_group kt-selectpicker" name="costtax_group[]" id="costtax_group' + rowcount + '" data-id=' + rowcount + '>\
           <option value="">Select</option>\
            @foreach($taxgrouplist as $data)\
            <option data-total="{{$data->total}}" value="{{$data->id}}"\
              {{($data->default_tax == 1)?"selected":""}}>{{$data->taxgroup_name}}</option>\
            @endforeach\
            </select>\
            <td>\
            <input type="text" class="form-control  costtax_amount" name="costtax_amount[]" id="costtax_amount' + rowcount + '"  data-id=' + rowcount + ' readonly>\
            </td>\
            <td>\
   ...
   $('body').on('change', '.costrate', function() {
      var id = $(this).attr('data-id');
      costrow_calculate(id);
   });
...
<script type="text/javascript">
   ...
   $(document).on('change', '#supplier', function() {
      ...
      $.ajax({
         ...
         success: function(data) {
            $.each(data, function(key, value) {
               ...
               $('#sup_group').val(value.sup_group); //.trigger('change').attr('disabled', true);;
      ...
      $("#use_advance").trigger("change");
   });

   $('body').on('change', '#use_advance', function() {
