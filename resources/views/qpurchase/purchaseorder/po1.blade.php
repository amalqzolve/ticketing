            ...
            <td style="border-color: white;   padding-top: 0; padding-right: 0; padding-bottom: 0;  ">
              ...
              <table style=" width: 100%; ">
                <tr>
                  ...
                  <td style="border-color: white; padding: 0;text-align: right;  font-size:11px; color: red;">{{ $poCode }}</td>
...
$qrtextof=str_replace('',"",$qrtextof);*/
      ...
      <div class="str">
        <table>
          ...
          @foreach($purchaseorder_product as $key=>$quotation_products)
          <tr class="str">
