      ...
      <tr>
        ...
        <!-- <h1 style="letter-spacing: 0px; margin: 0; text-align:left; margin-left: 5px; padding:0">Buyer: </h1> -->
               <table style=" width: 100%; ">
                  <tr>
                    <td style="border-color: white; padding: 0; font-weight: bold;  font-size:11px; width: 30%;">PO VO ID.</td>
...
$c=storage_path('app/public/'.str_slug($customer_id).'.svg');
   ...
   <table style="table-layout: auto; " cellspacing="0" cellpadding="0" >
    ...
    <tr>
      <td  style="border-color: white;   padding: 1px; text-align: center;">
        <h3 style="letter-spacing: 0px; margin: 0;">POVO</h3>
      </td>
    </tr>
    <tr>
      <td  style="border-color: white;   padding: 1px">
  ...
  <table>
     ...
     <td  style="border-color: white;  padding: 0; white: 6%;  background-color: white !important;width: 7%; text-align:right;">Total  </td>
      ...
      <tr class="str">
        <td style="background-color: white !important;border-color: white; border: 0px;  padding: 0;"  colspan="10"><hr style="height: 2px; color:black; font-size: 5px; background-color: black; margin: 0;"></td>
         
     </tr>
    
       @foreach($povo_product as $key=>$quotation_products)
     <tr class="str">
       <td  style="border-color: white;   padding: 2px;">{{$key+1}}</td>
       <td  style="border-color: white;   padding: 2px;">@foreach($productlist as $data)
       <?php if ($quotation_products->itemname == $data->product_id)
{
