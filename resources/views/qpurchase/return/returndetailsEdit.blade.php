      ...
      <div class="kt-portlet__head kt-portlet__head--lg">
         <div class="kt-portlet__head-label">
            ...
            <h3 class="kt-portlet__head-title">
               Purchase Invoice To Return Edit #{{$purchase_return->id}}
            </h3>
         </div>
      </div>
                     ...
                     <div class="form-group  row pr-md-3">
                        ...
                        <div class="col-md-9 input-group-sm">
                           ...
                           <select class="form-control single-select kt-selectpicker" id="terms" name="terms">
                              ...
                              <option value="{{$data->id}}" <?php if ($purchase_return->terms == $data->id) {
                                                               echo 'selected';
                                                            } ?>>{{$data->term}}</option>
                              @endforeach
                           </select>
                     ...
                     <div class="form-group  row pr-md-3">
                        <div class="col-md-12 input-group-sm">
                           <div class="kt-tinymce">
                              <textarea id="kt-tinymce-4" name="kt-tinymce-4" class="tox-target">{{$purchase_return->tpreview}}</textarea>
                           </div>
                        </div>
                     </div>
                  </div>
                     ...
                     <table class="table table-striped table-bordered table-hover" id="product_table" style="table-layout:fixed; width:100%; ">
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td><input type="text" class="form-control quantity " name="pquantity[]" id="pquantity{{$key+1}}" data-id="{{$key+1}}" value="{{$product->pquantity}}" readonly>
                                 <input type="hidden" name="inv_discount[]" id="inv_discount{{$key+1}}" value="{{$product->inv_discount}}">
                              </td>
