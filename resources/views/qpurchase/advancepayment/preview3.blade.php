...
<head>
  ...
  foreach ($advancepayment as $advancepayments) {
    ...
    $supplier_id = $advancepayments->supplier_id;
    $purchaseno = $advancepayments->purchaseno;
            ...
            <td style="border-color: white;   padding-top: 0; padding-right: 0; padding-bottom: 0;  ">
              ...
              <table style=" width: 100%; ">
                ...
                <tr>
                  ...
                  <td style="border-color: white; padding: 0;text-align:  center;  font-size:11px;">{{$purchaseno}}</td>
...
$qrtextof=str_replace('',"",$qrtextof);*/
      ...
      <div class="str">
        ...
        <table>
          ...
          <?php $total += $advancepayment_metods->amounts; ?>
          <tr class="str">
            <td style="border-color: white;   padding: 2px; text-align: left;">{{$key+1}}</td>
            <td style="border-color: white;   padding: 2px; text-align: left;">@foreach($ledgers as $key1=>$ledger){{($ledger->id==$advancepayment_metods->accountledger_debitaccount)?'['.$ledger->code.'] '. $ledger->name:''}}@endforeach</td>
            <td style="border-color: white;   padding: 2px;">
              {{$advancepayment_metods->preference}}
            </td>

            <td style="border-color: white;   padding: 2px; text-align: center;">{{$advancepayment_metods->amounts}}</td>
