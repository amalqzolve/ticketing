...
<head>
  ...
  foreach ($advancepayment as $advancepayments) {
    ...
    $adv_code = $advancepayments->code . '/' . $advancepayments->br_id;
  }
  ...
  //   $vatno_ar = $customers->vatno_ar;
  //   $buyerid_crno_ar = $customers->buyerid_crno_ar;
  ...
  foreach ($pname as $names) {
    ...
    $vatno = $names->vatno;
    $buyerid_crno = $names->buyerid_crno;
          ...
          <tr>
            ...
            <td style="border-color: white;   padding-top: 0; padding-right: 0; padding-bottom: 0;  ">
              ...
              <table style=" width: 100%; ">
                ...
                <tr>
                  <td style="border-color: white; padding: 0; font-weight: bold;  font-size:11px;">ID</td>
                  <td style="border-color: white; padding: 0;text-align:  center;  font-size:11px;">{{$adv_code}}</td>
                  ...
                  <tr>
                    ...
                    <td style="border-color: white; border-color: white;   padding: 0px; font-size: 11px; padding:0; ">
                      <table style=" width: 100%; margin: 0; padding:0;border-collapse: collapse; border-spacing: 0;">
                        <tr>
                          <td style="margin: 0; border-color: white; ; border-color: white;   padding: 0px;  font-size: 11px; "><?php if (isset($sup_add1)) {
                                                                                                                                  echo  $sup_add1;
                                                                                                                                  echo "<br>";
                                                                                                                                } ?>
                            <?php if (isset($sup_add2)) {
                              echo  $sup_add2;
                              echo "<br>";
                            } ?>
                          </td>
