		...
		<div class="kt-portlet__head kt-portlet__head--lg">
			<div class="kt-portlet__head-label">
				...
				<h3 class="kt-portlet__head-title">
					Advance Payment Edit # {{$adwancePaymnt->id}}
				</h3>
			</div>
			...
			<div class="row">
				<div class="col-lg-6">
					<div class="form-group row pr-md-3">
						...
						<div class="col-md-8  input-group-sm">
							<select class="form-control single-select kt-selectpicker supplier loadInvoice" name="supplier" id="supplier">
						...
						<div class="col-md-8">
							<div class="kt-radio-inline">
								<label class="kt-radio">
									<input type="radio" class="form-control transactiontype loadInvoice" {{($adwancePaymnt->transactiontype==1)?'checked':''}} name="transactiontype" value="1"> On Account
									<span></span>
								</label>
								<label class="kt-radio">
									<input type="radio" class="form-control transactiontype loadInvoice" name="transactiontype" {{($adwancePaymnt->transactiontype==2)?'checked':''}} value="2"> Sale Order ID
									<span></span>
								</label>
							</div>
						</div>
				...
				<div class="col-lg-6">
					<div class="form-group  row pr-md-3">
						...
						<div class="col-md-8 input-group-sm">
							...
							<input type="text" class="form-control kt_datetimepickerr" name="date" id="date" value="{{($adwancePaymnt->date!='')?date('d-m-Y',strtotime($adwancePaymnt->date)):''}}">
						</div>
					</div>
				</div>
				...
				<!-- <div class="col-lg-6">
					<div class="form-group row pr-md-3">
						...
						<div class="col-md-8  input-group-sm">
							<select class="form-control single-select kt-selectpicker" name="purchaseno" id="purchaseno" {{($adwancePaymnt->transactiontype==2)?'':'disabled'}}>
								<option value="">Select</option>
								<option value="{{$adwancePaymnt->purchaseno}}" selected>{{$adwancePaymnt->purchaseno}}</option>
							</select>
						</div>
					</div>
				</div> -->
				...
				<div class="col-lg-12">
					<div class="form-group  row pr-md-3">
						...
						<div class="col-md-10 input-group-sm">
							<textarea class="form-control" name="notes" id="notes">{{$adwancePaymnt->notes}}</textarea>
						</div>
					</div>
				</div>
