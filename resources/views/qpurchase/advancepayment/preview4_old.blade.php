            ...
            <td style="border-color: white;   padding-top: 0; padding-right: 0; padding-bottom: 0;  ">
              ...
              <table style=" width: 100%; ">
                ...
                <tr>
                  ...
                  <td style="border-color: white; padding: 0;text-align: center;  font-size:11px; color: red;"><?php if ($transactiontype == 1) echo "On Account"; ?> <?php if ($transactiontype == 2) echo "Purchase ID "; ?></td>
                ...
                <tr>
                  <td style="border-color: white; padding: 0; font-weight: bold;  font-size:11px;">Purchase No</td>
