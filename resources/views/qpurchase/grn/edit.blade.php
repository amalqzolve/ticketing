                  ...
                  <div class="row">
                     ...
                     <div class="col-lg-6">
                        <div class="form-group  row pr-md-3">
                           ...
                           <div class="col-md-8 input-group-sm">
                              <input type="text" class="form-control" name="attention" id="attention" value="{{$grn->attention}}">
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="col-lg-6">
                        <div class="form-group  row pr-md-3">
                           ...
                           <div class="col-md-8 input-group-sm">
                              <input type="text" class="form-control" name="vehicle" id="vehicle" value="{{$grn->vehicle}}">
                           </div>
                        </div>
                     </div>
                     <div class="col-lg-6">
                        <div class="form-group  row pr-md-3">
                           ...
                           <div class="col-md-8 input-group-sm">
                              <input type="text" class="form-control" name="driver" id="driver" value="{{$grn->driver}}">
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="col-lg-6">
                        <div class="form-group  row pr-md-3">
                           ...
                           <div class="col-md-8 input-group-sm">
                              <input type="text" class="form-control" name="deliverynote" id="deliverynote" value="{{$grn->deliverynote}}">
                           </div>
                        </div>
                     </div>
                  </div>
                     ...
                     <div class="form-group  row pr-md-3">
                        ...
                        <div class="col-md-9 input-group-sm">
                           ...
                           <select class="form-control single-select kt-selectpicker" id="terms" name="terms">
                              ...
                              <option value="{{$data->id}}" {{($grn->terms==$data->id)?"selected":''}}>{{$data->term}}</option>
                              @endforeach
                           </select>
                        </div>
                     </div>
                     ...
                     <div class="form-group  row pr-md-3">
                        <div class="col-md-12 input-group-sm">
                           <div class="kt-tinymce">
                              <textarea id="kt-tinymce-4" name="kt-tinymce-4" class="tox-target">{!! $grn->tpreview !!}</textarea>
                           </div>
                        </div>
                     </div>
                  </div>
                     ...
                     <table class="table table-striped table-bordered table-hover" id="product_table" style="table-layout:fixed; width:100%; ">
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              @endif
                              <td><textarea class="form-control" rows="1" name="product_description[]" id="product_description{{$key+1}}" data-id="{{$key+1}}">{{$cinvoice_products->product_description}}</textarea></td>
                              ...
                              <td><input type="text" class="form-control integerVal quantity" name="quantity[]" id="quantity{{$key+1}}" data-id="{{$key+1}}" value="{{$cinvoice_products->quantity}}"></td>
               ...
               <div class="kt-form__actions">
                  <div class="row">
                     ...
                     <div class="col-lg-12 kt-align-right">
                        ...
                        <button type="button" class="btn btn-primary" id="btnUpdate"><svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check-circle icon-16">
