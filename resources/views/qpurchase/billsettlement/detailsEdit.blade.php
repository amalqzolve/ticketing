		...
		<div class="kt-portlet__head kt-portlet__head--lg">
			<div class="kt-portlet__head-label">
				...
				<h3 class="kt-portlet__head-title">
					Bill Settlement Edit # {{$billSettlement->id}} For - {{$billSettlement->sup_name}}
				</h3>
			</div>
					...
					<div class="col-lg-6">
						<div class="useAdvance" style="display: {{($billSettlement->use_advance==1)?'block':'none'}};">
							<div class="form-group  row pr-md-3">
								...
								<div class="col-md-8 input-group-sm">
									<input type="text" class="form-control integerVal amount" name="advance_amt" id="advance_amt" value="{{$billSettlement->advance_amt}}">
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-12">
						<div class="form-group  row pr-md-3">
							...
							<div class="col-md-10 input-group-sm">
								<textarea class="form-control" name="notes" id="notes" cols="30" rows="4">{{$billSettlement->notes}}</textarea>
							</div>
						</div>
					</div>
				</div>
...
<script type="text/javascript">
	...
	$(document).on('click', '#bill_settlement_submit', function(e) {
		...
		function saveDetails(result) {
			...
			$.ajax({
				type: "POST",
				url: "qpurchase-bill-settlement-update",
				dataType: "json",
				data: {
					_token: $('#token').val(),
					id: $('#id').val(),
				...
				success: function(data) {
					...
					toastr.success('bill settlement Updated Successfuly');
				},
