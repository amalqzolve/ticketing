...
<head>
  ...
  foreach ($billsettlement as $billsettlements) {
    ...
    // $supplier = $billsettlements->supplier;
  ...
  $saleid = '';
  foreach ($supplier as $key => $customers) {
    $cust_type = $customers->type;
    $cust_group = $customers->group;
    $cust_category = $customers->sup_category;
    $cust_name = $customers->sup_name;
    $cust_add1 = $customers->sup_add1;
    $cust_add2 = $customers->sup_add2;
    $cust_country = $customers->cntry_name;
    $cust_region = $customers->sup_region;
    $cust_city = $customers->sup_city;
    $cust_zip = $customers->sup_zip;
    $mobile = $customers->mobile;
    $vatno = $customers->vatno;
    $buyerid_crno = $customers->buyerid_crno;

    $ar_cust_name = $customers->sup_name_ar;
    $ar_cust_add1 = $customers->sup_add1_ar;
    $ar_cust_add2 = $customers->sup_add2_ar;
    $ar_cust_region = $customers->sup_region_ar;
    $ar_cust_city = $customers->sup_city_ar;
    $ar_cust_zip = $customers->sup_zip_ar;
    $ar_vatno = $customers->vatno_ar;
    $ar_buyerid_crno = $customers->buyerid_crno_ar;
    $ar_cust_country = $customers->sup_country_ar;
  }
      ...
      <div class="str">
        ...
        <table>
          ...
          <tr class="str">
            ...
            <td style="border-color: white;   padding: 2px; text-align: left;">@foreach($ledgers as $key1=>$ledger){{($ledger->id==$billsettlement_metods->debitaccount)?'['.$ledger->code.'] '. $ledger->name:''}}@endforeach</td>
