							...
							<div class="col-lg-6">
								<div class="form-group  row pr-md-3">
									...
									<div class="col-md-8 input-group-sm">
										<input type="text" class="form-control kt_datetimepickerr" name="date" id="date" value="{{date('d-m-Y',strtotime($refund->date)) }}" readonly>
									</div>
								</div>
							</div>
							<div class="col-lg-6">
								<div class="form-group  row pr-md-3">
									...
									<div class="col-md-8 input-group-sm">
										<select class="form-control kt-selectpicker" id="rec_by" name="rec_by" disabled>
							...
							<div class="col-lg-12">
								<div class="form-group  row pr-md-3">
									...
									<div class="col-md-10 input-group-sm">
										<textarea class="form-control" name="notes" id="notes" readonly>{{$refund->notes}}</textarea>
									</div>
								</div>
							</div>
						</div>
					...
					<table class="table table-striped table-hover" id="modeofpaymenttable">
						...
						<tbody>
							...
							<tr>
								...
								<td style="padding: 0;">
									<select class="form-control" id="debitaccount[]" name="debitaccount[]" disabled>
										<option value="">select</option>
								...
								<td style="padding: 0;">
									<div class="input-group input-group-sm">
										<input type="text" class="form-control reference" name="reference[]" id="reference0" data-id="0" value="{{$refundProduct->reference}}" readonly>
									</div>
								</td>
								<td style="padding: 0;">
									<div class="input-group input-group-sm">
										<input type="text" class="form-control amount integerVal" name="amount[]" id="amount0" data-id="0" value="{{$refundProduct->amount}}" readonly>
									</div>
								</td>
							</tr>
							@endforeach
