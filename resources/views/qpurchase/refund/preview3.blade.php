...
<head>
  ...
  <?php
  foreach ($salesreturn as $key => $quotations) {
    $id = $quotations->id;
    ...
    $returndate = $quotations->returndate;
    $rtn_code = $quotations->code . '/' . $quotations->br_id;
    $inv_code = $quotations->inv_code . '/' . $quotations->invoice_id;
  }
            ...
            <td style="border-color: white;   padding-top: 0; padding-right: 0; padding-bottom: 0;  ">
              ...
              <table style=" width: 100%; ">
                ...
                <tr>
                  ...
                  <td style="border-color: white; padding: 0;text-align: center;  font-size:11px; color: red;">{{$rtn_code}}</td>
                ...
                <tr>
                  <td style="border-color: white; padding: 0; font-weight: bold;  font-size:11px; width: 30%;">Invoice NO</td>
                  <td style="border-color: white; padding: 0;text-align: center;  font-size:11px; color: red;">{{$inv_code}}</td>
                  <td style="border-color: white; padding: 0;text-align: right;  font-size:11px; width: 30%;">
                ...
                <tr>
                  ...
                  <td style="border-color: white; padding: 0;text-align:  center;  font-size:11px;">{{$returndate}}</td>
                ...
                <tr>
                  ...
                  <td style="border-color: white; padding: 0;text-align:  center;  font-size:11px;">{{$delivery_period}}</td>

                </tr>

                <tr>
                  <td style="border-color: white; padding: 0; font-weight: bold;  font-size:11px;">Payment Terms</td>
                  <td style="border-color: white; padding: 0;text-align:  center;  font-size:11px;">{{$payment_terms}}</td>
      ...
      <div class="str">
        ...
        <table>
          <tr>
            ...
            <td style="border-color: white; text-align: center; width: 20%;">Image <br></td>
          ...
          @foreach($salesreturnproducts as $key=>$quotation_products)
          ...
          <tr class="str">
            ...
            <?php if (!empty($quotation_products->image)) { ?>
              <td style="border-color: white;   padding: 2px;text-align: center;"> <img src="{{  URL::to('/public/'.$quotation_products->image) }}" style="width:100px">
