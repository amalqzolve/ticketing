            ...
            <form class="kt-form" id="kt_form" name="kt_form">
                ...
                <div class="tab-content">
                    <div class="tab-pane p-2 active" id="kt_tabs_2_1" role="tabpanel">
                        ...
                        <input type="hidden" name="stock_transfer_id" id="stock_transfer_id" value="{{$MaterialRequest->id}}">
                        <div class="row">
                            <div class="col-lg-6">
...
<script src="{{url('/')}}/resources/js/warehouse/transferStock/add.js" type="text/javascript"></script>
<script>
