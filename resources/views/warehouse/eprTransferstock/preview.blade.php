          ...
          <tr>
            <td style="border-color: white;   padding-top: 0; padding-right: 0; padding-bottom: 0;  ">
              <table style=" width: 100%; ">
                <tr>
                  <td style="border-color: white; padding: 0; font-weight: bold;  font-size:11px; width: 30%;">Transfer ID.</td>
                  <td style="border-color: white; padding: 0;text-align: left;  font-size:11px; color: red;"> TS {{$mainData['id']}}</td>
                  <td style="border-color: white; padding: 0;text-align: right;  font-size:11px; width: 30%;"></td>
                </tr>
                <tr>
                  <td style="border-color: white; padding: 0; font-weight: bold;  font-size:11px; width: 30%;">Warehouse </td>
                  <td style="border-color: white; padding: 0;text-align: left;  font-size:11px;"> {{$mainData['warehouse_name']}}</td>
                  <td style="border-color: white; padding: 0;text-align: right;  font-size:11px; width: 30%;"></td>
                </tr>
                <tr>
                  <td style="border-color: white; padding: 0; font-weight: bold;  font-size:11px; width: 30%;"> Transfer Date </td>
                  <td style="border-color: white; padding: 0;text-align: left;  font-size:11px; "> {{date('d-m-Y',strtotime($mainData['transfer_date']))}}</td>
                  <td style="border-color: white; padding: 0;text-align: right;  font-size:11px; width: 30%;"></td>
                </tr>
                @if($mainData['project']!='')
                <tr>
                  <td style="border-color: white; padding: 0; font-weight: bold;  font-size:11px; width: 30%;"> Project </td>
                  <td style="border-color: white; padding: 0;text-align: left;  font-size:11px; "> {{$mainData['project']}}</td>
                  <td style="border-color: white; padding: 0;text-align: right;  font-size:11px; width: 30%;"></td>
                </tr>
                @endif
                <tr>
                  <td style="border-color: white; padding: 0; font-weight: bold;  font-size:11px; width: 30%;"> Requested By </td>
                  <td style="border-color: white; padding: 0;text-align: left;  font-size:11px; "> {{$mainData['requested_by']->name}}</td>
                  <td style="border-color: white; padding: 0;text-align: right;  font-size:11px; width: 30%;"></td>
                </tr>
                <tr>
                  ...
                  <td style="border-color: white; ">
                    <table style=" padding:0">
                      ...
                      <tr>
                        ...
                        <td style="border-color: white; padding:0;">&nbsp;</td>
                        <td style="border-color: white; padding:0; text-align:right;"> <span style="font-weight: bold;">Generated by </span>:{{$mainData['created_name']}} <br>Date: {{isset($mainData['transfer_date'])?date('d-m-Y',strtotime($mainData['transfer_date'])):''}}</td>
                      </tr>
                </tr>
              </table>
            </td>
      ...
      <table style="table-layout: auto; " cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td style="border-color: white;   padding: 1px; text-align: center;">
            <h3 style="letter-spacing: 0px; margin: 0;">Stock Transfer Details</h3>
          </td>
        </tr>
        <tr>
          <td style="border-color: white;   padding: 1px">
