        ...
        <div class="kt-portlet__body pl-2 pr-2 pb-0">
            ...
            <form class="kt-form" id="kt_form" name="kt_form">
                ...
                <ul class="nav nav-tabs nav-fill" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab" href="#kt_tabs_2_1">Transfer Details</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="tab-content">
                    <div class="tab-pane p-2 active" id="kt_tabs_2_1" role="tabpanel">
                        ...
                        <input type="hidden" name="stock_transfer_id" id="stock_transfer_id" value="{{$MaterialRequest->stock_transfer_id}}">
                        <input type="hidden" name="id" id="id" value="{{$MaterialRequest->id}}">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    <div class="col-md-4">
                                        <label>Transfer @lang('app.Date') <span style="color: red">*</span></label>
                                    </div>
                                    <div class="col-md-8 input-group-sm">
                                        <input type="text" class="form-control kt_datetimepickerr" name="transfer_date" id="transfer_date" value="{{isset($MaterialRequest->transfer_date)?date('d-m-Y',strtotime($MaterialRequest->transfer_date)):date('d-m-Y')}}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <input type="text" name="" id="" class="form-control" value="{{$MaterialRequest->warehouse_name}}" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <input type="text" name="" id="" class="form-control" value="{{date('d-m-Y',strtotime($MaterialRequest->t_req_date))}}" readonly>
                                    </div>
                                </div>
                            </div>
                            ...
                            <table class="table table-striped table-bordered table-hover" id="product_table" style="table-layout:fixed; width:100%">
                                <thead class="thead-light">
                                    <tr>
                                       ...
                                       color: white; white-space: nowrap;     padding: 2px 7px !important;">@lang('app.Unit')</th>
                                        <th style="background-color:  #3f4aa0;
                                       color: white; white-space: nowrap;     padding: 2px 7px !important;" width="75px">Request <br> Qty</th>
                                        <th style="background-color:  #3f4aa0;
                                       color: white; white-space: nowrap;     padding: 2px 7px !important;" width="75px">Transferred <br> Qty</th>
                                        <th style="background-color:  #3f4aa0;
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="hidden" class="form-control eprProductId" name="eprProductId[]" id="eprProductId{{$key+1}}" data-id="{{$key+1}}" value="{{$cinvoice_products['epr_product_id']}}">
                                            <input type="hidden" class="form-control stock_transfer_product_id" name="stock_transfer_product_id[]" id="stock_transfer_product_id{{$key+1}}" data-id="{{$key+1}}" value="{{$cinvoice_products['stock_transfer_product_id']}}">
                                        ...
                                        <td><input type="text" class="form-control total_quantity" name="total_quantity[]" id="total_quantity{{$key+1}}" data-id="{{$key+1}}" value="{{$cinvoice_products['total_quantity']}}" readonly></td>
                                        <td><input type="text" class="form-control assigned_qty" name="assigned_qty[]" id="assigned_qty{{$key+1}}" data-id="{{$key+1}}" value="{{$cinvoice_products['assigned_qty']}}" readonly></td>
...
<script src="{{url('/')}}/resources/js/warehouse/transferStock/edit.js" type="text/javascript"></script>
<script>
