                                ...
                                <thead class="thead-light">
                                    <tr>
                                       ...
                                       color: white; white-space: nowrap;     padding: 2px 7px !important;" width="75px">Request <br> Qty</th>
                                        <th style="background-color:  #3f4aa0;
                                       color: white; white-space: nowrap;     padding: 2px 7px !important;" width="75px">Generated <br> Qty</th>
                                        <th style="background-color:  #3f4aa0;
...
<script src="{{url('/')}}/resources/js/procurement/stockTransfer/resubmit.js" type="text/javascript"></script>
<script>
