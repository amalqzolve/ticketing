                                 ...
                                 <div class="row" style="padding-bottom: 6px;">
                                    ...
                                    <div class="form-group row pl-md-3">
                                        <table class="table table-striped table-hover table-checkable dataTable no-footer" id="product_tables">
                                            ...
                                            <td>{{$products->transaction_date}}
                                            </td>
                                                  <td><?php if($products->transaction_type==1){ echo "Purchase"; }else{
                                                    echo "Sales";
                                                  } ?>
                                            </td>
                                              <td>{{$products->totalamount}}
                                            </td>
                                              <td>{{$products->vatamount}}
                                            </td>
                                             <td>{{$products->grandtotalamount}}
                                            </td>
