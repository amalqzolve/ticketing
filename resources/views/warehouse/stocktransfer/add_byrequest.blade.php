...
foreach ($products as $key => $value) {
 ...
 @foreach($pproducts as $key=>$cinvoice_products)
                                 
      <tr>
      	 <td>{{$key+1}}</td>
        <td>                 
        	<div class="input-group input-group-sm">               
        	  <input type="text" class="form-control single-select productname kt-selectpicker" name="productname[]" id="productname" data-id="{{$key+1}}" value="{{$cinvoice_products->product_name}}" readonly="">                 <div>                
        	   <input type="hidden" class="form-control single-select item_details_id" name="item_details_id[]" id="item_details_id" data-id="{{$key+1}}" value="{{$cinvoice_products->productname}}">                 </div></div></td><td>                
        	    <div class="input-group input-group-sm">              
        	       <input type="text" class="form-control available_stock" name="available_stock[]" id="available_stock2" data-id="{{$key+1}}" value="{{$cinvoice_products->available_stock}}" readonly="">  
        	                      </div>                 </td>                 <td>                 <div class="input-group input-group-sm">                 <input type="text" class="form-control stock_out_quantity" name="stock_out_quantity[]" data-id="{{$key+1}}" id="stock_out_quantity{{$key+1}}" value="{{$cinvoice_products->stock_out_quantity}}">                 </div>                 </td>                 <td style="background-color: white;">                      <div class="kt-demo-icon__preview remove" style="width: fit-content;    margin: auto;">                                          <span class="badge badge-pill mbdg2 mr-1 ml-1 mt-1 shadow">                                          <i class="fa fa-trash badge-pill" id="" style="padding:0; cursor: pointer;"></i></span>                                       </div>                        </td>                 </tr>
      </tr>
      @endforeach
												...
												<div class="kt-form__actions">
													<div class="row">
														...
														<div class="col-lg-6 kt-align-right">
															<button type="submit" name="stock_out_submit" id="stock_out_submit" class="btn btn-primary float-right ">
...
$(document).on('click', '#stock_out_submit', function(e) {
    e.preventDefault();
 ...
 var available_stock = [];
    ...
    $.ajax({
        ...
        success: function(data) {
             ...
             $('#stock_out_submit').removeClass('kt-spinner');
             $('#stock_out_submit').prop("disabled", false);
             location.reload();
