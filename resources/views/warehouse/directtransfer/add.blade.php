												...
												<div class="kt-form__actions">
													<div class="row">
														...
														<div class="col-lg-6 kt-align-right">
															<button type="submit" name="directstocktransfersubmit" id="directstocktransfersubmit" class="btn btn-primary float-right ">
...
$(document).on('click', '#directstocktransfersubmit', function(e) {
    e.preventDefault();
 ...
 var available_stock = [];
    ...
    $.ajax({
       ...
       console.log(data);
             ...
             $('#directstocktransfersubmit').removeClass('kt-spinner');
             $('#directstocktransfersubmit').prop("disabled", false);
             location.reload();
