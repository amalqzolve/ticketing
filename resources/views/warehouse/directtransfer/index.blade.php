...
{{-- <div class="kt-subheader   kt-grid__item" id="kt_subheader">
											       ...
											       <div class="kt-portlet__head-actions">
												         <a href="{{url('/')}}/directstocktransfer_add" class="btn btn-brand btn-elevate btn-icon-sm"> <i
							class="la la-plus"></i>
						{{ __('app.New Record') }}</a>
...
<table class="table table-striped table-hover table-checkable dataTable no-footer " id="productdetails_list" style="display: table;">
    <thead>
        <tr>
            ...
            <th>{{ __('warehouse.Requested By') }}</th>
            <th>{{ __('warehouse.Prepared By') }}</th>
            <th>{{ __('warehouse.Approved By') }}</th>
            <th>{{ __('warehouse.Stock Transfer qty') }}</th>
     ...
     <td><span style="overflow: visible; position: relative; width: 80px;">
            <div class="dropdown"><a data-toggle="dropdown" class="btn btn-sm btn-clean btn-icon btn-icon-md">
                        ...
                        <ul class="kt-nav">
                         ...
                         <a href="{{url('/')}}/directstocktransfer_edit?id={{$product->tid}}" data-type="edit"><li class="kt-nav__item">
                        <span class="kt-nav__link">
                        <i class="kt-nav__link-icon flaticon2-file-1"></i>
                        <span class="kt-nav__link-text" data-id="" >Edit</span>
                        </span></li></a>
                        <a  data-type="delete" data-target="#kt_form"><li class="kt-nav__item directtransfer_delete" id='{{$product->tid}}'>
                        <span class="kt-nav__link">
...
$(document).on('click', '.directtransfer_delete', function() {
        var id = $(this).attr('id');
        swal.fire({
            title: "Are you sure?",
            text: "Do you want Delete this Transfer",
            type: "warning",
            ...
            if (result.value) {
               ...
               window.location = "directtransfer-Delete?id="+id;
             } else {
