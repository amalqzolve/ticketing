                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <input type="hidden" name="warehouses_id" id="warehouses_id" class="form-control" value="{{$MaterialRequest->warehouse_id}}" readonly>
                                        <select class="form-control" id="warehouses" name="warehouses" disabled>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    <div class="col-md-4">
                                        <label>Warehouse Transfer Date </label>
                                    </div>
                                    <div class="col-md-8 input-group-sm">
...
<script src="{{url('/')}}/resources/js/warehouse/receiveStock/add.js" type="text/javascript"></script>
