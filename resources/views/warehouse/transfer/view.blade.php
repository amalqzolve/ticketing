...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
	...
	?>		
								...
								<input type="text" class="form-control kt_datetimepickerr" name="approveddate" id="approveddate" value="{{date('d-m-Y')}}" readonly="">               
										</div>
										</div>
										</div>
								   <div class="col-lg-6">
								...
								<input type="text" class="form-control" name="out_date" id="out_date" value="{{$trdate}}" readonly="">               
										</div>
										</div>
										</div>
            ...
            @endforeach
										...
										<div class="col-md-8 input-group-sm">
											...
											<select class="form-control kt-selectpicker" id="warehouse" disabled="">
									   	<option value="">select</option>
            ...
            @endforeach
								...
								<input type="text" class="form-control" name="requested_by" id="requested_by" value="{{$requested_by}}" readonly="">               
										</div>
										</div>
										</div>
                                    ...
                                    <textarea class="form-control" rows="1" name="notes" id="notes" readonly="">{{$notes}}</textarea>
                                    </div>
                                    </div>
                                    </div>
                 ...
                 <td>
                 <div class="input-group input-group-sm">
                 <input type="text" class="form-control stock_out_quantity" name="stock_out_quantity[]"  data-id="{{$key+1}}" id="stock_out_quantity{{$key+1}}" value="{{$directproducts->stock_out_quantity}}" readonly="">
                 </div>
                 </td>
												...
												<div class="kt-form__actions">
													<div class="row">
														...
														<div class="col-lg-6 kt-align-right">
															<button type="submit" name="transferapproved" id="transferapproved" class="btn btn-primary float-right ">
...
$(document).on('click', '#transferapproved', function(e) {
    e.preventDefault();
 ...
 var available_stock = [];
    ...
    $.ajax({
        ...
        success: function(data) {
             ...
             $('#transferapproved').removeClass('kt-spinner');
             $('#transferapproved').prop("disabled", false);
             location.reload();
