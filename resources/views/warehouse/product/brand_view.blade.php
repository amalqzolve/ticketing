...
<br/>
							<div class="kt-portlet kt-portlet--mobile">
								<div class="kt-portlet__head kt-portlet__head--lg">
                                    ...
                                    <div class=" kt-portlet__head-label">
									    <button class="btn btn-default btn-elevate btn-icon-sm float-right" onclick="history.back()"><i class="fa fa-chevron-circle-left" aria-hidden="true"></i> Go Back</button>
                                    </div>
								</div>
