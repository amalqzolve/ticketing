...
<!--begin: Datatable -->
<table class="table table-striped table-hover table-checkable dataTable no-footer table-responsive" id="productdetails_list">
    <thead>
        <tr>
...
<script src="{{ URL::asset('assets') }}/datatables/buttons.print.min.js" type="text/javascript"></script> 
 <script src="{{url('/')}}/resources/js/inventory/warproduct.js" type="text/javascript"></script>
