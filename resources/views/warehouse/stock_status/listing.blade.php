...
<table class="table table-striped table-hover table-checkable dataTable no-footer" id="maindetails_list">
    ...
    <tbody>
      <?php $i=1; ?>
         ...
         @foreach($Maitenance as $key => $products)
                                     

                                            <tr>
                                            <td class="row_count" id="rowcount">{{$key + 1}}</td>
                                                <td>{{$products->out_date}} </td>
                                            <td>{{$products->product_name}} </td>
                                            <td>{{$products->stock_out_quantity}} </td>
            ...
            <div class="kt-wizard-v3__content   fadeIn" data-ktwizard-type="step-content">
               <div class="mt-3">
      <table class="table table-striped table-hover table-checkable dataTable no-footer" id="servicedetails_list">
    <thead>
        <tr>
           <th>{{ __('mainproducts.S.No') }}</th>
            <th>Date</th>
    ...
    <tbody>
      <?php $i=1; ?>
         ...
         @foreach($Service as $key => $products)
    ...
    <div class="kt-wizard-v3__content   fadeIn" data-ktwizard-type="step-content">
               <div class="mt-3">
     <table class="table table-striped table-hover table-checkable dataTable no-footer" id="warrantydetails_list">
    <thead>
        <tr>
           <th>{{ __('mainproducts.S.No') }}</th>
            <th>Date</th>
    ...
    <tbody>
      <?php $i=1; ?>
         ...
         @foreach($Warranty as $key => $products)
                ...
                <div class="kt-wizard-v3__content   fadeIn" data-ktwizard-type="step-content">
               <div class="mt-3">
     <table class="table table-striped table-hover table-checkable dataTable no-footer" id="outofwarrantydetails_list">
    <thead>
        <tr>
           <th>{{ __('mainproducts.S.No') }}</th>
            <th>Date</th>
    ...
    <tbody>
      <?php $i=1; ?>
         ...
         @foreach($Outof_Warranty as $key => $products)
            ...
            <div class="kt-wizard-v3__content   fadeIn" data-ktwizard-type="step-content">
               <div class="mt-3">
<table class="table table-striped table-hover table-checkable dataTable no-footer" id="damageddetails_list">
    <thead>
        <tr>
           <th>{{ __('mainproducts.S.No') }}</th>
            <th>Date</th>
    ...
    <tbody>
      <?php $i=1; ?>
         ...
         @foreach($Damaged as $key => $products)
            ...
            <div class="kt-wizard-v3__content   fadeIn" data-ktwizard-type="step-content">
               <div class="mt-3">
<table class="table table-striped table-hover table-checkable dataTable no-footer" id="stolendetails_list">
    <thead>
        <tr>
           <th>{{ __('mainproducts.S.No') }}</th>
            <th>Date</th>
    ...
    <tbody>
      <?php $i=1; ?>
         ...
         @foreach($Stolen as $key => $products)
            ...
            <div class="kt-wizard-v3__content   fadeIn" data-ktwizard-type="step-content">
               <div class="mt-3">
    <table class="table table-striped table-hover table-checkable dataTable no-footer" id="scrapdetails_list">
    <thead>
        <tr>
           <th>{{ __('mainproducts.S.No') }}</th>
            <th>Date</th>
...
<script type="text/javascript">
   ...
   $(document).ready(function() {
      ...
      var servicedetails_list_table = $('#servicedetails_list').DataTable({
        processing: true,
         serverSide: false,
         pagingType: "full_numbers",
         /*          scrollX: true,*/
      ...
      var warrantydetails_list_table = $('#warrantydetails_list').DataTable({
        processing: true,
         serverSide: false,
         pagingType: "full_numbers",
         /*          scrollX: true,*/
      ...
      var outofwarrantydetails_list_table = $('#outofwarrantydetails_list').DataTable({
        processing: true,
         serverSide: false,
         pagingType: "full_numbers",
         /*          scrollX: true,*/
      ...
      var damageddetails_list_table = $('#damageddetails_list').DataTable({
        processing: true,
         serverSide: false,
         pagingType: "full_numbers",
         /*          scrollX: true,*/
      ...
      var stolendetails_list_table = $('#stolendetails_list').DataTable({
        processing: true,
         serverSide: false,
         pagingType: "full_numbers",
         /*          scrollX: true,*/
      ...
      var scrapdetails_list_table = $('#scrapdetails_list').DataTable({
        processing: true,
         serverSide: false,
         pagingType: "full_numbers",
         /*          scrollX: true,*/
