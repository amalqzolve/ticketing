												...
												<div class="kt-form__actions">
													<div class="row">
														...
														<div class="col-lg-6 kt-align-right">
															<button type="submit" name="transferrequestupdate" id="transferrequestupdate" class="btn btn-primary float-right ">
...
$(document).on('click', '#transferrequestupdate', function(e) {
    e.preventDefault();
 ...
 var available_stock = [];
    ...
    $.ajax({
        ...
        success: function(data) {
             ...
             $('#transferrequestupdate').removeClass('kt-spinner');
             $('#transferrequestupdate').prop("disabled", false);
             location.reload();
