	...
	?>		
            ...
            @endforeach
								   ...
								   <div class="col-lg-6">
									...
									<select class="form-control single-select kt-selectpicker reason" name="reason" id="reason">
										<option value="">{{ __('warehouse.select') }}</option>
										<option value="Maitenance">Maitenance</option>
										<option value="Service">Service</option>
										<option value="Warranty">Warranty</option>
										<option value="Outof Warranty">Outof Warranty</option>
                          ...
                          <table class="table table-striped table-bordered table-hover" id="product_table"  style="table-layout:fixed; width:100%">
                                    ...
                                    <th style="background-color:  #3f4aa0;
                                       color: white; white-space: nowrap;     padding: 2px 7px !important;">Stock Out Quantity</th>
...
if (parseInt(stock_out_quantity) > parseInt(available_stock))
    ...
    {
         toastr.error('Stock Out Quantity Must less or equal to Available Quantity');
        $(this).val("");
    } else {
        // do something
    }
