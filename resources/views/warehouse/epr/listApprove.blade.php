...
<!-- <script src="{{url('/')}}/resources/js/procurement/stockTransferApproval/list.js" type="text/javascript"></script> -->
<script src="{{url('/')}}/resources/js/warehouse/epr/stockTransferApprovallist.js" type="text/javascript"></script>
