                            ...
                            <table class="table table-striped table-bordered table-hover" id="product_table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><input type="text" class="form-control integerVal valChanged" name="amount" id="amount" data-id="amount" value="{{$totalAmount}}"></td>
                                    ...
                                    <tr>
                                        <td>2</td>
                                        <td><input type="text" class="form-control" name="additional_name" id="additional_name" value="Additional Charges" value="{{$performaInvoice->additional_name}}" readonly></td>
                                        <td><input type="text" class="form-control" name="additional_description" id="additional_description" value="{{$performaInvoice->additional_description}}"></td>
                                        <td><input type="text" class="form-control integerVal valChanged" name="additional_amount" id="additional_amount" data-id="amount" value="{{$totalAdditionalAmount}}"></td>
                                        ...
                                        <td>
                                            <select style="width: 2cm;" class="form-control form-control-sm single-select kt-selectpicker selectChanged" name="additional_vat_percentage" id="additional_vat_percentage" data-id="vat_percentage">
                                                <option value="">select</option>
                                                @foreach($vatlist as $data)
                                                <option value="{{$data->total}}" {{($data->total==$performaInvoice->additional_vat_percentage)?'selected':''}}>{{$data->total}}</option>
                                                @endforeach
                                            </select>
                                        </td>
                                        <td><input type="text" class="form-control integerVal valChanged" data-id="vat_amount" name="additional_vat_amount" id="additional_vat_amount" value="{{$performaInvoice->additional_vat_amount}}" readonly></td>
