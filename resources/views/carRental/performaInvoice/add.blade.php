        ...
        <div class="kt-portlet__head kt-portlet__head--lg">
            <div class="kt-portlet__head-label">
                ...
                <h3 class="kt-portlet__head-title">
                    Performa Invoice (TRIP-{{$car_in_out_id}})
                </h3>
            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        ...
                                        <input type="text" class="form-control kt_datetimepicker" name="quotedate" id="quotedate" value="{{date('d-m-Y')}}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <input type="text" class="form-control kt_datetimepicker" name="valid_till" id="valid_till" value="{{date('d-m-Y')}}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <table class="table table-striped table-bordered table-hover" id="product_table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><input type="text" class="form-control" name="invoiced_amount" id="invoiced_amount" value="{{$carInAndOut->total_amount_performa_invoiced}}" readonly></td>
                                        <td><input type="text" class="form-control" name="balanced_amount" id="balanced_amount" value="{{$totalAmount - $carInAndOut->total_amount_performa_invoiced}}" readonly></td>
                                        <td><input type="text" class="form-control integerVal valChanged" name="amount" id="amount" data-id="amount"></td>
                                        <td><input type="text" class="form-control integerValDiscount valChanged" name="discount_percentage" id="discount_percentage" data-id="discount"></td>
                                        <td>
                                            <select style="width: 2cm;" class="form-control form-control-sm single-select kt-selectpicker selectChanged" name="vat_percentage" id="vat_percentage">
                                                <option value="">select</option>
                                        ...
                                        <td><input type="text" class="form-control integerVal valChanged" data-id="vat_amount" name="vat_amount" id="vat_amount" value="" readonly></td>
                                        <td><input type="text" class="form-control integerVal valChanged" data-id="total_amount" name="total_amount" id="total_amount" value="" readonly> </td>
                                        <td></td>
                                    </tr>
                                    <tr>
                                        <td>2</td>
                                        ...
                                        <td><input type="text" class="form-control" name="invoiced_additional_amount" id="invoiced_additional_amount" value="{{$carInAndOut->total_additional_amount_performa_invoiced}}" readonly></td>
                                        <td><input type="text" class="form-control" name="additional_balanced_amount" id="additional_balanced_amount" value="{{$totalAdditionalAmount - $carInAndOut->total_additional_amount_performa_invoiced}}" readonly></td>
                                        <td><input type="text" class="form-control integerVal valChanged" name="additional_amount" id="additional_amount" data-id="amount" value=""></td>
                                        <td><input type="text" class="form-control integerValDiscount valChanged" name="additional_discount_percentage" id="additional_discount_percentage" value="" data-id="discount"></td>
                                        <td>
                                        ...
                                        <td><input type="text" class="form-control integerVal valChanged" data-id="vat_amount" name="additional_vat_amount" id="additional_vat_amount" value="" readonly></td>
                                        <td><input type="text" class="form-control integerVal valChanged" data-id="total_amount" name="additional_total_amount" id="additional_total_amount" value="" readonly> </td>
                                        <td></td>
                                    </tr>
                                </tbody>
                            </table>
...
<script src="{{url('/')}}/resources/js/carRental/proformaInvoice/add.js" type="text/javascript"></script>
