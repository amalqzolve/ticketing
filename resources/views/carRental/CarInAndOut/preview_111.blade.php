        ...
        <div class="row" style="margin-top:100px;">
                        ...
                        <td style="border-color: white;   padding-top: 0; padding-right: 0; padding-bottom: 0;  ">
                            ...
                            <table style=" width: 100%; ">
                                <tr>
                                    ...
                                    <td style="border-color: white; padding: 0;text-align: left;  font-size:11px; color: red;">&nbsp;TRIP {{$tripData->id}}</td>
                                </tr>
                                <tr>
                                    <td style="border-color: white; padding: 0; font-weight: bold;  font-size:11px;">Start Date</td>
                                    <td style="border-color: white; padding: 0;text-align:  left;  font-size:11px;">&nbsp;{{date('d-m-Y',strtotime($tripData->trip_start_date))}}</td>

                                </tr>
                                <tr>
                                    <td style="border-color: white; padding: 0; font-weight: bold;  font-size:11px;">Trip End Date</td>
                                    <td style="border-color: white; padding: 0;text-align:  left;  font-size:11px;">&nbsp;{{date('d-m-Y',strtotime($tripData->trip_end_date))}}</td>
                    ...
                    <tr>
                                        ...
                                        <table style=" padding:0">
                                            ...
                                            <tr>
                                                ...
                                                <td style="border-color: white; padding:0;">&nbsp;</td>
                                                <td style="border-color: white; padding:0; text-align:right;"> <br>Date: {{date('d-m-Y',strtotime($tripData->trip_start_date))}}</td>
                                    </td>
                                </tr>
                            </table>
                        </td>
            ...
            <table style="table-layout: auto; " cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td style="border-color: white;   padding: 1px; text-align: center;">
                        <h3 style="letter-spacing: 0px; margin: 0;"> ggggg </h3>
                    </td>
                </tr>
                <tr>
                    <td style="border-color: white;   padding: 1px">
            ...
            <div class="str">
                <table>
                    ...
                    <tr class="str">
                        <td style="border-color: white;   padding: 2px;">11</td>
                        <td style="border-color: white;   padding: 2px;">dddd</td>
                        <td style="border-color: white;   padding: 2px;">eeee</td>
                        <td style="border-color: white;   padding: 2px;">ffff</td>
                        <td style="border-color: white;   padding: 2px; text-align: right;">ffff</td>
                    </tr>
