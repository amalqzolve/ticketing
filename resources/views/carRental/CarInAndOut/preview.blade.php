      ...
      <div class="str">
        <table>
          ...
          <tr class="str">
            ...
            <td style="border-color: white;   padding: 2px; text-align: center;"> {{$tripData->trip_start_date}}</td>
            <td style="border-color: white;   padding: 2px; text-align: center;">{{$tripData->trip_end_date}}</td>
            <td style="border-color: white;   padding: 2px; text-align: center;">{{$tripData->trip_start_odometer}}</td>
            <td style="border-color: white;   padding: 2px; text-align: center;">{{$tripData->trip_end_odometer}}</td>
          </tr>
        </table>
