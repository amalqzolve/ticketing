                            ...
                            <table class="table table-striped table-bordered table-hover" id="product_table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><input type="text" class="form-control integerVal valChanged" data-id="amount" name="amount" id="amount" value=""></td>
                                        <td><input type="text" class="form-control integerValDiscount valChanged" data-id="discount" name="discount_percentage" id="discount_percentage" value=""></td>
                                        <td>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group  row pr-md-3">
                                ...
                                <div class="col-md-8 input-group-sm">
                                    ...
                                    <input type="text" class="form-control paidamount" name="paidamount" id="paidamount" value="" style=" text-align: right; font-size: 1.25rem; background-color: #f2f3f8;  height: calc(1.25em + 1rem + 2px);">
