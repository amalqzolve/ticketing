            ...
            <td style="border-color: white;   padding-top: 0; padding-right: 0; padding-bottom: 0;  ">
              ...
              <table style=" width: 100%; ">
                <tr>
                  ...
                  <td style="border-color: white; padding: 0;text-align: center;  font-size:11px; color: red;">{{$salesquotation}} INV-{{$salesinvoice->id}}{{$salesquotation_sufix}}</td>
                    ...
                    <td style="border-color: white; border-color: white;   padding: 0px; font-size: 11px; padding:0; ">
                      <table style=" width: 100%; margin: 0; padding:0;border-collapse: collapse; border-spacing: 0;">
                        <tr>
                          ...
                          <td style="margin: 0; border-color: white; ; border-color: white;   padding: 0px;  font-size: 11px; "><?php if ($carInAndOut->renter_office_address != '') {
                                                                                                                                  echo  $carInAndOut->renter_office_address;
                                                                                                                                  echo "<br>";
                                                                                                                                } ?>
                            <?php if ($carInAndOut->renter_res_address != '') {
                              echo  $carInAndOut->renter_res_address;
                              echo "<br>";
                            } ?>
                          </td>
                        </tr>
