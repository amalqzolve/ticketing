        ...
        <div class="kt-portlet__head kt-portlet__head--lg">
            <div class="kt-portlet__head-label">
                ...
                <h3 class="kt-portlet__head-title">
                    Invoice Convert To Receipt (TRIP-{{$car_in_out_id}})
                </h3>
            </div>
                                ...
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <select class="form-control single-select kt-selectpicker" id="discount_type" name="discount_type">
                                            <option value="1" {{($invoice->discount_type==1)?'selected':''}}>Flat</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group  row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group-sm">
                                        <textarea class="form-control" name="internalreference" id="internalreference">{{$invoice->notes}}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group row pr-md-3">
                                    ...
                                    <div class="col-md-8 input-group input-group-sm">
                                        <select class="form-control single-select " id="car_id" readonly>
                                            <option value="">Select</option>
                                            @foreach($cars as $car)
                            ...
                            <table class="table table-striped table-bordered table-hover" id="product_table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><input type="text" class="form-control integerVal valChanged" name="amount" id="amount" value="{{$invoice->grandtotalamount}}"></td>
                                    </tr>
                                </tbody>
                            </table>
...
<script src="{{url('/')}}/resources/js/carRental/invoice/convertToReceipt.js" type="text/javascript"></script>
@endsection