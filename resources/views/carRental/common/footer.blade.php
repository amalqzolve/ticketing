                        ...
                        <div class="tab-content pt-3">
                          ...
                          <div class="tab-pane active" id="kt_builder_themes">
                            <div class="card card-custom card-stretch">
                              <input type="hidden" name="id" value="{{isset($usr->id)?$usr->id:''}}">
                              <!--begin::Body-->
                              <div class="card-body">
                                <div class="form-group row">
                                  <label class="col-xl-3 col-lg-3 col-form-label"><!--Avatar--></label>
                                  <div class="col-lg-9 col-xl-6 " style="
                                  background-image: url('{{url('public')}}/{{ isset($usr->image)?$usr->image:'' }}');
                                      background-size: contain;
                                      background-repeat: no-repeat;
                                      height:150px;
                                  ">
                                    <!-- <img class="image-input" alt="Pic" src="{{url('public')}}/{{ isset($usr->image)?$usr->image:'' }}"> -->
                                  </div>
                                </div>
                                <br>
                                <br>
                                <div class="form-group row">
                                  ...
                                  <div class="col-lg-9 col-xl-6">
                                    <input class="form-control form-control-lg form-control-solid" id="user_name" name="user_name" type="text" value="{{ isset($usr->name)?$usr->name:'' }}">
                                  </div>
                                </div>
                                ...
                                <div class="form-group row">
                                  ...
                                  <div class="col-lg-9 col-xl-6">
                                    <div class="input-group input-group-lg input-group-solid">
                                      ...
                                      <input type="text" class="form-control form-control-lg form-control-solid" id="user_phone" name="user_phone" value="{{ isset($usr->phone)?$usr->phone:'' }}" placeholder="Phone">
                                    </div>
                                  </div>
                                </div>
                                <div class="form-group row">
                                  ...
                                  <div class="col-lg-9 col-xl-6">
                                    <div class="input-group input-group-lg input-group-solid">
                                      ...
                                      <input type="text" class="form-control form-control-lg form-control-solid" value="{{ isset($usr->email)?$usr->email:'' }}" placeholder="Email" readonly>
                                    </div>
                                  </div>
                                </div>
          ...
          <script>
            ...
            function chekFromToDate(fromIn, toIn) {
              fromIn = fromIn.split('-');
              toIn = toIn.split('-');

              var from = fromIn[1] + '/' + fromIn[0] + '/' + fromIn[2];
              var to = toIn[1] + '/' + toIn[0] + '/' + toIn[2];;
