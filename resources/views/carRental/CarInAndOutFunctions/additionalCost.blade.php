                        ...
                        <div class="form-group row">
                                ...
                                <div class="form-group row pr-md-3">
                                    ...
                                    <div class="col-md-10">
                                        <div class="input-group  input-group-sm">
                                            <input type="text" class="form-control integerVal" placeholder="" id="amount" name="amount" autocomplete="off">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group row pr-md-3">
                                    ...
                                    <div class="col-md-10">
                                        <div class="input-group  input-group-sm">
                                            <textarea class="form-control" name="remarks" id="remarks" cols="30" rows="8" maxlength="1000"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="kt-portlet__head">
                <div class="kt-portlet__head-toolbar">
                    <ul class="nav nav-tabs nav-tabs-line nav-tabs-line-primary nav-tabs-line-2x" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link  active" data-toggle="tab" href="{{URL::to('car-rental/trip-additional-cost',$id)}}" role="tab">
                    ...
                    <div class="tab-pane active" role="tabpanel">
                        ...
                        <div class="kt-portlet__head ">
                            <div class="kt-portlet__head-label">
                                <h5 class="kt-portlet__head-title">Additional Cost</h5>
                            </div>
                            <div class="kt-portlet__head-toolbar">
                                <div class="kt-portlet__head-wrapper">
                                    <div class="kt-portlet__head-actions">
                        ...
                        <table class="table table-striped  table-hover table-checkable" id="additionalCostTbl">
                            <thead>
                                <tr>
...
<script src="{{url('/')}}/resources/js/carRental/CarInAndOutFunctions/additionalCost.js" type="text/javascript"></script>
@endsection