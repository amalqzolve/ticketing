	...
	<div class="modal-dialog modal-xl" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="modalLabel">Upload Attachments</h5>
			...
			<div class="kt-portlet__head">
				<div class="kt-portlet__head-toolbar">
					<ul class="nav nav-tabs nav-tabs-line nav-tabs-line-primary nav-tabs-line-2x" role="tablist">
						...
						<li class="nav-item">
							<a class="nav-link  active" data-toggle="tab" href="{{URL::to('car-rental/trip-attachments',$id)}}" role="tab">
...
<script src="{{url('/')}}/resources/js/carRental/CarInAndOutFunctions/attachments.js" type="text/javascript"></script>
@endsection