			...
			<div class="kt-portlet__head">
				<div class="kt-portlet__head-toolbar">
					<ul class="nav nav-tabs nav-tabs-line nav-tabs-line-primary nav-tabs-line-2x" role="tablist">
						...
						<li class="nav-item">
							<a class="nav-link active " data-toggle="tab" href="{{URL::to('car-rental/trip-advance',$id)}}" role="tab">
					...
					<div class="tab-pane active" role="tabpanel">
						<div class="kt-portlet__head ">
							<div class="kt-portlet__head-label">
								<h5 class="kt-portlet__head-title">Payment </h5>
							</div>
							<div class="kt-portlet__head-toolbar">
								<div class="kt-portlet__head-wrapper">
									<div class="kt-portlet__head-actions">
										<a type="button" id="btnAdd" href="{{URL::to('car-rental/trip-advance-add',$id)}}" class="btn btn-default btn-brand btn-elevate btn-icon-sm" data-type="add"><i class="la la-plus"></i>New Record</a>
									</div>
								</div>
							</div>
						</div>
						<input type="hidden" name="car_in_out_id" id="car_in_out_id" value="{{$carInOut->id}}">
						<table class="table table-striped  table-hover table-checkable" id="tblAdvance">
							<thead>
								<tr>
									<th>@lang('app.S.No')</th>
									<th>Payment ID</th>
									<th>Payment @lang('app.Date')</th>
...
<script src="{{url('/')}}/resources/js/carRental/CarInAndOutFunctions/advance.js" type="text/javascript"></script>
@endsection