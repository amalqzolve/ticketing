	...
	<div class="modal-dialog modal-xl" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="modalLabel">Upload Agreements</h5>
...
<div class="modal fade" id="kt_modal_4_6" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
	<div class="modal-dialog modal-xl" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="modalLabel">Edit File Details</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"></button>
			</div>
			<div class="modal-body">
			...
			<div class="kt-portlet__head">
				<div class="kt-portlet__head-toolbar">
					<ul class="nav nav-tabs nav-tabs-line nav-tabs-line-primary nav-tabs-line-2x" role="tablist">
						...
						<li class="nav-item">
							<a class="nav-link  active" data-toggle="tab" href="{{URL::to('car-rental/trip-agreements',$id)}}" role="tab">
					...
					<div class="tab-pane active" role="tabpanel">
						<div class="kt-portlet__head ">
							<div class="kt-portlet__head-label">
								<h5 class="kt-portlet__head-title">Agreements</h5>
							</div>
							<div class="kt-portlet__head-toolbar">
								<div class="kt-portlet__head-wrapper">
									<div class="kt-portlet__head-actions">
										<!-- <button type="button" id="btnAdd" class="btn btn-default btn-brand btn-elevate btn-icon-sm" data-type="add"><i class="la la-plus"></i>New Agreement</button> -->
									</div>
								</div>
							</div>
						</div>
						<input type="hidden" name="car_in_out_id" id="car_in_out_id" value="{{$carInOut->id}}">
						<table class="table table-striped  table-hover table-checkable" id="filesTbl">
							<thead>
								<tr>
									<th>{{ __('customer.Sl. No') }}</th>
									<th>File</th>
									<th>Description</th>
									<th>Agreement Picked By</th>
									<th>Date</th>
									<th>Action</th>
								</tr>
							</thead>
...
<script src="{{url('/')}}/resources/js/carRental/CarInAndOutFunctions/agreements.js" type="text/javascript"></script>
@endsection