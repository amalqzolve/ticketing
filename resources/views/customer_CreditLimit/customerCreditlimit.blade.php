								...
								<div class="kt-portlet__head kt-portlet__head--lg">
									<div class="kt-portlet__head-label">
										...
										<h3 class="kt-portlet__head-title">
                                            {{ __('app.Cutomer Credit Limit List') }}										</h3>
									</div>
...
<!--begin: Datatable -->
<table class="table table-striped- table-bordered table-hover table-checkable" id="customerCredit_list">
    <thead>
        <tr>
            <th>{{ __('app.S.No') }}</th>
            <th>{{ __('app.Action') }}</th>
         ...
         <div class="form-group row">
            <div class="col-lg-4">
               <label>{{ __('customer.Customer Name') }}</label>
                    <select class="form-control single-select" id="cust_name" name="cust_name">
                         <option value="">{{ __('customer.Select') }}</option>
                         @foreach($data as $data)
                         <option value="{{$data->cust_name}}">{{$data->cust_name}}</option>
                         @endforeach
                    </select>
            </div>
            <div class="col-lg-4">
               <label>{{ __('app.Credit Limit on Number of Invoice') }}</label>
               <input type="text" class="form-control" placeholder="{{ __('app.Enter Number of Invoice') }}" id="numberinvoice" name="numberinvoice" autocomplete="off">
            </div>
             <div class="col-lg-4">
               <label>{{ __('customer.CreditLimit on TotalAmount') }}</label>
               <input type="text" class="form-control" placeholder="{{ __('app.CreditLimit on TotalAmount') }}" id="totalamount" name="totalamount"  autocomplete="off" style="padding-top: 0px;">
            </div>
...
@section('script')
    ...
    <script src="{{ URL::asset('assets') }}/js/pages/crud/datatables/basic/credit_limit.js" type="text/javascript"></script>
