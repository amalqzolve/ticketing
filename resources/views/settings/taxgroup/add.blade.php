							...
							<div class="kt-portlet kt-portlet--mobile">
								...
								<form class="kt-form" id="kt_form">
								 <div class="row" style="padding-bottom: 6px;">
									...
									<input type="text" class="form-control" name="taxgroup_name" placeholder="Tax Group Name" id="taxgroup_name">
									</div>
									</div>
									</div>
									<div class="col-lg-6">
									...
									<select class="form-control kt-select2 taxes" id="taxes" name="taxes[]" multiple="multiple">
									  ...
									  <option value="{{$taxlists->id}}">{{$taxlists->taxname}}</option>
									@endforeach
									</select>
									</div>
									</div>
									...
									<div class="col-md-8 input-group input-group-sm">
									<textarea class="form-control" name="description" placeholder="Note" id="description"></textarea>
									</div>
									</div>
									</div>
