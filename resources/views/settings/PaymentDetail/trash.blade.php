...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
	...
	<div class="kt-portlet kt-portlet--mobile">
		<div class="kt-portlet__head kt-portlet__head--lg">
			<div class="kt-portlet__head-label">    <span class="kt-portlet__head-icon">
				...
				<h3 class="kt-portlet__head-title">
											@lang('settings.Payment Terms Trash List')
				...
				<div class="kt-portlet__head-wrapper">
					...
					<div class="dropdown-menu dropdown-menu-right">
								<ul class="kt-nav">
									...
									<li class="kt-nav__item" id="paymenttrash_print"> <span href="#" class="kt-nav__link">
											<i class="kt-nav__link-icon la la-print"></i>
											<span class="kt-nav__link-text">@lang('app.Print')</span>
										</span>
									</li>
									<li class="kt-nav__item" id="paymenttrash_copy"> <span class="kt-nav__link">
											<i class="kt-nav__link-icon la la-copy"></i>
											<span class="kt-nav__link-text">@lang('app.Copy')</span>
										</span>
									</li>
									<li class="kt-nav__item" id="paymenttrash_csv">
										<a href="#" class="kt-nav__link"> <i class="kt-nav__link-icon la la-file-text-o"></i>
											<span class="kt-nav__link-text">@lang('app.CSV')</span>
										</a>
									</li>
									<li class="kt-nav__item" id="paymenttrash_pdf"> <span class="kt-nav__link">
		...
		<div class="kt-portlet__body">
			<table class="table table-striped  table-hover table-checkable" id="paymentmenttrashs">
				<thead>
					<tr>
						<th>{{ __('app.S.No') }}</th>
						<th>@lang('customer.Payment Terms')</th>
						<th>@lang('app.Note')</th>
						<th>{{ __('app.Action') }}</th>
					</tr>
				</thead>
...
<script src="{{url('/')}}/resources/js/settings/PaymentTerms.js" type="text/javascript"></script>
@endsection