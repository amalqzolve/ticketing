							...
							<div class="kt-portlet kt-portlet--mobile">
								...
								<form class="kt-form" id="kt_form">
								 <div class="row" style="padding-bottom: 6px;">
									...
									<input type="text" class="form-control" name="vouchername" placeholder="Voucher Name" id="vouchername">
									</div>
									</div>
									</div>
									<div class="col-lg-6">
									...
									<div class="col-md-8 input-group input-group-sm">
									<input type="text" class="form-control" name="prefix" placeholder="Prefix" id="prefix">
									</div>
									</div>
									</div>
									<div class="col-lg-6">
									...
									<div class="col-md-8 input-group input-group-sm">
									<input type="text" class="form-control" name="startingno" placeholder="Starting Number" id="startingno">
									</div>
									</div>
									</div>
									<div class="col-lg-6">
												...
												<div class="kt-form__actions">
													<div class="row">
														...
														<div class="col-lg-6 kt-align-right">
                                                            ...
                                                            <button type="submit" name="voucher_submit" id="voucher_submit" class="btn btn-primary">
