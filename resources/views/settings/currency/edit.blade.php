...
<br/>
							...
							@foreach($data as $datas)
									...
									<div class="col-md-4">
									<label>@lang('app.Currency Name')<span style="color: red">*</span></label>
									</div>
									<div class="col-md-8 input-group input-group-sm">
									<input type="text" class="form-control" name="currency_name" placeholder="Currency Name" id="currency_name" value="<?php echo $datas->currency_name;?>">
									</div>
									</div>
									</div>
									<div class="col-lg-6">
									...
									<div class="col-md-8 input-group input-group-sm">
									<input type="text" class="form-control" name="value" placeholder="Currency Value" id="value" value="<?php echo $datas->value;?>">
									</div>
									</div>
									</div>
									<div class="col-lg-6">
									...
									<div class="col-md-8 input-group input-group-sm">
									<input type="text" class="form-control" name="symbol" placeholder="Currency Symbol" id="symbol" value="<?php echo $datas->symbol;?>">
									</div>
									</div>
									</div>
									...
									<textarea class="form-control" name="notes" placeholder="notes" id="notes"><?php echo $datas->note;?></textarea>
									</div>
									</div>
									</div>
												...
												<div class="kt-form__actions">
													<div class="row">
														...
														<div class="col-lg-6 kt-align-right">
															...
															<button type="reset" class="btn btn-secondary cancel" onclick="Currencyedit_cancel()">
