			...
			<div class="kt-portlet__head-toolbar">
				<div class="kt-portlet__head-wrapper">
					<div class="kt-portlet__head-actions">
						...
						<a href="{{url('/')}}/settingsvendortypetrash" type="button" class="btn btn-secondary btn-hover-warning btn-icon-sm">@lang('app.Trash')
						</a>
					</div>
				</div>
			</div>
			 ...
			 id="vendortypedetails_list">
				<thead>
					<tr>
						...
						<th><strong>{{ __('vendor.VendorType') }}</strong></th>
	...
	<div class="modal-dialog modal-xl" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel">{{ __('vendor.VendorType') }}</h5>
						...
						<div class="form-group row">
								...
								<div class="form-group row pr-md-3">
									...
									<div class="col-md-8">
										<div class="input-group  input-group-sm">
											<input type="text" class="form-control" placeholder="{{ __('vendor.VendorType') }}" id="vendor_type" name="vendor_type" autocomplete="">
										</div>
									</div>
								</div>
							</div>
							<div class="col-lg-6">
								<div class="form-group row pl-md-3">
									...
									<div class="col-md-8">
										<div class="input-group  input-group-sm">
											<input type="text" class="form-control" placeholder="{{ __('app.Colour') }}" id="color"
								...
								<div class="form-group row ">
									...
									<div class="col-md-10 pl-md-2">
										<div class="input-group  input-group-sm">
											...
											<textarea placeholder="Note" class="form-control"  id="description"
...
<script src="{{url('/')}}/resources/js/settings/vendor.js" type="text/javascript">
</script>
@endsection