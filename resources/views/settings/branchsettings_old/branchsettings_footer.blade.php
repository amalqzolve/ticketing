...
<br/>
							<div class="kt-portlet kt-portlet--mobile">
								...
								<ul class="nav nav-tabs">
								  ...
								  <li class="nav-item">
									<a class="nav-link active" data-toggle="tab" href="#menu1">@lang('app.PDF Footer')</a>
								  </li>
								...
								<div class="tab-content">
								   ...
								   $header =isset($value->pdffooter)? $value->pdffooter :'';
								  		} @endphp
												...
												<div class="kt-form__actions">
													<div class="row">
														...
														<div class="col-lg-6 kt-align-right">
															...
															<button type="reset" class="btn btn-primary btn-icon-sm" id="pdffooter_submit">
    ...
    allowedFileTypes: ['image/*'],
		...
		onBeforeUpload: (files) => {
			...
			Object.keys(files).forEach(fileID => {
					fileData.push('pdffooter/' + files[fileID].name)
				})
				//return updatedFiles
...
$(document).on('click', '#pdffooter_submit', function(e) {
	e.preventDefault();

	$.ajax({
		type: "POST",
		url: "pdffooter_submit",
		dataType: "json",
		data: {
			_token: $('#token').val(),
			id: $('#id').val(),
		...
		success: function(data) {
			...
			$('#pdffooter_submit').removeClass('kt-spinner');
			$('#pdffooter_submit').prop("disabled", false);
			toastr.success('Sucessfully added');

			// swal.fire("Done", "Submission Sucessfully", "success");
			location.reload();
			window.location.href = "branchsettings_footer";
