							...
							<div class="kt-portlet kt-portlet--mobile">
								...
								<form class="kt-form" id="kt_form">
								 <div class="row" style="padding-bottom: 6px;">
									...
									<input type="text" class="form-control" name="accountname" placeholder="Account Name" id="accountname" value="{{$wallets->name}}">
									</div>
									</div>
									</div>
									...
									<div class="col-md-8 input-group input-group-sm">
									<select class="form-control kt-select2 ledger" id="ledger" name="ledger">
										@foreach($ledger as $ledgers)
										<option value="{{$ledgers->id}}"<?php if($ledgers->id == $wallets->ledger) { echo 'selected'; }?> >{{$ledgers->name}}</option>
										@endforeach
...
<input type="hidden" class="form-control" name="id" id="id" value="{{$wallets->id}}">
@endforeach
												...
												<div class="kt-form__actions">
													<div class="row">
														...
														<div class="col-lg-6 kt-align-right">
                                                            ...
                                                            <button type="submit" name="wallet_submit" id="wallet_submit" class="btn btn-primary">
