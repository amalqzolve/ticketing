									...
									<div class="kt-portlet__head-toolbar">
										<div class="kt-portlet__head-wrapper">
											<div class="kt-portlet__head-actions">
																							<a href="{{url('/')}}/settingsAdd-Unit" class="btn btn-brand btn-elevate btn-icon-sm">				<i class="la la-plus"></i>
												...
												<div class="dropdown dropdown-inline">
													...
													<a href="settingsunittrash" class="btn btn-secondary btn-hover-warning btn-icon-sm">
																																																							{{ __('product.Trash') }}
																																																			</a>
...
<table class="table table-striped table-hover table-checkable dataTable no-footer" id="productunitdetails_list">
				<thead>
								<tr>
												...
												<th><strong>{{ __('product.Unit Name') }}</strong></th>
												<th><strong>{{ __('product.Unit Code') }}</strong></th>
												<th><strong>{{ __('product.Base Unit') }}</strong></th>
												<!-- <th><strong>{{ __('product.Parent Unit') }}</strong></th> -->
												<th><strong>{{ __('product.Unit Value') }}</strong></th>
												<th><strong>{{ __('app.System ID') }}</strong></th>
												<th><strong>{{ __('product.Action') }}</strong></th>
								</tr>
				</thead>
				<tbody>
				</tbody>
