...
@section('content')
<link href="{{ URL::asset('assets') }}/plugins/crm/uppy/uppy.bundle.css" rel="stylesheet" type="text/css" />
<script src="{{ URL::asset('assets') }}/plugins/crm/uppy/uppy.bundle.js" type="text/javascript"></script>
							...
							<div class="kt-portlet kt-portlet--mobile">
								...
								<form class="kt-form" id="manufacture-form">
								 <div class="row" style="padding-bottom: 6px;">
									...
									<input type="text" class="form-control" name="name" id="name" placeholder="{{ __('customer.Name') }}" autocomplete="off">
									</div>
									</div>
									</div>
									</div>
									...
									<textarea class="form-control" placeholder="{{ __('app.Note') }}" id="note" name="note" autocomplete="off"></textarea>
									</div>
