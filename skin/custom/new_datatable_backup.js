	...
	datatable_iqama = $('#datatable_iqama').DataTable({
		...
		"buttons": [
			...
			},
			{
				...
				customize : function(doc) {
					doc.pageMargins = [50,50,50,50];
					doc.content[1].table.widths = [ '4%', '15%', '10%', '7%', 
														   '7%', '6%', '6%', '6%', 
																'6%', '8%', '6%', '6%',
																	'6%', '7%'];
				}
...
$("#document_Add").click(function() {
	window.location.href = base_url+'home/document_Add';
});
...
function documentedit(id) {
	window.location.href = base_url+'home/document_Add?id='+id;
}
...
function passport_notification_edit(id) {
	$.ajax({
		type: "POST",
...
function badge_notification_edit(id) {
	$.ajax({
		type: "POST",
...
function insurance_notification_edit(id) {
	$.ajax({
		type: "POST",
...
*****************************************/
function drivinglicense_notification_edit(id) {
	$.ajax({
		type: "POST",
...
function worklicense_notification_edit(id) {
	$.ajax({
		type: "POST",
...
*************************************************/
function id_notification_edit(id) {
	$.ajax({
		type: "POST",
