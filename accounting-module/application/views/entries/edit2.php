		...
		<div class="col-md-12">
			<div class="card card-primary card-outline">
					...
					<div class="entry add form">
						...
						<div class="card card-secondary">
							<div class="card-header">
								<h3 class="card-title"><?= lang('add_entries_below_label'); ?></h3>
							</div>
							<div class="card-body">
								<div class="row">
									<div class="col-md-1">
								...
								echo '<table class="stripped" id="edit_entries_table">';
								/* Header */
								echo "<thead>";
								...
								if (isset($curEntryitems) && !empty($curEntryitems) && sizeof($curEntryitems, 1) > 5) {
									foreach ($curEntryitems as $row => $entryitem) {
										...
										echo form_input($data);
										echo '<td>';
										echo '<span class="deleterow" escape="false"><i class="fas fa-trash"></i></span>';
										echo '</td>';
										echo '</tr>';
									}
								} else {
								...
								echo '<tr class="bold-text">' . '<td>' . lang('entries_views_add_items_td_total') . '</td>' . '<td>' . '</td>' . '<td id="dr-total">' . '</td>' . '<td id="cr-total">' . '</td>' . '<td>' . '' . '</td>' . '<td>' . '</td>' . '<td>' . '<span class="recalculate" escape="false"><i class="fas fa-sync"></i></span>' . '</td>' . '</tr>';
						...
						echo "<textarea name='notes' class='form-control' tabindex='9' rows='2'></textarea>";
						echo "</div>";
						?>
					</div>
				</div>
				<div class="card-footer">
					...
					echo anchor('entries/index', lang('entries_views_add_label_cancel_btn'), array('class' => 'btn btn-danger float-right', 'style' => 'margin-right: 5px;'));
					echo form_close();
					?>
				</div>
			</div>
