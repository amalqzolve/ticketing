			...
			<div class="card card-primary card-outline">
				...
				<div class="card-body">
					<div class="entry add form">
						...
						echo '<table class="stripped extra" id="add_entries_table">';
						/* Header */
						echo '<tr>';
						if ($this->mSettings->drcr_toby == 'toby') {
						...
						<?php
							...
							echo '<td>';
							echo '<span class="deleterow fas fa-trash" escape="false"></span>';
							echo '</td>';
							echo '</tr>';
						}
						/* Total and difference */
						echo '<tr class="bold-text">' . '<td>' . lang('entries_views_add_items_td_total') . '</td>' . '<td>' . '</td>' . '<td id="dr-total">' . '</td>' . '<td id="cr-total">' . '</td>' . '<td >' . '<span class="recalculate" escape="false"><i class="fas fa-sync"></i></span>' . '</td>' . '<td>' . '</td>' . '<td>' . '<span class="addrow" escape="false" style="padding-left: 5px;"><i class="fas fa-plus"></i></span>' . '</td>' . '</tr>';
