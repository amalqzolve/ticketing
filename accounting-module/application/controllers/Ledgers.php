 ...
 */
	public function edit($id = null) {
		...
		$allowed = $this->mAccountSettings->decimal_places;
		$this->form_validation->set_rules('name', lang("ledgers_cntrler_edit_form_validation_label_name"), 'required');
		$this->form_validation->set_rules('group_id', lang("ledgers_cntrler_edit_form_validation_label_group_id"), 'required');
		$this->form_validation->set_rules('op_balance_dc', lang("ledgers_cntrler_edit_form_validation_label_op_balance_dc"), 'required');
		$this->form_validation->set_rules('op_balance', lang("ledgers_cntrler_edit_form_validation_label_op_balance"), "amount_okay[$allowed]");
		$this->form_validation->set_rules('code', lang("ledgers_cntrler_edit_form_validation_label_code"), $is_unique);
