...
class RoleController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('crm.roles.create', compact('permission'));
    }
    ...
    public function show($id)
    {
        ...
        return view('crm.roles.show', compact('role', 'rolePermissions'));
    }
    public function edit($id)
    {
        ...
        $rolePermissions = DB::table("role_has_permissions")->where("role_has_permissions.role_id", $id)->pluck('role_has_permissions.permission_id', 'role_has_permissions.permission_id')
            ->all();
        return view('crm.roles.edit', compact('role', 'permission', 'rolePermissions'));
    }
