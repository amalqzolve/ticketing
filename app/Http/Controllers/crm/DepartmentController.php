...
*/
    public function index(Request $request)
    {
    	...
    	return view('crm.department.index',compact('branch'));
    }
/**
...
*/
    public function add()
    {
    	...
    	return view('crm.department.add',compact('branch'));
...
*/    
    public function edit_department(Request $request)
    {
    	...
    	$department=DepartmentModel::where('id',$id)->limit(1)
            ->first();
    	return view('crm.department.edit',['data' => $department],compact('branch'));
    }
 /**
...
*/  
    ...
    public function trash(Request $request)
    {
    	...
    	return view('crm.department.trash');
    }
/**
