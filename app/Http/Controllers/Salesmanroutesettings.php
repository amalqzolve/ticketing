...
use App\salesmanroute_settingModel;
use DB;
...
class Salesmanroutesettings extends Controller
{
     ...
     */
    public function salesmanrout_settings()
    {
        return view('salesman_routsettings.salesmanroute');
    }
    ...
    public function salesmanroutesettingList(Request $request)
    {
        ...
        foreach ($users as $user_detail)
        {
            ...
            $row[2] = $user_detail->routename;
            $row[3] = $user_detail->startpalce;
            $row[4] = $user_detail->endplace;
            $row[5] = $user_detail->totalkm;
            $data[$i] = $row;
            $i++;
    ...
    public function salesmansubmitgroup(Request $request)
    {
        ...
        'routename' => $request->routename, 'startpalce' => $request->startpalce, 'endplace' => $request->endplace, 'totalkm' => $request->totalkm
