...
class UserinfoController extends Controller
{
    ...
    public function userInfoSingle()
    {
        ...
        return view('user.userInfoSingle');
    }
    ...
    public function store(Request $request)
    {
        ...
        $data   = [
                ...
                'cust_officephone'  => $request->cust_officephone,
                'cust_mobile'       => $request->cust_mobile,
                'cust_fax'          => $request->cust_fax,
                'cust_website'      => $request->cust_website,
                'uniqueid'          => $request->UniqueID,
                'file_data'         => $request->file_data,
                'cust_users'        => isset($request->cust_users)?$request->cust_users:'',
            ];
    ...
    {
        $user = DB::table($table)->where('id', $row)->select('id','cust_name')->first();
        $data[$row]['id'] = $user->id;
