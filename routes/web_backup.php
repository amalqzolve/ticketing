...
Route::group(['middleware' => ['language', 'auth']], function () {
    ...
    Route::any('salesman_routepdf', 'crm\Salesmanroutesettings@salesman_routepdf')->name('salesman_routepdf');
    Route::any('crm', 'crm\DashboardController@index')->name('Dashboard');
    Route::post('CustomertypeList', 'crm\CustomerController@customertypeshow')
        ->name('CustomertypeList');
    Route::post('Typesubmit', 'crm\CustomerController@typeSubmit')
        ->name('Typesubmit');
    Route::any('customergroup', 'crm\CustomerController@groupindex')
        ->name('customergroup');
    Route::any('suppliergroup', 'crm\suppliergroup@supplier_grup')
        ->name('suppliergroup');
    Route::get('suppliergroupList', 'crm\suppliergroup@suppliergrupstore')
        ->name('suppliergroupList');
    Route::any('suppliergroupSubmit', 'crm\suppliergroup@submitgroup')
        ->name('suppliergroupSubmit');
    Route::any('getsuppliergrup', 'crm\suppliergroup@getsuppliergrup')
        ->name('getsuppliergrup');
    Route::any('deletesuppliergrupInfo', 'crm\suppliergroup@deletesuppliergrupInfo')
        ->name('deletesuppliergrupInfo');
    Route::any('suppliertrashshows', 'crm\suppliergroup@suppliergroupindex')
        ->name('suppliertrashshows');
    Route::post('suppliergruptrash', 'crm\suppliergroup@suppliergrouplist')
        ->name('suppliergruptrash');
    Route::any('suppliergrupTrashRestore', 'crm\suppliergroup@suppliergrupTrashRestore')
        ->name('suppliergrupTrashRestore');
    Route::any('suppliercategory', 'crm\SupplierController@category_list')
        ->name('suppliercategory');

    Route::any('supplier_pdf', 'crm\SupplierController@supplier_pdf')
        ->name('supplier_pdf');
    Route::post('grouptrashrestore', 'crm\CustomerController@grouptrashrestore')
        ->name('grouptrashrestore');
    Route::any('grouptrash', 'crm\CustomerController@grouptrash')
        ->name('grouptrash');
    Route::any('suppliercatgrySubmit', 'crm\SupplierController@Submit')
        ->name('suppliercatgrySubmit');
    Route::any('getsuppliercatgry', 'crm\SupplierController@getsuppliercatgry')
        ->name('getsuppliercatgry');
    Route::post('deletesuppliercatgryInfo', 'crm\SupplierController@deletesuppliercatgryInfo')
        ->name('deletesuppliercatgryInfo');
    Route::any('suppliercatgrytrash', 'crm\SupplierController@suplircatgry_trash')
        ->name('suppliercatgrytrash');
    Route::any('sup_cat_TrashRestore', 'crm\SupplierController@sup_cat_TrashRestore')
        ->name('sup_cat_TrashRestore');
    Route::post('CategoryLists', 'crm\SupplierController@Categoryshows')
        ->name('CategoryLists');
    Route::post('getgroupupdate', 'crm\CustomerController@groupupdate')
        ->name('getgroupupdate');
    Route::post('deletegroup', 'crm\CustomerController@groupdelete')
        ->name('deletegroup');

    Route::post('CustGroupinfo', 'crm\CustomerController@groupsubmit')
        ->name('CustGroupinfo');

    Route::post('getSinglecustomerInfo', 'crm\CustomerController@getSinglecustomerInfo')
        ->name('getSinglecustomerInfo');

    Route::any('customerdetails', 'crm\CustomerController@index')
        ->name('Customer Information');
    Route::get('addsupplierdetails', 'crm\SupplierController@index')
        ->name('addsupplierdetails.index');
    Route::any('supplierdetails', 'crm\SupplierController@supplierdetailss')
        ->name('supplierdetails');
    Route::post('SupplierList', 'crm\SupplierController@suppliershow')
        ->name('SupplierList');
    Route::get('edit_supplier', 'crm\SupplierController@edit_supplier')
        ->name('edit_supplier');
    Route::get('view_supplier', 'crm\SupplierController@view_supplier')
        ->name('view_supplier');

    Route::any('supplierdetailstrash', 'crm\SupplierController@supplierdetailstrash')
        ->name('supplierdetailstrash');
    Route::post('suptrashlist', 'crm\SupplierController@suptrashlist')
        ->name('suptrashlist');
    Route::post('SupplierSubmit', 'crm\SupplierController@suppliersubmit')
        ->name('SupplierSubmit');
    Route::post('supplierTrashRestore', 'crm\SupplierController@supplierTrashRestore')
        ->name('supplierTrashRestore');
    Route::any('suplier_accountpdf', 'crm\SupplierController@suplier_accountpdf')
        ->name('suplier_accountpdf');
    Route::post('deletesupplierInfo', 'crm\SupplierController@deletefiles')
        ->name('deletesupplierInfo');
    Route::any('supplierdocuments', 'crm\SupplierController@supplierdocuments')
        ->name('supplierdocuments');
    Route::any('sup_doc_view', 'crm\SupplierController@sup_doc_view')
        ->name('sup_doc_view');
    Route::any('sup_docpdf', 'crm\SupplierController@sup_docpdf')
        ->name('sup_docpdf');
    Route::any('SupplierdocumentList', 'crm\SupplierController@SupplierdocumentList')
        ->name('SupplierdocumentList');
    Route::any('edit_supplier_document', 'crm\SupplierController@edit_supplier_document')
        ->name('edit_supplier_document');

    Route::post('supplierdocumentSubmit', 'crm\SupplierController@supplierdocumentSubmit')
        ->name('supplierdocumentSubmit');

    Route::any('customertypedetails', 'crm\CustomerController@custtypeindex')
        ->name('customertypedetails.index');
    Route::any('customercategorydetails', 'crm\CustomerController@custcategoryindex')
        ->name('customercategorydetails.index');
    Route::any('Categoryinfo', 'crm\CustomerController@Categorys_submit')
        ->name('Categoryinfo');
    Route::any('categorytrash', 'crm\CustomerController@trashcategory')
        ->name('categorytrash');
    Route::any('typetrash', 'crm\CustomerController@typetrashs')
        ->name('typetrash');
    Route::any('customertrash', 'crm\CustomerController@customertrashshow')
        ->name('customertrash');
    Route::post('customerTrashRestore', 'crm\CustomerController@customertrashrestore')
        ->name('customerTrashRestore');

    Route::post('categoryTrashRestore', 'crm\CustomerController@trashrestore')
        ->name('categoryTrashRestore');
    Route::post('deletecustrows', 'crm\CustomerController@deleted')
        ->name('deletecustrows');
    Route::any('getcategorycode', 'crm\CustomerController@getcategorycode')
        ->name('getcategorycode');

    Route::any('edit_customer_document', 'crm\CustomerController@edit_customer_document')
        ->name('edit_customer_document');
    Route::any('cust_docpdf', 'crm\CustomerController@cust_docpdf')
        ->name('cust_docpdf');
    Route::post('customerdocumentSubmit', 'crm\CustomerController@customerdocumentSubmit')
        ->name('customerdocumentSubmit');

    Route::post('Categorytrashlist', 'crm\CustomerController@trashcategoryshow')
        ->name('Categorytrashlist');
    Route::post('typetrashlist', 'crm\CustomerController@trashtypeshow')
        ->name('typetrashlist');
    Route::post('getcategorylist', 'crm\CustomerController@categoryedit')
        ->name('getcategorylist');
    Route::post('deletecategory', 'crm\CustomerController@deletecategory')
        ->name('deletecategory');
    Route::post('deletetypeInfo', 'crm\CustomerController@deletetypeds')
        ->name('deletetypeInfo');

    Route::post('gettypeupdate', 'crm\CustomerController@type_updatess')
        ->name('gettypeupdate');
    Route::post('deleteCustomerInfo', 'crm\CustomerController@delete_customer')
        ->name('deleteCustomerInfo');
    Route::get('newcustomer', 'crm\CustomerController@add_custmer')
        ->name('newcustomer');
    Route::get('addcustomercategorydetails', 'crm\CustomerController@add_category')
        ->name('addcustomercategorydetails');
    Route::post('getcreditlimits', 'crm\customercreditlimit@getcreditlimitcustomer')
        ->name('getcreditlimits');
    Route::post('CustomerCreditSubmit', 'crm\customercreditlimit@CustomerCreditSubmit')
        ->name('CustomerCreditSubmit');

    Route::get('edit_customer', 'crm\CustomerController@edit_customer')
        ->name('edit_customer');
    Route::get('view_customer', 'crm\CustomerController@view_customer')
        ->name('view_customer');
    Route::get('view_type_lists', 'crm\CustomerController@view_type_list')
        ->name('view_type_lists');

    Route::get('view_category', 'crm\CustomerController@view_category_list')
        ->name('view_category');
    Route::post('CustomerSubmit', 'crm\CustomerController@submit_customer')
        ->name('CustomerSubmit');
    Route::get('edit_customer_docs', 'crm\CustomerController@edit_customer_docs')
        ->name('edit_customer_docs');

    Route::get('test', 'crm\HomeController@test')
        ->name('test');

    Route::any('supplier_type', 'crm\SupplierController@suplir_type')
        ->name('supplier_type');
    Route::any('suppliertypeList', 'crm\SupplierController@suppliertypestore')
        ->name('suppliertypeList');
    Route::any('suppliertypeSubmit', 'crm\SupplierController@typeSubmit')
        ->name('suppliertypeSubmit');

    Route::any('getsuppliertype', 'crm\SupplierController@getsuppliertype')
        ->name('getsuppliertype');
    Route::any('deletesuppliertypeInfo', 'crm\SupplierController@deletesuppliertypeInfo')
        ->name('deletesupplierInfo');
    Route::any('suppliertrash', 'crm\SupplierController@suplir_trash')
        ->name('suppliertrash');
    Route::post('suppliertypetrash', 'crm\SupplierController@getsuplir_trash')
        ->name('suppliertypetrash');
    Route::any('typeTrashRestores', 'crm\SupplierController@typeTrashRestores')
        ->name('typeTrashRestores');

    Route::get('edit_customers', 'crm\CustomerController@edits')
        ->name('edit_customers');
    Route::any('customer_pdf', 'crm\CustomerController@customer_pdf')
        ->name('customer_pdf');
    Route::get('edit_suppliers', 'crm\SupplierController@edits')
        ->name('edit_suppliers');
    Route::get('edit_supplier_docs', 'crm\SupplierController@edit_supplier_docs')
        ->name('edit_supplier_docs');

    Route::any('crmcustomerdocuments', 'crm\CustomerController@crmcustomerdocuments')->name('crmcustomerdocuments');
    Route::get('/findstartform', 'crm\CustomerController@findstartform');
    Route::get('/findsupplierstartfrom', 'crm\SupplierController@findsupplierstartfrom');

    Route::get('/vencategoryfindstartform', 'crm\vendorsController@vencategoryfindstartform');
    Route::get('supplier', 'crm\SupplierController@index')
        ->name('supplier.index');

    Route::any('vendors', 'crm\vendorsController@index')
        ->name('vendors.index');
    Route::post('vendorList', 'crm\vendorsController@vendorshow')
        ->name('vendorList');
    Route::get('addvendordetails', 'crm\vendorsController@addvendordetails')
        ->name('addvendordetails');
    Route::get('vendor_docpdf', 'crm\VendorDocumentController@vendor_docpdf')
        ->name('vendor_docpdf');
    Route::post('VendorSubmit', 'crm\vendorsController@submit_vendor')
        ->name('VendorSubmit');
    Route::post('getVendordetailsInfo', 'crm\vendorsController@edit_vendor')
        ->name('getVendordetailsInfo');
    Route::get('edit_vendor', 'crm\vendorsController@edit_vendor')
        ->name('edit_vendor');
    Route::post('deleteVendorInfo', 'crm\vendorsController@delete_vendor')
        ->name('deleteVendorInfo');
    Route::post('vendorRestoreTrash', 'crm\vendorsController@vendorTrashRestore')
        ->name('vendorRestoreTrash');
    Route::any('vendorcategorydetails', 'crm\VendorCategoryController@vendorcategoryindex')
        ->name('vendorcategorydetails');
    Route::get('addvendorcategorydetails', 'crm\VendorCategoryController@addvendorcategorydetails')
        ->name('VendorCategory.addvendorcategorydetails');
    Route::post('VendorCategorySubmit', 'crm\VendorCategoryController@submit_vendorcategory')
        ->name('VendorCategorySubmit');
    Route::get('edit_vendorcategory', 'crm\VendorCategoryController@edit_vendorcategory')
        ->name('edit_vendorcategory');
    Route::post('deleteVendorCategory', 'crm\VendorCategoryController@delete_vendorcategory')
        ->name('deleteVendorCategory');
    Route::any('vendorCategoryTrash', 'crm\VendorCategoryController@vendorCategoryTrash')
        ->name('vendorCategoryTrash');
    Route::post('vendorCategoryRestoreTrash', 'crm\VendorCategoryController@vendorcategoryRestore')
        ->name('vendorCategoryRestoreTrash');
    Route::any('vendortypedetails', 'crm\VendorTypeController@vendortypeindex')
        ->name('vendortypedetails');
    Route::post('VendorcategoryList', 'crm\VendorCategoryController@vendorcategoryshow')
        ->name('VendorcategoryList');
    Route::post('getvendortype', 'crm\VendorTypeController@typeedit')
        ->name('getvendortype');
    Route::post('VendorTypeSubmit', 'crm\VendorTypeController@submit_vendortype')
        ->name('VendorTypeSubmit');
    Route::post('deleteVendorType', 'crm\VendorTypeController@delete_vendortype')
        ->name('deleteVendorType');
    Route::any('vendortypetrash', 'crm\VendorTypeController@vendorTypeTrash')
        ->name('vendortypetrash');
    Route::post('VendorTypeRestoreTrash', 'crm\VendorTypeController@VendorTypeRestoreTrash')
        ->name('VendorTypeRestoreTrash');
    Route::post('vendortypetrashList', 'crm\VendorTypeController@vendortypelistTrash')
        ->name('vendortypetrashList');
    Route::any('vendorInfoTrash', 'crm\vendorsController@vendorInfoTrash')
        ->name('vendors.trash');
    Route::post('vendortrashList', 'crm\vendorsController@vendortrashshow')
        ->name('vendortrashList');
    Route::post('getvendorcategory', 'crm\VendorCategoryController@categoryedit')
        ->name('getvendorcategory');

    Route::get('vendortaxdetails', 'crm\VendorTaxController@vendortaxindex')
        ->name('VendorTax.index');
    Route::post('taxList', 'crm\VendorTaxController@taxList')
        ->name('taxList');
    Route::post('taxInfo', 'crm\VendorTaxController@store')
        ->name('taxInfo');
    Route::post('getTaxInfo', 'crm\VendorTaxController@getTaxInfo')
        ->name('getTaxInfo');
    Route::post('deleteTaxInfo', 'crm\VendorTaxController@deleteTaxInfo')
        ->name('deleteTaxInfo');
    Route::get('userTaxTrash', 'crm\VendorTaxController@TaxDetailsTrash')
        ->name('userTaxTrash');
    Route::post('taxtrashList', 'crm\VendorTaxController@taxinfotrash')
        ->name('taxtrashList');
    Route::post('VendorTaxRestoreTrash', 'crm\VendorTaxController@VendorTaxRestore')
        ->name('VendorTaxRestoreTrash');

    Route::any('vendorgroupdetails', 'crm\VendorGroupController@index')
        ->name('vendorgroupdetails');
    Route::post('getvendorgroup', 'crm\VendorGroupController@groupedit')
        ->name('getvendorgroup');
    Route::post('VendorGroupSubmit', 'crm\VendorGroupController@submit_vendorgroup')
        ->name('VendorGroupSubmit');
    Route::post('deleteVendorGroup', 'crm\VendorGroupController@delete_vendorgroup')
        ->name('deleteVendorGroup');
    Route::any('vendorgrouptrash', 'crm\VendorGroupController@GroupTrash')
        ->name('VendorGroup.trash');
    Route::post('vendorGroupRestoreTrash', 'crm\VendorGroupController@VendorGroupRestore')
        ->name('vendorGroupRestoreTrash');

    Route::any('vendordocuments', 'crm\VendorDocumentController@index')
        ->name('Vendor-Documents');
    Route::post('docList', 'crm\VendorDocumentController@docList')
        ->name('docList');
    Route::post('docInfo', 'crm\VendorDocumentController@store')
        ->name('docInfo');
    Route::post('getDocInfo', 'crm\VendorDocumentController@getDocInfo')
        ->name('getDocInfo');
    Route::post('deleteDocInfo', 'crm\VendorDocumentController@deleteDocInfo')
        ->name('deleteDocInfo');
    Route::any('edit_vendor_docs', 'crm\VendorDocumentController@edit_vendor_docs')
        ->name('edit_vendor_docs');
    Route::get('VendorDocTrash', 'crm\VendorDocumentController@DocDetailsTrash')
        ->name('VendorDocTrash');
    Route::post('DoctrashList', 'crm\VendorDocumentController@docinfotrash')
        ->name('DoctrashList');
    Route::post('getDocAdd', 'crm\VendorDocumentController@getDocAdd')
        ->name('getDocAdd');
    Route::post('getDocEdit', 'crm\VendorDocumentController@getDocEdit')
        ->name('getDocEdit');
    Route::post('VendordocList', 'crm\VendorDocumentController@VendordocList')
        ->name('VendordocList');
    Route::any('vendor_pdf', 'crm\vendorsController@vendor_pdf')
        ->name('vendor_pdf');
    Route::get('view_VendorDoc', 'crm\VendorDocumentController@view_vendordoc')
        ->name('view_VendorDoc');
    Route::get('vendorCreditLimits', 'crm\VendorCreditLimitController@index')
        ->name('VendorCredit.index');
    Route::post('VendorCreditList', 'crm\VendorCreditLimitController@VendorCreditList')
        ->name('VendorCreditList');
    Route::post('getCreditAdd', 'crm\VendorCreditLimitController@getCreditAdd')
        ->name('getCreditAdd');
    Route::post('CreditInfo', 'crm\VendorCreditLimitController@store')
        ->name('CreditInfo');
    Route::post('deleteCreditInfo', 'crm\VendorCreditLimitController@deleteCreditInfo')
        ->name('deleteCreditInfo');

    Route::any('paymentTerms', 'crm\PaymentController@index')
        ->name('PaymentDetail.index');

    Route::post('paymentTermstrashlists', 'crm\PaymentController@paymentttrashlists')
        ->name('paymentTermstrashlists');
    Route::any('PaymentSubmit', 'crm\PaymentController@PaymentSubmit')
        ->name('PaymentSubmit');
    Route::any('getPaymentTerms', 'crm\PaymentController@getPaymentTerms')
        ->name('getPaymentTerms');
    Route::any('deletePaymentInfo', 'crm\PaymentController@deletePaymentInfo')
        ->name('deletePaymentInfo');
    Route::any('paymentmenttrashdetails', 'crm\PaymentController@trash')
        ->name('PaymentDetail.trash');
    Route::any('paymentttrash', 'crm\PaymentController@paymentttrash')
        ->name('paymentttrash');
    Route::any('paymentTrashRestore', 'crm\PaymentController@paymentTrashRestore')
        ->name('paymentTrashRestore');
    Route::any('vendor_documentList', 'crm\VendorDocumentController@vendor_documentsshow')
        ->name('vendor_documentList');
    Route::any('edit_vendor_documents', 'crm\VendorDocumentController@edit_vendor_documents')
        ->name('edit_vendor_documents');
    Route::any('vendordocumentSubmit', 'crm\VendorDocumentController@vendordocumentSubmit')
        ->name('vendordocumentSubmit');

    Route::any('Department', 'crm\DepartmentController@index')
        ->name('Department');
    Route::any('newdepartment', 'crm\DepartmentController@add')
        ->name('newdepartment');
    Route::any('departmentSubmit', 'crm\DepartmentController@save')
        ->name('departmentSubmit');
    Route::any('edit_department', 'crm\DepartmentController@edit_department')
        ->name('edit_department');
    Route::any('deletedepartment', 'crm\DepartmentController@delete')
        ->name('deletedepartment');
    Route::any('departmenttrash', 'crm\DepartmentController@trash')
        ->name('departmenttrash');
    Route::any('departmenttrashlist', 'crm\DepartmentController@departmenttrashlist')
        ->name('departmenttrashlist');
    Route::get('/home', 'HomeController@index')
        ->name('home');
    Route::post('typeTrashRestore', 'crm\CustomerController@typetrashrestore')
        ->name('typeTrashRestore');

    Route::get('userActivity', 'userActivityController@index')
        ->name('userActivity');
    Route::post('userActivityList', 'userActivityController@userActivityList')
        ->name('userActivityList');

    Route::any('salesmandetailssettings', 'crm\SalesmanDetailController@salesmanindex', 'salesmandetailssettings');
    Route::any('keysalesmandetailssettings', 'crm\SalesmanDetailController@keysalesmanindex', 'keysalesmandetailssettings');
    Route::any('Salesmandetailstrash', 'crm\SalesmanDetailController@Salesmandetailstrash', 'Salesmandetailstrash');
    Route::any('salesmantrashs', 'crm\SalesmanDetailController@trashsalesman', 'salesmantrashs');
    Route::any('Salesmandetailsrestore', 'crm\SalesmanDetailController@Salesmandetailsrestore', 'Salesmandetailsrestore');
    Route::any('edit_salesman', 'crm\SalesmanDetailController@edit_salesman', 'edit_salesman');
    Route::any('keyedit_salesman', 'crm\SalesmanDetailController@keyedit_salesman', 'keyedit_salesman');
    Route::any('salesman_detailspdf', 'crm\SalesmanDetailController@salesman_detailspdf', 'salesman_detailspdf');

    Route::any('salesdepartment', 'crm\Salesdepartment@salesDepartment_settings')
        ->name('salesdepartment');
    Route::any('salesdepartmentList', 'crm\Salesdepartment@salesmandepartmentstore')
        ->name('salesdepartmentList');
    Route::any('saledepartmentSubmit', 'crm\Salesdepartment@salesdepartmentsubmitgroup')
        ->name('saledepartmentSubmit');
    Route::any('getsalesdepartment', 'crm\Salesdepartment@getsalesdepartmentsettings')
        ->name('getsalesdepartment');
    Route::any('deletesalesdptInfo', 'crm\Salesdepartment@deletesalesdptInfo')
        ->name('deletesalesdptInfo');
    Route::any('salesdepartmenttrashshows', 'crm\Salesdepartment@salesdepartment_index')
        ->name('salesdepartmenttrashshows');
    Route::any('salesdpttrash', 'crm\Salesdepartment@salesdepartmentList')
        ->name('salesdepartmentList');
    Route::any('salesdptTrashRestore', 'crm\Salesdepartment@salesDptTrashRestore')
        ->name('salesdptTrashRestore');
    Route::any('view_salesman', 'crm\SalesmanDetailController@view_salesman', 'view_salesman');
    Route::any('deletesalesmans', 'crm\SalesmanDetailController@deletesalesman', 'deletesalesman');
    Route::any('keydeletesalesman', 'crm\SalesmanDetailController@keydeletesalesman', 'keydeletesalesman');
    Route::any('addsalesmandetails', 'crm\SalesmanDetailController@addsalesmandetails', 'addsalesmandetails');
    Route::any('keyaddsalesmandetails', 'crm\SalesmanDetailController@keyaddsalesmandetails', 'keyaddsalesmandetails');

    Route::any('SalesmanSubmit', 'crm\SalesmanDetailController@SalesmanSubmit', 'SalesmanSubmit');
    Route::any('keySalesmanSubmit', 'crm\SalesmanDetailController@keySalesmanSubmit', 'keySalesmanSubmit');

    Route::any('salesmanroutesettings', 'crm\Salesmanroutesettings@salesmanrout_settings')
        ->name('salesmanroutesettings');
    Route::any('salesmanroutesettingList', 'crm\Salesmanroutesettings@salesmanroutestore')
        ->name('salesmanroutesettingList');
    Route::any('salesmanrouteSubmit', 'crm\Salesmanroutesettings@salesmansubmitgroup')
        ->name('salesmanrouteSubmit');
    Route::any('getsalesmanroutesettings', 'crm\Salesmanroutesettings@getsalesmanroutesettings')
        ->name('getsalesmanroutesettings');
    Route::any('deletesalesmanrouteInfo', 'crm\Salesmanroutesettings@deletesalesmanrouteInfo')
        ->name('deletesalesmanrouteInfo');
    Route::any('salesmanroutetrashshows', 'crm\Salesmanroutesettings@salesmanroute_index')
        ->name('salesmanroutetrashshows');
    Route::any('salesmanroutetrash', 'crm\Salesmanroutesettings@salesmanroutesettingList')
        ->name('salesmanroutetrash');
    Route::any('salesmanrouteTrashRestore', 'crm\Salesmanroutesettings@salesmanrouteTrashRestore')
        ->name('salesmanrouteTrashRestore');

    Route::get('salesmanaccounts', 'crm\SalesmanDetailController@salesmanaccounts', 'salesmanaccounts');
    Route::post('salesman_accounts_detailslist', 'crm\SalesmanDetailController@salesman_accounts_detailslist', 'salesman_accounts_detailslist');
    Route::post('getsalesmanaccounts', 'crm\SalesmanDetailController@getsalesmanaccounts')
        ->name('getsalesmanaccounts');
    Route::post('salesmanAccountSubmit', 'crm\SalesmanDetailController@salesmanAccountSubmit')
        ->name('salesmanAccountSubmit');

    Route::get('customercreditlimitdetails', 'crm\customercreditlimit@customercredit_settings')
        ->name('customercreditlimitdetails');
    Route::post('customercreditList', 'crm\customercreditlimit@customercreditstore')
        ->name('customercreditList');
    Route::post('creditlimitSubmit', 'crm\customercreditlimit@creditsubmitgroup')
        ->name('creditlimitSubmit');
    Route::post('getcreditlimit', 'crm\customercreditlimit@getcreditlimit')
        ->name('getcreditlimit');
    Route::post('deletecreditlimitInfo', 'crm\customercreditlimit@deletecreditlimitInfo')
        ->name('deletecreditlimitInfo');

    Route::any('vendoraccounts', 'crm\vendoraccountsController@accountsList')
        ->name('vendoraccounts');
    Route::any('vendoraccount_pdf', 'crm\vendoraccountsController@vendoraccount_pdf')
        ->name('vendoraccount_pdf');

    Route::any('supplieraccounts', 'crm\supplieraccountsController@accountsList')
        ->name('supplieraccounts');

    Route::post('SupAccountSubmit', 'crm\supplieraccountsController@accountsubmit')
        ->name('SupAccountSubmit');

    Route::any('customeraccounts', 'crm\customeraccountsController@accountsList')
        ->name('customeraccounts');
    Route::any('cust_account_pdf', 'crm\customeraccountsController@cust_account_pdf')
        ->name('cust_account_pdf');

    Route::any('CustomerAccountsList', 'crm\CustomerController@customeraccountshow')
        ->name('CustomerAccountsList');
    Route::post('getcustomeraccounts', 'crm\customeraccountsController@getaccountdata')
        ->name('getcustomeraccounts');

    Route::post('getgroup_details', 'crm\customeraccountsController@getgroup_details')
        ->name('getgroup_details');

    Route::post('CustAccountSubmit', 'crm\customeraccountsController@accountsubmit')
        ->name('CustAccountSubmit');

    Route::post('SupplieraccountsList', 'crm\SupplierController@supplieraccountsshow')
        ->name('SupplieraccountsList');

    Route::post('getsupplieraccounts', 'crm\supplieraccountsController@getaccountdata')
        ->name('getsupplieraccounts');

    Route::post('vendorAccountsList', 'crm\vendorsController@vendoraccountshow')
        ->name('vendorAccountsList');

    Route::post('getvendoraccounts', 'crm\vendoraccountsController@getaccountdata')
        ->name('getvendoraccounts');

    Route::post('VendorAccountSubmit', 'crm\vendoraccountsController@accountsubmit')
        ->name('VendorAccountSubmit');

    Route::post('getpayterms', 'crm\SupplierController@getpayterms')
        ->name('getpayterms');

    Route::post('FileUpload', 'crm\FileUploadController@store')
        ->name('FileUpload');
    Route::post('crmcustdocumentFileUpload', 'crm\FileUploadController@custdocumentInfoData')
        ->name('custdocumentInfoData');

    Route::post('customerdocumentDelete', 'crm\FileUploadController@customerdocumentDelete')
        ->name('customerdocumentDelete');

    Route::post('supplierdocumentDelete', 'crm\FileUploadController@supplierdocumentDelete')
        ->name('supplierdocumentDelete');

    Route::post('vendordocumentDelete', 'crm\FileUploadController@vendordocumentDelete')
        ->name('vendordocumentDelete');

    Route::post('supdocumentFileUpload', 'crm\FileUploadController@supdocumentFileUpload')
        ->name('supdocumentFileUpload');
    Route::post('vendordocumentFileUpload', 'crm\FileUploadController@vendordocumentFileUpload')
        ->name('vendordocumentFileUpload');
    Route::post('detUniqueID', 'CommonController@detUniqueID')
        ->name('detUniqueID');
    Route::get('salesdepartment', 'crm\Salesdepartment@salesDepartment_settings')
        ->name('salesdepartment');
    Route::get('salesdepartmentList', 'crm\Salesdepartment@salesmandepartmentstore')
        ->name('salesdepartmentList');
    Route::post('saledepartmentSubmit', 'crm\Salesdepartment@salesdepartmentsubmitgroup')
        ->name('saledepartmentSubmit');
    Route::post('getsalesdepartment', 'crm\Salesdepartment@getsalesdepartmentsettings')
        ->name('getsalesdepartment');
    Route::post('deletesalesdptInfo', 'crm\Salesdepartment@deletesalesdptInfo')
        ->name('deletesalesdptInfo');
    Route::get('salesdepartmenttrashshows', 'crm\Salesdepartment@salesdepartment_index')
        ->name('salesdepartmenttrashshows');
    Route::post('salesdpttrash', 'crm\Salesdepartment@salesdepartmentList')
        ->name('salesdepartmentList');
    Route::post('salesdptTrashRestore', 'crm\Salesdepartment@salesDptTrashRestore')
        ->name('salesdptTrashRestore');

    Route::any('customer_download', 'crm\CustomerController@customer_download')
        ->name('customer_download');
    Route::any('supplier_download', 'crm\SupplierController@supplier_download')
        ->name('supplier_download');
    Route::any('vendor_download', 'crm\VendorDocumentController@vendor_download')
        ->name('vendor_download');

    Route::get('download/{path}/{file}', 'crm\DownloadsController@download');
    Route::get('supplierdownload/{path}/{file}', 'crm\SupplierController@download');

    Route::get('vdownload/{path}/{uid}/{file}', 'crm\DownloadsController@download1');
    Route::any('ccdownload', 'crm\DownloadsController@ccdownload');
    Route::any('ssdownload', 'crm\DownloadsController@ssdownload');
    Route::any('vvdownload', 'crm\DownloadsController@vvdownload');
    Route::any('sgetcategorycode', 'crm\SupplierController@getcategorycode');

    Route::any('vgetcategorycode', 'crm\vendorsController@getcategorycode');

    Route::any('termsconditions', 'crm\TermsandconditionsController@list')
        ->name('list');

    Route::any('termsSubmit', 'crm\TermsandconditionsController@termsSubmit')
        ->name('termsSubmit');

    Route::any('termstrashdetails', 'crm\TermsandconditionsController@termstrashdetails')
        ->name('termstrashdetails');

    Route::any('deletetermsInfo', 'crm\TermsandconditionsController@deletetermsInfo')
        ->name('deletetermsInfo');

    Route::any('getTermsconditions', 'crm\TermsandconditionsController@getTermsconditions')
        ->name('getTermsconditions');

    Route::any('view_vendor', 'crm\vendorsController@view_vendor')
        ->name('view_vendor');

    Route::any('cust_doc_view', 'crm\CustomerController@cust_doc_view')
        ->name('Customer Doucment View');
    Route::any('vendor_doc_view', 'crm\VendorDocumentController@vendor_doc_view')
        ->name('Vendor Document View');

    Route::any('deleteCustomerdocumentfile', 'crm\CustomerController@deleteCustomerdocumentfile')
        ->name('deleteCustomerdocumentfile');

    Route::any('deleteSupplierdocumentfile', 'crm\CustomerController@deleteSupplierdocumentfile')
        ->name('deleteSupplierdocumentfile');

    Route::any('deleteVendordocumentfile', 'crm\CustomerController@deleteVendordocumentfile')
        ->name('deleteVendordocumentfile');
    Route::any('getcustomerusername', 'crm\CustomerController@getcustomerusername')
        ->name('getcustomerusername');
    Route::any('getsupplierusername', 'crm\SupplierController@getsupplierusername')
        ->name('getsupplierusername');
    Route::any('getvendorusername', 'crm\vendorsController@getvendorusername')
        ->name('getvendorusername');
    Route::any('getsalesmanemail', 'crm\SalesmanDetailController@getsalesmanemail')
        ->name('getsalesmanemail');

    Route::any('supplier-bank-account', 'crm\SupplierBankAccountController@list')->name('supplier-bank-account');
    Route::any('supplier-bank-account-add', 'crm\SupplierBankAccountController@add')->name('supplier-bank-account-add');
    Route::any('supplier-bank-account-save', 'crm\SupplierBankAccountController@save')->name('supplier-bank-account-save');
    Route::any('supplier-bank-account-edit-view', 'crm\SupplierBankAccountController@editView')->name('supplier-bank-account-edit-view');
    Route::any('supplier-bank-account-update', 'crm\SupplierBankAccountController@update')->name('supplier-bank-account-update');
    Route::any('supplier-bank-account-specific', 'crm\SupplierBankAccountController@specificSupplier')->name('supplier-bank-account-specific');
    Route::any('supplier-bank-account-pdf', 'crm\SupplierBankAccountController@pdf')->name('supplier-bank-account-pdf');

    Route::any('exportproductdatacustomer', 'crm\CustomerController@exportproductdatacustomer')->name('exportproductdatacustomer');
    Route::any('exportproductdatasupplier', 'crm\SupplierController@exportproductdatasupplier')->name('exportproductdatasupplier');
    Route::any('signatureupload', 'crm\FileUploadController@signatureupload')->name('signatureupload');
    Route::any('customerdatamigration', 'crm\DatamigrationController@customerdatamigration')->name('customerdatamigration');
    Route::any('customer_download', 'crm\DatamigrationController@customer_download')->name('customer_download');
    Route::post('file-import-customer', 'crm\DatamigrationController@submit_file_customer')->name('file-import-customer');
    Route::any('supplierdatamigration', 'crm\DatamigrationController@supplierdatamigration')->name('supplierdatamigration');
    Route::any('supplier_download', 'crm\DatamigrationController@supplier_download')->name('supplier_download');
    Route::post('file-import-supplier', 'crm\DatamigrationController@submit_file_supplier')->name('file-import-supplier');
    ...
    Route::any('paymentinvoicelist', 'sales\PaymentInvoiceController@paymentinvoicelist')->name('paymentinvoicelist');
    ...
    Route::any('settingscustomergroup', 'settings\CustomerController@groupindex')
        ->name('Customer Group');
    Route::any('settingsgrouptrash', 'settings\CustomerController@grouptrash')
        ->name('settingsgrouptrash');
    Route::post('settingsCustGroupinfo', 'settings\CustomerController@groupsubmit')
        ->name('CustGroupinfo');
    Route::post('settingsgetgroupupdate1', 'settings\CustomerController@groupupdate')
        ->name('settingsgetgroupupdate');
    Route::post('settingsdeletegroup', 'settings\CustomerController@groupdelete')
        ->name('deletegroup');
    Route::post('settingsgrouptrashrestore', 'settings\CustomerController@grouptrashrestore')
        ->name('grouptrashrestore');

    Route::any('settingscustomercategorydetails', 'settings\CustomerController@custcategoryindex')
        ->name('Customer Category Details');
    Route::any('settingscategorytrash', 'settings\CustomerController@trashcategory')
        ->name('Supplier Category Trash');
    Route::any('settingsCategoryinfo', 'settings\CustomerController@Categorys_submit')
        ->name('Categoryinfo');
    Route::post('settingsgetcategorylist', 'settings\CustomerController@categoryedit')
        ->name('getcategorylist');
    Route::post('settingsdeletecategory', 'settings\CustomerController@deletecategory')
        ->name('deletecategory');
    Route::post('settingscategoryTrashRestore', 'settings\CustomerController@trashrestore')
        ->name('categoryTrashRestore');

    Route::any('settingscustomertypedetails', 'settings\CustomerController@custtypeindex')
        ->name('Customer Type');
    Route::any('settingstypetrash', 'settings\CustomerController@typetrashs')
        ->name('Customer Type Trash');
    Route::post('settingsTypesubmit', 'settings\CustomerController@typeSubmit')
        ->name('Typesubmit');
    Route::post('settingsgettypeupdate', 'settings\CustomerController@type_updatess')
        ->name('gettypeupdate');
    Route::post('settingsdeletetypeInfo', 'settings\CustomerController@deletetypeds')
        ->name('deletetypeInfo');
    Route::post('settingstypeTrashRestore', 'settings\CustomerController@typetrashrestore')
        ->name('typeTrashRestore');

    Route::any('settingssuppliergroup', 'settings\SupplierController@supplier_grup')
        ->name('Supplier Group');
    Route::any('settingssuppliertrashshows', 'settings\SupplierController@suppliergroupindex')
        ->name('Supplier Group Trash');
    Route::any('settingssuppliergroupSubmit', 'settings\SupplierController@submitgroup')
        ->name('suppliergroupSubmit');
    Route::any('settingsgetsuppliergrup', 'settings\SupplierController@getsuppliergrup')
        ->name('getsuppliergrup');
    ...
    Route::any('settingssuppliercategory', 'settings\SupplierController@category_list')
        ->name('Supplier Category');
    Route::any('settingssuppliercatgrytrash', 'settings\SupplierController@suplircatgry_trash')
        ->name('Supplier Catgry Trash');
    Route::any('settingssuppliercatgrySubmit', 'settings\SupplierController@Submit')
        ->name('suppliercatgrySubmit');
    Route::any('settingsgetsuppliercatgry', 'settings\SupplierController@getsuppliercatgry')
        ->name('getsuppliercatgry');
    ...
    Route::any('company', 'settings\BranchController@company')->name('company');
    Route::any('settingscompanysubmit', 'settings\BranchController@settingscompanysubmit')->name('settingscompanysubmit');
    ...
    Route::any('branchsettings_header', 'settings\BranchController@branchsettings');
    Route::any('pdfheader_submit', 'settings\BranchController@pdfheader_submit');
    Route::any('pdfheaderFileUpload', 'settings\BranchController@pdfheaderFileUpload')
        ->name('pdfheaderFileUpload');

    Route::any('branchsettings_footer', 'settings\BranchController@branchsettings_footer');
    Route::any('pdffooter_submit', 'settings\BranchController@pdffooter_submit');
    Route::any('pdffooterFileUpload', 'settings\BranchController@pdffooterFileUpload')
        ->name('pdffooterFileUpload');
    ...
    Route::any('accountsettings', 'settings\AccountSettingsController@accountsettings')
        ->name('accountsettings');

    Route::any('settingsaccountssubmit', 'settings\AccountSettingsController@settingsaccountssubmit')->name('settingsaccountssubmit');

    Route::any('myaccount', 'settings\MyaccountController@index')->name('myaccount');

    Route::any('formatsettings', 'settings\BranchController@formatsettings')->name('formatsettings');
    Route::any('settingsformatsubmit', 'settings\BranchController@settingsformatsubmit')->name('settingsformatsubmit');
    ...
    Route::any('purchasereports', 'purchase\ReportsController@purchasereports')->name('purchasereports');


    Route::any('purchasereports1', 'Reports\ReportsController@purchasereports1')->name('purchasereports1');

    Route::any('purchaselistreports1', 'Reports\ReportsController@purchaselistreports1')->name('purchaselistreports1');

    Route::any('purchase_reportpdf_print', 'purchase\ReportsController@purchase_reportpdf_print')->name('purchase_reportpdf_print');

    Route::any('purchase_reportpdf_print1', 'Reports\ReportsController@purchase_reportpdf_print1')->name('purchase_reportpdf_print1');


    Route::any('purchase_pdf_print', 'purchase\PurchaseController@purchase_pdf_print')
        ->name('purchase_pdf_print');
    ...
    Route::any('logout', 'Auth\LoginController@logout')
        ->name('logout');
    Route::any('salesmanage', 'purchase1\PurchaseController@salesmanageListing')
        ->name('salesmanageListing');

    Route::any('salesmanage2', 'purchase1\PurchaseController@salesmanageListing2')
        ->name('salesmanageListing2');
    ...
    Route::any('paymentinvoicelist_sell', 'sell\PaymentInvoiceController@list')->name('paymentinvoicelist_sell');
    ...
    Route::any('gettermsqpurchase', 'sell\CommonController@gettermsquote')->name('gettermsqpurchase');
    ...
    Route::any('qpurchase_po_vo', 'qpurchase\PurchaseOrderController@po_vo')->name('qpurchase_po_vo');
    Route::any('qpurchasepovoupdate', 'qpurchase\PurchaseOrderController@qpurchasepovoupdate')->name('qpurchasepovoupdate');
    Route::any('qpurchase_order_issue', 'qpurchase\PurchaseOrderController@qpurchase_order_issue')->name('qpurchase_order_issue');
    Route::any('qpurchase_order_issue_submit', 'qpurchase\PurchaseOrderController@qpurchase_order_issue_submit')->name('qpurchase_order_issue_submit');
    Route::any('convertgrn', 'qpurchase\PurchaseOrderController@convertgrn')->name('convertgrn');
    Route::any('grnsubmit_qpurchase', 'qpurchase\PurchaseOrderController@grnsubmit_qpurchase')->name('grnsubmit_qpurchase');
    ...
    Route::any('p_soacorrect', 'qpurchase\PurchaseInvoiceController@p_soacorrect')->name('p_soacorrect');
    ...
    Route::any('qpurchase_debitnote', 'qpurchase\DebitNoteController@debitnote')->name('qpurchase_debitnote');
    Route::any('qpurchase_debitnote_add', 'qpurchase\DebitNoteController@add')->name('qpurchase_debitnote_add');
    Route::any('getpurchasenumber_purchase', 'qpurchase\CommonController@getpurchasenumber_purchase')->name('getpurchasenumber_purchase');
    Route::any('purchasenumber_submit_purchase_debit', 'qpurchase\DebitNoteController@purchasenumber_submit_purchase_debit')->name('purchasenumber_submit_purchase_debit');
    Route::any('qpurchase_debitnote_submit', 'qpurchase\DebitNoteController@qpurchase_debitnote_submit')->name('qpurchase_debitnote_submit');
    ...
    Route::any('qpurchasegrn_pdf', 'qpurchase\GRNController@pdf')->name('qpurchasegrn_pdf');
    ...
    Route::any('qpurchase_debitnote_pdf', 'qpurchase\DebitNoteController@pdf')->name('qpurchase_debitnote_pdf');
    ...
    Route::any('qpurchaseorder_pdf_comm', 'qpurchase\PurchaseOrderController@commpopdf')->name('qpurchaseorder_pdf_comm');
});
...
//Purchase Johny
Route::any('Addto-stock_sales_edit', 'purchase\SalesManagement@Addto_stock_sales_edit')
    ->name('Addto-stock_sales_edit');
Route::any('stock_submit_edit', 'purchase1\SalesManagement@stock_submit_edit')
    ->name('stock_submit_edit');
...
//
//seal
Route::any('seal', 'settings\SealController@seal')->name('seal');
Route::any('seal_submit', 'settings\SealController@sealsubmit')->name('seal_submit');
Route::any('sealupload', 'settings\SealController@sealupload')->name('sealupload');
...
//purchase soa
Route::any('soapurchase', 'Reports\PurchaseSOAController@soapurchase')->name('soapurchase');
Route::any('getsupplier_vendor_purchase_soa', 'Reports\PurchaseSOAController@getsupplier_vendor')->name('getsupplier_vendor');
Route::any('purchasesoasubmit', 'Reports\PurchaseSOAController@purchasesoasubmit')->name('purchasesoasubmit');
Route::any('soapurchasepdf', 'Reports\PurchaseSOAController@soapurchasepdf')->name('soapurchasepdf');
Route::any('soapurchaseexcel', 'Reports\PurchaseSOAController@soapurchaseexcel')->name('soapurchaseexcel');
...
Route::any('companylogoupload', 'settings\BranchController@companylogoupload')->name('companylogoupload');

Route::any('Purchaseinvoice-Approve', 'qpurchase\PurchaseInvoiceController@Purchase_Approve')->name('Purchase-Approve');

//salesmanage
Route::any('qpurchasesalesmanage', 'qpurchase\SalesmanageController@qpurchasesalesmanage')
    ->name('qpurchasesalesmanage');
Route::any('qpurchasesalesmanage2', 'qpurchase\SalesmanageController@salesmanageListing2')
    ->name('qpurchasesalesmanage2');
Route::any('Addto-stock_sales_purchase', 'qpurchase\SalesmanageController@AddtoStock_salesmanage');
Route::any('Addto-stock_sales_edit_purchase', 'qpurchase\SalesmanageController@Addto_stock_sales_edit');
//
//purchase bill settlement
Route::any('purchase_bill_settlement', 'qpurchase\PurchaseInvoiceController@purchase_bill_settlement')->name('purchase_bill_settlement');
Route::any('purchase_bill_settlement_add', 'qpurchase\PurchaseInvoiceController@purchase_bill_settlement_add')->name('purchase_bill_settlement_add');
Route::any('supplier_submit_purchase', 'qpurchase\PurchaseInvoiceController@supplier_submit_purchase')->name('supplier_submit_purchase');
Route::any('purchase_bill_settle_submit', 'qpurchase\PurchaseInvoiceController@purchase_bill_settle_submit')->name('purchase_bill_settle_submit');
Route::any('purchasebill_pdf', 'qpurchase\PurchaseInvoiceController@purchasebill_pdf')->name('purchasebill_pdf');
...
// Route::any('enquiryupdate_sell', 'sell\TicketController@update')->name('enquiryupdate_sell');
...
Route::any('purvatreport', 'sales\SalesReportController@purvatreport')
    ->name('purvatreport');
